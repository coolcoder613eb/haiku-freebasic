...
void IRINIT( void )
{
	label$10:;
	{
		$10FB_BACKEND TMP$105$2;
		TMP$105$2 = *($10FB_BACKEND*)((uint8*)&ENV$ + 208ll);
		if( TMP$105$2 != 1ll ) goto label$13;
		label$14:;
		{
		...
		goto label$12;
		label$13:;
		if( TMP$105$2 != 2ll ) goto label$15;
		label$16:;
		{
		...
		goto label$12;
		label$15:;
		if( TMP$105$2 != 3ll ) goto label$17;
		label$18:;
		{
...
void IRFOREACHDATASTMT( tmp$42 CALLBACK$1 )
{
	label$50:;
