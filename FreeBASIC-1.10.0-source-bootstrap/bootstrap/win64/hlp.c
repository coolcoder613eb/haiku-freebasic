...
uint8* HHEXUINT( uint64 VALUE$1 )
{
	...
	static struct $8FBARRAY1Iu7INTEGERE tmp$92$1 = { (int64*)HEXTB$1, (int64*)HEXTB$1, 128ll, 8ll, 1ll, 49ll, { { 16ll, 0ll, 15ll } } };
	MAXLEN$1 = 4ll;
...
FBSTRING* HFLOATTOHEX( double VALUE$1, int64 DTYPE$1 )
{
	...
	label$24:;
	if( TMP$107$1 != 16ll ) goto label$23;
	{
...
FBSTRING* HFLOATTOHEX_C99( double VALUE$1 )
{
	...
	FBSTRING* vr$37 = fb_StrConcat( &TMP$115$1, (void*)TMP$114$1, 0ll, (void*)vr$34, -1ll );
	__builtin_memset( &TMP$116$1, 0, 24ll );
	FBSTRING* vr$40 = fb_StrConcat( &TMP$116$1, (void*)"p", 2ll, (void*)vr$37, -1ll );
	__builtin_memset( &TMP$117$1, 0, 24ll );
	FBSTRING* vr$44 = fb_StrConcat( &TMP$117$1, (void*)&RET$1, -1ll, (void*)vr$40, -1ll );
...
int64 HFBRELOP2IRRELOP( int64 TK$1 )
{
	...
	static int64 OP$1;
	{
		...
		if( (TMP$118$2 - 299ull) > 5ull ) goto label$49;
		goto *tmp$119[TMP$118$2 - 299ull];
		label$41:;
	}
	fb$result$1 = OP$1;
	label$40:;
	...
	{
		{
			...
			if( TMP$121$3 > 122ull ) goto label$74;
...
FBSTRING* HSTRIPPATH( uint8* FILENAME$1 )
{
	...
	label$91:;
	{
		...
		*(int64*)((int64)(int64*)P$1 + 8ll) = vr$8;
		if( ((int64)-(*(int64*)P$1 == 0ll) | ((int64)-(*(int64*)((int64)(int64*)P$1 + 8ll) > 0ll) & (int64)-(*(int64*)((int64)(int64*)P$1 + 8ll) < *(int64*)P$1))) == 0ll ) goto label$95;
		{
		...
		label$94:;
		if( P_FOUND$1 != 0ll ) goto label$97;
		{
			goto label$92;
		}
		label$97:;
...
FBSTRING* HSTRIPFILENAME( uint8* FILENAME$1 )
{
	...
	label$102:;
	{
		...
		*(int64*)P$1 = vr$4;
		...
		int64 vr$8 = fb_StrInstr( LP$1 + 1ll, (FBSTRING*)vr$6, (FBSTRING*)vr$5 );
		*(int64*)((int64)(int64*)P$1 + 8ll) = vr$8;
		if( ((int64)-(*(int64*)P$1 == 0ll) | ((int64)-(*(int64*)((int64)(int64*)P$1 + 8ll) > 0ll) & (int64)-(*(int64*)((int64)(int64*)P$1 + 8ll) < *(int64*)P$1))) == 0ll ) goto label$106;
		{
			P_FOUND$1 = *(int64*)((int64)(int64*)P$1 + 8ll);
		}
		goto label$105;
		...
		label$105:;
		if( P_FOUND$1 != 0ll ) goto label$108;
		{
			goto label$103;
		}
		label$108:;
...
FBSTRING* HGETFILEEXT( uint8* FNAME$1 )
{
	...
	label$119:;
	{
		...
		if( ((int64)-(vr$11 > 0ll) | (int64)-(vr$14 > 0ll)) == 0ll ) goto label$121;
		{
			fb_StrAssign( (void*)&fb$result$1, -1ll, (void*)"", 1ll, 0 );
		}
		goto label$120;
		...
		if( vr$18 <= 0ll ) goto label$122;
		{
			if( ((int64)-((uint64)(int64)*(uint8*)*(uint8**)&RES$1 == 92ull) | (int64)-((uint64)(int64)*(uint8*)*(uint8**)&RES$1 == 47ull)) == 0ll ) goto label$124;
			{
				fb_StrAssign( (void*)&fb$result$1, -1ll, (void*)"", 1ll, 0 );
			}
			goto label$123;
...
void HREPLACESLASH( uint8* S$1, int64 CHAR$1 )
{
	label$125:;
	{
		...
		label$130:;
		{
			if( ((int64)-((int64)*(uint8*)((uint8*)S$1 + I$2) == 92ll) | (int64)-((int64)*(uint8*)((uint8*)S$1 + I$2) == 47ll)) == 0ll ) goto label$132;
			{
		...
		I$2 = I$2 + 1ll;
		label$127:;
		if( I$2 <= TMP$128$2 ) goto label$130;
		label$129:;
	}
	label$126:;
}
...
FBSTRING* PATHSTRIPDIV( FBSTRING* PATH$1 )
{
	...
	LENGTH$1 = vr$1;
	if( LENGTH$1 <= 0ll ) goto label$136;
	{
		LENGTH$1 = LENGTH$1 + -1ll;
		{
			uint8 TMP$129$3;
			TMP$129$3 = *(uint8*)((uint8*)*(uint8**)PATH$1 + LENGTH$1);
			if( (uint64)(int64)TMP$129$3 == 47ull ) goto label$139;
			label$140:;
			if( (uint64)(int64)TMP$129$3 != 92ull ) goto label$138;
			label$139:;
			{
...
int64 PATHISABSOLUTE( uint8* PATH$1 )
{
	...
	__builtin_memset( &fb$result$1, 0, 8ll );
	label$141:;
	if( (int64)*(uint8*)PATH$1 == 0ll ) goto label$144;
	{
		{
			uint8 TMP$130$3;
			TMP$130$3 = *(uint8*)((uint8*)PATH$1 + 1ll);
			if( (uint64)(int64)TMP$130$3 != 58ull ) goto label$146;
			label$147:;
			{
				fb$result$1 = -1ll;
			}
			goto label$145;
			label$146:;
			if( (uint64)(int64)TMP$130$3 != 92ull ) goto label$148;
			label$149:;
			{
...
int64 HCHECKFILEFORMAT( int64 F$1 )
{
	...
	{
		if( (int64)BOM$1 != 4294836224ll ) goto label$155;
		{
			FMT$1 = 5ll;
		}
		goto label$154;
		label$155:;
		if( (int64)BOM$1 != 65279ll ) goto label$156;
		{
			FMT$1 = 4ll;
		}
		goto label$154;
		label$156:;
		{
			...
			if( (int64)BOM$1 != 12565487ll ) goto label$158;
			{
				FMT$1 = 1ll;
			}
			goto label$157;
			label$158:;
			{
				...
				if( (int64)BOM$1 != 65279ll ) goto label$160;
				{
					FMT$1 = 2ll;
				}
				goto label$159;
				label$160:;
				if( (int64)BOM$1 != 65534ll ) goto label$161;
				{
					FMT$1 = 3ll;
				}
				label$161:;
		...
		label$154:;
		{
			if( FMT$1 != 0ll ) goto label$163;
			label$164:;
			{
				int32 vr$19 = fb_FileSeekLarge( (int32)F$1, 1ll );
				if( (int64)vr$19 == 0ll ) goto label$165;
			...
			goto label$162;
			label$163:;
			if( FMT$1 != 1ll ) goto label$166;
			label$167:;
			{
				int32 vr$23 = fb_FileSeekLarge( (int32)F$1, 4ll );
				if( (int64)vr$23 == 0ll ) goto label$168;
			...
			goto label$162;
			label$166:;
			if( FMT$1 == 2ll ) goto label$170;
			label$171:;
			if( FMT$1 != 3ll ) goto label$169;
			label$170:;
			{
...
FBSTRING* PATHSTRIPCURDIR( FBSTRING* PATH$1 )
{
	...
	if( (int64)vr$10 != 0ll ) goto label$178;
	{
...
int64 HISVALIDSYMBOLNAME( uint8* SYM$1 )
{
	...
	__builtin_memset( &fb$result$1, 0, 8ll );
	label$179:;
	if( SYM$1 != (uint8*)0ull ) goto label$182;
	{
		goto label$180;
		label$182:;
	}
	...
	SYMLEN$1 = vr$1;
	if( SYMLEN$1 != 0ll ) goto label$184;
	{
		goto label$180;
		label$184:;
	}
	if( (uint64)(int64)*SYM$1 < 97ull ) goto label$185;
	TMP$136$1 = (int64)-((uint64)(int64)*SYM$1 <= 122ull);
	goto label$203;
	label$185:;
	TMP$136$1 = 0ll;
	label$203:;
	if( TMP$136$1 != 0ll ) goto label$187;
	if( (uint64)(int64)*SYM$1 > 90ull ) goto label$186;
	TMP$138$1 = (int64)-((uint64)(int64)*SYM$1 >= 65ull);
	goto label$205;
	label$186:;
	TMP$138$1 = 0ll;
	label$205:;
	...
	TMP$139$1 = -1ll;
	label$204:;
	if( TMP$139$1 != 0ll ) goto label$188;
	TMP$141$1 = (int64)-((uint64)(int64)*SYM$1 == 95ull);
	goto label$206;
	label$188:;
	TMP$141$1 = -1ll;
	label$206:;
	if( TMP$141$1 != 0ll ) goto label$190;
	{
		goto label$180;
		label$190:;
	}
	{
		...
		label$194:;
		{
			...
			int64 TMP$147$3;
			int64 TMP$148$3;
			if( (uint64)(int64)*(uint8*)((uint8*)SYM$1 + I$2) < 97ull ) goto label$195;
			TMP$143$3 = (int64)-((uint64)(int64)*(uint8*)((uint8*)SYM$1 + I$2) <= 122ull);
			goto label$207;
			label$195:;
			TMP$143$3 = 0ll;
			label$207:;
			if( TMP$143$3 != 0ll ) goto label$197;
			if( (uint64)(int64)*(uint8*)((uint8*)SYM$1 + I$2) > 90ull ) goto label$196;
			TMP$144$3 = (int64)-((uint64)(int64)*(uint8*)((uint8*)SYM$1 + I$2) >= 65ull);
			goto label$209;
			label$196:;
			TMP$144$3 = 0ll;
			label$209:;
			...
			TMP$145$3 = -1ll;
			label$208:;
			if( TMP$145$3 != 0ll ) goto label$198;
			TMP$146$3 = (int64)-((uint64)(int64)*(uint8*)((uint8*)SYM$1 + I$2) == 95ull);
			goto label$210;
			label$198:;
			TMP$146$3 = -1ll;
			label$210:;
			if( TMP$146$3 != 0ll ) goto label$200;
			if( (uint64)(int64)*(uint8*)((uint8*)SYM$1 + I$2) > 57ull ) goto label$199;
			TMP$147$3 = (int64)-((uint64)(int64)*(uint8*)((uint8*)SYM$1 + I$2) >= 48ull);
			goto label$212;
			label$199:;
			TMP$147$3 = 0ll;
			label$212:;
			...
			TMP$148$3 = -1ll;
			label$211:;
			if( TMP$148$3 != 0ll ) goto label$202;
			{
				goto label$180;
				label$202:;
			}
		...
		I$2 = I$2 + 1ll;
		label$191:;
		if( I$2 <= TMP$142$2 ) goto label$194;
		label$193:;
	}
	fb$result$1 = -1ll;
	label$180:;
...
static int64 HFINDEXTBEGIN( FBSTRING* PATH$1 )
{
	...
	label$75:;
	{
		...
		label$80:;
		{
			{
				uint8 TMP$123$4;
				TMP$123$4 = *(uint8*)((uint8*)*(uint8**)PATH$1 + I$2);
				if( (uint64)(int64)TMP$123$4 != 46ull ) goto label$82;
				label$83:;
				{
					fb$result$1 = I$2;
					goto label$76;
				...
				goto label$81;
				label$82:;
				if( (uint64)(int64)TMP$123$4 == 92ull ) goto label$85;
				label$86:;
				if( (uint64)(int64)TMP$123$4 != 47ull ) goto label$84;
				label$85:;
				{
					goto label$79;
				}
