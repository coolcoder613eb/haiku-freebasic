...
struct $7ASTNODE* ASTCLONETREE( struct $7ASTNODE* N$1 )
{
	...
	label$20:;
	{
		$13AST_NODECLASS TMP$195$2;
		TMP$195$2 = *($13AST_NODECLASS*)N$1;
		if( TMP$195$2 != 17ll ) goto label$23;
		label$24:;
		{
		...
		goto label$22;
		label$23:;
		if( TMP$195$2 != 9ll ) goto label$29;
		label$30:;
		{
		...
		goto label$22;
		label$29:;
		if( TMP$195$2 != 26ll ) goto label$31;
		label$32:;
		{
		...
		goto label$22;
		label$31:;
		if( TMP$195$2 != 13ll ) goto label$33;
		label$34:;
		{
		...
		goto label$22;
		label$33:;
		if( TMP$195$2 != 36ll ) goto label$35;
		label$36:;
		{
		...
		goto label$22;
		label$35:;
		if( TMP$195$2 != 19ll ) goto label$37;
		label$38:;
		{
	...
	{
		{
			...
			if( TMP$196$3 != 1ll ) goto label$46;
			label$47:;
			{
			...
			goto label$45;
			label$46:;
			if( TMP$196$3 != 2ll ) goto label$48;
			label$49:;
			{
...
struct $7ASTNODE* ASTREBUILDWITHOUTEFFECTIVEPART( struct $7ASTNODE* N$1 )
{
	...
	if( *(int64*)N$1 != 15ll ) goto label$56;
	{
		...
		R$2 = *(struct $7ASTNODE**)((uint8*)N$1 + 120ll);
		{
			...
			if( TMP$197$3 != 1ll ) goto label$58;
			label$59:;
			{
			...
			goto label$57;
			label$58:;
			if( TMP$197$3 != 2ll ) goto label$60;
			label$61:;
			{
...
int64 ASTCANTAKEADDROF( struct $7ASTNODE* N$1 )
{
	...
	label$63:;
	{
		...
		label$69:;
		{
			{
				int64 TMP$199$4;
				TMP$199$4 = *(int64*)((uint8*)N$1 + 40ll);
				if( TMP$199$4 != 1ll ) goto label$71;
				label$72:;
				{
				...
				goto label$70;
				label$71:;
				if( TMP$199$4 != 2ll ) goto label$73;
				label$74:;
				{
		...
		goto label$65;
		label$66:;
		static const void* tmp$200[27ll] = {
			&&label$67,
			&&label$76,
			&&label$76,
			&&label$76,
		...
		if( (TMP$198$2 - 10ull) > 26ull ) goto label$76;
		goto *tmp$200[TMP$198$2 - 10ull];
		label$65:;
	}
	label$64:;
	return fb$result$1;
...
struct $7ASTNODE* ASTMAKEREF( struct $7ASTNODE** EXPR$1 )
{
	...
	TMP$201$1 = (int64)-(*(int64*)((uint8*)*(struct $8FBSYMBOL**)((uint8*)*EXPR$1 + 24ll) + 192ll) > 0ll);
	goto label$88;
	label$79:;
	TMP$201$1 = 0ll;
	label$88:;
	if( TMP$201$1 == 0ll ) goto label$81;
	{
	...
	if( *(int64*)*EXPR$1 != 9ll ) goto label$83;
	{
		{
			int64 TMP$202$3;
			TMP$202$3 = *(int64*)((uint8*)*EXPR$1 + 8ll) & 511ll;
			if( TMP$202$3 == 17ll ) goto label$86;
			label$87:;
			if( TMP$202$3 != 7ll ) goto label$85;
			label$86:;
			{
...
struct $7ASTNODE* ASTREMSIDEFX( struct $7ASTNODE** N$1 )
{
	...
	*N$1 = vr$2;
	{
		uint64 TMP$203$2;
		TMP$203$2 = (uint64)(*(int64*)((uint8*)*N$1 + 8ll) & 511ll);
		goto label$92;
		label$93:;
		{
		...
		if( (TMP$203$2 - 4ull) > 16ull ) goto label$94;
		goto *tmp$204[TMP$203$2 - 4ull];
		label$91:;
	}
	label$90:;
	return fb$result$1;
...
int64 ASTGETINVERSELOGOP( int64 OP$1 )
{
	...
	label$117:;
	{
		...
		if( (TMP$205$2 - 45ull) > 5ull ) goto label$119;
		goto *tmp$206[TMP$205$2 - 45ull];
		label$119:;
	}
	fb$result$1 = OP$1;
	label$118:;
