	...
	{
		{
			...
			label$192:;
			{
				...
				if( vr$15 == 0ll ) goto label$194;
				{
						...
						if( *(int64*)*(struct $8FBSYMBOL**)((uint8*)N$1 + 24ll) != 12ll ) goto label$198;
						{
							if( *(int64*)((uint8*)*(struct $8FBSYMBOL**)((uint8*)N$1 + 24ll) + 192ll) <= 0ll ) goto label$200;
							{
								if( *(int64*)((uint8*)*(struct $8FBSYMBOL**)((uint8*)N$1 + 24ll) + 184ll) != 0ll ) goto label$202;
								{
									...
									struct $7ASTNODE* vr$27 = _Z19ASTBUILDDEREFADDROFP7ASTNODExu7INTEGERP8FBSYMBOLS3_( vr$26, *(int64*)((uint8*)N$1 + 40ll), *(int64*)((uint8*)N$1 + 8ll), *(struct $8FBSYMBOL**)((uint8*)N$1 + 16ll), (struct $8FBSYMBOL*)0ull );
									L$1 = vr$27;
					...
					struct $7ASTNODE* vr$43 = _Z19ASTBUILDDEREFADDROFP7ASTNODExu7INTEGERP8FBSYMBOLS3_( vr$42, *(int64*)((uint8*)N$1 + 40ll), *(int64*)((uint8*)N$1 + 8ll), *(struct $8FBSYMBOL**)((uint8*)N$1 + 16ll), *(struct $8FBSYMBOL**)((uint8*)N$1 + 24ll) );
					L$1 = vr$43;
			...
			label$205:;
			{
				...
				if( vr$48 == 0ll ) goto label$207;
				{
					...
					struct $7ASTNODE* vr$53 = _Z19ASTBUILDDEREFADDROFP7ASTNODExu7INTEGERP8FBSYMBOLS3_( vr$52, *(int64*)((uint8*)N$1 + 40ll), *(int64*)((uint8*)N$1 + 8ll), *(struct $8FBSYMBOL**)((uint8*)N$1 + 16ll), (struct $8FBSYMBOL*)0ull );
					L$1 = vr$53;
			...
			label$209:;
			{
				...
				if( vr$58 == 0ll ) goto label$211;
				{
					...
					struct $7ASTNODE* vr$64 = _Z19ASTBUILDDEREFADDROFP7ASTNODExu7INTEGERP8FBSYMBOLS3_( vr$63, *(int64*)((uint8*)N$1 + 40ll), *(int64*)((uint8*)N$1 + 8ll), *(struct $8FBSYMBOL**)((uint8*)N$1 + 16ll), *(struct $8FBSYMBOL**)((uint8*)N$1 + 24ll) );
					L$1 = vr$64;
