...
static uint8* _PROCGETFRAMEREGNAME( void )
{
	...
	__builtin_memset( &fb$result$1, 0, 8ll );
	label$69:;
	uint8* vr$1 = (*(tmp$44*)((uint8*)&EMIT$ + 368ll))(  );
	fb$result$1 = vr$1;
	label$70:;
	return fb$result$1;
}
...
static void _EMITVARINISTR( int64 TOTLGT$1, uint8* LITSTR$1, int64 LITLGT$1 )
{
	...
	if( LITLGT$1 <= TOTLGT$1 ) goto label$187;
	{
		...
		uint8* vr$5 = HESCAPE( (uint8*)*(uint8**)&TMP$115$2 );
		S$1 = vr$5;
...
static void _EMITVARINIWSTR( int64 TOTLGT$1, uint16* LITSTR$1, int64 LITLGT$1 )
{
	...
	if( LITLGT$1 <= TOTLGT$1 ) goto label$195;
	{
		...
		TMP$116$2 = vr$2;
		uint8* vr$3 = HESCAPEW( (uint16*)TMP$116$2 );
		S$1 = vr$3;
		fb_WstrDelete( (uint16*)TMP$116$2 );
	}
	goto label$194;
	label$195:;
	{
		uint8* vr$4 = HESCAPEW( (uint16*)LITSTR$1 );
		S$1 = vr$4;
	}
	label$194:;
