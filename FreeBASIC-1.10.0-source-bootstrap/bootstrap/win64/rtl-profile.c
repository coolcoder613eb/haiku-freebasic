...
static void fb_ctor__rtlzprofile( void ) __attribute__(( constructor ));
...
static struct $14FB_RTL_PROCDEF DATAMCOUNTNORMAL$[2] = { { (uint8*)"fb_mcount", (uint8*)"mcount", 0ll, 3ll, (tmp$34)0ull, 0ll, 0ll }, { (uint8*)0ull } };
static struct $14FB_RTL_PROCDEF DATAMCOUNTWIN64$[2] = { { (uint8*)"fb_mcount", (uint8*)"_mcount", 0ll, 3ll, (tmp$34)0ull, 0ll, 0ll }, { (uint8*)0ull } };
static struct $14FB_RTL_PROCDEF DATAMONSTARTUP$[2] = { { (uint8*)"fb__monstartup", (uint8*)"_monstartup", 0ll, 3ll, (tmp$34)0ull, 0ll, 0ll }, { (uint8*)0ull } };

void RTLPROFILEMODINIT( void )
{
	label$10:;
	int64 vr$1 = FBIS64BIT(  );
	if( ((int64)-(*(int64*)((uint8*)&ENV$ + 216ll) == 0ll) & vr$1) == 0ll ) goto label$13;
	{
		RTLADDINTRINSICPROCS( (struct $14FB_RTL_PROCDEF*)DATAMCOUNTWIN64$ );
	}
	goto label$12;
	label$13:;
	{
		RTLADDINTRINSICPROCS( (struct $14FB_RTL_PROCDEF*)DATAMCOUNTNORMAL$ );
	}
	label$12:;
	RTLADDINTRINSICPROCS( (struct $14FB_RTL_PROCDEF*)DATAMONSTARTUP$ );
	label$11:;
}
...
struct $7ASTNODE* RTLPROFILECALL_MCOUNT( void )
{
	...
	label$16:;
	struct $8FBSYMBOL* vr$1 = RTLPROCLOOKUP( (uint8*)"fb_mcount", 334ll );
...
{
	label$18:;
	struct $8FBSYMBOL* vr$0 = RTLPROCLOOKUP( (uint8*)"fb__monstartup", 335ll );
	struct $7ASTNODE* vr$1 = ASTNEWCALL( vr$0, (struct $7ASTNODE*)0ull );
	ASTADD( vr$1 );
	label$19:;
}

__attribute__(( constructor )) static void fb_ctor__rtlzprofile( void )
{
	label$0:;
	label$1:;
}
