		...
		label$90:;
		{
			...
			label$103:;
			{
				...
				SUBTYPE$1 = *(struct $8FBSYMBOL**)((uint8*)FLD$2 + 64ll);
				{
					...
					goto label$115;
					label$104:;
					TMP$100$5 = DTYPE$1 & 31ll;
					label$115:;
					TMP$101$5 = TMP$100$5;
					if( TMP$101$5 != 20ll ) goto label$106;
					label$107:;
					{
			...
			if( (TMP$99$3 - 1ull) > 11ull ) goto label$114;
			goto *tmp$103[TMP$99$3 - 1ull];
			label$92:;
		}
		LEXSKIPTOKEN( 2112ll );
	}
		...
		if( SYM$2 == (struct $8FBSYMBOL*)0ull ) goto label$123;
		{
			...
			*IS_FIXLENSTR$1 = (int64)-((*(int64*)((uint8*)SYM$2 + 24ll) & 2097152ll) != 0ll);
			if( *(int64*)SYM$2 != 2ll ) goto label$127;
			{
				{
					int64 TMP$104$5;
					TMP$104$5 = *DTYPE$1 & 511ll;
					if( TMP$104$5 == 7ll ) goto label$130;
					label$131:;
					if( TMP$104$5 == 4ll ) goto label$130;
					label$132:;
					if( TMP$104$5 == 17ll ) goto label$130;
					label$133:;
					if( TMP$104$5 != 18ll ) goto label$129;
					label$130:;
					{
						*IS_FIXLENSTR$1 = -1ll;
...
struct $7ASTNODE* CMEMBERDEREF( int64 DTYPE$1, struct $8FBSYMBOL* SUBTYPE$1, struct $7ASTNODE* VAREXPR$1, int64 CHECK_ARRAY$1 )
{
	...
	label$159:;
	{
		IDXEXPR$1 = (struct $7ASTNODE*)0ull;
		{
			...
			TMP$108$3 = vr$1;
			if( TMP$108$3 != 400ll ) goto label$163;
			label$164:;
			{
				DEREFCNT$1 = 0ll;
				if( (DTYPE$1 & 480ll) == 0ll ) goto label$166;
				{
					...
					{
						int64 TMP$109$6;
						TMP$109$6 = DTYPE$1 & 511ll;
						if( TMP$109$6 == 0ll ) goto label$169;
						label$170:;
						if( TMP$109$6 != 23ll ) goto label$168;
						label$169:;
						{
						...
						goto label$167;
						label$168:;
						if( TMP$109$6 != 20ll ) goto label$171;
						label$172:;
						{
						}
						goto label$167;
			...
			goto label$162;
			label$163:;
			if( TMP$108$3 != 91ll ) goto label$192;
			label$193:;
			{
				LEXSKIPTOKEN( 0ll );
				...
				{
					int64 TMP$110$5;
					TMP$110$5 = DTYPE$1 & 511ll;
					if( TMP$110$5 == 17ll ) goto label$198;
					label$199:;
					if( TMP$110$5 == 18ll ) goto label$198;
					label$200:;
					if( TMP$110$5 == 4ll ) goto label$198;
					label$201:;
					if( TMP$110$5 != 7ll ) goto label$197;
					label$198:;
					{
					...
					goto label$196;
					label$197:;
					if( TMP$110$5 != 20ll ) goto label$202;
					label$203:;
					{
					...
					label$202:;
					{
						{
							int64 TMP$111$7;
							TMP$111$7 = DTYPE$1 & 511ll;
							if( TMP$111$7 == 0ll ) goto label$221;
							label$222:;
							if( TMP$111$7 != 23ll ) goto label$220;
							label$221:;
							{
								ERRREPORT( 71ll, -1ll, (uint8*)0ull );
								DTYPE$1 = 40ll;
			...
			goto label$162;
			label$192:;
			if( TMP$108$3 != 46ll ) goto label$238;
			label$239:;
			{
...
struct $7ASTNODE* CVARIABLE( struct $10FBSYMCHAIN* CHAIN_$1, int64 CHECK_ARRAY$1 )
{
	...
	label$396:;
	{
		...
		TMP$113$2 = vr$1;
		if( TMP$113$2 == 0ll ) goto label$400;
		label$401:;
		if( TMP$113$2 != 2ll ) goto label$399;
		label$400:;
		{
...
struct $7ASTNODE* CVARORDEREF( $13FB_VAREXPROPT OPTIONS$1 )
{
	...
	if( EXPR$1 == (struct $7ASTNODE*)0ull ) goto label$430;
	{
		...
		COMPLAIN$2 = -1ll;
		{
			...
			goto label$433;
			label$434:;
			static const void* tmp$115[17ll] = {
				&&label$436,
				&&label$433,
				&&label$433,
				&&label$433,
			...
			if( (TMP$114$3 - 9ull) > 16ull ) goto label$433;
			goto *tmp$115[TMP$114$3 - 9ull];
			label$433:;
		}
...
static struct $7ASTNODE* HCHECKINTEGERINDEX( struct $7ASTNODE* EXPR$1 )
{
	...
	label$14:;
	{
		...
		label$439:;
		TMP$94$2 = TMP$93$2;
		if( TMP$94$2 != 8ll ) goto label$18;
		label$19:;
		{
		}
		goto label$17;
		label$18:;
		if( TMP$94$2 != 24ll ) goto label$20;
		label$21:;
		{
...
static struct $8FBSYMBOL* HMEMBERID( struct $8FBSYMBOL* PARENT$1, int64 ALLOW_INNER$1 )
{
	...
	label$60:;
	{
		...
		goto label$62;
		label$63:;
		static const void* tmp$116[3ll] = {
			&&label$64,
			&&label$64,
			&&label$64,
		};
		if( TMP$95$2 > 2ull ) goto label$65;
		goto *tmp$116[TMP$95$2 - 0ull];
		label$62:;
	}
	RES$1 = (struct $8FBSYMBOL*)0ull;
	{
		...
		TMP$96$2 = vr$2;
		if( TMP$96$2 != 347ll ) goto label$67;
		label$68:;
		{
		...
		goto label$66;
		label$67:;
		if( TMP$96$2 != 348ll ) goto label$69;
		label$70:;
		{
	...
	SYM$1 = *(struct $8FBSYMBOL**)CHAIN_$1;
	{
		...
		goto label$75;
		label$76:;
		static const void* tmp$117[14ll] = {
			&&label$77,
			&&label$77,
			&&label$83,
			&&label$84,
		...
		if( (TMP$97$2 - 1ull) > 13ull ) goto label$84;
		goto *tmp$117[TMP$97$2 - 1ull];
		label$75:;
	}
	fb$result$1 = SYM$1;
	goto label$59;
...
static struct $7ASTNODE* HSTRINDEXING( int64 DTYPE$1, struct $7ASTNODE* VAREXPR$1, struct $7ASTNODE* IDXEXPR$1 )
{
	...
	label$440:;
	if( TMP$105$1 != 17ll ) goto label$144;
	{
	...
	label$441:;
	if( TMP$106$1 != 7ll ) goto label$147;
	{
	...
	label$442:;
	if( TMP$107$1 != 7ll ) goto label$152;
	{
...
static struct $8FBSYMBOL* HVARADDUNDECL( uint8* ID$1, int64 DTYPE$1 )
{
	...
	*(struct $10FBARRAYDIM**)((uint8*)&tmp$112$1 + 8ll) = (struct $10FBARRAYDIM*)DTB$1;
	*(int64*)((uint8*)&tmp$112$1 + 16ll) = 16ll;
	*(int64*)((uint8*)&tmp$112$1 + 24ll) = 16ll;
	*(int64*)((uint8*)&tmp$112$1 + 32ll) = 1ll;
	*(int64*)((uint8*)&tmp$112$1 + 40ll) = 49ll;
	*(int64*)((uint8*)&tmp$112$1 + 48ll) = 1ll;
	*(int64*)((uint8*)&tmp$112$1 + 56ll) = 0ll;
	*(int64*)((uint8*)&tmp$112$1 + 64ll) = 0ll;
	int64 ATTRIB$1;
	int64 OPTIONS$1;
	...
	label$286:;
	struct $8FBSYMBOL* vr$15 = SYMBADDVAR( (uint8*)ID$1, (uint8*)0ull, DTYPE$1, (struct $8FBSYMBOL*)0ull, 0ll, 0ll, (struct $7FBARRAYI10FBARRAYDIME*)&tmp$112$1, ATTRIB$1, OPTIONS$1 );
	S$1 = vr$15;
	if( S$1 != (struct $8FBSYMBOL*)0ull ) goto label$291;
	{
		ERRREPORTEX( 4ll, (uint8*)ID$1, 0ll, 1ll, (uint8*)0ull );
		uint8* vr$17 = SYMBUNIQUELABEL(  );
		struct $8FBSYMBOL* vr$18 = SYMBADDVAR( (uint8*)vr$17, (uint8*)0ull, DTYPE$1, (struct $8FBSYMBOL*)0ull, 0ll, 0ll, (struct $7FBARRAYI10FBARRAYDIME*)&tmp$112$1, ATTRIB$1, OPTIONS$1 );
		S$1 = vr$18;
	}
	goto label$290;
	label$291:;
