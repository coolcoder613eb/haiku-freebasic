...
static struct $7ASTNODE* _Z13HMAKEUINTMASKu8UINTEGER( uint64 );
static struct $7ASTNODE* _Z13HMAKEUINTMASKu8UINTEGERS_( uint64, uint64 );
...
FBSTRING* ASTDUMPOPTOSTR( $6AST_OP OP$1 )
{
	...
	if( ((int64)-(OP$1 > 120ll) | (int64)-(OP$1 < 0ll)) == 0ll ) goto label$201;
	{
		...
		FBSTRING* vr$7 = fb_StrConcat( &TMP$261$2, (void*)"OP:", 4ll, (void*)vr$4, -1ll );
...
static struct $7ASTNODE* _Z13HMAKEUINTMASKu8UINTEGER( uint64 BITS$1 )
{
	struct $7ASTNODE* fb$result$1;
	__builtin_memset( &fb$result$1, 0, 8ll );
	label$130:;
...
static struct $7ASTNODE* _Z13HMAKEUINTMASKu8UINTEGERS_( uint64 BITS$1, uint64 BITPOS$1 )
{
	struct $7ASTNODE* fb$result$1;
	__builtin_memset( &fb$result$1, 0, 8ll );
	label$136:;
	struct $7ASTNODE* vr$1 = ASTNEWCONSTI( (int64)BITPOS$1, 8ll, (struct $8FBSYMBOL*)0ull );
	struct $7ASTNODE* vr$2 = _Z13HMAKEUINTMASKu8UINTEGER( BITS$1 );
...
static struct $7ASTNODE* ASTSETBITFIELD( struct $8FBSYMBOL* BITFIELD$1, struct $7ASTNODE* L$1, struct $7ASTNODE* R$1 )
{
	...
	L$1 = vr$12;
	struct $7ASTNODE* vr$15 = _Z13HMAKEUINTMASKu8UINTEGERS_( *(uint64*)((uint8*)BITFIELD$1 + 192ll), *(uint64*)((uint8*)BITFIELD$1 + 184ll) );
	...
	if( (*(int64*)((uint8*)BITFIELD$1 + 56ll) & 511ll) != 1ll ) goto label$143;
	{
		...
		R$1 = vr$24;
		struct $7ASTNODE* vr$27 = _Z13HMAKEUINTMASKu8UINTEGERS_( *(uint64*)((uint8*)BITFIELD$1 + 192ll), *(uint64*)((uint8*)BITFIELD$1 + 184ll) );
	...
	label$143:;
	{
		struct $7ASTNODE* vr$30 = _Z13HMAKEUINTMASKu8UINTEGER( *(uint64*)((uint8*)BITFIELD$1 + 192ll) );
...
static struct $7ASTNODE* ASTACCESSBITFIELD( struct $8FBSYMBOL* BITFIELD$1, struct $7ASTNODE* L$1 )
{
	...
	label$154:;
	label$153:;
	struct $7ASTNODE* vr$22 = _Z13HMAKEUINTMASKu8UINTEGER( *(uint64*)((uint8*)BITFIELD$1 + 192ll) );
...
static FBSTRING* HASTNODECLASSTOSTR( $13AST_NODECLASS C$1 )
{
	...
	if( ((int64)-(C$1 > 44ll) | (int64)-(C$1 < 0ll)) == 0ll ) goto label$205;
	{
		...
		FBSTRING* vr$7 = fb_StrConcat( &TMP$263$2, (void*)"CLASS:", 7ll, (void*)vr$4, -1ll );
		fb_StrInit( (void*)&fb$result$1, -1ll, (void*)vr$7, -1ll, 0 );
		goto label$203;
	}
	label$205:;
...
static FBSTRING* HASTNODETOSTR( struct $7ASTNODE* N$1 )
{
	...
	label$217:;
	{
		...
		label$221:;
		{
			...
			FBSTRING* vr$8 = fb_StrConcat( &TMP$266$3, (void*)vr$5, -1ll, (void*)" =-= ", 6ll );
			__builtin_memset( &TMP$267$3, 0, 24ll );
			FBSTRING* vr$11 = fb_StrConcat( &TMP$267$3, (void*)vr$8, -1ll, (void*)vr$3, -1ll );
		...
		label$223:;
		{
			...
			goto label$268;
			label$224:;
			TMP$268$3 = *(int64*)((uint8*)N$1 + 8ll) & 31ll;
			label$268:;
			if( *(int64*)((int64)(struct $13SYMB_DATATYPE*)SYMB_DTYPETB$ + (TMP$268$3 * 56ll)) != 1ll ) goto label$226;
			{
				FBSTRING TMP$271$4;
				FBSTRING TMP$272$4;
				FBSTRING TMP$273$4;
				...
				FBSTRING* vr$24 = fb_StrConcat( &TMP$271$4, (void*)" (", 3ll, (void*)vr$21, -1ll );
				__builtin_memset( &TMP$272$4, 0, 24ll );
				FBSTRING* vr$27 = fb_StrConcat( &TMP$272$4, (void*)vr$24, -1ll, (void*)")", 2ll );
				FBSTRING* vr$29 = fb_DoubleToStr( *(double*)((uint8*)N$1 + 40ll) );
				__builtin_memset( &TMP$273$4, 0, 24ll );
				FBSTRING* vr$32 = fb_StrConcat( &TMP$273$4, (void*)vr$29, -1ll, (void*)vr$27, -1ll );
			...
			FBSTRING* vr$37 = fb_StrConcat( &TMP$274$3, (void*)" (", 3ll, (void*)vr$34, -1ll );
			__builtin_memset( &TMP$275$3, 0, 24ll );
			FBSTRING* vr$40 = fb_StrConcat( &TMP$275$3, (void*)vr$37, -1ll, (void*)")", 2ll );
			FBSTRING* vr$42 = fb_LongintToStr( *(int64*)((uint8*)N$1 + 40ll) );
			__builtin_memset( &TMP$276$3, 0, 24ll );
			FBSTRING* vr$45 = fb_StrConcat( &TMP$276$3, (void*)vr$42, -1ll, (void*)vr$40, -1ll );
		...
		label$227:;
		{
			...
			FBSTRING* vr$50 = fb_StrConcat( &TMP$283$3, (void*)" (", 3ll, (void*)vr$47, -1ll );
			__builtin_memset( &TMP$284$3, 0, 24ll );
			FBSTRING* vr$53 = fb_StrConcat( &TMP$284$3, (void*)vr$50, -1ll, (void*)")", 2ll );
			if( *(struct $8FBSYMBOL**)((uint8*)N$1 + 24ll) == (struct $8FBSYMBOL*)0ull ) goto label$228;
			TMP$279$3 = *(uint8**)((uint8*)*(struct $8FBSYMBOL**)((uint8*)N$1 + 24ll) + 32ll);
			goto label$269;
			label$228:;
			TMP$279$3 = (uint8*)"<NULL>";
			label$269:;
			__builtin_memset( &TMP$281$3, 0, 24ll );
			FBSTRING* vr$59 = fb_StrConcat( &TMP$281$3, (void*)"VAR( ", 6ll, (void*)TMP$279$3, 0ll );
			__builtin_memset( &TMP$282$3, 0, 24ll );
			FBSTRING* vr$62 = fb_StrConcat( &TMP$282$3, (void*)vr$59, -1ll, (void*)" )", 3ll );
			__builtin_memset( &TMP$285$3, 0, 24ll );
			FBSTRING* vr$65 = fb_StrConcat( &TMP$285$3, (void*)vr$62, -1ll, (void*)vr$53, -1ll );
		...
		label$229:;
		{
			...
			FBSTRING* vr$70 = fb_StrConcat( &TMP$289$3, (void*)" (", 3ll, (void*)vr$67, -1ll );
			__builtin_memset( &TMP$290$3, 0, 24ll );
			FBSTRING* vr$73 = fb_StrConcat( &TMP$290$3, (void*)vr$70, -1ll, (void*)")", 2ll );
			__builtin_memset( &TMP$287$3, 0, 24ll );
			FBSTRING* vr$78 = fb_StrConcat( &TMP$287$3, (void*)"FIELD( ", 8ll, *(void**)((uint8*)*(struct $8FBSYMBOL**)((uint8*)N$1 + 24ll) + 32ll), 0ll );
			__builtin_memset( &TMP$288$3, 0, 24ll );
			FBSTRING* vr$81 = fb_StrConcat( &TMP$288$3, (void*)vr$78, -1ll, (void*)" )", 3ll );
			__builtin_memset( &TMP$291$3, 0, 24ll );
			FBSTRING* vr$84 = fb_StrConcat( &TMP$291$3, (void*)vr$81, -1ll, (void*)vr$73, -1ll );
		...
		label$230:;
		{
			...
			if( *(struct $8FBSYMBOL**)((uint8*)N$1 + 24ll) == (struct $8FBSYMBOL*)0ull ) goto label$232;
			{
				...
				FBSTRING* vr$91 = fb_StrConcat( &TMP$293$4, (void*)"DECL( ", 7ll, *(void**)((uint8*)*(struct $8FBSYMBOL**)((uint8*)N$1 + 24ll) + 32ll), 0ll );
				__builtin_memset( &TMP$294$4, 0, 24ll );
				FBSTRING* vr$94 = fb_StrConcat( &TMP$294$4, (void*)vr$91, -1ll, (void*)" )", 3ll );
			...
			FBSTRING* vr$99 = fb_StrConcat( &TMP$295$3, (void*)" (", 3ll, (void*)vr$96, -1ll );
			__builtin_memset( &TMP$296$3, 0, 24ll );
			FBSTRING* vr$102 = fb_StrConcat( &TMP$296$3, (void*)vr$99, -1ll, (void*)")", 2ll );
			__builtin_memset( &TMP$297$3, 0, 24ll );
			FBSTRING* vr$105 = fb_StrConcat( &TMP$297$3, (void*)"DECL", 5ll, (void*)vr$102, -1ll );
		...
		label$233:;
		{
			...
			FBSTRING* vr$111 = fb_StrConcat( &TMP$299$3, (void*)"CALL( ", 7ll, *(void**)((uint8*)*(struct $8FBSYMBOL**)((uint8*)N$1 + 24ll) + 32ll), 0ll );
			__builtin_memset( &TMP$300$3, 0, 24ll );
			FBSTRING* vr$114 = fb_StrConcat( &TMP$300$3, (void*)vr$111, -1ll, (void*)" )", 3ll );
		...
		label$234:;
		{
			...
			FBSTRING* vr$120 = fb_StrConcat( &TMP$302$3, (void*)"LABEL: ", 8ll, (void*)vr$117, -1ll );
		...
		label$235:;
		{
			...
			FBSTRING* vr$128 = fb_StrConcat( &TMP$305$3, (void*)"BRANCH: ", 9ll, (void*)vr$125, -1ll );
			__builtin_memset( &TMP$306$3, 0, 24ll );
			FBSTRING* vr$131 = fb_StrConcat( &TMP$306$3, (void*)vr$128, -1ll, (void*)" ", 2ll );
			__builtin_memset( &TMP$307$3, 0, 24ll );
			FBSTRING* vr$134 = fb_StrConcat( &TMP$307$3, (void*)vr$131, -1ll, (void*)vr$123, -1ll );
		...
		label$236:;
		{
			...
			FBSTRING* vr$140 = fb_StrConcat( &TMP$309$3, (void*)"SCOPEBEGIN: ", 13ll, (void*)vr$137, -1ll );
		...
		label$237:;
		{
			...
			FBSTRING* vr$145 = fb_StrConcat( &TMP$318$3, (void*)" (", 3ll, (void*)vr$142, -1ll );
			__builtin_memset( &TMP$319$3, 0, 24ll );
			FBSTRING* vr$148 = fb_StrConcat( &TMP$319$3, (void*)vr$145, -1ll, (void*)")", 2ll );
			...
			FBSTRING* vr$157 = fb_StrConcat( &TMP$313$3, (void*)vr$154, -1ll, (void*)"( offset=", 10ll );
			__builtin_memset( &TMP$314$3, 0, 24ll );
			FBSTRING* vr$160 = fb_StrConcat( &TMP$314$3, (void*)vr$157, -1ll, (void*)vr$152, -1ll );
			__builtin_memset( &TMP$315$3, 0, 24ll );
			FBSTRING* vr$163 = fb_StrConcat( &TMP$315$3, (void*)vr$160, -1ll, (void*)", bytes=", 9ll );
			__builtin_memset( &TMP$316$3, 0, 24ll );
			FBSTRING* vr$166 = fb_StrConcat( &TMP$316$3, (void*)vr$163, -1ll, (void*)vr$150, -1ll );
			__builtin_memset( &TMP$317$3, 0, 24ll );
			FBSTRING* vr$169 = fb_StrConcat( &TMP$317$3, (void*)vr$166, -1ll, (void*)" ) ", 4ll );
			__builtin_memset( &TMP$320$3, 0, 24ll );
			FBSTRING* vr$172 = fb_StrConcat( &TMP$320$3, (void*)vr$169, -1ll, (void*)vr$148, -1ll );
		...
		label$238:;
		{
			...
			FBSTRING* vr$177 = fb_StrConcat( &TMP$324$3, (void*)" (", 3ll, (void*)vr$174, -1ll );
			__builtin_memset( &TMP$325$3, 0, 24ll );
			FBSTRING* vr$180 = fb_StrConcat( &TMP$325$3, (void*)vr$177, -1ll, (void*)")", 2ll );
			FBSTRING* vr$182 = ASTDUMPOPTOSTR( *($6AST_OP*)((uint8*)N$1 + 40ll) );
			__builtin_memset( &TMP$322$3, 0, 24ll );
			FBSTRING* vr$185 = fb_StrConcat( &TMP$322$3, (void*)"MACRO: ", 8ll, (void*)vr$182, -1ll );
			__builtin_memset( &TMP$323$3, 0, 24ll );
			FBSTRING* vr$188 = fb_StrConcat( &TMP$323$3, (void*)vr$185, -1ll, (void*)" ", 2ll );
			__builtin_memset( &TMP$326$3, 0, 24ll );
			FBSTRING* vr$191 = fb_StrConcat( &TMP$326$3, (void*)vr$188, -1ll, (void*)vr$180, -1ll );
		...
		label$239:;
		{
			...
			{
				int64 TMP$327$4;
				TMP$327$4 = *(int64*)((uint8*)N$1 + 40ll);
				if( TMP$327$4 != 1ll ) goto label$241;
				label$242:;
				{
				...
				goto label$240;
				label$241:;
				if( TMP$327$4 != 2ll ) goto label$243;
				label$244:;
				{
			...
			FBSTRING* vr$201 = fb_StrConcat( &TMP$331$3, (void*)" (", 3ll, (void*)vr$198, -1ll );
			__builtin_memset( &TMP$332$3, 0, 24ll );
			FBSTRING* vr$204 = fb_StrConcat( &TMP$332$3, (void*)vr$201, -1ll, (void*)")", 2ll );
			FBSTRING* vr$206 = HASTNODECLASSTOSTR( *($13AST_NODECLASS*)N$1 );
			__builtin_memset( &TMP$330$3, 0, 24ll );
			FBSTRING* vr$209 = fb_StrConcat( &TMP$330$3, (void*)"*", 2ll, (void*)vr$206, -1ll );
			__builtin_memset( &TMP$333$3, 0, 24ll );
			FBSTRING* vr$212 = fb_StrConcat( &TMP$333$3, (void*)vr$209, -1ll, (void*)vr$204, -1ll );
			__builtin_memset( &TMP$334$3, 0, 24ll );
			FBSTRING* vr$215 = fb_StrConcat( &TMP$334$3, (void*)vr$212, -1ll, (void*)"-", 2ll );
			__builtin_memset( &TMP$335$3, 0, 24ll );
			FBSTRING* vr$218 = fb_StrConcat( &TMP$335$3, (void*)vr$215, -1ll, (void*)&S$3, -1ll );
		...
		label$245:;
		{
			...
			FBSTRING* vr$225 = fb_StrConcat( &TMP$336$3, (void*)" (", 3ll, (void*)vr$222, -1ll );
			__builtin_memset( &TMP$337$3, 0, 24ll );
			FBSTRING* vr$228 = fb_StrConcat( &TMP$337$3, (void*)vr$225, -1ll, (void*)")", 2ll );
			FBSTRING* vr$230 = HASTNODECLASSTOSTR( *($13AST_NODECLASS*)N$1 );
			__builtin_memset( &TMP$338$3, 0, 24ll );
			FBSTRING* vr$233 = fb_StrConcat( &TMP$338$3, (void*)vr$230, -1ll, (void*)vr$228, -1ll );
			fb_StrInit( (void*)&fb$result$1, -1ll, (void*)vr$233, -1ll, 0 );
			goto label$218;
		}
		goto label$219;
		label$220:;
		static const void* tmp$345[42ll] = {
			&&label$221,
			&&label$222,
			&&label$245,
			&&label$245,
		...
		if( (TMP$264$2 - 3ull) > 41ull ) goto label$245;
		goto *tmp$345[TMP$264$2 - 3ull];
		label$219:;
	}
	label$218:;
...
static void ASTDUMPTREEEX( struct $7ASTNODE* N$1, int64 COL$1, int64 JUST$1, int64 DEPTH$1 )
{
	...
	if( *(struct $7ASTNODE**)((uint8*)N$1 + 112ll) == (struct $7ASTNODE*)0ull ) goto label$253;
	{
		if( *(struct $7ASTNODE**)((uint8*)N$1 + 120ll) == (struct $7ASTNODE*)0ull ) goto label$255;
		{
			...
			fb_StrAssign( (void*)&TMP$340$3, -1ll, (void*)"/ \x5C", 4ll, 0 );
		...
		label$255:;
		{
			...
			fb_StrAssign( (void*)&TMP$341$3, -1ll, (void*)"/", 2ll, 0 );
			DBG_ASTOUTPUT( &TMP$341$3, COL$1 + -2ll, 0ll, -1ll );
			fb_StrDelete( (FBSTRING*)&TMP$341$3 );
		}
		label$254:;
	}
	goto label$252;
	...
	if( *(struct $7ASTNODE**)((uint8*)N$1 + 120ll) == (struct $7ASTNODE*)0ull ) goto label$256;
	{
		...
		fb_StrAssign( (void*)&TMP$343$2, -1ll, (void*)"  \x5C", 4ll, 0 );
		DBG_ASTOUTPUT( &TMP$343$2, COL$1 + -2ll, 0ll, -1ll );
	...
	label$256:;
	{
		...
		fb_StrAssign( (void*)&TMP$344$2, -1ll, (void*)"", 1ll, 0 );
		DBG_ASTOUTPUT( &TMP$344$2, 0ll, 0ll, -1ll );
