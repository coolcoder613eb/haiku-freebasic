...
struct $6IRVREG* ASTLOADBOUNDCHK( struct $7ASTNODE* N$1 )
{
	...
	if( *(int64*)((uint8*)&AST$ + 272ll) == 0ll ) goto label$27;
	{
		...
		LABEL$1 = vr$10;
		struct $6IRVREG* vr$11 = (*(tmp$70*)((uint8*)&IR$ + 456ll))( 8ll, (struct $8FBSYMBOL*)0ull, 0ll );
		(*(tmp$51*)((uint8*)&IR$ + 184ll))( 45ll, VR$1, vr$11, (struct $6IRVREG*)0ull, LABEL$1 );
		(*(tmp$53*)((uint8*)&IR$ + 272ll))( VR$1 );
		(*(tmp$42*)((uint8*)&IR$ + 128ll))( LABEL$1 );
	}
	label$27:;
	label$26:;
...
struct $7ASTNODE* ASTBUILDBOUNDCHK( struct $7ASTNODE* EXPR$1, struct $7ASTNODE* LB$1, struct $7ASTNODE* UB$1 )
{
	...
	__builtin_memset( &fb$result$1, 0, 8ll );
	label$28:;
	struct $7ASTNODE* vr$3 = ASTNEWBOUNDCHK( EXPR$1, LB$1, UB$1, *(int64*)((uint8*)*(struct $9LEX_TKCTX**)((uint8*)&LEX$ + 426768ll) + 8560ll), (uint8*)((uint8*)&ENV$ + 608ll) );
	fb$result$1 = vr$3;
	label$29:;
	return fb$result$1;
}
...
struct $7ASTNODE* ASTBUILDPTRCHK( struct $7ASTNODE* EXPR$1 )
{
	...
	__builtin_memset( &fb$result$1, 0, 8ll );
	label$40:;
	struct $7ASTNODE* vr$3 = ASTNEWPTRCHK( EXPR$1, *(int64*)((uint8*)*(struct $9LEX_TKCTX**)((uint8*)&LEX$ + 426768ll) + 8560ll), (uint8*)((uint8*)&ENV$ + 608ll) );
	fb$result$1 = vr$3;
	label$41:;
	return fb$result$1;
}
