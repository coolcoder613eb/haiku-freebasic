...
void OBJINFOREADLIB( FBSTRING* LIBNAME$1, struct $5TLIST* LIBPATHS$1 )
{
	...
	FBSTRING* vr$2 = fb_StrConcat( &TMP$56$1, (void*)"lib", 4ll, (void*)LIBNAME$1, -1ll );
	__builtin_memset( &TMP$57$1, 0, 24ll );
	FBSTRING* vr$5 = fb_StrConcat( &TMP$57$1, (void*)vr$2, -1ll, (void*)".a", 3ll );
	...
	if( PATH$1 == (struct $11TSTRSETITEM*)0ull ) goto label$308;
	{
		...
		FBSTRING* vr$11 = fb_StrConcat( &TMP$58$2, (void*)PATH$1, -1ll, (void*)"\x5C", 2ll );
		__builtin_memset( &TMP$59$2, 0, 24ll );
		FBSTRING* vr$14 = fb_StrConcat( &TMP$59$2, (void*)vr$11, -1ll, (void*)&FILENAME$1, -1ll );
	...
	if( *(int64*)((uint8*)&PARSER$ + 32ll) == 0ll ) goto label$324;
	{
		...
		if( *(int64*)&PARSER$ >= *(int64*)((uint8*)&FBCTINF$ + 8ll) ) goto label$326;
		{
			...
			*(int64*)&PARSER$ = *(int64*)&PARSER$ + 1ll;
			...
			{
				int64 TMP$60$4;
				TMP$60$4 = *(int64*)((uint8*)&PARSER$ + 40ll);
				if( TMP$60$4 != 1ll ) goto label$336;
				label$337:;
				{
					fb$result$1 = 0ll;
					goto label$320;
				...
				goto label$335;
				label$336:;
				if( TMP$60$4 != 2ll ) goto label$338;
				label$339:;
				{
					fb$result$1 = 1ll;
					goto label$320;
				...
				goto label$335;
				label$338:;
				if( TMP$60$4 != 3ll ) goto label$340;
				label$341:;
				{
					{
						FBSTRING TMP$61$6;
						fb_StrInit( (void*)&TMP$61$6, -1ll, (void*)DAT$1, -1ll, 0 );
						int32 vr$13 = fb_StrCompare( (void*)&TMP$61$6, -1ll, (void*)"-lang", 6ll );
						...
						label$344:;
						{
							...
							{
								fb$result$1 = 4ll;
								fb_StrDelete( (FBSTRING*)&TMP$61$6 );
								goto label$320;
							}
							label$346:;
							label$345:;
						...
						goto label$342;
						label$343:;
						int32 vr$19 = fb_StrCompare( (void*)&TMP$61$6, -1ll, (void*)"-mt", 4ll );
	...
	{
		{
			...
			TMP$46$3 = vr$1;
			if( TMP$46$3 != 1ll ) goto label$267;
			label$268:;
			{
			...
			goto label$266;
			label$267:;
			if( TMP$46$3 != 0ll ) goto label$269;
			label$270:;
			{
	...
	{
		{
			...
			TMP$47$3 = vr$3;
			if( TMP$47$3 != 1ll ) goto label$273;
			label$274:;
			{
			...
			goto label$272;
			label$273:;
			if( TMP$47$3 != 0ll ) goto label$275;
			label$276:;
			{
			...
			goto label$272;
			label$275:;
			if( TMP$47$3 != 3ll ) goto label$277;
			label$278:;
			{
			...
			goto label$272;
			label$277:;
			if( TMP$47$3 != 2ll ) goto label$279;
			label$280:;
			{
			...
			goto label$272;
			label$279:;
			if( TMP$47$3 == 5ll ) goto label$282;
			label$283:;
			if( TMP$47$3 != 6ll ) goto label$281;
			label$282:;
			{
			...
			goto label$272;
			label$281:;
			if( TMP$47$3 != 4ll ) goto label$284;
			label$285:;
			{
