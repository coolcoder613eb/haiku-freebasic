...
struct $7ASTNODE* CINITIALIZER( struct $8FBSYMBOL* SYM$1, $9FB_INIOPT OPTIONS$1, int64 DTYPE$1, struct $8FBSYMBOL* SUBTYPE$1 )
{
	...
	*(struct $7ASTNODE**)((uint8*)&CTX$1 + 32ll) = vr$15;
	...
	TMP$95$1 = *(struct $7ASTNODE**)((uint8*)&CTX$1 + 32ll);
	goto label$169;
	label$168:;
	TMP$95$1 = (struct $7ASTNODE*)0ull;
	label$169:;
	fb$result$1 = TMP$95$1;
	label$157:;
	return fb$result$1;
}
	...
	if( vr$1 != 123ll ) goto label$29;
	{
		...
		*(int64*)((uint8*)CTX$1 + 24ll) = *(int64*)((uint8*)CTX$1 + 24ll) + 1ll;
		...
		if( *(int64*)((uint8*)CTX$1 + 24ll) < *(int64*)((uint8*)*(struct $8FBSYMBOL**)CTX$1 + 104ll) ) goto label$31;
		{
			...
			TMP$93$3 = 63ll;
			label$170:;
			ERRREPORT( TMP$93$3, 0ll, (uint8*)0ull );
	...
	if( ELEMENTS$1 <= 0ll ) goto label$65;
	{
		...
		label$73:;
		{
			...
			label$75:;
			{
				{
					uint64 TMP$94$5;
					TMP$94$5 = (uint64)(*(int64*)((uint8*)CTX$1 + 8ll) & 511ll);
					goto label$77;
					label$78:;
					{
					...
					if( (TMP$94$5 - 4ull) > 14ull ) goto label$79;
					goto *tmp$96[TMP$94$5 - 4ull];
					label$76:;
				}
			}
			label$74:;
