...
struct $7ASTNODE* ASTNEWMEM( int64 OP$1, struct $7ASTNODE* L$1, struct $7ASTNODE* R$1, int64 BYTES$1 )
{
	...
	struct $7ASTNODE* N$1;
	uint64 BLKMAXLEN$1;
	int64 vr$1 = (*(tmp$40*)((uint8*)&IR$ + 32ll))( 1ll );
...
struct $7ASTNODE* ASTBUILDNEWOP( $6AST_OP OP$1, struct $8FBSYMBOL* TMP$1, struct $7ASTNODE* ELEMENTSEXPR$1, struct $7ASTNODE* INITEXPR$1, int64 DTYPE$1, struct $8FBSYMBOL* SUBTYPE$1, int64 DO_CLEAR$1, struct $7ASTNODE* NEWEXPR$1 )
{
	...
	label$51:;
	label$50:;
	struct $7ASTNODE* vr$20 = _Z17ASTBUILDVARASSIGNP8FBSYMBOLP7ASTNODEu7INTEGER( TMP$1, NEWEXPR$1, 64ll );
	...
	label$56:;
	{
		...
		label$60:;
		{
			...
			struct $7ASTNODE* vr$40 = _Z15ASTTYPEINIFLUSHP7ASTNODES0_u7INTEGERS1_( vr$39, INITEXPR$1, 0ll, 64ll );
			INITEXPR$1 = vr$40;
		}
		goto label$58;
		label$61:;
		...
		if( TMP$85$2 > 4ull ) goto label$65;
		goto *tmp$86[TMP$85$2 - 0ull];
		label$58:;
	}
...
struct $6IRVREG* ASTLOADMEM( struct $7ASTNODE* N$1 )
{
	...
	{
		(*(tmp$58*)((uint8*)&IR$ + 296ll))( *(int64*)((uint8*)N$1 + 48ll), V1$1, V2$1, *(int64*)((uint8*)N$1 + 40ll) );
	}
	label$83:;
	label$82:;
	fb$result$1 = (struct $6IRVREG*)0ull;
...
static struct $7ASTNODE* HCALLCTORLIST( struct $8FBSYMBOL* TMP$1, struct $7ASTNODE* ELEMENTSEXPR$1, int64 DTYPE$1, struct $8FBSYMBOL* SUBTYPE$1 )
{
	...
	struct $7ASTNODE* vr$15 = _Z17ASTBUILDVARASSIGNP8FBSYMBOLP7ASTNODEu7INTEGER( ITER$1, vr$14, 64ll );
	TREE$1 = vr$15;
...
static struct $7ASTNODE* HCALLDTORLIST( struct $7ASTNODE* PTREXPR$1 )
{
	...
	struct $7ASTNODE* vr$14 = _Z17ASTBUILDVARASSIGNP8FBSYMBOLP7ASTNODEu7INTEGER( ELMTS$1, vr$13, 64ll );
	TREE$1 = vr$14;
	...
	struct $7ASTNODE* vr$17 = _Z17ASTBUILDVARASSIGNP8FBSYMBOLP7ASTNODEu7INTEGER( ITER$1, vr$16, 64ll );
