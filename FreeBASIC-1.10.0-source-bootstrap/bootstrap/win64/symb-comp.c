...
void SYMBCHECKCOMPCTOR( struct $8FBSYMBOL* SYM$1, struct $8FBSYMBOL* PROC$1 )
{
	...
	if( *(int64*)SYM$1 != 10ll ) goto label$152;
	{
		{
			int16 TMP$89$3;
			TMP$89$3 = *(int16*)((uint8*)PROC$1 + 120ll);
			if( (int64)TMP$89$3 != 1ll ) goto label$154;
			label$155:;
			{
			...
			goto label$153;
			label$154:;
			if( (int64)TMP$89$3 != 2ll ) goto label$156;
			label$157:;
			{
...
struct $8FBSYMBOL* SYMBGETCOMPOPOVLHEAD( struct $8FBSYMBOL* SYM$1, $6AST_OP OP$1 )
{
	...
	{
		{
			$12FB_SYMBCLASS TMP$90$3;
			TMP$90$3 = *($12FB_SYMBCLASS*)SYM$1;
			if( TMP$90$3 != 10ll ) goto label$235;
			label$236:;
			{
			...
			goto label$234;
			label$235:;
			if( TMP$90$3 != 9ll ) goto label$239;
			label$240:;
			{
				fb$result$1 = (struct $8FBSYMBOL*)0ull;
			}
			goto label$234;
			label$239:;
			if( TMP$90$3 != 11ll ) goto label$241;
			label$242:;
			{
			}
			label$241:;
...
void SYMBCOMPRTTIINIT( void )
{
	...
	static struct $8FBARRAY1I10FBARRAYDIME tmp$91$1 = { (struct $10FBARRAYDIM*)DTB$1, (struct $10FBARRAYDIM*)DTB$1, 16ll, 16ll, 1ll, 49ll, { { 1ll, 0ll, 0ll } } };
	...
	*(struct $8FBSYMBOL**)((uint8*)&SYMB$ + 199232ll) = RTTITYPE$1;
	SYMBADDFIELD( RTTITYPE$1, (uint8*)"stdlibvtable", 0ll, (struct $7FBARRAYI10FBARRAYDIME*)&tmp$91$1, 32ll, (struct $8FBSYMBOL*)0ull, 0ll, 0ll, 0ll );
	SYMBADDFIELD( RTTITYPE$1, (uint8*)"id", 0ll, (struct $7FBARRAYI10FBARRAYDIME*)&tmp$91$1, 36ll, (struct $8FBSYMBOL*)0ull, 0ll, 0ll, 0ll );
	SYMBADDFIELD( RTTITYPE$1, (uint8*)"rttibase", 0ll, (struct $7FBARRAYI10FBARRAYDIME*)&tmp$91$1, 52ll, RTTITYPE$1, 0ll, 0ll, 0ll );
	...
	*($12FB_SYMBSTATS*)((uint8*)OBJTYPE$1 + 24ll) = *(int64*)((uint8*)OBJTYPE$1 + 24ll) | 262144ll;
	...
	SYMBADDFIELD( OBJTYPE$1, (uint8*)"vptr$", 0ll, (struct $7FBARRAYI10FBARRAYDIME*)&tmp$91$1, 32ll, (struct $8FBSYMBOL*)0ull, 0ll, 0ll, 0ll );
	...
	struct $8FBSYMBOL* vr$10 = SYMBADDVAR( (uint8*)0ull, (uint8*)"__fb_ZTS6Object", 20ll, *(struct $8FBSYMBOL**)((uint8*)&SYMB$ + 199232ll), 0ll, 0ll, (struct $7FBARRAYI10FBARRAYDIME*)&tmp$91$1, 17ll, 1ll );
	OBJRTTI$1 = vr$10;
...
static void HBUILDRTTI( struct $8FBSYMBOL* UDT$1 )
{
	...
	SYMBNESTBEGIN( UDT$1, -1ll );
	struct $8FBSYMBOL* vr$0 = SYMBADDVAR( (uint8*)0ull, (uint8*)0ull, 20ll, *(struct $8FBSYMBOL**)((uint8*)&SYMB$ + 199232ll), 0ll, 0ll, (struct $7FBARRAYI10FBARRAYDIME*)&tmp$85$1, 8390659ll, 1ll );
	RTTI$1 = vr$0;
...
static void HBUILDVTABLE( struct $8FBSYMBOL* UDT$1 )
{
	...
	*(int64*)((int64)(struct $10FBARRAYDIM*)DTB$1 + 8ll) = *(int64*)((uint8*)*(struct $12FB_STRUCTEXT**)((uint8*)UDT$1 + 240ll) + 288ll) + -1ll;
	struct $8FBSYMBOL* vr$3 = SYMBADDVAR( (uint8*)0ull, (uint8*)0ull, 32ll, (struct $8FBSYMBOL*)0ull, 0ll, 1ll, (struct $7FBARRAYI10FBARRAYDIME*)&tmp$86$1, 8390659ll, 1ll );
	VTABLE$1 = vr$3;
...
static struct $8FBSYMBOL* HCOPYUNIONFIELDS( struct $8FBSYMBOL* THIS_$1, struct $8FBSYMBOL* RHS$1, struct $8FBSYMBOL* BASE_FLD$1 )
{
	...
	TMP$87$1 = (int64)-((struct $8FBSYMBOL*)(int64)-(*(int64*)FLD$1 == 12ll) != (struct $8FBSYMBOL*)0ull);
	goto label$349;
	label$71:;
	TMP$87$1 = 0ll;
	label$349:;
	if( TMP$87$1 == 0ll ) goto label$72;
	TMP$88$1 = (int64)-((*(int64*)((uint8*)FLD$1 + 24ll) & 16777216ll) != 0ll);
	goto label$350;
	label$72:;
	TMP$88$1 = 0ll;
	label$350:;
	if( TMP$88$1 != 0ll ) goto label$66;
	label$67:;
