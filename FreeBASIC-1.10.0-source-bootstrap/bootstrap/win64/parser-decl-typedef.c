	...
	{
		{
			...
			label$17:;
			{
				LEXSKIPTOKEN( 2048ll );
				{
					...
					TMP$94$5 = vr$1;
					if( TMP$94$5 == 373ll ) goto label$20;
					label$21:;
					if( TMP$94$5 != 374ll ) goto label$19;
					label$20:;
					{
			...
			if( (TMP$93$3 - 335ull) > 39ull ) goto label$28;
			goto *tmp$97[TMP$93$3 - 335ull];
			label$15:;
		}
	}
	label$14:;
...
static uint8* HREADTYPE( int64* DTYPE$1, struct $8FBSYMBOL** SUBTYPE$1, int64* LGT$1, int64* IS_FIXLENSTR$1 )
{
	...
	label$31:;
	{
		...
		TMP$95$2 = vr$2;
		if( TMP$95$2 == 0ll ) goto label$35;
		label$36:;
		if( TMP$95$2 != 2ll ) goto label$34;
		label$35:;
		{
	...
	CCURRENTPARENTID(  );
	{
		...
		label$68:;
		{
			if( (*(int64*)((uint8*)&ENV$ + 1424ll) & 524288ll) == 0ll ) goto label$70;
			{
				...
				{
					if( *(int64*)((uint8*)*(struct $7FBTOKEN**)((uint8*)*(struct $9LEX_TKCTX**)((uint8*)&LEX$ + 426768ll) + 8520ll) + 2096ll) <= 0ll ) goto label$74;
					{
		...
		goto label$66;
		label$67:;
		static const void* tmp$98[3ll] = {
			&&label$68,
			&&label$68,
			&&label$68,
		};
		if( TMP$96$2 > 2ull ) goto label$75;
		goto *tmp$98[TMP$96$2 - 0ull];
		label$66:;
	}
