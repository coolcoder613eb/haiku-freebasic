...
struct $7ASTNODE* _Z17ASTBUILDVARASSIGNP8FBSYMBOLu7INTEGERS1_( struct $8FBSYMBOL*, int64, int64 );
...
struct $7ASTNODE* _Z19ASTBUILDDEREFADDROFP7ASTNODES0_u7INTEGERP8FBSYMBOLS3_( struct $7ASTNODE*, struct $7ASTNODE*, int64, struct $8FBSYMBOL*, struct $8FBSYMBOL* );
...
struct $7ASTNODE* _Z17ASTBUILDVARASSIGNP8FBSYMBOLu7INTEGERS1_( struct $8FBSYMBOL* LHS$1, int64 RHS$1, int64 OPTIONS$1 )
{
...
struct $7ASTNODE* _Z17ASTBUILDVARASSIGNP8FBSYMBOLP7ASTNODEu7INTEGER( struct $8FBSYMBOL* LHS$1, struct $7ASTNODE* RHS$1, int64 OPTIONS$1 )
{
	struct $7ASTNODE* fb$result$1;
	__builtin_memset( &fb$result$1, 0, 8ll );
	label$12:;
...
struct $7ASTNODE* ASTBUILDFAKEWSTRINGASSIGN( struct $8FBSYMBOL* SYM$1, struct $7ASTNODE* EXPR$1, int64 OPTIONS$1 )
{
	...
	struct $7ASTNODE* vr$8 = _Z17ASTBUILDVARASSIGNP8FBSYMBOLP7ASTNODEu7INTEGER( SYM$1, vr$7, OPTIONS$1 );
...
struct $7ASTNODE* _Z19ASTBUILDVARDTORCALLP8FBSYMBOLu7INTEGER( struct $8FBSYMBOL* S$1, int64 CHECK_ACCESS$1 )
{
	struct $7ASTNODE* fb$result$1;
	__builtin_memset( &fb$result$1, 0, 8ll );
	label$35:;
	...
	label$38:;
	{
		{
			int64 TMP$93$3;
			TMP$93$3 = *(int64*)((uint8*)S$1 + 56ll) & 511ll;
			if( TMP$93$3 != 17ll ) goto label$40;
			label$41:;
			{
			...
			goto label$39;
			label$40:;
			if( TMP$93$3 != 39ll ) goto label$42;
			label$43:;
			{
...
struct $7ASTNODE* _Z19ASTBUILDDEREFADDROFP7ASTNODES0_u7INTEGERP8FBSYMBOLS3_( struct $7ASTNODE* N$1, struct $7ASTNODE* OFFSETEXPR$1, int64 DTYPE$1, struct $8FBSYMBOL* SUBTYPE$1, struct $8FBSYMBOL* MAYBEAFIELD$1 )
{
	struct $7ASTNODE* fb$result$1;
	__builtin_memset( &fb$result$1, 0, 8ll );
	label$51:;
...
struct $7ASTNODE* _Z19ASTBUILDDEREFADDROFP7ASTNODExu7INTEGERP8FBSYMBOLS3_( struct $7ASTNODE* N$1, int64 OFFSET$1, int64 DTYPE$1, struct $8FBSYMBOL* SUBTYPE$1, struct $8FBSYMBOL* MAYBEAFIELD$1 )
{
	struct $7ASTNODE* fb$result$1;
	__builtin_memset( &fb$result$1, 0, 8ll );
	label$59:;
	...
	label$61:;
	struct $7ASTNODE* vr$2 = _Z19ASTBUILDDEREFADDROFP7ASTNODES0_u7INTEGERP8FBSYMBOLS3_( N$1, OFFSETEXPR$1, DTYPE$1, SUBTYPE$1, MAYBEAFIELD$1 );
	fb$result$1 = vr$2;
	label$60:;
	return fb$result$1;
}
...
struct $7ASTNODE* ASTBUILDVARFIELD( struct $8FBSYMBOL* SYM$1, struct $8FBSYMBOL* FLD$1, int64 OFFSET$1 )
{
	...
	if( FLD$1 == (struct $8FBSYMBOL*)0ull ) goto label$68;
	{
		...
		struct $7ASTNODE* vr$29 = _Z19ASTBUILDDEREFADDROFP7ASTNODExu7INTEGERP8FBSYMBOLS3_( N$1, OFFSET$1, *(int64*)((uint8*)FLD$1 + 56ll), *(struct $8FBSYMBOL**)((uint8*)FLD$1 + 64ll), FLD$1 );
		N$1 = vr$29;
	}
	goto label$67;
	label$68:;
	{
		struct $7ASTNODE* vr$32 = _Z19ASTBUILDDEREFADDROFP7ASTNODExu7INTEGERP8FBSYMBOLS3_( N$1, OFFSET$1, *(int64*)((uint8*)SYM$1 + 56ll), *(struct $8FBSYMBOL**)((uint8*)SYM$1 + 64ll), (struct $8FBSYMBOL*)0ull );
		N$1 = vr$32;
	}
	label$67:;
	fb$result$1 = N$1;
...
struct $7ASTNODE* ASTBUILDWHILECOUNTERBEGIN( struct $7ASTNODE* TREE$1, struct $8FBSYMBOL* CNT$1, struct $8FBSYMBOL* LABEL$1, struct $8FBSYMBOL* EXITLABEL$1, struct $7ASTNODE* INITEXPR$1, int64 FLUSH_LABEL$1 )
{
	...
	__builtin_memset( &fb$result$1, 0, 8ll );
	label$73:;
	struct $7ASTNODE* vr$1 = _Z17ASTBUILDVARASSIGNP8FBSYMBOLP7ASTNODEu7INTEGER( CNT$1, INITEXPR$1, 0ll );
...
struct $7ASTNODE* ASTBUILDFORBEGIN( struct $7ASTNODE* TREE$1, struct $8FBSYMBOL* CNT$1, struct $8FBSYMBOL* LABEL$1, int64 INIVALUE$1, int64 FLUSH_LABEL$1 )
{
	...
	__builtin_memset( &fb$result$1, 0, 8ll );
	label$77:;
	struct $7ASTNODE* vr$1 = _Z17ASTBUILDVARASSIGNP8FBSYMBOLu7INTEGERS1_( CNT$1, INIVALUE$1, 0ll );
	struct $7ASTNODE* vr$2 = ASTNEWLINK( TREE$1, vr$1, 0ll );
	TREE$1 = vr$2;
	struct $7ASTNODE* vr$3 = ASTNEWLABEL( LABEL$1, FLUSH_LABEL$1 );
	struct $7ASTNODE* vr$4 = ASTNEWLINK( TREE$1, vr$3, 0ll );
	...
	if( CNT$1 <= 0ll ) goto label$148;
	{
		...
		label$150:;
		{
			DTYPE$1 = (((DTYPE$1 & 31ll) | ((DTYPE$1 & 480ll) + -32ll)) | (((DTYPE$1 & 261632ll) >> (1ll & 63ll)) & 261632ll)) | (DTYPE$1 & 32505856ll);
			{
				...
				label$166:;
				TMP$95$4 = TMP$94$4;
				if( TMP$95$4 == 0ll ) goto label$160;
				label$161:;
				if( TMP$95$4 != 23ll ) goto label$159;
				label$160:;
				{
				...
				goto label$158;
				label$159:;
				if( TMP$95$4 != 22ll ) goto label$162;
				label$163:;
				{
...
struct $7ASTNODE* ASTBUILDARRAYDESCINITREE( struct $8FBSYMBOL* DESC$1, struct $8FBSYMBOL* ARRAY$1, struct $7ASTNODE* ARRAY_EXPR$1 )
{
	...
	goto label$187;
	label$175:;
	TMP$96$1 = *(int64*)((uint8*)ARRAY$1 + 120ll);
	label$187:;
	struct $7ASTNODE* vr$36 = ASTNEWCONSTI( TMP$96$1, 8ll, (struct $8FBSYMBOL*)0ull );
	...
	TMP$97$1 = vr$43;
	label$188:;
	struct $7ASTNODE* vr$44 = ASTNEWCONSTI( TMP$97$1, 8ll, (struct $8FBSYMBOL*)0ull );
	...
	{
		{
			...
			I$3 = 0ll;
			int64 TMP$98$3;
			TMP$98$3 = *(int64*)((uint8*)ARRAY$1 + 104ll) + -1ll;
			goto label$181;
			label$184:;
			{
				ELM$1 = DIMTB$1;
			...
			I$3 = I$3 + 1ll;
			label$181:;
			if( I$3 <= TMP$98$3 ) goto label$184;
			label$183:;
		}
	}
	goto label$179;
...
static struct $7ASTNODE* HCONSTBOUND( struct $7ASTNODE* ARRAYEXPR$1, struct $7ASTNODE* DIMEXPR$1, int64 IS_LBOUND$1 )
{
	...
	fb$result$1 = (struct $7ASTNODE*)0ull;
	{
		...
		TMP$99$2 = *($13AST_NODECLASS*)ARRAYEXPR$1;
		if( TMP$99$2 == 17ll ) goto label$193;
		label$194:;
		if( TMP$99$2 != 19ll ) goto label$192;
		label$193:;
		{
		}
		goto label$191;
	...
	label$203:;
	{
		if( DIMENSION$1 != -1ll ) goto label$209;
		{
			...
			goto label$220;
			label$210:;
			TMP$100$3 = *(int64*)((uint8*)ARRAY$1 + 104ll);
			label$220:;
			BOUND$1 = TMP$100$3;
		}
		goto label$208;
