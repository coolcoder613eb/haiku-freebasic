...
int32 fb_FileGetWstrLarge( int32, int64, uint16*, int64 );
...
void LEXREADUTF8( void )
{
	...
	label$69:;
	*(int64*)((uint8*)*(struct $9LEX_TKCTX**)((uint8*)&LEX$ + 426768ll) + 8648ll) = CHARS$1;
...
static int64 HUTF8TOCHAR( void )
{
	...
	static struct $8FBARRAY1IhE tmp$94$1 = { (uint8*)SRC$1, (uint8*)SRC$1, 7ll, 1ll, 1ll, 49ll, { { 7ll, 0ll, 6ll } } };
	static uint8* P$1;
	static uint64 C$1;
	static uint8* DST$1;
	static int64 CHARS$1;
	...
	static int64 I$1;
	DST$1 = (uint8*)((uint8*)*(struct $9LEX_TKCTX**)((uint8*)&LEX$ + 426768ll) + 8664ll);
	CHARS$1 = 0ll;
	label$12:;
...
static int64 HUTF8TOUTF16LE( void )
{
	...
	static int64 EXTBYTES$1;
	static int64 I$1;
	DST$1 = (uint16*)((uint8*)*(struct $9LEX_TKCTX**)((uint8*)&LEX$ + 426768ll) + 8664ll);
	CHARS$1 = 0ll;
	label$29:;
...
static int64 HUTF8TOUTF32LE( void )
{
	...
	static int64 EXTBYTES$1;
	static int64 I$1;
	DST$1 = (uint32*)((uint8*)*(struct $9LEX_TKCTX**)((uint8*)&LEX$ + 426768ll) + 8664ll);
	CHARS$1 = 0ll;
	label$48:;
...
static int64 HUTF16LETOUTF16LE( void )
{
	...
	__builtin_memset( &fb$result$1, 0, 8ll );
	label$88:;
	int32 vr$4 = fb_FileGetWstrLarge( (int32)*(int64*)((uint8*)&ENV$ + 600ll), 0ll, (uint16*)((uint8*)*(struct $9LEX_TKCTX**)((uint8*)&LEX$ + 426768ll) + 8664ll), 8193ll );
	if( (int64)vr$4 != 0ll ) goto label$91;
	{
		int64 vr$7 = fb_FileTell( (int32)*(int64*)((uint8*)&ENV$ + 600ll) );
		fb$result$1 = (int64)((uint64)(vr$7 - *(int64*)((uint8*)*(struct $9LEX_TKCTX**)((uint8*)&LEX$ + 426768ll) + 25056ll)) >> (1ull & 63ll));
	}
	goto label$90;
	label$91:;
	{
...
static int64 HUTF16BETOUTF16LE( void )
{
	...
	DST$1 = (uint16*)((uint8*)*(struct $9LEX_TKCTX**)((uint8*)&LEX$ + 426768ll) + 8664ll);
	{
		...
		I$1 = I$1 + 1ll;
		label$135:;
		if( I$1 <= TMP$100$2 ) goto label$138;
		label$137:;
	}
	fb$result$1 = CHARS$1;
	label$134:;
...
static int64 HUTF32LETOUTF32LE( void )
{
	...
	{
		int64 vr$7 = fb_FileTell( (int32)*(int64*)((uint8*)&ENV$ + 600ll) );
		fb$result$1 = (int64)((uint64)(vr$7 - *(int64*)((uint8*)*(struct $9LEX_TKCTX**)((uint8*)&LEX$ + 426768ll) + 25056ll)) >> (2ull & 63ll));
	}
	goto label$184;
	label$185:;
	{
...
static int64 HUTF32BETOUTF32LE( void )
{
	...
	DST$1 = (uint32*)((uint8*)*(struct $9LEX_TKCTX**)((uint8*)&LEX$ + 426768ll) + 8664ll);
	{
		...
		I$1 = I$1 + 1ll;
		label$221:;
		if( I$1 <= TMP$102$2 ) goto label$224;
		label$223:;
	}
	fb$result$1 = CHARS$1;
	label$220:;
