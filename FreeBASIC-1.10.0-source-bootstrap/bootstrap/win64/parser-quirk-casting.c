...
struct $7ASTNODE* CTYPECONVEXPR( $8FB_TOKEN TK$1, int64 ISASM$1 )
{
	...
	OP$1 = -1ll;
	{
		...
		if( (TMP$93$2 - 401ull) > 14ull ) goto label$12;
		goto *tmp$94[TMP$93$2 - 401ull];
		label$12:;
	}
...
struct $7ASTNODE* CANONTYPE( void )
{
	...
	if( IS_EXPLICIT$1 == 0ll ) goto label$59;
	{
		...
		TMP$96$2 = 0ll;
		TMP$95$2 = 0ll;
		int64 vr$6 = CSYMBOLTYPE( &DTYPE$1, &SUBTYPE$1, &TMP$95$2, &TMP$96$2, 1ll );
	...
	label$59:;
	{
		...
		label$62:;
		{
			...
			if( TMP$97$3 == 0ll ) goto label$66;
			label$67:;
			if( TMP$97$3 != 23ll ) goto label$65;
			label$66:;
			{
				ERRREPORT( 71ll, 0ll, (uint8*)0ull );
				DTYPE$1 = 8ll;
