...
static struct $14FB_RTL_PROCDEF FUNCDATA$[17] = { { (uint8*)"fb_ConsoleView", (uint8*)0ull, 11ll, -1ll, (tmp$34)0ull, 0ll, 2ll, { { 523ll, 1ll, -1ll, 0ll }, { 523ll, 1ll, -1ll, 0ll } } }, { (uint8*)"fb_ReadXY", (uint8*)0ull, 12ll, -1ll, (tmp$34)0ull, 0ll, 3ll, { { 523ll, 1ll, 0ll }, { 523ll, 1ll, 0ll }, { 523ll, 1ll, -1ll, 0ll } } }, { (uint8*)"fb_Width", (uint8*)0ull, 11ll, -1ll, (tmp$34)0ull, 0ll, 2ll, { { 523ll, 1ll, -1ll, -1ll }, { 523ll, 1ll, -1ll, -1ll } } }, { (uint8*)"fb_WidthDev", (uint8*)0ull, 11ll, -1ll, (tmp$34)0ull, 0ll, 2ll, { { 529ll, 2ll, 0ll }, { 523ll, 1ll, -1ll, -1ll } } }, { (uint8*)"fb_WidthFile", (uint8*)0ull, 11ll, -1ll, (tmp$34)0ull, 0ll, 2ll, { { 523ll, 1ll, 0ll }, { 523ll, 1ll, -1ll, -1ll } } }, { (uint8*)"locate", (uint8*)"fb_Locate", 11ll, -1ll, (tmp$34)0ull, 0ll, 5ll, { { 523ll, 1ll, -1ll, 0ll }, { 523ll, 1ll, -1ll, 0ll }, { 523ll, 1ll, -1ll, -1ll }, { 523ll, 1ll, -1ll, 0ll }, { 523ll, 1ll, -1ll, 0ll } } }, { (uint8*)"pos", (uint8*)"fb_GetX", 11ll, -1ll, (tmp$34)0ull, 1ll, 0ll }, { (uint8*)"pos", (uint8*)"fb_Pos", 11ll, -1ll, (tmp$34)0ull, 1ll, 1ll, { { 523ll, 1ll, 0ll } } }, { (uint8*)"csrlin", (uint8*)"fb_GetY", 11ll, -1ll, (tmp$34)0ull, 0ll, 0ll }, { (uint8*)"cls", (uint8*)"fb_Cls", 0ll, -1ll, (tmp$34)0ull, 0ll, 1ll, { { 523ll, 1ll, -1ll, 4294901760ll } } }, { (uint8*)"fb_Color", (uint8*)0ull, 12ll, -1ll, (tmp$34)0ull, 0ll, 3ll, { { 523ll, 1ll, 0ll }, { 523ll, 1ll, 0ll }, { 524ll, 1ll, 0ll } } }, { (uint8*)"inkey", (uint8*)"fb_Inkey", 17ll, -1ll, (tmp$34)0ull, 192ll, 0ll }, { (uint8*)"inkey", (uint8*)"fb_InkeyQB", 17ll, -1ll, (tmp$34)0ull, 320ll, 0ll }, { (uint8*)"getkey", (uint8*)"fb_Getkey", 11ll, -1ll, (tmp$34)0ull, 128ll, 0ll }, { (uint8*)"pcopy", (uint8*)"fb_PageCopy", 11ll, -1ll, (tmp$34)0ull, 0ll, 2ll, { { 523ll, 1ll, -1ll, -1ll }, { 523ll, 1ll, -1ll, -1ll } } }, { (uint8*)"fb_PageSet", (uint8*)0ull, 11ll, -1ll, (tmp$34)0ull, 0ll, 2ll, { { 523ll, 1ll, -1ll, -1ll }, { 523ll, 1ll, -1ll, -1ll } } }, { (uint8*)0ull } };
...
struct $7ASTNODE* RTLCONSOLEVIEW( struct $7ASTNODE* TOPEXPR$1, struct $7ASTNODE* BOTEXPR$1 )
{
	...
	struct $8FBSYMBOL* vr$1 = RTLPROCLOOKUP( (uint8*)"fb_ConsoleView", 214ll );
...
struct $7ASTNODE* RTLWIDTHSCREEN( struct $7ASTNODE* WIDTH_ARG$1, struct $7ASTNODE* HEIGHT_ARG$1, int64 ISFUNC$1 )
{
	...
	struct $7ASTNODE* PROC$1;
	fb$result$1 = (struct $7ASTNODE*)0ull;
	struct $8FBSYMBOL* vr$1 = RTLPROCLOOKUP( (uint8*)"fb_Width", 289ll );
	struct $7ASTNODE* vr$2 = ASTNEWCALL( vr$1, (struct $7ASTNODE*)0ull );
	PROC$1 = vr$2;
...
struct $7ASTNODE* RTLCOLOR( struct $7ASTNODE* FEXPR$1, struct $7ASTNODE* BEXPR$1, int64 ISFUNC$1 )
{
	...
	fb$result$1 = (struct $7ASTNODE*)0ull;
	FLAGS$1 = 0ll;
	struct $8FBSYMBOL* vr$1 = RTLPROCLOOKUP( (uint8*)"fb_Color", 216ll );
	struct $7ASTNODE* vr$2 = ASTNEWCALL( vr$1, (struct $7ASTNODE*)0ull );
	PROC$1 = vr$2;
...
struct $7ASTNODE* RTLPAGESET( struct $7ASTNODE* ACTIVE$1, struct $7ASTNODE* VISIBLE$1, int64 ISFUNC$1 )
{
	...
	struct $7ASTNODE* PROC$1;
	fb$result$1 = (struct $7ASTNODE*)0ull;
	struct $8FBSYMBOL* vr$1 = RTLPROCLOOKUP( (uint8*)"fb_PageSet", 217ll );
	struct $7ASTNODE* vr$2 = ASTNEWCALL( vr$1, (struct $7ASTNODE*)0ull );
	PROC$1 = vr$2;
...
struct $7ASTNODE* RTLCONSOLEREADXY( struct $7ASTNODE* ROWEXPR$1, struct $7ASTNODE* COLUMNEXPR$1, struct $7ASTNODE* COLORFLAGEXPR$1 )
{
	...
	struct $7ASTNODE* PROC$1;
	fb$result$1 = (struct $7ASTNODE*)0ull;
	struct $8FBSYMBOL* vr$1 = RTLPROCLOOKUP( (uint8*)"fb_ReadXY", 215ll );
	struct $7ASTNODE* vr$2 = ASTNEWCALL( vr$1, (struct $7ASTNODE*)0ull );
	PROC$1 = vr$2;
