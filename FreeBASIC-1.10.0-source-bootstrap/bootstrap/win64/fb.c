...
void FBINIT( int64 ISMAIN$1, uint8* ENTRY$1, int64 MODULE_COUNT$1 )
{
	...
	*(int64*)((uint8*)&ENV$ + 584ll) = 0ll;
	{
		...
		label$45:;
		if( TMP$151$2 == 4ll ) goto label$44;
		label$46:;
		if( TMP$151$2 != 9ll ) goto label$43;
		label$44:;
		{
		...
		goto label$42;
		label$43:;
		if( TMP$151$2 == 1ll ) goto label$48;
		label$49:;
		if( TMP$151$2 != 0ll ) goto label$47;
		label$48:;
		{
	...
	*(int64*)((uint8*)&ENV$ + 592ll) = 0ll;
	...
	goto label$51;
	label$50:;
	TMP$152$1 = *(int64*)((uint8*)&ENV$ + 544ll) & 31ll;
	label$51:;
	*(int64*)((uint8*)&ENV$ + 576ll) = (int64)-(*(int64*)(((int64)(struct $13SYMB_DATATYPE*)SYMB_DTYPETB$ + (TMP$152$1 * 56ll)) + 8ll) == 2ll);
...
void FBSETOPTION( int64 OPT$1, int64 VALUE$1 )
{
	label$68:;
	{
		...
		label$110:;
		{
			...
			label$112:;
			{
				...
				label$117:;
				{
					...
					TMP$156$5 = VALUE$1;
					label$127:;
					*(int64*)((uint8*)&ENV$ + 488ll) = TMP$156$5;
				}
				label$116:;
			}
			label$111:;
		...
		goto label$70;
		label$71:;
		static const void* tmp$157[44ll] = {
			&&label$72,
			&&label$73,
			&&label$74,
			&&label$75,
		...
		if( TMP$153$2 > 43ull ) goto label$70;
...
int64 FBGETOPTION( int64 OPT$1 )
{
	...
	label$128:;
	{
		...
		goto label$130;
		label$131:;
		static const void* tmp$159[44ll] = {
			&&label$132,
			&&label$133,
			&&label$134,
			&&label$135,
		...
		if( TMP$158$2 > 43ull ) goto label$176;
...
void FBCHANGEOPTION( int64 OPT$1, int64 VALUE$1 )
{
	label$177:;
	{
		...
		goto label$179;
		label$180:;
		static const void* tmp$161[25ll] = {
			&&label$182,
			&&label$193,
			&&label$193,
			&&label$193,
		...
		if( (TMP$160$2 - 10ull) > 24ull ) goto label$193;
...
FBSTRING* FBGETMODULEENTRY( void )
{
	...
	fb_StrAssign( (void*)&TMP$174$1, -1ll, (void*)((uint8*)&ENV$ + 904ll), 261ll, 0 );
...
FBSTRING* FBGETINPUTFILEPARENTDIR( void )
{
	...
	FBSTRING* vr$13 = fb_StrConcat( &TMP$177$1, (void*)&S$1, -1ll, (void*)((uint8*)&ENV$ + 608ll), 261ll );
...
void FBADDLIB( uint8* LIBNAME$1 )
{
	...
	fb_StrAssign( (void*)&TMP$181$1, -1ll, (void*)LIBNAME$1, 0ll, 0 );
	STRSETADD( (struct $7TSTRSET*)((uint8*)&ENV$ + 1608ll), &TMP$181$1, 0ll );
...
void FBADDLIBPATH( uint8* PATH$1 )
{
	...
	fb_StrAssign( (void*)&TMP$182$1, -1ll, (void*)PATH$1, 0ll, 0 );
	FBSTRING* vr$4 = PATHSTRIPDIV( &TMP$182$1 );
	fb_StrAssign( (void*)&TMP$183$1, -1ll, (void*)vr$4, -1ll, 0 );
	STRSETADD( (struct $7TSTRSET*)((uint8*)&ENV$ + 1696ll), &TMP$183$1, 0ll );
	fb_StrDelete( (FBSTRING*)&TMP$183$1 );
...
void FBCOMPILE( uint8* INFNAME$1, uint8* OUTFNAME$1, FBSTRING* PPONLYFILE$1, int64 ISMAIN$1 )
{
	...
	HREPLACESLASH( (uint8*)((uint8*)&ENV$ + 608ll), 92ll );
	...
	*(int64*)((uint8*)&ENV$ + 600ll) = (int64)vr$7;
	...
	if( *(int64*)((uint8*)&ENV$ + 504ll) == 0ll ) goto label$342;
	{
		...
		fb_StrAssign( (void*)&TMP$194$2, -1ll, (void*)INFNAME$1, 0ll, 0 );
		FBSTRING* vr$17 = PATHSTRIPCURDIR( &TMP$194$2 );
		fb_StrAssign( (void*)&TMP$195$2, -1ll, (void*)vr$17, -1ll, 0 );
		HSHOWINCLUDE( 0ll, &TMP$195$2 );
		fb_StrDelete( (FBSTRING*)&TMP$195$2 );
	...
	*($13FBFILE_FORMAT*)((uint8*)&ENV$ + 888ll) = vr$22;
	int64 vr$23 = (*(tmp$39*)((uint8*)&IR$ + 16ll))(  );
...
void FBINCLUDEFILE( uint8* FILENAME$1, int64 ISONCE$1 )
{
	...
	if( *(int64*)((uint8*)&ENV$ + 1272ll) < 16ll ) goto label$428;
	{
	...
	if( vr$6 != 0ll ) goto label$430;
	{
		...
		if( vr$7 != 0ll ) goto label$432;
		{
			...
			goto label$433;
			label$434:;
			if( PATH$3 != (FBSTRING*)0ull ) goto label$438;
			{
				FBSTRING TMP$209$4;
				FBSTRING TMP$210$4;
				FBSTRING TMP$211$4;
				if( *(int64*)((uint8*)&ENV$ + 504ll) == 0ll ) goto label$440;
				{
					FBSTRING TMP$206$5;
					FBSTRING TMP$207$5;
					__builtin_memset( &TMP$207$5, 0, 24ll );
					__builtin_memset( &TMP$206$5, 0, 24ll );
					FBSTRING* vr$21 = fb_StrConcat( &TMP$206$5, (void*)FILENAME$1, 0ll, (void*)" (not found in include dirs)", 29ll );
					fb_StrAssign( (void*)&TMP$207$5, -1ll, (void*)vr$21, -1ll, 0 );
					HSHOWINCLUDE( *(int64*)((uint8*)&ENV$ + 1272ll) + 1ll, &TMP$207$5 );
					fb_StrDelete( (FBSTRING*)&TMP$207$5 );
				}
				label$440:;
				label$439:;
				__builtin_memset( &TMP$211$4, 0, 24ll );
				__builtin_memset( &TMP$209$4, 0, 24ll );
				FBSTRING* vr$29 = fb_StrConcat( &TMP$209$4, (void*)"\x22", 2ll, (void*)FILENAME$1, 0ll );
				__builtin_memset( &TMP$210$4, 0, 24ll );
				FBSTRING* vr$32 = fb_StrConcat( &TMP$210$4, (void*)vr$29, -1ll, (void*)"\x22", 2ll );
				fb_StrAssign( (void*)&TMP$211$4, -1ll, (void*)vr$32, -1ll, 0 );
				ERRREPORTEX( 23ll, (uint8*)*(uint8**)&TMP$211$4, 0ll, 1ll, (uint8*)0ull );
				fb_StrDelete( (FBSTRING*)&TMP$211$4 );
				ERRHIDEFURTHERERRORS(  );
				goto label$426;
			}
			label$438:;
	...
	label$430:;
	label$429:;
	TMP$212$1 = (uint8*)INCFILE$1;
	int64 vr$36 = IS_ROOTPATH( &TMP$212$1 );
	if( vr$36 != 0ll ) goto label$442;
	{
		FBSTRING TMP$213$2;
		FBSTRING TMP$214$2;
		FBSTRING* vr$37 = HCURDIR(  );
		__builtin_memset( &TMP$213$2, 0, 24ll );
		FBSTRING* vr$40 = fb_StrConcat( &TMP$213$2, (void*)vr$37, -1ll, (void*)"\x5C", 2ll );
		__builtin_memset( &TMP$214$2, 0, 24ll );
		FBSTRING* vr$43 = fb_StrConcat( &TMP$214$2, (void*)vr$40, -1ll, (void*)INCFILE$1, 260ll );
		fb_StrAssign( (void*)INCFILE$1, 260ll, (void*)vr$43, -1ll, 0 );
	}
	label$442:;
	label$441:;
	TMP$215$1 = (uint8*)INCFILE$1;
	int64 vr$45 = IS_ROOTPATH( &TMP$215$1 );
	if( vr$45 != 0ll ) goto label$444;
	{
		FBSTRING TMP$216$2;
		FBSTRING TMP$217$2;
		FBSTRING TMP$218$2;
		...
		FBSTRING* vr$49 = fb_StrConcat( &TMP$216$2, (void*)"\x22", 2ll, (void*)INCFILE$1, 260ll );
		__builtin_memset( &TMP$217$2, 0, 24ll );
		FBSTRING* vr$52 = fb_StrConcat( &TMP$217$2, (void*)vr$49, -1ll, (void*)"\x22", 2ll );
		fb_StrAssign( (void*)&TMP$218$2, -1ll, (void*)vr$52, -1ll, 0 );
		ERRREPORTEX( 23ll, (uint8*)*(uint8**)&TMP$218$2, 0ll, 1ll, (uint8*)0ull );
	...
	if( vr$55 != 0ll ) goto label$446;
	{
		...
		FBSTRING* vr$59 = fb_StrConcat( &TMP$219$2, (void*)"\x22", 2ll, (void*)INCFILE$1, 260ll );
		__builtin_memset( &TMP$220$2, 0, 24ll );
		FBSTRING* vr$62 = fb_StrConcat( &TMP$220$2, (void*)vr$59, -1ll, (void*)"\x22", 2ll );
		fb_StrAssign( (void*)&TMP$221$2, -1ll, (void*)vr$62, -1ll, 0 );
		ERRREPORTEX( 23ll, (uint8*)*(uint8**)&TMP$221$2, 0ll, 1ll, (uint8*)0ull );
	...
	if( ISONCE$1 == 0ll ) goto label$448;
	{
		uint8* vr$66 = HFINDINCFILE( (struct $5THASH*)((uint8*)&ENV$ + 1224ll), (uint8*)INCFILE$1 );
		if( vr$66 == (uint8*)0ull ) goto label$450;
		{
			FBSTRING TMP$222$3;
			__builtin_memset( &TMP$222$3, 0, 24ll );
			fb_StrAssign( (void*)&TMP$222$3, -1ll, (void*)INCFILE$1, 260ll, 0 );
			HONSKIPPEDFILE( &TMP$222$3 );
	...
	*(uint8**)((uint8*)&ENV$ + 872ll) = FILEIDX$1;
	if( *(int64*)((uint8*)&ENV$ + 504ll) == 0ll ) goto label$454;
	{
		FBSTRING TMP$224$2;
		FBSTRING TMP$225$2;
		__builtin_memset( &TMP$225$2, 0, 24ll );
		__builtin_memset( &TMP$224$2, 0, 24ll );
		fb_StrAssign( (void*)&TMP$224$2, -1ll, (void*)INCFILE$1, 260ll, 0 );
		FBSTRING* vr$90 = PATHSTRIPCURDIR( &TMP$224$2 );
		fb_StrAssign( (void*)&TMP$225$2, -1ll, (void*)vr$90, -1ll, 0 );
		HSHOWINCLUDE( *(int64*)((uint8*)&ENV$ + 1272ll), &TMP$225$2 );
	...
	*(int64*)((uint8*)&ENV$ + 600ll) = (int64)vr$95;
	...
	if( (int64)vr$99 == 0ll ) goto label$456;
	{
		FBSTRING TMP$226$2;
		FBSTRING TMP$227$2;
		FBSTRING TMP$228$2;
		...
		FBSTRING* vr$104 = fb_StrConcat( &TMP$226$2, (void*)"\x22", 2ll, (void*)FILENAME$1, 0ll );
		__builtin_memset( &TMP$227$2, 0, 24ll );
		FBSTRING* vr$107 = fb_StrConcat( &TMP$227$2, (void*)vr$104, -1ll, (void*)"\x22", 2ll );
		fb_StrAssign( (void*)&TMP$228$2, -1ll, (void*)vr$107, -1ll, 0 );
		ERRREPORTEX( 23ll, (uint8*)*(uint8**)&TMP$228$2, 0ll, 1ll, (uint8*)0ull );
	...
	*($13FBFILE_FORMAT*)((uint8*)&ENV$ + 888ll) = vr$110;
	...
	if( (int64)vr$112 == 0ll ) goto label$457;
...
$7FB_LANG FBGETLANGID( uint8* TXT$1 )
{
	...
	label$460:;
	{
		...
		fb_StrInit( (void*)&TMP$229$2, -1ll, (void*)vr$2, -1ll, 0 );
		int32 vr$5 = fb_StrCompare( (void*)&TMP$229$2, -1ll, (void*)"fb", 3ll );
		if( (int64)vr$5 != 0ll ) goto label$463;
		label$464:;
		{
			fb$result$1 = 0ll;
		}
		goto label$462;
		label$463:;
		int32 vr$8 = fb_StrCompare( (void*)&TMP$229$2, -1ll, (void*)"deprecated", 11ll );
		...
		goto label$462;
		label$465:;
		int32 vr$11 = fb_StrCompare( (void*)&TMP$229$2, -1ll, (void*)"fblite", 7ll );
		if( (int64)vr$11 != 0ll ) goto label$467;
		label$468:;
		{
			fb$result$1 = 2ll;
		}
		goto label$462;
		label$467:;
		int32 vr$14 = fb_StrCompare( (void*)&TMP$229$2, -1ll, (void*)"qb", 3ll );
		if( (int64)vr$14 != 0ll ) goto label$469;
		label$470:;
		{
			fb$result$1 = 3ll;
		}
...
$19FB_CVA_LIST_TYPEDEF FBGETBACKENDVALISTTYPE( void )
{
	...
	TYPEDEF$1 = 0ll;
	{
		$10FB_BACKEND TMP$230$2;
		TMP$230$2 = *($10FB_BACKEND*)((uint8*)&ENV$ + 208ll);
		if( TMP$230$2 != 1ll ) goto label$475;
		label$476:;
		{
			{
				int64 TMP$231$4;
				...
				TMP$231$4 = vr$1;
				if( TMP$231$4 != 0ll ) goto label$478;
				label$479:;
				{
					TYPEDEF$1 = 2ll;
				}
				goto label$477;
				label$478:;
				if( TMP$231$4 != 1ll ) goto label$480;
				label$481:;
				{
					{
						$13FB_COMPTARGET TMP$232$6;
						TMP$232$6 = *($13FB_COMPTARGET*)((uint8*)&ENV$ + 216ll);
						if( TMP$232$6 != 0ll ) goto label$483;
						label$484:;
						{
							TYPEDEF$1 = 2ll;
						}
				...
				goto label$477;
				label$480:;
				if( TMP$231$4 != 2ll ) goto label$486;
				label$487:;
				{
					TYPEDEF$1 = 5ll;
				}
				goto label$477;
				label$486:;
				if( TMP$231$4 != 3ll ) goto label$488;
				label$489:;
				{
					TYPEDEF$1 = 4ll;
				}
				goto label$477;
				label$488:;
				if( TMP$231$4 != 4ll ) goto label$490;
				label$491:;
				{
					TYPEDEF$1 = 2ll;
				}
				goto label$477;
				label$490:;
				if( TMP$231$4 == 5ll ) goto label$493;
				label$494:;
				if( TMP$231$4 != 6ll ) goto label$492;
				label$493:;
				{
					TYPEDEF$1 = 2ll;
				}
		...
		goto label$474;
		label$475:;
		if( TMP$230$2 != 0ll ) goto label$496;
		label$497:;
		{
			TYPEDEF$1 = 1ll;
		}
		goto label$474;
		label$496:;
		if( TMP$230$2 != 2ll ) goto label$498;
		label$499:;
		{
			TYPEDEF$1 = 1ll;
		}
		goto label$474;
		label$498:;
		if( TMP$230$2 != 3ll ) goto label$500;
		label$501:;
		{
			{
				$13FB_COMPTARGET TMP$233$4;
				TMP$233$4 = *($13FB_COMPTARGET*)((uint8*)&ENV$ + 216ll);
				if( TMP$233$4 != 0ll ) goto label$503;
				label$504:;
				{
					TYPEDEF$1 = 2ll;
				}
	...
	if( TYPEDEF$1 != 2ll ) goto label$508;
	{
		int64 vr$2 = FBGETOPTION( 29ll );
		if( vr$2 == 0ll ) goto label$510;
		{
			TYPEDEF$1 = 1ll;
		}
		label$510:;
...
static FBSTRING* HGETTARGETID( int64 OS$1, int64 CPUTYPE$1 )
{
	...
	FBSTRING* vr$19 = fb_StrConcat( &TMP$165$1, (void*)vr$16, -1ll, *(void**)((int64)(struct $15FBCPUFAMILYINFO*)CPUFAMILYINFO$ + (CPUFAMILY$1 << (4ll & 63ll))), 0ll );
...
static void HEMITOBJINFO( void )
{
	...
	if( *(int64*)((uint8*)&ENV$ + 272ll) == 0ll ) goto label$322;
	{
		...
		fb_StrAssign( (void*)&TMP$185$2, -1ll, (void*)vr$17, -1ll, 0 );
		HAPPENDFBCTINF( (uint8*)*(uint8**)&TMP$185$2 );
		fb_StrDelete( (FBSTRING*)&TMP$185$2 );
	}
	label$322:;
	label$321:;
	if( *(int64*)((uint8*)&ENV$ + 1784ll) == 0ll ) goto label$324;
	{
		(*(tmp$38*)((uint8*)&IR$ + 440ll))(  );
	}
	label$324:;
	label$323:;
	label$308:;
...
static void HSHOWINCLUDE( int64 INCLUDELEVEL$1, FBSTRING* MESSAGE$1 )
{
	...
	__builtin_memset( &LN$1, 0, 24ll );
	{
		...
		I$2 = I$2 + 1ll;
		label$327:;
		if( I$2 <= TMP$186$2 ) goto label$330;
		label$329:;
	}
	__builtin_memset( &TMP$188$1, 0, 24ll );
	FBSTRING* vr$6 = fb_StrConcat( &TMP$188$1, (void*)&LN$1, -1ll, (void*)MESSAGE$1, -1ll );
...
static void HONSKIPPEDFILE( FBSTRING* FILENAME$1 )
{
	...
	if( *(int64*)((uint8*)&ENV$ + 504ll) == 0ll ) goto label$334;
	{
		...
		FBSTRING* vr$4 = fb_StrConcat( &TMP$191$2, (void*)"(", 2ll, (void*)vr$1, -1ll );
		__builtin_memset( &TMP$192$2, 0, 24ll );
		FBSTRING* vr$7 = fb_StrConcat( &TMP$192$2, (void*)vr$4, -1ll, (void*)")", 2ll );
		fb_StrAssign( (void*)&TMP$193$2, -1ll, (void*)vr$7, -1ll, 0 );
		HSHOWINCLUDE( *(int64*)((uint8*)&ENV$ + 1272ll) + 1ll, &TMP$193$2 );
...
static int64 IS_ROOTPATH( uint8** PATH$1 )
{
	...
	label$392:;
	label$391:;
	if( (uint64)(int64)*(uint8*)((uint8*)*PATH$1 + 1ll) != 58ull ) goto label$394;
	{
		fb$result$1 = -1ll;
	}
	label$394:;
	label$393:;
	if( ((int64)-((uint64)(int64)*(*PATH$1) == 47ull) | (int64)-((uint64)(int64)*(*PATH$1) == 92ull)) == 0ll ) goto label$396;
	{
		if( ((int64)-((uint64)(int64)*(uint8*)((uint8*)*PATH$1 + 1ll) == 47ull) | (int64)-((uint64)(int64)*(uint8*)((uint8*)*PATH$1 + 1ll) == 92ull)) == 0ll ) goto label$398;
		{
			fb$result$1 = -1ll;
		}
		goto label$397;
		label$398:;
		{
			...
			FBSTRING* vr$28 = fb_StrConcat( &TMP$198$3, (void*)vr$25, -1ll, (void*)":", 2ll );
			__builtin_memset( &TMP$199$3, 0, 24ll );
			FBSTRING* vr$31 = fb_StrConcat( &TMP$199$3, (void*)vr$28, -1ll, *(void**)PATH$1, 0ll );
...
static int64 GET_ROOTPATH_LEN( uint8* PATH$1 )
{
	...
	label$399:;
	fb$result$1 = 0ll;
	if( (int64)*PATH$1 != 0ll ) goto label$402;
	{
		goto label$400;
	}
	label$402:;
	label$401:;
	fb$result$1 = 1ll;
	if( (uint64)(int64)*(uint8*)((uint8*)PATH$1 + 1ll) != 58ull ) goto label$404;
	{
		fb$result$1 = 3ll;
	}
	label$404:;
	label$403:;
	if( ((int64)-((uint64)(int64)*PATH$1 == 47ull) | (int64)-((uint64)(int64)*PATH$1 == 92ull)) == 0ll ) goto label$406;
	{
		if( ((int64)-((uint64)(int64)*(uint8*)((uint8*)PATH$1 + 1ll) == 47ull) | (int64)-((uint64)(int64)*(uint8*)((uint8*)PATH$1 + 1ll) == 92ull)) == 0ll ) goto label$408;
		{
			fb$result$1 = 2ll;
		}
		label$408:;
...
static int64 SOLVE_PATH( uint8* PATH$1 )
{
	...
	static struct $8FBARRAY1Iu7INTEGERE tmp$200$1 = { (int64*)CIDX$1, (int64*)CIDX$1, 1048ll, 8ll, 1ll, 49ll, { { 131ll, 0ll, 130ll } } };
	int64 STK$1;
	int64 S$1;
	int64 N$1;
	int64 D$1;
	...
	*(int64*)((int64)(int64*)CIDX$1 + (STK$1 << (3ll & 63ll))) = S$1;
	...
	D$1 = 0ll;
	{
		...
		label$414:;
		{
			...
			if( ((int64)-((uint64)C$1 == 47ull) | (int64)-((uint64)C$1 == 92ull)) == 0ll ) goto label$416;
			{
				if( N$1 != 0ll ) goto label$418;
				{
				}
				goto label$417;
				label$418:;
				if( ((int64)-(D$1 == 1ll) & (int64)-(N$1 == 1ll)) == 0ll ) goto label$419;
				{
					W$1 = W$1 + -1ll;
				}
				goto label$417;
				label$419:;
				if( ((int64)-(D$1 == 2ll) & (int64)-(N$1 == 2ll)) == 0ll ) goto label$420;
				{
					if( STK$1 == 0ll ) goto label$422;
					{
						STK$1 = STK$1 + -1ll;
					}
					label$422:;
			...
			label$416:;
			{
				if( (uint64)C$1 != 46ull ) goto label$424;
				{
					D$1 = D$1 + 1ll;
				}
				label$424:;
		...
		R$1 = R$1 + 1ll;
		label$411:;
		if( R$1 <= TMP$201$2 ) goto label$414;
		label$413:;
	}
