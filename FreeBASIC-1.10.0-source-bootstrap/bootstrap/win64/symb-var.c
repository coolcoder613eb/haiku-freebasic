...
void SYMBVARINIT( void )
{
	...
	*(struct $8FBSYMBOL**)((uint8*)&SYMB$ + 199208ll) = vr$0;
	SYMBADDFIELD( *(struct $8FBSYMBOL**)((uint8*)&SYMB$ + 199208ll), (uint8*)"elements", 0ll, (struct $7FBARRAYI10FBARRAYDIME*)&tmp$93$1, 8ll, (struct $8FBSYMBOL*)0ull, 0ll, 0ll, 0ll );
	SYMBADDFIELD( *(struct $8FBSYMBOL**)((uint8*)&SYMB$ + 199208ll), (uint8*)"lbound", 0ll, (struct $7FBARRAYI10FBARRAYDIME*)&tmp$93$1, 8ll, (struct $8FBSYMBOL*)0ull, 0ll, 0ll, 0ll );
	SYMBADDFIELD( *(struct $8FBSYMBOL**)((uint8*)&SYMB$ + 199208ll), (uint8*)"ubound", 0ll, (struct $7FBARRAYI10FBARRAYDIME*)&tmp$93$1, 8ll, (struct $8FBSYMBOL*)0ull, 0ll, 0ll, 0ll );
...
struct $8FBSYMBOL* SYMBADDARRAYDESCRIPTORTYPE( int64 DIMENSIONS$1, int64 ARRAYDTYPE$1, struct $8FBSYMBOL* ARRAYSUBTYPE$1 )
{
	...
	label$20:;
	static struct $10FBARRAYDIM DTB$1[1];
	static struct $8FBARRAY1I10FBARRAYDIME tmp$99$1 = { (struct $10FBARRAYDIM*)DTB$1, (struct $10FBARRAYDIM*)DTB$1, 16ll, 16ll, 1ll, 49ll, { { 1ll, 0ll, 0ll } } };
	FBSTRING ID$1;
	...
	ATTRIB$1 = 0ll;
	PATTRIB$1 = 0ll;
	TMP$103$1 = (struct $8FBSYMBOL*)0ull;
	struct $8FBSYMBOL* vr$20 = SYMBLOOKUPINTERNALLYMANGLEDSUBTYPE( (uint8*)*(uint8**)&ID$1, (struct $8FBSYMBOL*)0ull, ($13FB_SYMBATTRIB*)&ATTRIB$1, ($13FB_PROCATTRIB*)&PATTRIB$1, &TMP$103$1, &SYMTB$1, &HASHTB$1 );
	SYM$1 = vr$20;
	...
	*(int64*)((int64)(struct $10FBARRAYDIM*)DTB$1 + 8ll) = 0ll;
	SYMBADDFIELD( SYM$1, (uint8*)"data", 0ll, (struct $7FBARRAYI10FBARRAYDIME*)&tmp$99$1, (((ARRAYDTYPE$1 & 31ll) | ((ARRAYDTYPE$1 & 480ll) + 32ll)) | ((ARRAYDTYPE$1 & 261632ll) << (1ll & 63ll))) | (ARRAYDTYPE$1 & 32505856ll), ARRAYSUBTYPE$1, 0ll, 0ll, 0ll );
	SYMBADDFIELD( SYM$1, (uint8*)"ptr", 0ll, (struct $7FBARRAYI10FBARRAYDIME*)&tmp$99$1, (((ARRAYDTYPE$1 & 31ll) | ((ARRAYDTYPE$1 & 480ll) + 32ll)) | ((ARRAYDTYPE$1 & 261632ll) << (1ll & 63ll))) | (ARRAYDTYPE$1 & 32505856ll), ARRAYSUBTYPE$1, 0ll, 0ll, 0ll );
	SYMBADDFIELD( SYM$1, (uint8*)"size", 0ll, (struct $7FBARRAYI10FBARRAYDIME*)&tmp$99$1, 8ll, (struct $8FBSYMBOL*)0ull, 0ll, 0ll, 0ll );
	SYMBADDFIELD( SYM$1, (uint8*)"element_len", 0ll, (struct $7FBARRAYI10FBARRAYDIME*)&tmp$99$1, 8ll, (struct $8FBSYMBOL*)0ull, 0ll, 0ll, 0ll );
	SYMBADDFIELD( SYM$1, (uint8*)"dimensions", 0ll, (struct $7FBARRAYI10FBARRAYDIME*)&tmp$99$1, 8ll, (struct $8FBSYMBOL*)0ull, 0ll, 0ll, 0ll );
	SYMBADDFIELD( SYM$1, (uint8*)"flags", 0ll, (struct $7FBARRAYI10FBARRAYDIME*)&tmp$99$1, 8ll, (struct $8FBSYMBOL*)0ull, 0ll, 0ll, 0ll );
	...
	*(int64*)((int64)(struct $10FBARRAYDIM*)DTB$1 + 8ll) = DIMENSIONS$1 + -1ll;
	SYMBADDFIELD( SYM$1, (uint8*)"dimTB", 1ll, (struct $7FBARRAYI10FBARRAYDIME*)&tmp$99$1, 20ll, *(struct $8FBSYMBOL**)((uint8*)&SYMB$ + 199208ll), 0ll, 0ll, 0ll );
	...
	label$33:;
	{
		...
		if( ((int64)-((*(int64*)((uint8*)ARRAY$1 + 8ll) & 8ll) != 0ll) | ISDYNAMIC$1) == 0ll ) goto label$37;
		{
			...
			if( (*(int64*)((uint8*)ARRAY$1 + 8ll) & 1048576ll) == 0ll ) goto label$39;
			{
				...
				TMP$111$4 = 0ll;
				uint8* vr$24 = HMANGLEBUILTINTYPE( *(int64*)((uint8*)ARRAY$1 + 56ll) & 511ll, &TMP$111$4 );
				__builtin_memset( &TMP$112$4, 0, 24ll );
				FBSTRING* vr$27 = fb_StrConcat( &TMP$112$4, (void*)&TEMPID$1, -1ll, (void*)vr$24, 0ll );
...
int64 SYMBARRAYHASUNKNOWNBOUNDS( struct $8FBSYMBOL* SYM$1 )
{
	...
	label$68:;
	{
		...
		I$2 = 0ll;
		int64 TMP$114$2;
		TMP$114$2 = *(int64*)((uint8*)SYM$1 + 104ll) + -1ll;
		goto label$70;
		label$73:;
		{
		...
		I$2 = I$2 + 1ll;
		label$70:;
		if( I$2 <= TMP$114$2 ) goto label$73;
		label$72:;
	}
	label$67:;
	return fb$result$1;
	...
	*(struct $10FBARRAYDIM**)((uint8*)SYM$1 + 112ll) = (struct $10FBARRAYDIM*)vr$3;
	{
		...
		I$2 = I$2 + 1ll;
		label$86:;
		if( I$2 <= TMP$115$2 ) goto label$89;
		label$88:;
	}
...
void SYMBSETFIXEDSIZEARRAYDIMENSIONELEMENTS( struct $8FBSYMBOL* SYM$1, int64 DIMENSION$1, int64 ELEMENTS$1 )
{
	label$90:;
	{
		struct $10FBARRAYDIM* TMP$116$2;
		TMP$116$2 = (struct $10FBARRAYDIM*)((uint8*)*(struct $10FBARRAYDIM**)((uint8*)SYM$1 + 112ll) + (DIMENSION$1 << (4ll & 63ll)));
		*(int64*)((uint8*)TMP$116$2 + 8ll) = (*(int64*)TMP$116$2 + ELEMENTS$1) + -1ll;
	}
	SYMBRECALCARRAYDIFFANDELEMENTS( SYM$1 );
	label$91:;
}
...
struct $8FBSYMBOL* SYMBADDTEMPVAR( int64 DTYPE$1, struct $8FBSYMBOL* SUBTYPE$1 )
{
	...
	struct $8FBSYMBOL* vr$4 = SYMBADDVAR( (uint8*)vr$3, (uint8*)0ull, DTYPE$1, SUBTYPE$1, 0ll, 0ll, (struct $7FBARRAYI10FBARRAYDIME*)&tmp$117$1, 4096ll, OPTIONS$1 );
	SYM$1 = vr$4;
...
struct $8FBSYMBOL* SYMBADDIMPLICITVAR( int64 DTYPE$1, struct $8FBSYMBOL* SUBTYPE$1, int64 OPTIONS$1 )
{
	...
	label$135:;
	static struct $10FBARRAYDIM DTB$1[1];
	static struct $8FBARRAY1I10FBARRAYDIME tmp$118$1 = { (struct $10FBARRAYDIM*)DTB$1, (struct $10FBARRAYDIM*)DTB$1, 16ll, 16ll, 1ll, 49ll, { { 1ll, 0ll, 0ll } } };
	struct $8FBSYMBOL* SYM$1;
	uint8* vr$1 = SYMBUNIQUEID( (boolean)0ll );
	struct $8FBSYMBOL* vr$2 = SYMBADDVAR( (uint8*)vr$1, (uint8*)0ull, DTYPE$1, SUBTYPE$1, 0ll, 0ll, (struct $7FBARRAYI10FBARRAYDIME*)&tmp$118$1, 0ll, OPTIONS$1 );
	SYM$1 = vr$2;
	*($12FB_SYMBSTATS*)((uint8*)SYM$1 + 24ll) = *(int64*)((uint8*)SYM$1 + 24ll) | 16ll;
	fb$result$1 = SYM$1;
	label$136:;
...
struct $8FBSYMBOL* SYMBADDANDALLOCATETEMPVAR( int64 DTYPE$1 )
{
	...
	S$1 = vr$1;
	(*(tmp$43*)((uint8*)&IR$ + 72ll))( *(struct $8FBSYMBOL**)((uint8*)&PARSER$ + 216ll), S$1 );
	fb$result$1 = S$1;
	label$138:;
	return fb$result$1;
}
...
int64 SYMBGETREALSIZE( struct $8FBSYMBOL* SYM$1 )
{
	...
	TMP$119$1 = *(int64*)((uint8*)&ENV$ + 592ll);
	goto label$142;
	label$141:;
	TMP$119$1 = *(int64*)((uint8*)SYM$1 + 80ll);
	label$142:;
	SIZE$1 = TMP$119$1;
...
void SYMBGETREALTYPE( struct $8FBSYMBOL* SYM$1, int64* DTYPE$1, struct $8FBSYMBOL** SUBTYPE$1 )
{
	...
	*SUBTYPE$1 = *(struct $8FBSYMBOL**)((uint8*)SYM$1 + 64ll);
	if( (*(int64*)((uint8*)SYM$1 + 8ll) & 114688ll) == 0ll ) goto label$146;
	{
		...
		label$147:;
		_Z21SYMBGETREALPARAMDTYPEu7INTEGERP8FBSYMBOLRS_RS1_( PARAMMODE$2, BYDESCREALSUBTYPE$2, DTYPE$1, SUBTYPE$1 );
	}
	goto label$145;
	label$146:;
...
int64 SYMBCALCARRAYELEMENTS( struct $8FBSYMBOL* SYM$1, int64 FIRST$1 )
{
	...
	TOTALELEMENTS$1 = 1ll;
	{
		...
		I$2 = FIRST$1;
		int64 TMP$120$2;
		TMP$120$2 = *(int64*)((uint8*)SYM$1 + 104ll) + -1ll;
		goto label$153;
		label$156:;
		{
		...
		I$2 = I$2 + 1ll;
		label$153:;
		if( I$2 <= TMP$120$2 ) goto label$156;
		label$155:;
	}
...
int64 SYMBCHECKARRAYSIZE( int64 DIMENSIONS$1, struct $10FBARRAYDIM* DIMTB$1, int64 LGT$1, int64 IS_ON_STACK$1 )
{
	...
	ALLELEMENTS$1 = 1ull;
	{
		...
		I$2 = I$2 + 1ll;
		label$159:;
		if( I$2 <= TMP$121$2 ) goto label$162;
		label$161:;
	}
...
int64 SYMBGETVARHASCTOR( struct $8FBSYMBOL* S$1 )
{
	...
	label$179:;
	{
		...
		if( TMP$122$2 != 17ll ) goto label$182;
		label$183:;
		{
			fb$result$1 = -1ll;
			goto label$178;
		...
		goto label$181;
		label$182:;
		if( TMP$122$2 != 39ll ) goto label$184;
		label$185:;
		{
...
int64 SYMBGETVARHASDTOR( struct $8FBSYMBOL* S$1 )
{
	...
	{
		int64 TMP$123$2;
		TMP$123$2 = *(int64*)((uint8*)S$1 + 56ll) & 511ll;
		if( TMP$123$2 != 17ll ) goto label$195;
		label$196:;
		{
			fb$result$1 = -1ll;
			goto label$191;
		...
		goto label$194;
		label$195:;
		if( TMP$123$2 != 39ll ) goto label$197;
		label$198:;
		{
		...
		{
			{
				...
				I$4 = 0ll;
				int64 TMP$125$4;
				TMP$125$4 = *(int64*)((uint8*)SYM$1 + 104ll) + -1ll;
				goto label$212;
				label$215:;
				{
				...
				I$4 = I$4 + 1ll;
				label$212:;
				if( I$4 <= TMP$125$4 ) goto label$215;
				label$214:;
			}
		}
		label$211:;
		label$210:;
		struct $8FBSYMBOL* vr$27 = SYMBADDVAR( (uint8*)*(uint8**)((uint8*)SYM$1 + 32ll), (uint8*)0ull, *(int64*)((uint8*)SYM$1 + 56ll) & 511ll, *(struct $8FBSYMBOL**)((uint8*)SYM$1 + 64ll), 0ll, *(int64*)((uint8*)SYM$1 + 104ll), (struct $7FBARRAYI10FBARRAYDIME*)&tmp$124$1, *($13FB_SYMBATTRIB*)((uint8*)SYM$1 + 8ll), 0ll );
		fb$result$1 = vr$27;
	}
	label$207:;
	label$206:;
...
void SYMBDELVAR( struct $8FBSYMBOL* S$1, int64 IS_TBDEL$1 )
{
	...
	if( (*(int64*)((uint8*)S$1 + 8ll) & 1024ll) == 0ll ) goto label$232;
	{
		...
		{
			if( *(uint16**)((uint8*)S$1 + 96ll) == (uint16*)0ull ) goto label$236;
			{
				if( *(uint16**)((uint8*)S$1 + 96ll) == (uint16*)0ull ) goto label$238;
				{
...
static void SYMBRECALCARRAYDIFF( struct $8FBSYMBOL* SYM$1 )
{
	...
	LAST$1 = *(int64*)((uint8*)SYM$1 + 104ll) + -1ll;
	{
		...
		I$2 = I$2 + 1ll;
		label$58:;
		if( I$2 <= TMP$113$2 ) goto label$61;
		label$60:;
	}
