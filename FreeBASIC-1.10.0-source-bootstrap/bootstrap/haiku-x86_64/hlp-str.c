...
FBSTRING* HREPLACE( uint8* ORGTEXT$1, uint8* OLDTEXT$1, uint8* NEWTEXT$1 )
{
	...
	label$112:;
	{
		...
		FBSTRING* vr$12 = fb_StrConcat( &TMP$82$2, (void*)&TEXT$1, -1ll, (void*)NEWTEXT$1, 0ll );
			...
			SRC$1 = (uint8*)((uint8*)SRC$1 + 1ll);
			{
				...
				label$154:;
				{
					...
					label$159:;
					{
						...
						if( (TMP$86$6 - 66ull) > 45ull ) goto label$161;
						goto *tmp$87[TMP$86$6 - 66ull];
						label$161:;
					}
				}
				goto label$142;
			...
			*DST$1 = (uint32)27u;
			...
			SRC$1 = (uint32*)((uint8*)SRC$1 + 4ll);
			{
				...
				label$245:;
				{
					...
					label$250:;
					{
						...
						if( (TMP$88$6 - 66ull) > 45ull ) goto label$252;
						goto *tmp$90[TMP$88$6 - 66ull];
						label$252:;
					}
				}
				goto label$233;
			...
			if( ISNUMBER$1 == 0ll ) goto label$306;
			{
				...
				*DST$1 = (uint32)(uint32)LGT$1;
				...
				TMP$89$4 = vr$85;
				fb_WstrAssign( DST$1, 0ll, (uint32*)TMP$89$4 );
	...
	if( LGT$1 <= 0ll ) goto label$354;
	{
		if( (int64)*TEXT$1 != 92ll ) goto label$356;
		{
			...
			CHAR$1 = (uint64)*TEXT$1;
			{
				...
				if( (TMP$100$4 - 34ull) > 84ull ) goto label$357;
	...
	if( LGT$1 <= 0ll ) goto label$363;
	{
		if( (int64)*TEXT$1 != 92ll ) goto label$365;
		{
			...
			CHAR$1 = (uint64)*TEXT$1;
			{
				...
				if( (TMP$102$4 - 34ull) > 84ull ) goto label$366;
		...
		if( CHAR$1 != 27ll ) goto label$427;
		{
			...
			label$431:;
			{
				if( (uint64)CHAR$1 != 117ull ) goto label$435;
				{
					...
					uint64 vr$22 = HU16TOWCHAR( (uint32*)SRC$1 );
					CHAR$1 = (int64)vr$22;
					SRC$1 = (uint32*)((uint8*)SRC$1 + 16ll);
				}
				goto label$434;
...
int64 HSTR2LONG( FBSTRING* TXT$1, int32* VALUE$1 )
{
	...
	TMP$110$1 = (int64)-((int64)*S$1 == 0ll);
	goto label$456;
	label$446:;
	TMP$110$1 = -1ll;
	label$456:;
	if( TMP$110$1 == 0ll ) goto label$448;
	{
		fb$result$1 = 0ll;
		goto label$443;
	}
	...
	TMP$111$1 = (int64)-((uint64)(int64)*S$1 >= 48ull);
	goto label$457;
	label$455:;
	TMP$111$1 = 0ll;
	label$457:;
	if( TMP$111$1 == 0ll ) goto label$454;
	{
...
int64 HSTR2TOK( uint8* TXT$1, struct $7FBARRAYI8FBSTRINGE* RES$1 )
{
	...
	if( (int64)*S$1 == 0ll ) goto label$491;
	{
		...
		label$495:;
		{
			...
			FBSTRING* vr$24 = fb_StrConcat( &TMP$113$3, (void*)((T$1 * 24ll) + *(int64*)RES$1), -1ll, (void*)vr$17, -1ll );
...
int64 HSTR2ARGS( uint8* TXT$1, struct $7FBARRAYI8FBSTRINGE* RES$1 )
{
	...
	label$512:;
	{
		...
		C$1 = (uint64)*S$1;
		{
			...
			label$532:;
			{
				...
				if( C$1 == 34ull ) goto label$536;
				{
					...
					FBSTRING* vr$31 = fb_StrConcat( &TMP$115$5, (void*)((uint8*)((T$1 * 24ll) + *(int64*)RES$1) + -24ll), -1ll, (void*)vr$24, -1ll );
				...
				FBSTRING* vr$46 = fb_StrConcat( &TMP$116$4, (void*)((uint8*)((T$1 * 24ll) + *(int64*)RES$1) + -24ll), -1ll, (void*)vr$39, -1ll );
				...
				label$539:;
				{
					...
					FBSTRING* vr$61 = fb_StrConcat( &TMP$117$5, (void*)((uint8*)((T$1 * 24ll) + *(int64*)RES$1) + -24ll), -1ll, (void*)vr$54, -1ll );
					...
					if( C$1 != 34ull ) goto label$545;
					{
						...
						FBSTRING* vr$76 = fb_StrConcat( &TMP$118$6, (void*)((uint8*)((T$1 * 24ll) + *(int64*)RES$1) + -24ll), -1ll, (void*)vr$69, -1ll );
					...
					if( C$1 != 92ull ) goto label$548;
					{
						C$1 = (uint64)*S$1;
						{
							...
							label$551:;
							{
								...
								FBSTRING* vr$91 = fb_StrConcat( &TMP$119$8, (void*)((uint8*)((T$1 * 24ll) + *(int64*)RES$1) + -24ll), -1ll, (void*)vr$84, -1ll );
			...
			label$554:;
			{
				...
				FBSTRING* vr$104 = fb_StrConcat( &TMP$120$4, (void*)((uint8*)((T$1 * 24ll) + *(int64*)RES$1) + -24ll), -1ll, (void*)vr$97, -1ll );
				...
				FBSTRING* vr$119 = fb_StrConcat( &TMP$121$4, (void*)((uint8*)((T$1 * 24ll) + *(int64*)RES$1) + -24ll), -1ll, (void*)vr$112, -1ll );
				...
				label$557:;
				{
					...
					FBSTRING* vr$134 = fb_StrConcat( &TMP$122$5, (void*)((uint8*)((T$1 * 24ll) + *(int64*)RES$1) + -24ll), -1ll, (void*)vr$127, -1ll );
					...
					if( C$1 != 39ull ) goto label$563;
					{
						...
						if( C$1 != 47ull ) goto label$565;
						{
							...
							__builtin_memset( &TMP$123$7, 0, 24ll );
							FBSTRING* vr$149 = fb_StrConcat( &TMP$123$7, (void*)((uint8*)((T$1 * 24ll) + *(int64*)RES$1) + -24ll), -1ll, (void*)vr$142, -1ll );
			...
			label$567:;
			{
				...
				if( C$1 == 0ull ) goto label$569;
				{
					...
					__builtin_memset( &TMP$124$5, 0, 24ll );
					FBSTRING* vr$162 = fb_StrConcat( &TMP$124$5, (void*)((uint8*)((T$1 * 24ll) + *(int64*)RES$1) + -24ll), -1ll, (void*)vr$155, -1ll );
		...
		FBSTRING* vr$177 = fb_StrConcat( &TMP$125$2, (void*)((uint8*)((T$1 * 24ll) + *(int64*)RES$1) + -24ll), -1ll, (void*)vr$170, -1ll );
...
static int64 HREMAPCHAR( int64 CHAR$1 )
{
	...
	label$339:;
	{
		...
		goto label$341;
		label$342:;
		static const void* tmp$126[22ll] = {
			&&label$347,
			&&label$346,
			&&label$350,
			&&label$350,
		...
		if( (TMP$91$2 - 97ull) > 21ull ) goto label$350;
		goto *tmp$126[TMP$91$2 - 97ull];
		label$341:;
	}
	label$340:;
	return fb$result$1;
