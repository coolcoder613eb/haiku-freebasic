...
uint8* SYMBUNIQUEID( boolean VALIDFBNAME$1 )
{
	...
	if( ((int64)-(*(int64*)((uint8*)&ENV$ + 208ll) == 1ll) & (int64)-((int64)-VALIDFBNAME$1 == 0ll)) == 0ll ) goto label$17;
	{
		...
		FBSTRING* vr$10 = fb_StrConcat( &TMP$83$2, (void*)((uint8*)&CTX$ + 120ll), 17ll, (void*)vr$6, -1ll );
	...
	label$17:;
	{
		...
		FBSTRING* vr$17 = fb_StrConcat( &TMP$85$2, (void*)((uint8*)&CTX$ + 120ll), 17ll, (void*)vr$13, 0ll );
...
uint8* SYMBUNIQUELABEL( void )
{
	...
	if( *(int64*)((uint8*)&ENV$ + 208ll) != 1ll ) goto label$21;
	{
		...
		FBSTRING* vr$6 = fb_StrConcat( &TMP$87$2, (void*)((uint8*)&CTX$ + 120ll), 17ll, (void*)vr$2, -1ll );
	...
	label$21:;
	{
		...
		FBSTRING* vr$15 = fb_StrConcat( &TMP$90$2, (void*)((uint8*)&CTX$ + 120ll), 17ll, (void*)vr$11, 0ll );
...
uint8* SYMBMAKEPROFILELABELNAME( void )
{
	...
	FBSTRING* vr$4 = fb_StrConcat( &TMP$92$1, (void*)"LP_", 4ll, (void*)vr$1, 0ll );
	...
	{
		{
			...
			goto label$30;
			label$31:;
			static const void* tmp$94[4ll] = {
				&&label$32,
				&&label$32,
				&&label$32,
				&&label$32,
			};
			if( (TMP$93$3 - 8ull) > 3ull ) goto label$35;
			goto *tmp$94[TMP$93$3 - 8ull];
			label$30:;
		}
	}
	label$29:;
...
uint8* SYMBGETMANGLEDNAME( struct $8FBSYMBOL* SYM$1 )
{
	...
	label$56:;
	{
		...
		if( (TMP$101$2 - 1ull) > 13ull ) goto label$65;
		goto *tmp$103[TMP$101$2 - 1ull];
		label$58:;
	}
...
uint8* HMANGLEBUILTINTYPE( int64 DTYPE$1, int64* ADD_ABBREV$1 )
{
	...
	*ADD_ABBREV$1 = 0ll;
	...
	static struct $8FBARRAY1IPcE tmp$112$1 = { (uint8**)TYPECODES$1, (uint8**)TYPECODES$1, 208ll, 8ll, 1ll, 49ll, { { 26ll, 0ll, 25ll } } };
...
void SYMBMANGLETYPE( FBSTRING* MANGLED$1, int64 DTYPE$1, struct $8FBSYMBOL* SUBTYPE$1, $12FB_MANGLEOPT OPTIONS$1 )
{
	...
	label$175:;
	if( TMP$127$1 != 23ll ) goto label$125;
	{
			...
			{
				{
					...
					TMP$131$5 = vr$31;
					if( TMP$131$5 != 3ll ) goto label$143;
					label$144:;
					{
					...
					goto label$142;
					label$143:;
					if( TMP$131$5 == 4ll ) goto label$148;
					label$149:;
					if( TMP$131$5 != 5ll ) goto label$147;
					label$148:;
					{
	...
	label$136:;
	{
		...
		if( TMP$134$2 == 20ll ) goto label$152;
		label$153:;
		if( TMP$134$2 != 10ll ) goto label$151;
		label$152:;
		{
		...
		goto label$150;
		label$151:;
		if( TMP$134$2 != 21ll ) goto label$160;
		label$161:;
		{
		...
		goto label$150;
		label$160:;
		if( TMP$134$2 != 22ll ) goto label$166;
		label$167:;
		{
		...
		label$166:;
		{
			...
			FBSTRING* vr$55 = fb_StrConcat( &TMP$137$3, (void*)MANGLED$1, -1ll, (void*)vr$52, 0ll );
...
void SYMBMANGLEPARAM( FBSTRING* MANGLED$1, struct $8FBSYMBOL* PARAM$1 )
{
	...
	{
		uint64 TMP$138$2;
		TMP$138$2 = *(uint64*)((uint8*)PARAM$1 + 96ll);
		goto label$179;
		label$180:;
		{
		...
		if( (TMP$138$2 - 1ull) > 3ull ) goto label$178;
		goto *tmp$140[TMP$138$2 - 1ull];
		label$178:;
	}
	label$177:;
}
...
static void HMANGLEUDTID( FBSTRING* MANGLED$1, struct $8FBSYMBOL* SYM$1 )
{
	...
	if( *(uint8**)((uint8*)SYM$1 + 40ll) == (uint8*)0ull ) goto label$51;
	{
		...
		FBSTRING* vr$6 = fb_StrConcat( &TMP$95$2, (void*)MANGLED$1, -1ll, (void*)vr$3, -1ll );
		fb_StrAssign( (void*)MANGLED$1, -1ll, (void*)vr$6, -1ll, 0 );
		__builtin_memset( &TMP$96$2, 0, 24ll );
		FBSTRING* vr$10 = fb_StrConcat( &TMP$96$2, (void*)MANGLED$1, -1ll, *(void**)((uint8*)SYM$1 + 40ll), 0ll );
	...
	label$51:;
	{
		...
		FBSTRING* vr$16 = fb_StrConcat( &TMP$97$2, (void*)MANGLED$1, -1ll, (void*)vr$13, -1ll );
		fb_StrAssign( (void*)MANGLED$1, -1ll, (void*)vr$16, -1ll, 0 );
		__builtin_memset( &TMP$98$2, 0, 24ll );
		FBSTRING* vr$20 = fb_StrConcat( &TMP$98$2, (void*)MANGLED$1, -1ll, *(void**)((uint8*)SYM$1 + 32ll), 0ll );
...
static void HMANGLENAMESPACE( FBSTRING* MANGLED$1, struct $8FBSYMBOL* NS$1, int64 DOHASHING$1, int64 ISCONST$1 )
{
	...
	static struct $8FBARRAY1IP8FBSYMBOLE tmp$141$1 = { (struct $8FBSYMBOL**)NSSTK$1, (struct $8FBSYMBOL**)NSSTK$1, 512ll, 8ll, 1ll, 49ll, { { 64ll, 0ll, 63ll } } };
	int64 TOS$1;
...
static void HMANGLEVARIABLE( struct $8FBSYMBOL* SYM$1 )
{
	...
	if( (*(int64*)((uint8*)SYM$1 + 8ll) & 59ll) == 0ll ) goto label$225;
	{
		...
		label$228:;
		{
			...
			TMP$143$3 = *($13FB_COMPTARGET*)((uint8*)&ENV$ + 216ll);
			if( TMP$143$3 == 0ll ) goto label$232;
			label$233:;
			if( TMP$143$3 != 1ll ) goto label$231;
			label$232:;
			{
	...
	label$247:;
	{
		...
		if( (ISGLOBAL$1 | DOCPP$1) == 0ll ) goto label$249;
		{
			...
			if( (*(int64*)((uint8*)SYM$1 + 8ll) & 1048576ll) == 0ll ) goto label$255;
			{
				...
				FBSTRING TMP$150$4;
				TMP$149$4 = 0ll;
				uint8* vr$44 = HMANGLEBUILTINTYPE( *(int64*)((uint8*)SYM$1 + 56ll) & 511ll, &TMP$149$4 );
				__builtin_memset( &TMP$150$4, 0, 24ll );
				FBSTRING* vr$47 = fb_StrConcat( &TMP$150$4, (void*)&ID$1, -1ll, (void*)vr$44, 0ll );
		...
		{
			{
				...
				TMP$151$4 = *($10FB_BACKEND*)((uint8*)&ENV$ + 208ll);
				if( TMP$151$4 != 1ll ) goto label$259;
				label$260:;
				{
					...
					label$262:;
					{
						if( (int64)*(int16*)((uint8*)SYM$1 + 74ll) != 0ll ) goto label$264;
						{
							...
							if( (*(int64*)((uint8*)SYM$1 + 8ll) & 1048576ll) == 0ll ) goto label$266;
							{
								...
								FBSTRING TMP$153$8;
								TMP$152$8 = 0ll;
								uint8* vr$62 = HMANGLEBUILTINTYPE( *(int64*)((uint8*)SYM$1 + 56ll) & 511ll, &TMP$152$8 );
								__builtin_memset( &TMP$153$8, 0, 24ll );
								FBSTRING* vr$65 = fb_StrConcat( &TMP$153$8, (void*)&ID$1, -1ll, (void*)vr$62, 0ll );
							...
							__builtin_memset( &TMP$154$7, 0, 24ll );
							FBSTRING* vr$71 = fb_StrConcat( &TMP$154$7, (void*)&ID$1, -1ll, (void*)vr$68, -1ll );
				...
				goto label$258;
				label$259:;
				if( TMP$151$4 != 2ll ) goto label$267;
				label$268:;
				{
					if( (int64)*(int16*)((uint8*)SYM$1 + 74ll) != 0ll ) goto label$270;
					{
						...
						if( (*(int64*)((uint8*)SYM$1 + 8ll) & 1048576ll) == 0ll ) goto label$272;
						{
							...
							FBSTRING TMP$156$7;
							TMP$155$7 = 0ll;
							uint8* vr$81 = HMANGLEBUILTINTYPE( *(int64*)((uint8*)SYM$1 + 56ll) & 511ll, &TMP$155$7 );
							__builtin_memset( &TMP$156$7, 0, 24ll );
							FBSTRING* vr$84 = fb_StrConcat( &TMP$156$7, (void*)&ID$1, -1ll, (void*)vr$81, 0ll );
				...
				goto label$258;
				label$267:;
				if( TMP$151$4 != 3ll ) goto label$273;
				label$274:;
				{
					if( (int64)*(int16*)((uint8*)SYM$1 + 74ll) != 0ll ) goto label$276;
					{
						...
						if( (*(int64*)((uint8*)SYM$1 + 8ll) & 1048576ll) == 0ll ) goto label$278;
						{
							...
							FBSTRING TMP$158$7;
							TMP$157$7 = 0ll;
							uint8* vr$96 = HMANGLEBUILTINTYPE( *(int64*)((uint8*)SYM$1 + 56ll) & 511ll, &TMP$157$7 );
							__builtin_memset( &TMP$158$7, 0, 24ll );
							FBSTRING* vr$99 = fb_StrConcat( &TMP$158$7, (void*)&ID$1, -1ll, (void*)vr$96, 0ll );
				...
				label$273:;
				{
					...
					label$282:;
					{
						uint8* vr$109 = (*(tmp$43*)((uint8*)&IR$ + 80ll))(  );
...
static uint8* HGETOPERATORNAME( struct $8FBSYMBOL* PROC$1 )
{
	...
	{
		uint64 TMP$159$2;
		TMP$159$2 = *(uint64*)((uint8*)*(struct $10FB_PROCEXT**)((uint8*)PROC$1 + 208ll) + 80ll);
		goto label$305;
		label$306:;
		{
		...
		goto label$304;
		label$305:;
		static const void* tmp$247[82ll] = {
			&&label$306,
			&&label$308,
			&&label$310,
			&&label$312,
		...
		if( TMP$159$2 > 81ull ) goto label$304;
		goto *tmp$247[TMP$159$2 - 0ull];
		label$304:;
	}
	label$303:;
	return fb$result$1;
...
static void HMANGLEPROC( struct $8FBSYMBOL* SYM$1 )
{
	...
	if( *(int64*)((uint8*)&ENV$ + 208ll) != 2ll ) goto label$385;
	{
		...
		label$386:;
		{
			...
			TMP$234$3 = *($13FB_COMPTARGET*)((uint8*)&ENV$ + 216ll);
			if( TMP$234$3 == 0ll ) goto label$390;
			label$391:;
			if( TMP$234$3 == 1ll ) goto label$390;
			label$392:;
			if( TMP$234$3 != 4ll ) goto label$389;
			label$390:;
			{
		...
		{
			{
				...
				TMP$236$4 = *($13FB_COMPTARGET*)((uint8*)&ENV$ + 216ll);
				if( TMP$236$4 == 0ll ) goto label$401;
				label$402:;
				if( TMP$236$4 == 1ll ) goto label$401;
				label$403:;
				if( TMP$236$4 != 4ll ) goto label$400;
				label$401:;
				{
					fb_StrConcatAssign( (void*)&MANGLED$1, -1ll, (void*)"@", 2ll, 0 );
				}
	...
	if( (*(int64*)((uint8*)SYM$1 + 24ll) & 512ll) == 0ll ) goto label$410;
	{
		...
		if( DOCPP$1 == 0ll ) goto label$412;
		{
			...
			FBSTRING* vr$46 = fb_StrConcat( &TMP$237$3, (void*)&MANGLED$1, -1ll, (void*)vr$42, -1ll );
			fb_StrAssign( (void*)&MANGLED$1, -1ll, (void*)vr$46, -1ll, 0 );
		}
		label$412:;
		label$411:;
		__builtin_memset( &TMP$238$2, 0, 24ll );
		FBSTRING* vr$52 = fb_StrConcat( &TMP$238$2, (void*)&MANGLED$1, -1ll, *(void**)((uint8*)SYM$1 + 40ll), 0ll );
	...
	if( (*(int64*)((uint8*)SYM$1 + 16ll) & 16ll) == 0ll ) goto label$413;
	{
		...
		label$415:;
		{
			...
			FBSTRING* vr$66 = fb_StrConcat( &TMP$240$3, (void*)&MANGLED$1, -1ll, (void*)vr$62, 0ll );
	...
	label$418:;
	{
		...
		FBSTRING* vr$90 = fb_StrConcat( &TMP$244$2, (void*)&MANGLED$1, -1ll, (void*)ID$1, 0ll );
