...
int64 CERRORSTMT( void )
{
	...
	label$13:;
	label$12:;
	RTLERRORTHROW( EXPR$1, *(int64*)((uint8*)*(struct $9LEX_TKCTX**)((uint8*)&LEX$ + 844560ll) + 16752ll), (uint8*)((uint8*)&ENV$ + 608ll) );
	fb$result$1 = -1ll;
	label$11:;
	return fb$result$1;
}
...
struct $7ASTNODE* CERRORFUNCT( void )
{
	...
	if( vr$1 == 0ll ) goto label$23;
	{
		int64 vr$2 = LEXGETTOKEN( 0ll );
		if( vr$2 == 41ll ) goto label$25;
		{
