...
void HMETHODCALLADDINSTPTROVLARG( struct $8FBSYMBOL* PROC$1, struct $7ASTNODE* THISEXPR$1, struct $16FB_CALL_ARG_LIST* ARG_LIST$1, $12FB_PARSEROPT* OPTIONS$1 )
{
	...
	*(struct $7ASTNODE**)ARG$1 = THISEXPR$1;
	...
	TMP$93$1 = -1ll;
	label$61:;
	*($12FB_PARAMMODE*)((uint8*)ARG$1 + 8ll) = TMP$93$1;
...
int64 CPROCCALLORASSIGN( void )
{
	...
	label$249:;
	{
		...
		{
			{
				...
				goto label$255;
				label$256:;
				static const void* tmp$102[50ll] = {
					&&label$257,
					&&label$271,
					&&label$255,
					&&label$263,
				...
				if( (TMP$101$4 - 346ull) > 49ull ) goto label$255;
				goto *tmp$102[TMP$101$4 - 346ull];
				label$255:;
			}
		}
		goto label$251;
		...
		if( TMP$100$2 > 6ull ) goto label$251;
		goto *tmp$103[TMP$100$2 - 0ull];
		label$251:;
	}
	label$248:;
	return fb$result$1;
...
int64 HFORWARDCALL( void )
{
	...
	fb$result$1 = 0ll;
	{
		...
		TMP$104$2 = vr$1;
		if( TMP$104$2 != 0ll ) goto label$328;
		label$329:;
		{
			if( (*(int64*)((uint8*)&ENV$ + 1424ll) & 524288ll) == 0ll ) goto label$331;
			{
				...
				{
					if( *(int64*)((uint8*)*(struct $7FBTOKEN**)((uint8*)*(struct $9LEX_TKCTX**)((uint8*)&LEX$ + 844560ll) + 16712ll) + 4144ll) <= 0ll ) goto label$335;
					{
	...
	if( *(int64*)((uint8*)*(struct $7FBTOKEN**)((uint8*)*(struct $9LEX_TKCTX**)((uint8*)&LEX$ + 844560ll) + 16712ll) + 16ll) == 2147483648ll ) goto label$338;
	{
		ERRREPORT( 17ll, 0ll, (uint8*)0ull );
	}
	label$338:;
	...
	*(struct $11FB_CALL_ARG**)((uint8*)&ARG_LIST$1 + 16ll) = (struct $11FB_CALL_ARG*)0ull;
	label$341:;
	{
		...
		{
			int64 TMP$105$3;
			TMP$105$3 = *(int64*)((uint8*)EXPR$2 + 8ll) & 511ll;
			if( TMP$105$3 == 17ll ) goto label$352;
			label$353:;
			if( TMP$105$3 == 18ll ) goto label$352;
			label$354:;
			if( TMP$105$3 == 4ll ) goto label$352;
			label$355:;
			if( TMP$105$3 != 7ll ) goto label$351;
			label$352:;
			{
				DTYPE$2 = 17ll;
			}
		...
		TMP$106$2 = 0ll;
		label$367:;
		struct $8FBSYMBOL* vr$17 = SYMBADDPROCPARAM( PROC$1, (uint8*)0ull, DTYPE$2, (struct $8FBSYMBOL*)0ull, TMP$106$2, MODE$2, 0ll, 0ll );
...
static int64 HLOOKSLIKEENDOFSTATEMENT( void )
{
	...
	label$62:;
	{
		...
		int64 vr$1 = LEXGETTOKEN( 0ll );
		TMP$94$2 = vr$1;
		if( TMP$94$2 == 258ll ) goto label$66;
		label$67:;
		if( TMP$94$2 == 257ll ) goto label$66;
		label$68:;
		if( TMP$94$2 == 256ll ) goto label$66;
		label$69:;
		if( TMP$94$2 == 259ll ) goto label$66;
		label$70:;
		if( TMP$94$2 != 260ll ) goto label$65;
		label$66:;
		{
			fb$result$1 = -1ll;
		}
...
static int64 HMATCHESDEFDTYPE( struct $8FBSYMBOL* SYM$1, int64 DEFDTYPE$1 )
{
	...
	if( DEFDTYPE$1 != 17ll ) goto label$160;
	{
		{
			int64 TMP$95$3;
			TMP$95$3 = *(int64*)((uint8*)SYM$1 + 56ll) & 511ll;
			if( TMP$95$3 == 17ll ) goto label$163;
			label$164:;
			if( TMP$95$3 == 18ll ) goto label$163;
			label$165:;
			if( TMP$95$3 != 4ll ) goto label$162;
			label$163:;
			{
				fb$result$1 = -1ll;
			}
				...
				{
					{
						...
						if( (TMP$96$6 - 1ull) > 5ull ) goto label$182;
						goto *tmp$107[TMP$96$6 - 1ull];
						label$182:;
					}
				}
				label$181:;
				...
				{
					{
						...
						if( (TMP$97$6 - 1ull) > 5ull ) goto label$202;
		...
		{
			{
				...
				if( (TMP$98$4 - 1ull) > 11ull ) goto label$228;
				goto *tmp$109[TMP$98$4 - 1ull];
				label$228:;
			}
			SYM$2 = *(struct $8FBSYMBOL**)((uint8*)SYM$2 + 280ll);
		}
...
static int64 HPROCCALLORASSIGN_QB( void )
{
	...
	fb$result$1 = 0ll;
	{
		...
		label$239:;
		{
			int64 vr$4 = HASSIGNORCALL_QB( *(struct $10FBSYMCHAIN**)((uint8*)*(struct $7FBTOKEN**)((uint8*)*(struct $9LEX_TKCTX**)((uint8*)&LEX$ + 844560ll) + 16712ll) + 4136ll), 0ll );
			fb$result$1 = vr$4;
			goto label$236;
		}
		goto label$237;
		label$240:;
		{
			...
			{
				int64 vr$8 = HASSIGNORCALL_QB( *(struct $10FBSYMCHAIN**)((uint8*)*(struct $7FBTOKEN**)((uint8*)*(struct $9LEX_TKCTX**)((uint8*)&LEX$ + 844560ll) + 16712ll) + 4136ll), 0ll );
				fb$result$1 = vr$8;
				goto label$236;
			}
			label$242:;
			...
			label$243:;
			LEXSKIPTOKEN( 2048ll );
			if( *(struct $10FBSYMCHAIN**)((uint8*)*(struct $7FBTOKEN**)((uint8*)*(struct $9LEX_TKCTX**)((uint8*)&LEX$ + 844560ll) + 16712ll) + 4136ll) != (struct $10FBSYMCHAIN*)0ull ) goto label$246;
			{
			...
			label$246:;
			{
				int64 vr$15 = HASSIGNORCALL_QB( *(struct $10FBSYMCHAIN**)((uint8*)*(struct $7FBTOKEN**)((uint8*)*(struct $9LEX_TKCTX**)((uint8*)&LEX$ + 844560ll) + 16712ll) + 4136ll), -1ll );
				fb$result$1 = vr$15;
				goto label$236;
			}
			label$245:;
		...
		if( TMP$99$2 > 5ull ) goto label$237;
		goto *tmp$110[TMP$99$2 - 0ull];
		label$237:;
	}
	label$236:;
	return fb$result$1;
