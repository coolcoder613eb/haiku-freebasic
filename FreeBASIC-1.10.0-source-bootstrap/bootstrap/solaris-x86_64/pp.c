...
{
	label$30:;
	if( *(int64*)*(struct $7FBTOKEN**)((uint8*)*(struct $9LEX_TKCTX**)((uint8*)&LEX$ + 844560ll) + 16712ll) == 35ll ) goto label$33;
	{
		goto label$31;
	}
	label$33:;
	label$32:;
	if( *(int64*)((uint8*)*(struct $9LEX_TKCTX**)((uint8*)&LEX$ + 844560ll) + 16768ll) == 0ll ) goto label$35;
	{
		goto label$31;
	}
	label$35:;
	label$34:;
	if( *(int64*)((uint8*)*(struct $9LEX_TKCTX**)((uint8*)&LEX$ + 844560ll) + 16760ll) == 257ll ) goto label$37;
	{
		if( *(int64*)((uint8*)*(struct $9LEX_TKCTX**)((uint8*)&LEX$ + 844560ll) + 16760ll) == -1ll ) goto label$39;
		{
			goto label$31;
		}
		label$39:;
	...
	*(struct $8FBSYMBOL**)((uint8*)*(struct $9LEX_TKCTX**)((uint8*)&LEX$ + 844560ll) + 16784ll) = (struct $8FBSYMBOL*)&PP$;
	LEXSKIPTOKEN( 256ll );
	PPPARSE(  );
	*(int64*)((uint8*)*(struct $9LEX_TKCTX**)((uint8*)&LEX$ + 844560ll) + 16768ll) = *(int64*)((uint8*)*(struct $9LEX_TKCTX**)((uint8*)&LEX$ + 844560ll) + 16768ll) + -1ll;
	label$31:;
...
void PPPARSE( void )
{
	label$40:;
	{
		...
		if( (TMP$116$2 - 266ull) > 22ull ) goto label$73;
	...
	if( *(int64*)((uint8*)&ENV$ + 296ll) == 0ll ) goto label$75;
	{
		...
		{
			struct $7ASTNODE* vr$19 = ASTNEWLIT( *(uint8**)((uint8*)*(struct $9LEX_TKCTX**)((uint8*)&LEX$ + 844560ll) + 49648ll) );
			ASTADD( vr$19 );
	...
	{
		{
			...
			label$138:;
			{
				...
				label$141:;
				{
					LEXSKIPTOKEN( 63ll );
					{
						...
						TMP$133$6 = vr$2;
						if( TMP$133$6 == 257ll ) goto label$146;
						label$147:;
						if( TMP$133$6 != 256ll ) goto label$145;
						label$146:;
						{
							goto label$142;
						}
			...
			{
				{
					...
					TMP$134$5 = vr$3;
					if( TMP$134$5 != 35ll ) goto label$150;
					label$151:;
					{
						LEXSKIPTOKEN( 62ll );
						LEXSKIPTOKEN( 63ll );
			...
			label$167:;
			{
				...
				fb_StrAssign( (void*)&TMP$138$4, -1ll, (void*)vr$10, -1ll, 0 );
			...
			goto label$128;
			label$129:;
			static const void* tmp$139[369ll] = {
				&&label$164,
				&&label$128,
				&&label$128,
				&&label$128,
			...
			if( (TMP$131$3 - 9ull) > 368ull ) goto label$128;
			goto *tmp$139[TMP$131$3 - 9ull];
			label$128:;
		}
		if( *(int64*)((uint8*)*(struct $7FBTOKEN**)((uint8*)*(struct $9LEX_TKCTX**)((uint8*)&LEX$ + 844560ll) + 16712ll) + 16ll) == 7ll ) goto label$169;
		{
		...
		label$169:;
		{
			DZSTRCONCATASSIGNW( &TEXT$1, (uint32*)((uint8*)*(struct $7FBTOKEN**)((uint8*)*(struct $9LEX_TKCTX**)((uint8*)&LEX$ + 844560ll) + 16712ll) + 24ll) );
		}
		label$168:;
		LEXSKIPTOKEN( 62ll );
	}
	...
	{
		{
			...
			label$193:;
			{
				...
				label$196:;
				{
					LEXSKIPTOKEN( 63ll );
					{
						...
						int64 vr$2 = LEXGETTOKEN( 62ll );
						TMP$143$6 = vr$2;
						if( TMP$143$6 == 257ll ) goto label$201;
						label$202:;
						if( TMP$143$6 != 256ll ) goto label$200;
						label$201:;
						{
							goto label$197;
						}
			...
			{
				{
					...
					int64 vr$3 = LEXGETLOOKAHEAD( 1ll, 314ll );
					TMP$144$5 = vr$3;
					if( TMP$144$5 != 35ll ) goto label$205;
					label$206:;
					{
						LEXSKIPTOKEN( 62ll );
						LEXSKIPTOKEN( 63ll );
						uint8* vr$4 = LEXGETTEXT(  );
						int32 vr$5 = fb_StrCompare( (void*)vr$4, 0ll, (void*)"_", 2ll );
						if( (int64)vr$5 == 0ll ) goto label$208;
						{
					...
					goto label$204;
					label$205:;
					if( TMP$144$5 != 274ll ) goto label$209;
					label$210:;
					{
					...
					goto label$204;
					label$209:;
					if( TMP$144$5 != 275ll ) goto label$213;
					label$214:;
					{
			...
			label$222:;
			{
				...
				FBSTRING* vr$10 = PPTYPEOF(  );
				fb_StrAssign( (void*)&TMP$146$4, -1ll, (void*)vr$10, -1ll, 0 );
			...
			goto label$183;
			label$184:;
			static const void* tmp$147[369ll] = {
				&&label$219,
				&&label$183,
				&&label$183,
				&&label$183,
			...
			if( (TMP$141$3 - 9ull) > 368ull ) goto label$183;
			goto *tmp$147[TMP$141$3 - 9ull];
			label$183:;
		}
		if( *(int64*)((uint8*)*(struct $7FBTOKEN**)((uint8*)*(struct $9LEX_TKCTX**)((uint8*)&LEX$ + 844560ll) + 16712ll) + 16ll) != 7ll ) goto label$224;
		{
			DWSTRCONCATASSIGN( &TEXT$1, (uint32*)((uint8*)*(struct $7FBTOKEN**)((uint8*)*(struct $9LEX_TKCTX**)((uint8*)&LEX$ + 844560ll) + 16712ll) + 24ll) );
		}
		goto label$223;
		label$224:;
		{
			uint8* vr$18 = LEXGETTEXT(  );
			DWSTRCONCATASSIGNA( &TEXT$1, (uint8*)vr$18 );
		}
		label$223:;
		LEXSKIPTOKEN( 62ll );
	}
...
FBSTRING* PPTYPEOF( void )
{
	...
	TMP$148$1 = (struct $8FBSYMBOL*)0ull;
...
static void PPLINE( void )
{
	...
	label$101:;
	{
		...
		*(int64*)((uint8*)*(struct $9LEX_TKCTX**)((uint8*)&LEX$ + 844560ll) + 16752ll) = (int64)vr$3;
		LEXSKIPTOKEN( 0ll );
	...
	{
		{
			...
			goto label$119;
			label$120:;
			static const void* tmp$155[24ll] = {
				&&label$121,
				&&label$121,
				&&label$122,
				&&label$122,
			...
			if( (TMP$130$3 - 9ull) > 23ull ) goto label$122;
			goto *tmp$155[TMP$130$3 - 9ull];
			label$119:;
		}
...
static void HRTRIMMACROTEXTW( struct $8DWSTRING* TEXT$1 )
{
	label$170:;
	static uint32* P$1;
	P$1 = (uint32*)((uint8*)((uint8*)*(uint32**)TEXT$1 + (*(int64*)((uint8*)TEXT$1 + 8ll) << (2ll & 63ll))) + -4ll);
	label$172:;
	if( P$1 <= *(uint32**)TEXT$1 ) goto label$173;
	{
		{
			uint64 TMP$140$3;
			TMP$140$3 = (uint64)*(uint32*)P$1;
			goto label$175;
			label$176:;
			{
				*(int64*)((uint8*)TEXT$1 + 8ll) = *(int64*)((uint8*)TEXT$1 + 8ll) + -1ll;
			...
			if( (TMP$140$3 - 9ull) > 23ull ) goto label$177;
			goto *tmp$156[TMP$140$3 - 9ull];
			label$174:;
		}
...
static void PPCMDLINE( void )
{
	...
	if( *(int64*)((uint8*)&ENV$ + 1192ll) <= 0ll ) goto label$238;
	{
		...
		FBSTRING* vr$5 = fb_StrConcat( &TMP$150$2, (void*)"#cmdline \x22", 11ll, (void*)ARGS$1, 0ll );
		__builtin_memset( &TMP$151$2, 0, 24ll );
		FBSTRING* vr$8 = fb_StrConcat( &TMP$151$2, (void*)vr$5, -1ll, (void*)"\x22", 2ll );
		fb_StrAssign( (void*)&TMP$152$2, -1ll, (void*)vr$8, -1ll, 0 );
