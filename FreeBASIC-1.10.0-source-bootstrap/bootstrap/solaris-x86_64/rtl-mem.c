...
static struct $14FB_RTL_PROCDEF FUNCDATA$[12] = { { (uint8*)"fb_NullPtrChk", (uint8*)0ull, 32ll, -1ll, (tmp$33)0ull, 2048ll, 3ll, { { 1056ll, 1ll, 0ll }, { 523ll, 1ll, 0ll }, { 1060ll, 1ll, 0ll } } }, { (uint8*)"fb_MemSwap", (uint8*)0ull, 0ll, -1ll, (tmp$33)0ull, 0ll, 3ll, { { 0ll, 2ll, 0ll, 0ll }, { 0ll, 2ll, 0ll, 0ll }, { 520ll, 1ll, 0ll } } }, { (uint8*)"fb_MemCopyClear", (uint8*)0ull, 0ll, -1ll, (tmp$33)0ull, 0ll, 4ll, { { 0ll, 2ll, 0ll, 0ll }, { 521ll, 1ll, 0ll }, { 512ll, 2ll, 0ll, 0ll }, { 521ll, 1ll, 0ll } } }, { (uint8*)"fre", (uint8*)"fb_GetMemAvail", 9ll, -1ll, (tmp$33)0ull, 0ll, 1ll, { { 523ll, 1ll, -1ll, 0ll } } }, { (uint8*)"allocate", (uint8*)"malloc", 32ll, 3ll, (tmp$33)0ull, 128ll, 1ll, { { 521ll, 1ll, 0ll } } }, { (uint8*)"callocate", (uint8*)"calloc", 32ll, 3ll, (tmp$33)0ull, 128ll, 2ll, { { 521ll, 1ll, 0ll }, { 521ll, 1ll, -1ll, 1ll } } }, { (uint8*)"reallocate", (uint8*)"realloc", 32ll, 3ll, (tmp$33)0ull, 128ll, 2ll, { { 1056ll, 1ll, 0ll, 0ll }, { 521ll, 1ll, 0ll } } }, { (uint8*)"deallocate", (uint8*)"free", 0ll, 3ll, (tmp$33)0ull, 128ll, 1ll, { { 1056ll, 1ll, 0ll, 0ll } } }, { (uint8*)"clear", (uint8*)"memset", 32ll, 3ll, (tmp$33)0ull, 0ll, 3ll, { { 0ll, 2ll, 0ll, 0ll }, { 523ll, 1ll, -1ll, 0ll }, { 521ll, 1ll, 0ll } } }, { (uint8*)"fb_MemMove", (uint8*)"memmove", 32ll, 3ll, (tmp$33)0ull, 0ll, 3ll, { { 0ll, 2ll, 0ll, 0ll }, { 512ll, 2ll, 0ll }, { 521ll, 1ll, 0ll } } }, { (uint8*)"fb_MemCopy", (uint8*)"memcpy", 32ll, 3ll, (tmp$33)0ull, 0ll, 3ll, { { 0ll, 2ll, 0ll, 0ll }, { 512ll, 2ll, 0ll }, { 521ll, 1ll, 0ll } } }, { (uint8*)0ull } };
...
struct $7ASTNODE* RTLMEMNEWOP( int64 OP$1, struct $7ASTNODE* LEN_EXPR$1, int64 DTYPE$1, struct $8FBSYMBOL* SUBTYPE$1 )
{
	...
	goto label$55;
	label$42:;
	TMP$103$1 = DTYPE$1 & 31ll;
	label$55:;
	if( TMP$103$1 != 20ll ) goto label$44;
	{
...
struct $7ASTNODE* RTLMEMDELETEOP( int64 OP$1, struct $7ASTNODE* PTR_EXPR$1, int64 DTYPE$1, struct $8FBSYMBOL* SUBTYPE$1 )
{
	...
	label$71:;
	if( TMP$104$1 != 20ll ) goto label$60;
	{
		struct $8FBSYMBOL* vr$4 = SYMBGETCOMPOPOVLHEAD( SUBTYPE$1, *($6AST_OP*)(((int64)(struct $10AST_OPINFO*)AST_OPTB$ + (OP$1 << (5ll & 63ll))) + 24ll) );
		SYM$1 = vr$4;
