				...
				{
					{
						...
						label$339:;
						{
							FBSTRING* vr$277 = HFINDLIB( (uint8*)"start_dyn.o" );
...
static void HANDLEOPT( int64 OPTID$1, FBSTRING* ARG$1, int64 IS_SOURCE$1 )
{
	label$500:;
	{
		...
		label$637:;
		{
			...
			if( (((int64)-(OS$3 != 7ll) | (int64)-(CPUTYPE$3 != 13ll)) | IS_GNU_TRIPLET$3) == 0ll ) goto label$641;
			{
				FBSTRING TMP$344$4;
...
static int64 HCOMPILESTAGE2MODULE( struct $9FBCIOFILE* MODULE$1 )
{
	...
	label$1145:;
	{
		...
		label$1149:;
		{
			...
			{
				fb_StrConcatAssign( (void*)&LN$1, -1ll, (void*)"-S -lroot -nostdlib -nostdinc -Wall ", 30ll, 0 );
