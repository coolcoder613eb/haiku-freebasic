...
int32 RTLDATAREAD( struct $7ASTNODE* );
...
int32 CDATASTMT( $8FB_TOKEN TK$1 )
{
	int32 fb$result$1;
	...
	fb$result$1 = 0;
	{
		...
		label$14:;
		{
			...
			SYM$3 = (struct $8FBSYMBOL*)0u;
			{
				...
				TMP$93$4 = vr$1;
				if( TMP$93$4 == 0 ) goto label$17;
				label$18:;
				if( TMP$93$4 == 2 ) goto label$17;
				label$19:;
				if( TMP$93$4 != 3 ) goto label$16;
				label$17:;
				{
					struct $10FBSYMCHAIN* CHAIN_$5;
					struct $8FBSYMBOL* BASE_PARENT$5;
					struct $10FBSYMCHAIN* vr$3 = CIDENTIFIER( &BASE_PARENT$5, 34 );
					CHAIN_$5 = vr$3;
					struct $8FBSYMBOL* vr$4 = SYMBFINDBYCLASS( CHAIN_$5, 7 );
					SYM$3 = vr$4;
					if( SYM$3 != (struct $8FBSYMBOL*)0u ) goto label$21;
					{
						uint8* vr$5 = LEXGETTEXT(  );
						struct $8FBSYMBOL* vr$6 = SYMBADDLABEL( vr$5, 72 );
						SYM$3 = vr$6;
						if( SYM$3 != (struct $8FBSYMBOL*)0u ) goto label$23;
						{
			...
			int32 vr$7 = RTLDATARESTORE( SYM$3, (struct $7ASTNODE*)0u );
			fb$result$1 = vr$7;
		}
		goto label$12;
		label$13:;
		if( TK$1 != 446 ) goto label$24;
		label$25:;
		{
			LEXSKIPTOKEN( 2048 );
			struct $7ASTNODE* EXPR$3;
			EXPR$3 = (struct $7ASTNODE*)0u;
			label$26:;
			{
				struct $7ASTNODE* vr$8 = CVARORDEREF( 0 );
				EXPR$3 = vr$8;
				if( EXPR$3 != (struct $7ASTNODE*)0u ) goto label$30;
				{
				...
				label$30:;
				{
					int32 vr$9 = RTLDATAREAD( EXPR$3 );
					if( vr$9 != 0 ) goto label$32;
					{
						goto label$11;
					}
					label$32:;
			...
			if( vr$10 != 0 ) goto label$26;
			label$27:;
			fb$result$1 = -1;
		}
		goto label$12;
		label$24:;
		if( TK$1 != 447 ) goto label$33;
		label$34:;
		{
			if( *(int32*)((uint8*)&ENV$ + 136) == 3 ) goto label$36;
			{
				int32 vr$11 = CCOMPSTMTISALLOWED( 32 );
				if( vr$11 != 0 ) goto label$38;
				{
					HSKIPUNTIL( -1, 0, 0, 0 );
					goto label$11;
				}
				label$38:;
				label$37:;
				if( *(uint32*)((uint8*)&PARSER$ + 100) <= 0u ) goto label$40;
				{
					if( *(struct $8FBSYMBOL**)((uint8*)&PARSER$ + 108) == *(struct $8FBSYMBOL**)((uint8*)&ENV$ + 1032) ) goto label$42;
					{
			...
			struct $7ASTNODE* EXPR$3;
			EXPR$3 = (struct $7ASTNODE*)0u;
			if( *(int32*)((uint8*)&ENV$ + 136) == 3 ) goto label$46;
			{
				LEXSKIPTOKEN( 2048 );
				label$47:;
				{
					...
					EXPR$3 = vr$13;
					if( EXPR$3 != (struct $7ASTNODE*)0u ) goto label$51;
					{
						goto label$11;
					}
					label$51:;
					label$50:;
					int32 ISCONST$5;
					ISCONST$5 = -(*(int32*)EXPR$3 == 16);
					if( ISCONST$5 != 0 ) goto label$53;
					{
						if( *(int32*)EXPR$3 != 23 ) goto label$55;
						{
							ISCONST$5 = -1;
						}
						goto label$54;
						label$55:;
						{
							{
								int32 TMP$94$8;
								TMP$94$8 = *(int32*)((uint8*)EXPR$3 + 4) & 511;
								if( TMP$94$8 == 4 ) goto label$58;
								label$59:;
								if( TMP$94$8 != 7 ) goto label$57;
								label$58:;
								{
									struct $8FBSYMBOL* vr$19 = ASTGETSTRLITSYMBOL( EXPR$3 );
									ISCONST$5 = -(vr$19 != (struct $8FBSYMBOL*)0u);
								}
								label$57:;
								label$56:;
							}
					...
					label$61:;
					{
						...
						if( vr$21 != (struct $7ASTNODE*)0u ) goto label$63;
						{
							goto label$11;
						}
						label$63:;
			...
			label$46:;
			{
				...
				DO_EXIT$4 = 0;
				FBSTRING TEXT$4;
				__builtin_memset( &TEXT$4, 0, 12 );
				label$64:;
				{
					int32 TOKENS$5;
					TOKENS$5 = 0;
					fb_StrAssign( (void*)&TEXT$4, -1, (void*)"", 1, 0 );
					label$67:;
					{
						FBSTRING TMP$96$6;
						{
							uint32 TMP$95$7;
							int32 vr$25 = LEXGETTOKEN( 62 );
							TMP$95$7 = (uint32)vr$25;
							goto label$71;
							label$72:;
							{
								LEXSKIPTOKEN( 62 );
							...
							if( (TMP$95$7 - 9u) > 251u ) goto label$70;
							goto *tmp$98[TMP$95$7 - 9u];
							label$70:;
						}
						uint8* vr$27 = LEXGETTEXT(  );
						__builtin_memset( &TMP$96$6, 0, 12 );
						FBSTRING* vr$31 = fb_StrConcat( &TMP$96$6, (void*)&TEXT$4, -1, (void*)vr$27, 0 );
						fb_StrAssign( (void*)&TEXT$4, -1, (void*)vr$31, -1, 0 );
						LEXSKIPTOKEN( 62 );
						TOKENS$5 = TOKENS$5 + 1;
					}
					label$69:;
					...
					fb_StrAssign( (void*)&TEXT$4, -1, (void*)vr$35, -1, 0 );
					if( TOKENS$5 != 1 ) goto label$76;
					{
						int32 vr$38 = fb_StrLen( (void*)&TEXT$4, -1 );
						if( vr$38 <= 1 ) goto label$78;
						{
							if( (uint32)(int32)*(uint8*)*(uint8**)&TEXT$4 != 34u ) goto label$80;
							{
								int32 vr$42 = fb_StrLen( (void*)&TEXT$4, -1 );
								if( (uint32)(int32)*(uint8*)((uint8*)((uint8*)*(uint8**)&TEXT$4 + vr$42) + -1) != 34u ) goto label$82;
								{
									int32 vr$46 = fb_StrLen( (void*)&TEXT$4, -1 );
									FBSTRING* vr$49 = fb_StrMid( (FBSTRING*)&TEXT$4, 2, vr$46 + -2 );
									fb_StrAssign( (void*)&TEXT$4, -1, (void*)vr$49, -1, 0 );
								}
								label$82:;
								label$81:;
							}
					...
					if( vr$52 != (struct $7ASTNODE*)0u ) goto label$84;
					{
