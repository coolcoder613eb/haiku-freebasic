...
static void fb_ctor__parserzlabel( void ) __attribute__(( constructor ));
...
int32 CLABEL( void )
{
	...
	fb$result$1 = 0;
	{
		...
		label$14:;
		{
			...
			label$16:;
			label$15:;
			if( (*(int32*)((uint8*)&ENV$ + 1040) & 1048576) != 0 ) goto label$18;
			{
				ERRREPORTNOTALLOWED( 1048576, 146, (uint8*)0u );
				HSKIPUNTIL( -1, 0, 0, 0 );
			}
			goto label$17;
			label$18:;
			{
				...
				struct $8FBSYMBOL* vr$5 = SYMBADDLABEL( vr$4, 68 );
				L$1 = vr$5;
				if( L$1 != (struct $8FBSYMBOL*)0u ) goto label$20;
				{
		...
		label$21:;
		{
			...
			if( vr$7 != 258 ) goto label$23;
			{
				int32 vr$8 = CCOMPSTMTISALLOWED( 1 );
				if( vr$8 != 0 ) goto label$25;
				{
					HSKIPUNTIL( -1, 0, 0, 0 );
					goto label$11;
				}
				...
				struct $8FBSYMBOL* vr$11 = SYMBFINDBYCLASS( CHAIN_$1, 3 );
				if( vr$11 == (struct $8FBSYMBOL*)0u ) goto label$27;
				{
					goto label$11;
				}
				label$27:;
				...
				struct $8FBSYMBOL* vr$13 = SYMBADDLABEL( vr$12, 68 );
				L$1 = vr$13;
		...
		goto label$12;
		label$13:;
		static const void* tmp$93[4] = {
			&&label$21,
			&&label$12,
			&&label$12,
			&&label$14,
		};
		if( TMP$92$2 > 3u ) goto label$12;
		goto *tmp$93[TMP$92$2 - 0u];
		label$12:;
	}
	if( L$1 == (struct $8FBSYMBOL*)0u ) goto label$31;
	{
		struct $7ASTNODE* vr$14 = ASTNEWLABEL( L$1, -1 );
		ASTADD( vr$14 );
		*(struct $8FBSYMBOL**)((uint8*)&SYMB$ + 99044) = L$1;
		fb$result$1 = -1;
	}
	label$31:;
	label$30:;
