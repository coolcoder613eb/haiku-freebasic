...
{
	label$10:;
	*(uint32*)((uint8*)&PARSER$ + 96) = 0u;
	*(uint32*)((uint8*)&PARSER$ + 100) = 0u;
	*(struct $8FBSYMBOL**)((uint8*)&PARSER$ + 108) = (struct $8FBSYMBOL*)0u;
	*(struct $8FBSYMBOL**)((uint8*)&PARSER$ + 112) = (struct $8FBSYMBOL*)0u;
	*(int32*)((uint8*)&PARSER$ + 88) = 0;
	*(struct $10FBSYMCHAIN**)((uint8*)&PARSER$ + 92) = (struct $10FBSYMCHAIN*)0u;
	*($11FB_MANGLING*)((uint8*)&PARSER$ + 104) = 0;
	*(int32*)((uint8*)&PARSER$ + 28) = 0;
	*($8FB_TOKEN*)((uint8*)&PARSER$ + 24) = 0;
	*(int32*)((uint8*)&PARSER$ + 148) = 0;
	*($12FB_PARSEROPT*)((uint8*)&PARSER$ + 152) = 2;
...
void CPROGRAM( void )
{
	label$24:;
	int32 STARTLEVEL$1;
	STARTLEVEL$1 = *(int32*)((uint8*)&PP$ + 216);
	label$26:;
	{
		int32 vr$0 = LEXGETTOKEN( 0 );
		if( vr$0 != 257 ) goto label$30;
		{
		...
		label$30:;
		label$29:;
		int32 vr$5 = CCOMMENT( 0 );
		if( vr$5 == 0 ) goto label$34;
		{
			int32 vr$6 = FBSHOULDCONTINUE(  );
			if( vr$6 != 0 ) goto label$36;
			{
				goto label$25;
			}
			label$36:;
		...
		goto label$37;
		label$38:;
		int32 vr$8 = FBSHOULDCONTINUE(  );
		if( vr$8 != 0 ) goto label$39;
		{
			goto label$25;
		}
		label$39:;
		label$37:;
		*(uint32*)((uint8*)&PARSER$ + 96) = 1u;
		struct $7ASTNODE* vr$10 = ASTNEWDBG( 113, *(int32*)((uint8*)*(struct $9LEX_TKCTX**)((uint8*)&LEX$ + 840072) + 16568), *(uint8**)((uint8*)&ENV$ + 568) );
		ASTADD( vr$10 );
		CLABEL(  );
		CSTATEMENT(  );
		CCOMMENT( 0 );
		int32 vr$11 = FBSHOULDCONTINUE(  );
		if( vr$11 != 0 ) goto label$41;
		{
			goto label$25;
		}
		label$41:;
		label$40:;
		if( *(int32*)((uint8*)&ENV$ + 148) == 0 ) goto label$43;
		{
			if( *(int32*)((uint8*)&ENV$ + 900) != 0 ) goto label$45;
			{
		...
		int32 vr$13 = FBSHOULDCONTINUE(  );
		if( vr$13 != 0 ) goto label$53;
		{
			goto label$25;
		}
		label$53:;
		label$52:;
		struct $7ASTNODE* vr$14 = ASTNEWDBG( 114, 0, (uint8*)0u );
		ASTADD( vr$14 );
		*(int32*)((uint8*)&PARSER$ + 28) = *(int32*)((uint8*)&PARSER$ + 28) + 1;
	}
	label$28:;
	int32 vr$16 = LEXGETTOKEN( 0 );
	if( vr$16 != 256 ) goto label$26;
	label$27:;
	if( *(int32*)((uint8*)&PP$ + 216) == STARTLEVEL$1 ) goto label$55;
	{
		ERRREPORT( 290, 0, (uint8*)0u );
	}
	label$55:;
	label$54:;
	LEXSKIPTOKEN( 0 );
	if( *(int32*)((uint8*)&ENV$ + 900) != 0 ) goto label$57;
	{
		CCOMPSTMTCHECK(  );
	}
	label$57:;
...
void HSKIPUNTIL( int32 TOKEN$1, int32 DOEAT$1, $8LEXCHECK FLAGS$1, int32 STOP_ON_COMMA$1 )
{
	label$58:;
	int32 PRNTCNT$1;
	__builtin_memset( &PRNTCNT$1, 0, 4 );
	PRNTCNT$1 = 0;
	label$60:;
	{
		{
			uint32 TMP$93$3;
			int32 vr$1 = LEXGETTOKEN( FLAGS$1 );
			...
			label$84:;
			{
				if( (-(TOKEN$1 == 44) | STOP_ON_COMMA$1) == 0 ) goto label$86;
				{
					if( PRNTCNT$1 != 0 ) goto label$88;
					{
						goto label$61;
					}
					label$88:;
			...
			label$89:;
			{
				int32 vr$8 = LEXGETTOKEN( FLAGS$1 );
			...
			if( (TMP$93$3 - 40u) > 220u ) goto label$89;
			goto *tmp$94[TMP$93$3 - 40u];
			label$63:;
		}
	...
	goto label$60;
	label$61:;
	if( DOEAT$1 == 0 ) goto label$93;
	{
		int32 vr$9 = LEXGETTOKEN( FLAGS$1 );
...
void HSKIPCOMPOUND( int32 FOR_TOKEN$1, int32 UNTIL_TOKEN$1, $8LEXCHECK FLAGS$1 )
{
	label$96:;
	int32 CNT$1;
	__builtin_memset( &CNT$1, 0, 4 );
	int32 ISCOMMENT$1;
	__builtin_memset( &ISCOMMENT$1, 0, 4 );
	if( UNTIL_TOKEN$1 != -1 ) goto label$99;
	{
	...
	label$100:;
	{
		{
			int32 TMP$95$3;
			int32 vr$2 = LEXGETTOKEN( FLAGS$1 );
			TMP$95$3 = vr$2;
			if( TMP$95$3 != 256 ) goto label$104;
			label$105:;
			{
				goto label$97;
			}
			goto label$103;
			label$104:;
			if( TMP$95$3 != 257 ) goto label$106;
			label$107:;
			{
				ISCOMMENT$1 = 0;
			}
			goto label$103;
			label$106:;
			if( TMP$95$3 == 259 ) goto label$109;
			label$110:;
			if( TMP$95$3 != 260 ) goto label$108;
			label$109:;
			{
				ISCOMMENT$1 = -1;
			}
			goto label$103;
			label$108:;
			if( TMP$95$3 != 340 ) goto label$111;
			label$112:;
			{
				if( ISCOMMENT$1 != 0 ) goto label$114;
				{
					int32 vr$3 = LEXGETLOOKAHEAD( 1, FLAGS$1 );
					if( vr$3 != UNTIL_TOKEN$1 ) goto label$116;
					{
						LEXSKIPTOKEN( FLAGS$1 );
						if( CNT$1 <= 0 ) goto label$118;
						{
							CNT$1 = CNT$1 + -1;
						}
						label$118:;
						label$117:;
						if( CNT$1 != 0 ) goto label$120;
						{
							goto label$101;
						}
						label$120:;
			...
			goto label$103;
			label$111:;
			if( TMP$95$3 != FOR_TOKEN$1 ) goto label$121;
			label$122:;
			{
				if( ISCOMMENT$1 != 0 ) goto label$124;
				{
					CNT$1 = CNT$1 + 1;
				}
				label$124:;
...
struct $7ASTNODE* HMATCHEXPR( int32 DTYPE$1 )
{
	...
	EXPR$1 = vr$2;
	if( EXPR$1 != (struct $7ASTNODE*)0u ) goto label$128;
	{
		ERRREPORT( 9, 0, (uint8*)0u );
		if( DTYPE$1 != -2147483648u ) goto label$130;
		{
		...
		label$130:;
		label$129:;
		struct $7ASTNODE* vr$3 = ASTNEWCONSTZ( DTYPE$1, (struct $8FBSYMBOL*)0u );
		EXPR$1 = vr$3;
	}
	label$128:;
	label$127:;
...
static void HEMITCURRENTLINETEXT( void )
{
	label$16:;
	struct $7ASTNODE* N$1;
	N$1 = *(struct $7ASTNODE**)((uint8*)*(struct $7ASTNODE**)((uint8*)&AST$ + 40) + 68);
	label$18:;
	if( N$1 == (struct $7ASTNODE*)0u ) goto label$19;
	{
		if( *(int32*)N$1 != 30 ) goto label$21;
		{
			if( *(int32*)((uint8*)N$1 + 32) != 113 ) goto label$23;
			{
				struct $7ASTNODE* vr$4 = ASTNEWLIT( *(uint8**)((uint8*)*(struct $9LEX_TKCTX**)((uint8*)&LEX$ + 840072) + 49400) );
