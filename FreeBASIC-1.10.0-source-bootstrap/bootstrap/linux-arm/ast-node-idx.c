...
struct $7ASTNODE* ASTNEWIDX( struct $7ASTNODE* VAR_$1, struct $7ASTNODE* IDX$1 )
{
	...
	label$10:;
	struct $7ASTNODE* N$1;
	struct $7ASTNODE* vr$3 = ASTNEWNODE( 18, *(int32*)((uint8*)VAR_$1 + 4), *(struct $8FBSYMBOL**)((uint8*)VAR_$1 + 8) );
	N$1 = vr$3;
	*(struct $7ASTNODE**)((uint8*)N$1 + 64) = IDX$1;
	*(struct $7ASTNODE**)((uint8*)N$1 + 68) = VAR_$1;
	*(struct $8FBSYMBOL**)((uint8*)N$1 + 12) = *(struct $8FBSYMBOL**)((uint8*)VAR_$1 + 12);
...
struct $6IRVREG* ASTLOADIDX( struct $7ASTNODE* N$1 )
{
	...
	int64 OFS$1;
	VAR_$1 = *(struct $7ASTNODE**)((uint8*)N$1 + 68);
	if( VAR_$1 != (struct $7ASTNODE*)0u ) goto label$15;
	{
	...
	label$15:;
	label$14:;
	IDX$1 = *(struct $7ASTNODE**)((uint8*)N$1 + 64);
	if( IDX$1 == (struct $7ASTNODE*)0u ) goto label$17;
	{
	...
	label$17:;
	{
		VIDX$1 = (struct $6IRVREG*)0u;
	}
	label$16:;
	if( *(int32*)((uint8*)&AST$ + 136) == 0 ) goto label$19;
	{
		S$1 = *(struct $8FBSYMBOL**)((uint8*)VAR_$1 + 12);
		*($12FB_SYMBSTATS*)((uint8*)S$1 + 12) = *(int32*)((uint8*)S$1 + 12) | 2;
		OFS$1 = *(int64*)((uint8*)N$1 + 24);
		if( (*(int32*)((uint8*)S$1 + 4) & 16388) != 0 ) goto label$21;
		{
			OFS$1 = ((OFS$1 + *(int64*)((uint8*)S$1 + 72)) + *(int64*)((uint8*)S$1 + 48)) + *(int64*)((uint8*)VAR_$1 + 24);
		}
		goto label$20;
		label$21:;
		{
		...
		label$20:;
		if( VIDX$1 == (struct $6IRVREG*)0u ) goto label$23;
		{
			if( *(int32*)VIDX$1 == 4 ) goto label$25;
			{
				(*(tmp$52*)((uint8*)&IR$ + 108))( VIDX$1 );
			}
			label$25:;
			label$24:;
			struct $6IRVREG* vr$21 = (*(tmp$72*)((uint8*)&IR$ + 240))( *(int32*)((uint8*)N$1 + 4), *(struct $8FBSYMBOL**)((uint8*)N$1 + 8), S$1, OFS$1, *(int32*)((uint8*)N$1 + 32), VIDX$1 );
			VR$1 = vr$21;
		}
		goto label$22;
		label$23:;
		{
			struct $6IRVREG* vr$24 = (*(tmp$71*)((uint8*)&IR$ + 236))( *(int32*)((uint8*)N$1 + 4), *(struct $8FBSYMBOL**)((uint8*)N$1 + 8), S$1, OFS$1 );
			VR$1 = vr$24;
		}
		label$22:;
