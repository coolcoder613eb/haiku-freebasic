...
static void fb_ctor__parserzquirkziif( void ) __attribute__(( constructor ));
...
struct $7ASTNODE* CIIFFUNCT( void )
{
	...
	TRUEXPR$1 = vr$4;
	if( TRUEXPR$1 != (struct $7ASTNODE*)0u ) goto label$19;
	{
		goto label$11;
	}
	label$19:;
	label$18:;
	int32 vr$5 = ASTDTORLISTSCOPEEND(  );
	TRUECOOKIE$1 = vr$5;
	int32 vr$6 = LEXGETTOKEN( 0 );
	if( vr$6 == 44 ) goto label$21;
	{
		ERRREPORT( 16, 0, (uint8*)0u );
	}
	goto label$20;
	...
	label$20:;
	ASTDTORLISTSCOPEBEGIN( 0 );
	struct $7ASTNODE* vr$9 = HMATCHEXPR( *(int32*)((uint8*)TRUEXPR$1 + 4) & 511 );
	FALSEXPR$1 = vr$9;
	if( FALSEXPR$1 != (struct $7ASTNODE*)0u ) goto label$23;
	{
		goto label$11;
	}
	label$23:;
	label$22:;
	int32 vr$10 = ASTDTORLISTSCOPEEND(  );
	FALSECOOKIE$1 = vr$10;
	int32 vr$11 = LEXGETTOKEN( 0 );
	if( vr$11 == 41 ) goto label$25;
	{
