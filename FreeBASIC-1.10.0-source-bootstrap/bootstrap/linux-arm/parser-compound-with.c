...
void CWITHSTMTBEGIN( void )
{
	...
	SCOPENODE$1 = vr$0;
	if( SCOPENODE$1 != (struct $7ASTNODE*)0u ) goto label$19;
	{
	...
	if( EXPR$1 != (struct $7ASTNODE*)0u ) goto label$21;
	{
		...
		struct $7ASTNODE* vr$3 = ASTNEWVAR( vr$2, 0ll, -2147483648u, (struct $8FBSYMBOL*)0u );
		EXPR$1 = vr$3;
	}
	goto label$20;
	label$21:;
	{
		if( (*(int32*)((uint8*)EXPR$1 + 4) & 511) == 20 ) goto label$23;
		{
		...
		label$23:;
		{
			if( *(int32*)EXPR$1 != 9 ) goto label$25;
			{
	...
	label$27:;
	{
		...
		EXPR$1 = vr$18;
		OPTIONS$1 = 0;
		if( (*(int32*)((uint8*)&ENV$ + 1040) & 2) != 0 ) goto label$29;
		{
			OPTIONS$1 = OPTIONS$1 | 2;
		}
		label$29:;
		label$28:;
		struct $8FBSYMBOL* vr$23 = SYMBADDIMPLICITVAR( *(int32*)((uint8*)EXPR$1 + 4), *(struct $8FBSYMBOL**)((uint8*)EXPR$1 + 8), OPTIONS$1 );
		SYM$1 = vr$23;
		if( (OPTIONS$1 & 2) == 0 ) goto label$31;
		{
			struct $7ASTNODE* vr$25 = ASTNEWDECL( SYM$1, -1 );
			ASTADDUNSCOPED( vr$25 );
			struct $7ASTNODE* vr$26 = ASTNEWVAR( SYM$1, 0ll, -2147483648u, (struct $8FBSYMBOL*)0u );
			struct $7ASTNODE* vr$27 = ASTNEWASSIGN( vr$26, EXPR$1, 0 );
			struct $7ASTNODE* vr$28 = ASTNEWLINK( T$1, vr$27, 2 );
			T$1 = vr$28;
		}
		goto label$30;
		label$31:;
		{
			struct $7ASTNODE* vr$29 = ASTNEWDECL( SYM$1, 0 );
			struct $7ASTNODE* vr$30 = ASTNEWLINK( T$1, vr$29, 2 );
			T$1 = vr$30;
			struct $7ASTNODE* vr$31 = ASTNEWVAR( SYM$1, 0ll, -2147483648u, (struct $8FBSYMBOL*)0u );
			struct $7ASTNODE* vr$32 = ASTNEWASSIGN( vr$31, EXPR$1, 64 );
			struct $7ASTNODE* vr$33 = ASTNEWLINK( T$1, vr$32, 2 );
			T$1 = vr$33;
		}
		label$30:;
		IS_PTR$1 = -1;
	...
	label$26:;
	ASTADD( T$1 );
	struct $13FB_CMPSTMTSTK* vr$34 = CCOMPSTMTPUSH( 280, 1 );
	STK$1 = vr$34;
	*(struct $8FBSYMBOL**)((uint8*)STK$1 + 16) = SYM$1;
	*(int32*)((uint8*)STK$1 + 20) = IS_PTR$1;
	*(struct $7ASTNODE**)((uint8*)STK$1 + 8) = SCOPENODE$1;
	label$17:;
}
...
void CWITHSTMTEND( void )
{
	label$32:;
	struct $13FB_CMPSTMTSTK* STK$1;
	struct $13FB_CMPSTMTSTK* vr$0 = CCOMPSTMTGETTOS( 280, -1 );
	STK$1 = vr$0;
	if( STK$1 != (struct $13FB_CMPSTMTSTK*)0u ) goto label$35;
	{
		HSKIPUNTIL( -1, 0, 0, 0 );
		goto label$33;
	}
	...
	LEXSKIPTOKEN( 2048 );
	LEXSKIPTOKEN( 2048 );
	if( *(struct $7ASTNODE**)((uint8*)STK$1 + 8) == (struct $7ASTNODE*)0u ) goto label$37;
	{
...
static struct $7ASTNODE* HEXTENDTEMPLIFETIME( struct $8FBSYMBOL* SCP$1 )
{
	...
	{
		if( *(int32*)SYM$1 != 1 ) goto label$15;
		{
			ASTDTORLISTDEL( SYM$1 );
			*($13FB_SYMBATTRIB*)((uint8*)SYM$1 + 4) = *(int32*)((uint8*)SYM$1 + 4) & -4097;
			struct $7ASTNODE* vr$6 = ASTNEWDECL( SYM$1, 0 );
			struct $7ASTNODE* vr$7 = ASTNEWLINK( T$1, vr$6, 2 );
			T$1 = vr$7;
		}
		label$15:;
		label$14:;
