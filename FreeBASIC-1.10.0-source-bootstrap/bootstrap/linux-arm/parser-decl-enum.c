...
struct $8FBSYMBOL* SYMBADDENUM( uint8*, uint8*, $13FB_SYMBATTRIB, int32 );
struct $8FBSYMBOL* SYMBADDENUMELEMENT( struct $8FBSYMBOL*, uint8*, int64, $13FB_SYMBATTRIB );
int32 SYMBNAMESPACEIMPORT( struct $8FBSYMBOL* );
...
void CENUMBODY( struct $8FBSYMBOL* S$1, $13FB_SYMBATTRIB ATTRIB$1 )
{
	...
	{
		label$26:;
		int32 vr$0 = CCOMMENT( 0 );
		int32 vr$1 = CSTMTSEPARATOR( 0 );
		int32 vr$3 = LEXGETTOKEN( 0 );
		if( ((vr$0 | vr$1) & -(vr$3 != 256)) == 0 ) goto label$27;
		{
		}
		goto label$26;
		label$27:;
		{
			...
			label$31:;
			{
				label$34:;
				{
					{
						int32 TMP$94$6;
						int32 vr$7 = LEXGETCLASS( 0 );
						TMP$94$6 = vr$7;
						if( TMP$94$6 != 0 ) goto label$38;
						label$39:;
						{
							if( (*(int32*)((uint8*)&ENV$ + 1040) & 524288) == 0 ) goto label$41;
							{
								if( *(struct $8FBSYMBOL**)((uint8*)&SYMB$ + 98536) == (struct $8FBSYMBOL*)((uint8*)&SYMB$ + 98352) ) goto label$43;
								{
									if( *(int32*)((uint8*)*(struct $7FBTOKEN**)((uint8*)*(struct $9LEX_TKCTX**)((uint8*)&LEX$ + 840072) + 16548) + 4120) <= 0 ) goto label$45;
									{
						...
						goto label$37;
						label$38:;
						if( TMP$94$6 != 2 ) goto label$46;
						label$47:;
						{
							if( (-(*(struct $8FBSYMBOL**)((uint8*)&SYMB$ + 98536) == (struct $8FBSYMBOL*)((uint8*)&SYMB$ + 98352)) | -(*(uint32*)((uint8*)&PARSER$ + 100) > 0u)) == 0 ) goto label$49;
							{
								ERRREPORT( 4, 0, (uint8*)0u );
								uint8* vr$17 = SYMBUNIQUELABEL(  );
								fb_StrAssign( (void*)ID$1, 129, (void*)vr$17, 0, 0 );
							}
							goto label$48;
							label$49:;
							{
								uint8* vr$18 = LEXGETTEXT(  );
								fb_StrAssign( (void*)ID$1, 129, (void*)vr$18, 0, 0 );
							}
							label$48:;
						}
						goto label$37;
					...
					if( vr$20 != (struct $8FBSYMBOL*)0u ) goto label$52;
					{
				...
				label$35:;
				CCOMMENT( 0 );
				if( *(int32*)((uint8*)&ENV$ + 148) == 0 ) goto label$56;
				{
					if( *(int32*)((uint8*)&ENV$ + 900) != 0 ) goto label$58;
					{
						struct $7ASTNODE* vr$24 = ASTNEWLIT( *(uint8**)((uint8*)*(struct $9LEX_TKCTX**)((uint8*)&LEX$ + 840072) + 49400) );
						ASTADD( vr$24 );
				...
				label$56:;
				label$55:;
				int32 vr$27 = CSTMTSEPARATOR( 0 );
				if( vr$27 != 0 ) goto label$60;
				{
	...
	goto label$23;
	label$24:;
	if( *(int32*)((uint8*)S$1 + 96) != 0 ) goto label$62;
	{
...
void CENUMDECL( $13FB_SYMBATTRIB ATTRIB$1 )
{
	...
	if( vr$0 != 0 ) goto label$66;
	{
		HSKIPCOMPOUND( 338, -1, 0 );
		goto label$64;
	}
	label$66:;
	label$65:;
	LEXSKIPTOKEN( 2048 );
	{
		...
		TMP$95$2 = vr$1;
		if( TMP$95$2 == 0 ) goto label$69;
		label$70:;
		if( TMP$95$2 != 2 ) goto label$68;
		label$69:;
		{
			if( (*(int32*)((uint8*)&ENV$ + 1040) & 524288) == 0 ) goto label$72;
			{
				if( *(struct $8FBSYMBOL**)((uint8*)&SYMB$ + 98536) == (struct $8FBSYMBOL*)((uint8*)&SYMB$ + 98352) ) goto label$74;
				{
					if( *(int32*)((uint8*)*(struct $7FBTOKEN**)((uint8*)*(struct $9LEX_TKCTX**)((uint8*)&LEX$ + 840072) + 16548) + 4120) <= 0 ) goto label$76;
					{
						ERRREPORT( 90, 0, (uint8*)0u );
					}
					label$76:;
	...
	label$78:;
	int32 USE_HASHTB$1;
	USE_HASHTB$1 = -(*(int32*)((uint8*)&PARSER$ + 104) == 0);
	USE_HASHTB$1 = USE_HASHTB$1 | ISEXPLICIT$1;
	struct $8FBSYMBOL* vr$13 = SYMBADDENUM( (uint8*)ID$1, PALIAS$1, ATTRIB$1, USE_HASHTB$1 );
	E$1 = vr$13;
	if( E$1 != (struct $8FBSYMBOL*)0u ) goto label$81;
	{
		ERRREPORTEX( 4, (uint8*)ID$1, 0, 1, (uint8*)0u );
		uint8* vr$14 = SYMBUNIQUELABEL(  );
		struct $8FBSYMBOL* vr$15 = SYMBADDENUM( vr$14, (uint8*)0u, 0, USE_HASHTB$1 );
		E$1 = vr$15;
	}
	label$81:;
	label$80:;
	CCOMMENT( 0 );
	if( *(int32*)((uint8*)&ENV$ + 148) == 0 ) goto label$83;
	{
		if( *(int32*)((uint8*)&ENV$ + 900) != 0 ) goto label$85;
		{
			struct $7ASTNODE* vr$17 = ASTNEWLIT( *(uint8**)((uint8*)*(struct $9LEX_TKCTX**)((uint8*)&LEX$ + 840072) + 49400) );
			ASTADD( vr$17 );
			DZSTRRESET( (struct $8DZSTRING*)((uint8*)*(struct $9LEX_TKCTX**)((uint8*)&LEX$ + 840072) + 49400) );
		}
		label$85:;
	...
	label$83:;
	label$82:;
	int32 vr$20 = CSTMTSEPARATOR( 0 );
	if( vr$20 != 0 ) goto label$87;
	{
	...
	label$87:;
	label$86:;
	if( USE_HASHTB$1 == 0 ) goto label$89;
	{
		SYMBNESTBEGIN( E$1, 0 );
	}
	label$89:;
	label$88:;
	CENUMBODY( E$1, ATTRIB$1 & -16777217 );
	if( USE_HASHTB$1 == 0 ) goto label$91;
	{
		SYMBNESTEND( 0 );
	}
	label$91:;
	label$90:;
	int32 vr$22 = LEXGETTOKEN( 0 );
	if( vr$22 == 340 ) goto label$93;
	{
		ERRREPORT( 74, 0, (uint8*)0u );
		HSKIPUNTIL( -1, 0, 0, 0 );
	}
	goto label$92;
	label$93:;
	{
		...
		{
			LEXSKIPTOKEN( 2048 );
			if( ISEXPLICIT$1 != 0 ) goto label$97;
			{
				if( USE_HASHTB$1 == 0 ) goto label$99;
				{
...
static void HENUMCONSTDECL( uint8* ID$1, int64* VALUE$1 )
{
	...
	if( vr$0 == 0 ) goto label$13;
	{
		...
		label$15:;
		label$14:;
		if( *(int32*)EXPR$1 == 16 ) goto label$17;
		{
			ERRREPORT( 11, 0, (uint8*)0u );
			ASTDELTREE( EXPR$1 );
			goto label$11;
		...
		label$17:;
		label$16:;
		if( ((*(int32*)((uint8*)EXPR$1 + 4) & 511) & 480) == 0 ) goto label$18;
		TMP$92$2 = 24;
		goto label$100;
		label$18:;
		TMP$92$2 = (*(int32*)((uint8*)EXPR$1 + 4) & 511) & 31;
		label$100:;
		if( *(int32*)((int32)(struct $13SYMB_DATATYPE*)SYMB_DTYPETB$ + (TMP$92$2 * 28)) == 0 ) goto label$20;
		{
			ERRREPORTWARN( 5, (uint8*)ID$1, 1, (uint8*)0u );
		}
		label$20:;
		label$19:;
		int64 vr$10 = ASTCONSTFLUSHTOINT( EXPR$1, 8 );
		*VALUE$1 = vr$10;
	}
	label$13:;
	label$12:;
