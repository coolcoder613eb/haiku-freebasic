...
struct $8FBSYMBOL* SYMBREUSEORADDCONST( uint8*, int32, struct $8FBSYMBOL*, union $7FBVALUE*, $13FB_SYMBATTRIB );
...
static void HGETTYPE( int32*, struct $8FBSYMBOL** );
static void CCONSTASSIGN( int32, struct $8FBSYMBOL*, $13FB_SYMBATTRIB );
...
static void HGETTYPE( int32* DTYPE$1, struct $8FBSYMBOL** SUBTYPE$1 )
{
	label$10:;
	int32 vr$0 = LEXGETTOKEN( 0 );
	if( vr$0 != 376 ) goto label$13;
	{
		int64 TMP$92$2;
		int32 TMP$93$2;
		LEXSKIPTOKEN( 2048 );
		TMP$93$2 = 0;
		TMP$92$2 = 0ll;
		int32 vr$3 = CSYMBOLTYPE( DTYPE$1, SUBTYPE$1, &TMP$92$2, &TMP$93$2, 1 );
		...
		{
			int32 TMP$94$3;
			TMP$94$3 = *DTYPE$1 & 511;
			if( TMP$94$3 == 0 ) goto label$18;
			label$19:;
			if( TMP$94$3 == 18 ) goto label$18;
			label$20:;
			if( TMP$94$3 == 4 ) goto label$18;
			label$21:;
			if( TMP$94$3 == 7 ) goto label$18;
			label$22:;
			if( TMP$94$3 == 20 ) goto label$18;
			label$23:;
			if( TMP$94$3 != 23 ) goto label$17;
			label$18:;
			{
...
static void CCONSTASSIGN( int32 DTYPE$1, struct $8FBSYMBOL* SUBTYPE$1, $13FB_SYMBATTRIB ATTRIB$1 )
{
	label$24:;
	...
	CCURRENTPARENTID(  );
	{
		...
		label$28:;
		{
			if( (*(int32*)((uint8*)&ENV$ + 1040) & 524288) == 0 ) goto label$30;
			{
				if( *(struct $8FBSYMBOL**)((uint8*)&SYMB$ + 98536) == (struct $8FBSYMBOL*)((uint8*)&SYMB$ + 98352) ) goto label$32;
				{
					if( *(int32*)((uint8*)*(struct $7FBTOKEN**)((uint8*)*(struct $9LEX_TKCTX**)((uint8*)&LEX$ + 840072) + 16548) + 4120) <= 0 ) goto label$34;
					{
		...
		label$35:;
		{
			if( *(int32*)((uint8*)&ENV$ + 136) == 3 ) goto label$37;
			{
				if( (-(*(struct $8FBSYMBOL**)((uint8*)&SYMB$ + 98536) == (struct $8FBSYMBOL*)((uint8*)&SYMB$ + 98352)) | -(*(uint32*)((uint8*)&PARSER$ + 100) > 0u)) == 0 ) goto label$39;
				{
		...
		label$40:;
		{
			if( *(int32*)((uint8*)&ENV$ + 136) == 3 ) goto label$42;
			{
				ERRREPORT( 4, 0, (uint8*)0u );
				HSKIPUNTIL( 44, 0, 0, 0 );
				goto label$25;
		...
		if( TMP$95$2 > 5u ) goto label$43;
		goto *tmp$96[TMP$95$2 - 0u];
		label$26:;
	}
	uint8* vr$9 = LEXGETTEXT(  );
	fb_StrAssign( (void*)ID$1, 129, (void*)vr$9, 0, 0 );
	LEXCHECKTOKEN( 4096 );
	SUFFIX$1 = *(int32*)((uint8*)*(struct $7FBTOKEN**)((uint8*)*(struct $9LEX_TKCTX**)((uint8*)&LEX$ + 840072) + 16548) + 8);
	LEXSKIPTOKEN( 0 );
	if( DTYPE$1 != -2147483648u ) goto label$45;
	{
		HGETTYPE( &DTYPE$1, &SUBTYPE$1 );
	}
	label$45:;
	label$44:;
	if( SUFFIX$1 == -2147483648u ) goto label$47;
	{
		if( DTYPE$1 == -2147483648u ) goto label$49;
		{
	...
	label$46:;
	DOSKIP$1 = 0;
	int32 vr$15 = CASSIGNTOKEN(  );
	if( vr$15 != 0 ) goto label$51;
	{
	...
	{
		ERRREPORTEX( 11, (uint8*)ID$1, 0, 1, (uint8*)0u );
		DOSKIP$1 = -1;
		if( DTYPE$1 != -2147483648u ) goto label$55;
		{
			DTYPE$1 = 8;
		}
		label$55:;
	...
	label$52:;
	int32 EXPRDTYPE$1;
	EXPRDTYPE$1 = *(int32*)((uint8*)EXPR$1 + 4) & 511;
	LITSYM$1 = (struct $8FBSYMBOL*)0u;
	{
		if( EXPRDTYPE$1 == 4 ) goto label$58;
		label$59:;
		if( EXPRDTYPE$1 != 7 ) goto label$57;
		label$58:;
		{
	...
	if( LITSYM$1 == (struct $8FBSYMBOL*)0u ) goto label$61;
	{
		if( DTYPE$1 == -2147483648u ) goto label$63;
		{
			if( (DTYPE$1 & 511) == 17 ) goto label$65;
			{
				ERRREPORTEX( 24, (uint8*)ID$1, 0, 1, (uint8*)0u );
			}
			label$65:;
			label$64:;
		}
		...
		*(struct $8FBSYMBOL**)&VALUE$1 = LITSYM$1;
		struct $8FBSYMBOL* vr$23 = SYMBREUSEORADDCONST( (uint8*)ID$1, EXPRDTYPE$1, (struct $8FBSYMBOL*)0u, &VALUE$1, ATTRIB$1 );
		if( vr$23 != (struct $8FBSYMBOL*)0u ) goto label$67;
		{
	...
	label$61:;
	{
		if( *(int32*)EXPR$1 == 16 ) goto label$69;
		{
			ERRREPORTEX( 11, (uint8*)ID$1, 0, 1, (uint8*)0u );
			ASTDELTREE( EXPR$1 );
		...
		label$69:;
		label$68:;
		if( DTYPE$1 == -2147483648u ) goto label$71;
		{
			int32 vr$26 = ASTCHECKASSIGNTOTYPE( DTYPE$1, SUBTYPE$1, EXPR$1, 0 );
			if( vr$26 != 0 ) goto label$73;
			{
				ERRREPORTEX( 20, (uint8*)ID$1, 0, 1, (uint8*)0u );
				ASTDELTREE( EXPR$1 );
				EXPRDTYPE$1 = DTYPE$1;
				SUBTYPE$1 = (struct $8FBSYMBOL*)0u;
				struct $7ASTNODE* vr$27 = ASTNEWCONSTSTR( (uint8*)0u );
				EXPR$1 = vr$27;
			}
			label$73:;
			label$72:;
			if( (-(DTYPE$1 != EXPRDTYPE$1) | -(SUBTYPE$1 != *(struct $8FBSYMBOL**)((uint8*)EXPR$1 + 8))) == 0 ) goto label$75;
			{
				struct $7ASTNODE* vr$32 = ASTNEWCONV( DTYPE$1, SUBTYPE$1, EXPR$1, 0, (int32*)0u );
				EXPR$1 = vr$32;
		...
		label$70:;
		struct $8FBSYMBOL* vr$37 = SYMBREUSEORADDCONST( (uint8*)ID$1, DTYPE$1, SUBTYPE$1, (union $7FBVALUE*)((uint8*)EXPR$1 + 24), ATTRIB$1 );
		if( vr$37 != (struct $8FBSYMBOL*)0u ) goto label$79;
		{
			ERRREPORTEX( 4, (uint8*)ID$1, 0, 1, (uint8*)0u );
		}
		label$79:;
