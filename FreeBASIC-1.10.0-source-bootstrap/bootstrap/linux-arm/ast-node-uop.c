...
struct $7ASTNODE* ASTNEWUOP( int32 OP$1, struct $7ASTNODE* O$1 )
{
	...
	goto label$142;
	label$70:;
	TMP$88$1 = *(int32*)((uint8*)O$1 + 4) & 31;
	label$142:;
	if( *(int32*)((int32)(struct $13SYMB_DATATYPE*)SYMB_DTYPETB$ + (TMP$88$1 * 28)) != 2 ) goto label$72;
	{
		goto label$56;
	}
	label$72:;
	label$71:;
	{
		...
		goto label$143;
		label$73:;
		TMP$89$2 = *(int32*)((uint8*)O$1 + 4) & 31;
		label$143:;
		TMP$90$2 = (uint32)TMP$89$2;
		goto label$75;
		label$76:;
		{
		...
		if( (TMP$90$2 - 4u) > 20u ) goto label$74;
		goto *tmp$103[TMP$90$2 - 4u];
		label$74:;
	}
	if( (*(int32*)((uint8*)O$1 + 4) & 480) == 0 ) goto label$84;
	TMP$91$1 = 24;
	goto label$144;
	label$84:;
	TMP$91$1 = *(int32*)((uint8*)O$1 + 4) & 31;
	label$144:;
	DO_PROMOTE$1 = -(*(int32*)((uint8*)&ENV$ + 136) != 3) & -(*(int32*)((int32)(struct $13SYMB_DATATYPE*)SYMB_DTYPETB$ + (TMP$91$1 * 28)) == 0);
	if( (*(int32*)((uint8*)O$1 + 4) & 511) != 1 ) goto label$86;
	{
		if( OP$1 != 52 ) goto label$88;
		{
			DO_PROMOTE$1 = 0;
		}
		goto label$87;
	...
	label$86:;
	label$85:;
	if( DO_PROMOTE$1 == 0 ) goto label$90;
	{
		int32 TMP$92$2;
		int32 TMP$93$2;
		int32 TMP$94$2;
		if( (*(int32*)((uint8*)O$1 + 4) & 480) == 0 ) goto label$91;
		TMP$92$2 = 24;
		goto label$145;
		label$91:;
		TMP$92$2 = *(int32*)((uint8*)O$1 + 4) & 31;
		label$145:;
		if( (*(int32*)(((int32)(struct $13SYMB_DATATYPE*)SYMB_DTYPETB$ + (TMP$92$2 * 28)) + 16) & 480) == 0 ) goto label$93;
		TMP$94$2 = 24;
		goto label$146;
		label$93:;
		if( (*(int32*)((uint8*)O$1 + 4) & 480) == 0 ) goto label$92;
		TMP$93$2 = 24;
		goto label$147;
		label$92:;
		TMP$93$2 = *(int32*)((uint8*)O$1 + 4) & 31;
		label$147:;
		TMP$94$2 = *(int32*)(((int32)(struct $13SYMB_DATATYPE*)SYMB_DTYPETB$ + (TMP$93$2 * 28)) + 16) & 31;
		label$146:;
		RANK$1 = *(int32*)(((int32)(struct $13SYMB_DATATYPE*)SYMB_DTYPETB$ + (TMP$94$2 * 28)) + 12);
		...
		label$95:;
		{
			if( (-(INTRANK$1 < RANK$1) & -(RANK$1 < UINTRANK$1)) == 0 ) goto label$97;
			{
	...
	{
		uint32 TMP$95$2;
		TMP$95$2 = (uint32)OP$1;
		goto label$99;
		label$100:;
		{
			int32 TMP$96$3;
			if( (*(int32*)((uint8*)O$1 + 4) & 480) == 0 ) goto label$101;
			TMP$96$3 = 24;
			goto label$148;
			label$101:;
			TMP$96$3 = *(int32*)((uint8*)O$1 + 4) & 31;
			label$148:;
			if( *(int32*)((int32)(struct $13SYMB_DATATYPE*)SYMB_DTYPETB$ + (TMP$96$3 * 28)) == 0 ) goto label$103;
			{
		...
		{
			int32 TMP$97$3;
			if( (*(int32*)((uint8*)O$1 + 4) & 480) == 0 ) goto label$105;
			TMP$97$3 = 24;
			goto label$149;
			label$105:;
			TMP$97$3 = *(int32*)((uint8*)O$1 + 4) & 31;
			label$149:;
			if( *(int32*)((int32)(struct $13SYMB_DATATYPE*)SYMB_DTYPETB$ + (TMP$97$3 * 28)) != 0 ) goto label$107;
			{
		...
		label$108:;
		{
			...
			TMP$98$3 = DTYPE$1 & 31;
			label$150:;
			if( ~(*(int32*)(((int32)(struct $13SYMB_DATATYPE*)SYMB_DTYPETB$ + (TMP$98$3 * 28)) + 8)) == 0 ) goto label$111;
			{
				if( *(int32*)O$1 != 16 ) goto label$113;
				{
					if( *(int32*)((uint8*)&AST$ + 232) != 0 ) goto label$115;
					{
						int32 TMP$99$6;
						if( (DTYPE$1 & 480) == 0 ) goto label$116;
						TMP$99$6 = 24;
						goto label$151;
						label$116:;
						TMP$99$6 = DTYPE$1 & 31;
						label$151:;
						if( *(uint64*)((uint8*)O$1 + 24) <= (1ull << (((*(int32*)(((int32)(struct $13SYMB_DATATYPE*)SYMB_DTYPETB$ + (TMP$99$6 * 28)) + 4) << (3 & 31)) + -1) & 63)) ) goto label$118;
						{
		...
		{
			int32 TMP$100$3;
			if( (*(int32*)((uint8*)O$1 + 4) & 480) == 0 ) goto label$120;
			TMP$100$3 = 24;
			goto label$152;
			label$120:;
			TMP$100$3 = *(int32*)((uint8*)O$1 + 4) & 31;
			label$152:;
			if( *(int32*)((int32)(struct $13SYMB_DATATYPE*)SYMB_DTYPETB$ + (TMP$100$3 * 28)) == 1 ) goto label$122;
			{
		...
		{
			int32 TMP$101$3;
			if( (*(int32*)((uint8*)O$1 + 4) & 480) == 0 ) goto label$124;
			TMP$101$3 = 24;
			goto label$153;
			label$124:;
			TMP$101$3 = *(int32*)((uint8*)O$1 + 4) & 31;
			label$153:;
			if( *(int32*)((int32)(struct $13SYMB_DATATYPE*)SYMB_DTYPETB$ + (TMP$101$3 * 28)) != 0 ) goto label$126;
			{
		...
		{
			int32 TMP$102$3;
			if( (*(int32*)((uint8*)O$1 + 4) & 480) == 0 ) goto label$128;
			TMP$102$3 = 24;
			goto label$154;
			label$128:;
			TMP$102$3 = *(int32*)((uint8*)O$1 + 4) & 31;
			label$154:;
			if( *(int32*)((int32)(struct $13SYMB_DATATYPE*)SYMB_DTYPETB$ + (TMP$102$3 * 28)) != 0 ) goto label$130;
			{
		...
		if( (TMP$95$2 - 52u) > 20u ) goto label$98;
		goto *tmp$104[TMP$95$2 - 52u];
		label$98:;
	}
	if( *(int32*)O$1 != 16 ) goto label$133;
	{
	...
	label$133:;
	label$132:;
	if( OP$1 != 52 ) goto label$135;
	{
		int32 vr$125 = ASTISRELATIONALBOP( O$1 );
		if( vr$125 == 0 ) goto label$137;
		{
	...
	label$135:;
	label$134:;
	if( (*(int32*)((uint8*)&IR$ + 272) & 131072) == 0 ) goto label$139;
	{
		int32 vr$130 = (*(tmp$40*)((uint8*)&IR$ + 20))( OP$1, DTYPE$1 );
		if( vr$130 != 0 ) goto label$141;
		{
...
struct $6IRVREG* ASTLOADUOP( struct $7ASTNODE* N$1 )
{
	...
	if( O$1 != (struct $7ASTNODE*)0u ) goto label$158;
	{
	...
	V1$1 = vr$5;
	if( *(int32*)((uint8*)&AST$ + 136) == 0 ) goto label$162;
	{
		if( (*(int32*)((uint8*)N$1 + 28) & 1) == 0 ) goto label$164;
		{
			struct $6IRVREG* vr$10 = (*(tmp$68*)((uint8*)&IR$ + 224))( *(int32*)((uint8*)O$1 + 4), *(struct $8FBSYMBOL**)((uint8*)O$1 + 8) );
			VR$1 = vr$10;
		...
		label$163:;
		(*(tmp$51*)((uint8*)&IR$ + 96))( OP$1, V1$1, VR$1 );
		if( VR$1 != (struct $6IRVREG*)0u ) goto label$166;
		{
			VR$1 = V1$1;
		}
		label$166:;
...
static struct $7ASTNODE* HCONSTUOP( int32 OP$1, int32 DTYPE$1, struct $8FBSYMBOL* SUBTYPE$1, struct $7ASTNODE* L$1 )
{
	...
	goto label$167;
	label$17:;
	TMP$83$1 = *(int32*)((uint8*)L$1 + 4) & 31;
	label$167:;
	if( *(int32*)((int32)(struct $13SYMB_DATATYPE*)SYMB_DTYPETB$ + (TMP$83$1 * 28)) != 1 ) goto label$19;
	{
		D$1 = *(double*)((uint8*)L$1 + 24);
		{
			uint32 TMP$84$3;
			TMP$84$3 = (uint32)OP$1;
			goto label$21;
			label$22:;
			{
				D$1 = -D$1;
			...
			if( (TMP$84$3 - 54u) > 18u ) goto label$37;
			goto *tmp$105[TMP$84$3 - 54u];
			label$20:;
		}
	...
	label$19:;
	{
		...
		goto label$168;
		label$38:;
		TMP$85$2 = *(int32*)((uint8*)L$1 + 4) & 31;
		label$168:;
		if( *(int32*)(((int32)(struct $13SYMB_DATATYPE*)SYMB_DTYPETB$ + (TMP$85$2 * 28)) + 4) != 8 ) goto label$40;
		{
			{
				uint32 TMP$86$4;
				TMP$86$4 = (uint32)OP$1;
				goto label$42;
				label$43:;
				{
					I$1 = ~I$1;
				...
				if( (TMP$86$4 - 52u) > 5u ) goto label$47;
				goto *tmp$106[TMP$86$4 - 52u];
				label$41:;
			}
		}
		goto label$39;
		...
		{
			{
				...
				if( (TMP$87$4 - 52u) > 5u ) goto label$54;
