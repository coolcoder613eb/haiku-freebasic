...
struct $7ASTNODE* ASTNEWDEREF( struct $7ASTNODE* L$1, int32 DTYPE$1, struct $8FBSYMBOL* SUBTYPE$1, int64 OFS$1 )
{
	...
	{
		if( DTYPE$1 != -2147483648u ) goto label$15;
		{
			DTYPE$1 = (((*(int32*)((uint8*)L$1 + 4) & 31) | ((*(int32*)((uint8*)L$1 + 4) & 480) + -32)) | (((*(int32*)((uint8*)L$1 + 4) & 261632) >> (1 & 31)) & 261632)) | (*(int32*)((uint8*)L$1 + 4) & 32505856);
		...
		if( OFS$1 != 0ll ) goto label$17;
		{
			...
			int32 DELCHILD$3;
			{
				$13AST_NODECLASS TMP$82$4;
				TMP$82$4 = *($13AST_NODECLASS*)T$3;
				if( TMP$82$4 != 6 ) goto label$19;
				label$20:;
				{
					DELCHILD$3 = -1;
				}
				goto label$18;
				label$19:;
				if( TMP$82$4 != 23 ) goto label$21;
				label$22:;
				{
					DELCHILD$3 = -(*(int64*)((uint8*)T$3 + 24) == 0ll);
				}
				goto label$18;
				label$21:;
				if( TMP$82$4 != 32 ) goto label$23;
				label$24:;
				{
					if( (-(*(int32*)*(struct $7ASTNODE**)((uint8*)T$3 + 64) == 6) | (-(*(int32*)*(struct $7ASTNODE**)((uint8*)T$3 + 64) == 23) & -(*(int64*)((uint8*)*(struct $7ASTNODE**)((uint8*)T$3 + 64) + 24) == 0ll))) == 0 ) goto label$26;
					{
						ASTDELTREE( *(struct $7ASTNODE**)((uint8*)T$3 + 68) );
						T$3 = *(struct $7ASTNODE**)((uint8*)T$3 + 64);
						DELCHILD$3 = -1;
					}
					goto label$25;
					label$26:;
			...
			if( DELCHILD$3 == 0 ) goto label$29;
			{
				N$1 = *(struct $7ASTNODE**)((uint8*)T$3 + 64);
				label$30:;
				if( L$1 == N$1 ) goto label$31;
				{
					T$3 = *(struct $7ASTNODE**)((uint8*)L$1 + 64);
					ASTDELNODE( L$1 );
					L$1 = T$3;
				}
				goto label$30;
		...
		label$17:;
		label$16:;
		if( *(int32*)L$1 != 16 ) goto label$33;
		{
			int64 vr$36 = ASTCONSTFLUSHTOINT( L$1, 8 );
			OFS$1 = OFS$1 + vr$36;
			L$1 = (struct $7ASTNODE*)0u;
		}
		label$33:;
		label$32:;
	}
	label$13:;
	label$12:;
	struct $7ASTNODE* vr$38 = ASTNEWNODE( 20, DTYPE$1, SUBTYPE$1 );
	N$1 = vr$38;
...
struct $6IRVREG* ASTLOADDEREF( struct $7ASTNODE* N$1 )
{
	...
	if( L$1 != (struct $7ASTNODE*)0u ) goto label$37;
	{
		if( *(int32*)((uint8*)&AST$ + 136) == 0 ) goto label$39;
		{
			struct $6IRVREG* vr$5 = (*(tmp$73*)((uint8*)&IR$ + 244))( *(int32*)((uint8*)N$1 + 4), *(struct $8FBSYMBOL**)((uint8*)N$1 + 8), *(int64*)((uint8*)N$1 + 24), (struct $6IRVREG*)0u );
			VR$1 = vr$5;
	...
	if( *(int32*)((uint8*)&AST$ + 136) == 0 ) goto label$41;
	{
		int32 TMP$83$2;
		int32 TMP$84$2;
		if( (*(int32*)((uint8*)V1$1 + 4) & 480) == 0 ) goto label$42;
		TMP$83$2 = 24;
		goto label$46;
		label$42:;
		TMP$83$2 = *(int32*)((uint8*)V1$1 + 4) & 31;
		label$46:;
		if( (*(int32*)((uint8*)V1$1 + 4) & 480) == 0 ) goto label$43;
		TMP$84$2 = 24;
		goto label$47;
		label$43:;
		TMP$84$2 = *(int32*)((uint8*)V1$1 + 4) & 31;
		label$47:;
		if( ((-(*(int32*)V1$1 != 4) | -(*(int32*)((int32)(struct $13SYMB_DATATYPE*)SYMB_DTYPETB$ + (TMP$83$2 * 28)) != 0)) | -(*(int32*)(((int32)(struct $13SYMB_DATATYPE*)SYMB_DTYPETB$ + (TMP$84$2 * 28)) + 4) != *(int32*)((uint8*)&ENV$ + 296))) == 0 ) goto label$45;
		{
			struct $6IRVREG* vr$39 = (*(tmp$68*)((uint8*)&IR$ + 224))( (((*(int32*)((uint8*)N$1 + 4) & 31) | ((*(int32*)((uint8*)N$1 + 4) & 480) + 32)) | ((*(int32*)((uint8*)N$1 + 4) & 261632) << (1 & 31))) | (*(int32*)((uint8*)N$1 + 4) & 32505856), *(struct $8FBSYMBOL**)((uint8*)N$1 + 8) );
			VP$1 = vr$39;
			(*(tmp$51*)((uint8*)&IR$ + 120))( 76, V1$1, VP$1 );
		}
		goto label$44;
		label$45:;
		{
		...
		label$44:;
		struct $6IRVREG* vr$43 = (*(tmp$73*)((uint8*)&IR$ + 244))( *(int32*)((uint8*)N$1 + 4), *(struct $8FBSYMBOL**)((uint8*)N$1 + 8), *(int64*)((uint8*)N$1 + 24), VP$1 );
		VR$1 = vr$43;
		*(int32*)((uint8*)VR$1 + 20) = *(int32*)((uint8*)N$1 + 16);
	}
	label$41:;
