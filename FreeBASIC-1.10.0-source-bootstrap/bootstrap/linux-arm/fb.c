...
void FBGLOBALINIT( void )
{
	...
	*($13FB_COMPTARGET*)((uint8*)&ENV$ + 108) = 2;
	*($10FB_CPUTYPE*)((uint8*)&ENV$ + 112) = 15;
...
int32 FBISCROSSCOMP( void )
{
	...
	__builtin_memset( &fb$result$1, 0, 4 );
	label$194:;
	fb$result$1 = -(*(int32*)((uint8*)&ENV$ + 108) != 2);
	label$195:;
	return fb$result$1;
}
...
FBSTRING* FBGETHOSTID( void )
{
	...
	__builtin_memset( &fb$result$1, 0, 12 );
	label$209:;
	FBSTRING* vr$1 = HGETTARGETID( 2, 15 );
	fb_StrAssign( (void*)&fb$result$1, -1, (void*)vr$1, -1, 0 );
	label$210:;
	FBSTRING* vr$4 = fb_StrAllocTempResult( (FBSTRING*)&fb$result$1 );
	return vr$4;
...
int32 FBGETHOSTBITS( void )
{
	...
	__builtin_memset( &fb$result$1, 0, 4 );
	label$241:;
	fb$result$1 = *(int32*)((int32)(struct $13FBCPUTYPEINFO*)CPUTYPEINFO$ + 312);
	label$242:;
	return fb$result$1;
}
