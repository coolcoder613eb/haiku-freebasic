...
void CWHILESTMTBEGIN( void )
{
	...
	label$13:;
	label$12:;
	struct $7ASTNODE* vr$5 = ASTBUILDBRANCH( EXPR$1, EL$1, 0, 0 );
	EXPR$1 = vr$5;
	...
	label$14:;
	struct $13FB_CMPSTMTSTK* vr$6 = CCOMPSTMTPUSH( 273, 1 );
	STK$1 = vr$6;
	struct $7ASTNODE* vr$7 = ASTSCOPEBEGIN(  );
	*(struct $7ASTNODE**)((uint8*)STK$1 + 8) = vr$7;
	*(struct $8FBSYMBOL**)((uint8*)STK$1 + 16) = IL$1;
	*(struct $8FBSYMBOL**)((uint8*)STK$1 + 20) = EL$1;
	label$11:;
}
...
void CWHILESTMTEND( void )
{
	label$16:;
	struct $13FB_CMPSTMTSTK* STK$1;
	struct $13FB_CMPSTMTSTK* vr$0 = CCOMPSTMTGETTOS( 273, -1 );
	STK$1 = vr$0;
	if( STK$1 != (struct $13FB_CMPSTMTSTK*)0u ) goto label$19;
	{
		HSKIPUNTIL( -1, 0, 0, 0 );
		goto label$17;
	}
	...
	label$18:;
	LEXSKIPTOKEN( 2048 );
	if( *(struct $7ASTNODE**)((uint8*)STK$1 + 8) == (struct $7ASTNODE*)0u ) goto label$21;
	{
		ASTSCOPEEND( *(struct $7ASTNODE**)((uint8*)STK$1 + 8) );
	}
	label$21:;
	label$20:;
	struct $7ASTNODE* vr$4 = ASTNEWBRANCH( 98, *(struct $8FBSYMBOL**)((uint8*)STK$1 + 16), (struct $7ASTNODE*)0u );
	ASTADD( vr$4 );
	struct $7ASTNODE* vr$6 = ASTNEWLABEL( *(struct $8FBSYMBOL**)((uint8*)STK$1 + 20), -1 );
	ASTADD( vr$6 );
	CCOMPSTMTPOP( STK$1 );
	label$17:;
}
