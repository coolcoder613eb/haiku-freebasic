	...
	{
		{
			...
			TMP$82$3 = DTYPE$1 & 31;
			label$26:;
			TMP$83$3 = *($12FB_DATACLASS*)((int32)(struct $13SYMB_DATATYPE*)SYMB_DTYPETB$ + (TMP$82$3 * 28));
			if( TMP$83$3 != 0 ) goto label$16;
			label$17:;
			{
				int32 TMP$84$4;
				...
				TMP$84$4 = DTYPE$1 & 31;
				label$27:;
				if( *(int32*)(((int32)(struct $13SYMB_DATATYPE*)SYMB_DTYPETB$ + (TMP$84$4 * 28)) + 4) >= *(int32*)((int32)(struct $13SYMB_DATATYPE*)SYMB_DTYPETB$ + 228) ) goto label$20;
				{
			...
			label$22:;
			{
				...
				TMP$85$4 = DTYPE$1 & 31;
				label$28:;
				if( *(int32*)(((int32)(struct $13SYMB_DATATYPE*)SYMB_DTYPETB$ + (TMP$85$4 * 28)) + 4) >= *(int32*)((int32)(struct $13SYMB_DATATYPE*)SYMB_DTYPETB$ + 452) ) goto label$25;
				{
...
struct $6IRVREG* ASTLOADMACRO( struct $7ASTNODE* N$1 )
{
	...
	OP$1 = *($6AST_OP*)((uint8*)N$1 + 24);
	{
		...
		label$37:;
		{
			...
			V2$1 = vr$12;
			struct $6IRVREG* vr$15 = (*(tmp$68*)((uint8*)&IR$ + 224))( *(int32*)((uint8*)N$1 + 4), *(struct $8FBSYMBOL**)((uint8*)N$1 + 8) );
			VR$1 = vr$15;
		}
		goto label$31;
		label$36:;
	...
	{
		(*(tmp$58*)((uint8*)&IR$ + 152))( OP$1, V1$1, V2$1, VR$1 );
	}
	label$41:;
	label$40:;
