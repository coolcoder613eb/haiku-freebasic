...
int32 ASTGOSUBADDRETURN( struct $8FBSYMBOL*, struct $8FBSYMBOL* );
...
void RTLERRORRESUME( int32 );
static int32 HFUNCRETURN( void );
static struct $8FBSYMBOL* HGETLABELID( void );
static void HGOSUBBRANCH( void );
static int32 HGOSUBRETURN( void );
...
int32 CGOTOSTMT( $8FB_TOKEN TK$1 )
{
	int32 fb$result$1;
	...
	fb$result$1 = 0;
	{
		...
		label$53:;
		{
			...
			L$1 = vr$1;
			if( L$1 == (struct $8FBSYMBOL*)0u ) goto label$55;
			{
				ASTSCOPEBREAK( L$1 );
			}
			label$55:;
		...
		label$56:;
		{
			if( (*(int32*)((uint8*)&ENV$ + 1040) & 65536) != 0 ) goto label$58;
			{
				ERRREPORTNOTALLOWED( 65536, 146, (uint8*)0u );
				HSKIPUNTIL( -1, 0, 0, 0 );
				fb$result$1 = -1;
				goto label$50;
			}
			label$58:;
			label$57:;
			if( *(int32*)((uint8*)&ENV$ + 1100) == 0 ) goto label$60;
			{
				HGOSUBBRANCH(  );
			}
			goto label$59;
		...
		label$61:;
		{
			if( (*(int32*)((uint8*)&ENV$ + 1040) & 65536) == 0 ) goto label$63;
			{
				if( *(int32*)((uint8*)&ENV$ + 1100) == 0 ) goto label$65;
				{
					int32 vr$4 = HGOSUBRETURN(  );
					fb$result$1 = vr$4;
					goto label$50;
				}
				label$65:;
		...
		label$66:;
		{
			if( (*(int32*)((uint8*)&ENV$ + 1040) & 134217728) != 0 ) goto label$68;
			{
				ERRREPORTNOTALLOWED( 134217728, 146, (uint8*)0u );
				HSKIPUNTIL( -1, 0, 0, 0 );
				fb$result$1 = -1;
				goto label$50;
			}
			...
			label$67:;
			LEXSKIPTOKEN( 2048 );
			int32 vr$7 = HMATCH( 283, 2048 );
			RTLERRORRESUME( vr$7 );
			fb$result$1 = -1;
		}
		goto label$51;
		label$52:;
		static const void* tmp$97[111] = {
			&&label$61,
			&&label$53,
			&&label$56,
			&&label$51,
		...
		if( (TMP$96$2 - 392u) > 110u ) goto label$51;
		goto *tmp$97[TMP$96$2 - 392u];
		label$51:;
	}
	label$50:;
	return fb$result$1;
...
static int32 HFUNCRETURN( void )
{
	...
	if( *(struct $13FB_CMPSTMTSTK**)((uint8*)&PARSER$ + 48) == (struct $13FB_CMPSTMTSTK*)0u ) goto label$13;
	{
		LABEL$1 = *(struct $8FBSYMBOL**)((uint8*)*(struct $13FB_CMPSTMTSTK**)((uint8*)&PARSER$ + 48) + 24);
	}
	label$13:;
	label$12:;
	if( LABEL$1 != (struct $8FBSYMBOL*)0u ) goto label$15;
	{
		ERRREPORT( 53, 0, (uint8*)0u );
		HSKIPUNTIL( -1, 0, 0, 0 );
		fb$result$1 = -1;
		goto label$11;
	}
	...
	label$14:;
	LEXSKIPTOKEN( 2048 );
	if( (*(int32*)((uint8*)*(struct $8FBSYMBOL**)((uint8*)&PARSER$ + 108) + 28) & 511) == 0 ) goto label$17;
	{
		CHECKEXPR$1 = -1;
	}
	goto label$16;
	...
	{
		{
			...
			if( (TMP$93$3 - 256u) > 84u ) goto label$21;
			goto *tmp$98[TMP$93$3 - 256u];
			label$18:;
		}
	}
	label$16:;
	if( CHECKEXPR$1 == 0 ) goto label$23;
	{
		int32 vr$5 = CASSIGNFUNCTRESULT( -1 );
		if( vr$5 != 0 ) goto label$25;
		{
			goto label$11;
		}
		label$25:;
...
static struct $8FBSYMBOL* HGETLABELID( void )
{
	...
	struct $8FBSYMBOL* SYM$1;
	{
		...
		label$30:;
		{
			...
			struct $8FBSYMBOL* vr$3 = SYMBLOOKUPBYNAMEANDCLASS( *(struct $8FBSYMBOL**)((uint8*)&SYMB$ + 98536), (uint8*)vr$2, 7, 0, 0 );
			SYM$1 = vr$3;
		}
		goto label$28;
		label$31:;
		{
			...
			struct $10FBSYMCHAIN* vr$5 = CIDENTIFIER( &BASE_PARENT$3, 38 );
			CHAIN_$3 = vr$5;
			struct $8FBSYMBOL* vr$6 = SYMBFINDBYCLASS( CHAIN_$3, 7 );
			SYM$1 = vr$6;
		}
		goto label$28;
		label$32:;
		...
		goto label$28;
		label$29:;
		static const void* tmp$99[4] = {
			&&label$31,
			&&label$31,
			&&label$31,
			&&label$30,
		};
		if( TMP$94$2 > 3u ) goto label$32;
		goto *tmp$99[TMP$94$2 - 0u];
		label$28:;
	}
	if( SYM$1 != (struct $8FBSYMBOL*)0u ) goto label$34;
	{
		uint8* vr$7 = LEXGETTEXT(  );
		struct $8FBSYMBOL* vr$8 = SYMBADDLABEL( vr$7, 64 );
		SYM$1 = vr$8;
		if( SYM$1 != (struct $8FBSYMBOL*)0u ) goto label$36;
		{
			ERRREPORT( 14, 0, (uint8*)0u );
		}
		label$36:;
...
static void HGOSUBBRANCH( void )
{
	...
	L$1 = vr$0;
	if( L$1 == (struct $8FBSYMBOL*)0u ) goto label$40;
	{
		ASTGOSUBADDJMP( *(struct $8FBSYMBOL**)((uint8*)&PARSER$ + 108), L$1 );
	}
	label$40:;
	label$39:;
	label$38:;
...
static int32 HGOSUBRETURN( void )
{
	...
	LEXSKIPTOKEN( 2048 );
	{
		...
		label$45:;
		{
			int32 vr$2 = ASTGOSUBADDRETURN( *(struct $8FBSYMBOL**)((uint8*)&PARSER$ + 108), (struct $8FBSYMBOL*)0u );
			fb$result$1 = vr$2;
		}
		goto label$43;
		label$46:;
		{
			...
			L$1 = vr$3;
			if( L$1 == (struct $8FBSYMBOL*)0u ) goto label$48;
			{
				int32 vr$4 = ASTGOSUBADDRETURN( *(struct $8FBSYMBOL**)((uint8*)&PARSER$ + 108), L$1 );
				fb$result$1 = vr$4;
			}
			goto label$47;
			label$48:;
		...
		if( (TMP$95$2 - 256u) > 84u ) goto label$46;
		goto *tmp$100[TMP$95$2 - 256u];
		label$43:;
	}
	label$42:;
	return fb$result$1;
