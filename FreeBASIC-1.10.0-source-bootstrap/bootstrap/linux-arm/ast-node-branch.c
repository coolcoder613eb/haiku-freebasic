...
static struct $7ASTNODE* ASTNEWJMPTB( struct $7ASTNODE*, struct $8FBSYMBOL*, uint64*, struct $8FBSYMBOL**, int32, struct $8FBSYMBOL*, uint64, uint64 );
static int64 HPRECALCBIASOFFSET( uint64, int32 );
...
struct $7ASTNODE* ASTNEWBRANCH( int32 OP$1, struct $8FBSYMBOL* LABEL$1, struct $7ASTNODE* L$1 )
{
	...
	label$12:;
	struct $7ASTNODE* vr$2 = ASTNEWNODE( 7, DTYPE$1, (struct $8FBSYMBOL*)0u );
	N$1 = vr$2;
	fb$result$1 = N$1;
...
struct $6IRVREG* ASTLOADBRANCH( struct $7ASTNODE* N$1 )
{
	...
	if( L$1 == (struct $7ASTNODE*)0u ) goto label$17;
	{
	...
	{
		if( *(struct $8FBSYMBOL**)((uint8*)N$1 + 32) != (struct $8FBSYMBOL*)0u ) goto label$21;
		{
			{
				int32 TMP$82$4;
				TMP$82$4 = *(int32*)((uint8*)N$1 + 24);
				if( TMP$82$4 != 104 ) goto label$23;
				label$24:;
				{
					(*(tmp$52*)((uint8*)&IR$ + 136))( VR$1 );
				}
				goto label$22;
				label$23:;
				if( TMP$82$4 != 101 ) goto label$25;
				label$26:;
				{
					(*(tmp$45*)((uint8*)&IR$ + 68))( 0 );
				}
				goto label$22;
				label$25:;
				{
		...
		label$21:;
		{
			(*(tmp$55*)((uint8*)&IR$ + 140))( *(int32*)((uint8*)N$1 + 24), *(struct $8FBSYMBOL**)((uint8*)N$1 + 32) );
		}
		label$20:;
	}
	label$19:;
...
struct $6IRVREG* ASTLOADJMPTB( struct $7ASTNODE* N$1 )
{
	...
	if( *(int32*)((uint8*)&AST$ + 136) == 0 ) goto label$39;
	{
		(*(tmp$56*)((uint8*)&IR$ + 144))( V1$1, *(struct $8FBSYMBOL**)((uint8*)N$1 + 12), *(uint64**)((uint8*)N$1 + 24), *(struct $8FBSYMBOL***)((uint8*)N$1 + 28), *(int32*)((uint8*)N$1 + 32), *(struct $8FBSYMBOL**)((uint8*)N$1 + 36), *(uint64*)((uint8*)N$1 + 40), *(uint64*)((uint8*)N$1 + 48) );
	}
	label$39:;
	label$38:;
	free( *(void**)((uint8*)N$1 + 24) );
	free( *(void**)((uint8*)N$1 + 28) );
	fb$result$1 = (struct $6IRVREG*)0u;
	label$37:;
	return fb$result$1;
}

struct $7ASTNODE* ASTBUILDJMPTB( struct $8FBSYMBOL* TEMPVAR$1, uint64* VALUES1$1, struct $8FBSYMBOL** LABELS1$1, int32 LABELCOUNT$1, struct $8FBSYMBOL* DEFLABEL$1, uint64 BIAS$1, uint64 SPAN$1 )
{
	struct $7ASTNODE* fb$result$1;
	__builtin_memset( &fb$result$1, 0, 4 );
	label$42:;
	...
	int32 DTYPE$1;
	DTYPE$1 = *(int32*)((uint8*)TEMPVAR$1 + 28) & 511;
	TREE$1 = (struct $7ASTNODE*)0u;
	{
		$10FB_BACKEND TMP$85$2;
		TMP$85$2 = *($10FB_BACKEND*)((uint8*)&ENV$ + 104);
		if( TMP$85$2 == 0 ) goto label$46;
		label$47:;
		if( TMP$85$2 != 2 ) goto label$45;
		label$46:;
		{
			if( LABELCOUNT$1 > 0 ) goto label$49;
			{
				struct $7ASTNODE* vr$3 = ASTNEWBRANCH( 98, DEFLABEL$1, (struct $7ASTNODE*)0u );
				fb$result$1 = vr$3;
				goto label$43;
			}
			label$49:;
	...
	if( *(int32*)((uint8*)&ENV$ + 104) != 0 ) goto label$51;
	{
		uint8* vr$4 = SYMBUNIQUELABEL(  );
		struct $8FBSYMBOL* vr$5 = SYMBADDVAR( (uint8*)vr$4, (uint8*)0u, 32, (struct $8FBSYMBOL*)0u, 0ll, 0, (struct $7FBARRAYI10FBARRAYDIME*)&tmp$84$1, 1, 0 );
		TBSYM$1 = vr$5;
		*($12FB_SYMBSTATS*)((uint8*)TBSYM$1 + 12) = *(int32*)((uint8*)TBSYM$1 + 12) | 32768;
		struct $7ASTNODE* vr$9 = ASTNEWCONSTI( (int64)SPAN$1, DTYPE$1, (struct $8FBSYMBOL*)0u );
		struct $7ASTNODE* vr$10 = ASTNEWCONSTI( (int64)BIAS$1, DTYPE$1, (struct $8FBSYMBOL*)0u );
		struct $7ASTNODE* vr$11 = ASTNEWVAR( TEMPVAR$1, 0ll, -2147483648u, (struct $8FBSYMBOL*)0u );
		struct $7ASTNODE* vr$12 = ASTNEWBOP( 29, vr$11, vr$10, (struct $8FBSYMBOL*)0u, 1 );
		struct $7ASTNODE* vr$13 = ASTNEWBOP( 46, vr$12, vr$9, DEFLABEL$1, 0 );
		struct $7ASTNODE* vr$14 = ASTNEWLINK( TREE$1, vr$13, 0 );
		TREE$1 = vr$14;
		struct $7ASTNODE* vr$16 = ASTNEWCONSTI( (int64)*(int32*)((uint8*)&ENV$ + 296), DTYPE$1, (struct $8FBSYMBOL*)0u );
		struct $7ASTNODE* vr$17 = ASTNEWVAR( TEMPVAR$1, 0ll, -2147483648u, (struct $8FBSYMBOL*)0u );
		struct $7ASTNODE* vr$18 = ASTNEWBOP( 30, vr$17, vr$16, (struct $8FBSYMBOL*)0u, 1 );
		int64 vr$19 = HPRECALCBIASOFFSET( BIAS$1, DTYPE$1 );
		struct $7ASTNODE* vr$20 = ASTNEWVAR( TBSYM$1, vr$19, -2147483648u, (struct $8FBSYMBOL*)0u );
		struct $7ASTNODE* vr$21 = ASTNEWIDX( vr$20, vr$18 );
		struct $7ASTNODE* vr$22 = ASTNEWBRANCH( 104, (struct $8FBSYMBOL*)0u, vr$21 );
	...
	label$51:;
	{
		TBSYM$1 = (struct $8FBSYMBOL*)0u;
	}
	label$50:;
	struct $7ASTNODE* vr$24 = ASTNEWVAR( TEMPVAR$1, 0ll, -2147483648u, (struct $8FBSYMBOL*)0u );
	struct $7ASTNODE* vr$25 = ASTNEWJMPTB( vr$24, TBSYM$1, VALUES1$1, LABELS1$1, LABELCOUNT$1, DEFLABEL$1, BIAS$1, SPAN$1 );
...
struct $7ASTNODE* ASTNEWLOOP( struct $8FBSYMBOL* LABEL$1, struct $7ASTNODE* TREE$1 )
{
	...
	label$52:;
	struct $7ASTNODE* N$1;
	struct $7ASTNODE* vr$1 = ASTNEWNODE( 13, -2147483648u, (struct $8FBSYMBOL*)0u );
	N$1 = vr$1;
	fb$result$1 = N$1;
	*(struct $7ASTNODE**)((uint8*)N$1 + 64) = TREE$1;
	*(struct $8FBSYMBOL**)((uint8*)N$1 + 32) = LABEL$1;
	*(int32*)((uint8*)N$1 + 24) = 24;
	*($9AST_OPOPT*)((uint8*)N$1 + 28) = 0;
	label$53:;
	return fb$result$1;
}
...
static struct $7ASTNODE* ASTNEWJMPTB( struct $7ASTNODE* L$1, struct $8FBSYMBOL* TBSYM$1, uint64* VALUES1$1, struct $8FBSYMBOL** LABELS1$1, int32 LABELCOUNT$1, struct $8FBSYMBOL* DEFLABEL$1, uint64 BIAS$1, uint64 SPAN$1 )
{
	struct $7ASTNODE* fb$result$1;
	__builtin_memset( &fb$result$1, 0, 4 );
	label$28:;
	...
	TREE$1 = (struct $7ASTNODE*)0u;
	if( LABELCOUNT$1 <= 0 ) goto label$31;
	{
		...
		LABELS$1 = (struct $8FBSYMBOL**)vr$4;
		{
			...
			I$3 = 0;
			int32 TMP$83$3;
			TMP$83$3 = LABELCOUNT$1 + -1;
			goto label$32;
			label$35:;
			{
				*(uint64*)((uint8*)VALUES$1 + (I$3 << (3 & 31))) = *(uint64*)((uint8*)VALUES1$1 + (I$3 << (3 & 31)));
				*(struct $8FBSYMBOL**)((uint8*)LABELS$1 + (I$3 << (2 & 31))) = *(struct $8FBSYMBOL**)((uint8*)LABELS1$1 + (I$3 << (2 & 31)));
			}
			label$33:;
			I$3 = I$3 + 1;
			label$32:;
			if( I$3 <= TMP$83$3 ) goto label$35;
			label$34:;
		}
	}
	goto label$30;
	...
	{
		VALUES$1 = (uint64*)0u;
		LABELS$1 = (struct $8FBSYMBOL**)0u;
	}
	label$30:;
	struct $7ASTNODE* vr$15 = ASTNEWNODE( 8, -2147483648u, (struct $8FBSYMBOL*)0u );
	N$1 = vr$15;
	*(struct $7ASTNODE**)((uint8*)N$1 + 64) = L$1;
	*(struct $8FBSYMBOL**)((uint8*)N$1 + 12) = TBSYM$1;
	*(uint64**)((uint8*)N$1 + 24) = VALUES$1;
	*(struct $8FBSYMBOL***)((uint8*)N$1 + 28) = LABELS$1;
	*(int32*)((uint8*)N$1 + 32) = LABELCOUNT$1;
	*(struct $8FBSYMBOL**)((uint8*)N$1 + 36) = DEFLABEL$1;
	*(uint64*)((uint8*)N$1 + 40) = BIAS$1;
	*(uint64*)((uint8*)N$1 + 48) = SPAN$1;
	struct $7ASTNODE* vr$24 = ASTNEWLINK( TREE$1, N$1, 0 );
	fb$result$1 = vr$24;
	label$29:;
	return fb$result$1;
}

static int64 HPRECALCBIASOFFSET( uint64 BIAS$1, int32 DTYPE$1 )
{
	int64 fb$result$1;
	...
	*(int32*)((uint8*)&AST$ + 232) = *(int32*)((uint8*)&AST$ + 232) + 1;
	struct $7ASTNODE* T$1;
	struct $7ASTNODE* vr$2 = ASTNEWCONSTI( (int64)BIAS$1, DTYPE$1, (struct $8FBSYMBOL*)0u );
	T$1 = vr$2;
	struct $7ASTNODE* vr$3 = ASTNEWUOP( 54, T$1 );
	T$1 = vr$3;
	struct $7ASTNODE* vr$5 = ASTNEWCONSTI( (int64)*(int32*)((uint8*)&ENV$ + 296), DTYPE$1, (struct $8FBSYMBOL*)0u );
	struct $7ASTNODE* vr$6 = ASTNEWBOP( 30, T$1, vr$5, (struct $8FBSYMBOL*)0u, 1 );
	T$1 = vr$6;
	int64 vr$7 = ASTCONSTFLUSHTOINT( T$1, 11 );
	fb$result$1 = vr$7;
	*(int32*)((uint8*)&AST$ + 232) = *(int32*)((uint8*)&AST$ + 232) + -1;
	label$41:;
	return fb$result$1;
