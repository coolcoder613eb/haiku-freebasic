...
struct $7ASTNODE* CMATHFUNCT( $8FB_TOKEN TK$1, int32 ISASM$1 )
{
	...
	fb$result$1 = (struct $7ASTNODE*)0u;
	{
		...
		if( (TMP$103$2 - 448u) > 18u ) goto label$85;
		goto *tmp$104[TMP$103$2 - 448u];
		label$85:;
	}
	label$84:;
	return fb$result$1;
...
static struct $7ASTNODE* HLEN( struct $7ASTNODE* EXPR$1, int64* LGT$1 )
{
	...
	{
		int32 TMP$93$2;
		TMP$93$2 = *(int32*)((uint8*)EXPR$1 + 4) & 511;
		if( TMP$93$2 != 17 ) goto label$37;
		label$38:;
		{
		...
		label$44:;
		{
			...
			label$45:;
			TMP$94$3 = 0;
			uint32* vr$13 = HUNESCAPEW( *(uint32**)((uint8*)LITSYM$1 + 56), &TMP$94$3 );
			int32 vr$14 = fb_WstrLen( (uint32*)vr$13 );
			*LGT$1 = (int64)vr$14;
		}
		goto label$36;
		label$43:;
		if( TMP$93$2 != 18 ) goto label$47;
		label$48:;
		{
			int32 TMP$95$3;
			TMP$95$3 = 0;
			int64 vr$18 = ASTSIZEOF( EXPR$1, &TMP$95$3 );
			*LGT$1 = vr$18 + -1ll;
		}
		goto label$36;
		label$47:;
		if( TMP$93$2 != 20 ) goto label$49;
		label$50:;
		{
			int32 TMP$96$3;
			struct $7ASTNODE* vr$21 = ASTNEWUOP( 73, EXPR$1 );
			LENEXPR$1 = vr$21;
			...
			label$51:;
			TMP$96$3 = 0;
			int64 vr$23 = ASTSIZEOF( EXPR$1, &TMP$96$3 );
			*LGT$1 = vr$23;
		}
		goto label$36;
		label$49:;
		{
			int32 TMP$97$3;
			TMP$97$3 = 0;
			int64 vr$26 = ASTSIZEOF( EXPR$1, &TMP$97$3 );
			*LGT$1 = vr$26;
		}
		label$53:;
		label$36:;
...
static struct $7ASTNODE* HLENSIZEOF( int32 TK$1, int32 ISASM$1 )
{
	...
	goto label$58;
	label$59:;
	if( TK$1 != 466 ) goto label$62;
	{
		struct $8FBSYMBOL* TMP$99$2;
		int32 IS_FIXLENSTR$2;
		__builtin_memset( &IS_FIXLENSTR$2, 0, 4 );
		TMP$99$2 = (struct $8FBSYMBOL*)0u;
		CUDTTYPEMEMBER( &DTYPE$1, &SUBTYPE$1, &LGT$1, &IS_FIXLENSTR$2, &TMP$99$2 );
	}
	goto label$58;
	label$62:;
	if( TK$1 != 465 ) goto label$63;
	{
		struct $8FBSYMBOL* TMP$100$2;
		int32 IS_FIXLENSTR$2;
		__builtin_memset( &IS_FIXLENSTR$2, 0, 4 );
		TMP$100$2 = (struct $8FBSYMBOL*)0u;
		CUDTTYPEMEMBER( &DTYPE$1, &SUBTYPE$1, &LGT$1, &IS_FIXLENSTR$2, &TMP$100$2 );
		if( IS_FIXLENSTR$2 == 0 ) goto label$65;
		{
			{
				int32 TMP$101$4;
				TMP$101$4 = DTYPE$1 & 511;
				if( TMP$101$4 == 4 ) goto label$68;
				label$69:;
				if( TMP$101$4 == 17 ) goto label$68;
				label$70:;
				if( TMP$101$4 != 18 ) goto label$67;
				label$68:;
				{
					LGT$1 = LGT$1 - (int64)*(int32*)((int32)(struct $13SYMB_DATATYPE*)SYMB_DTYPETB$ + 116);
					LGT$1 = fb_D2L( (double)LGT$1 / (double)*(int32*)((int32)(struct $13SYMB_DATATYPE*)SYMB_DTYPETB$ + 116) );
				}
				goto label$66;
				label$67:;
				if( TMP$101$4 != 7 ) goto label$71;
				label$72:;
				{
					LGT$1 = LGT$1 - (int64)*(int32*)((int32)(struct $13SYMB_DATATYPE*)SYMB_DTYPETB$ + 200);
					LGT$1 = fb_D2L( (double)LGT$1 / (double)*(int32*)((int32)(struct $13SYMB_DATATYPE*)SYMB_DTYPETB$ + 200) );
				}
				label$71:;
				label$66:;
			}
	...
	{
		if( TK$1 != 465 ) goto label$80;
		{
			struct $7ASTNODE* vr$36 = HLEN( EXPR$1, &LGT$1 );
			EXPR$1 = vr$36;
			if( EXPR$1 != (struct $7ASTNODE*)0u ) goto label$82;
			{
				struct $7ASTNODE* vr$37 = ASTNEWCONSTI( LGT$1, 8, (struct $8FBSYMBOL*)0u );
				EXPR$1 = vr$37;
			}
			label$82:;
			label$81:;
		...
		label$80:;
		{
			int32 TMP$102$3;
			TMP$102$3 = 0;
			int64 vr$39 = ASTSIZEOF( EXPR$1, &TMP$102$3 );
			LGT$1 = vr$39;
			ASTDELTREE( EXPR$1 );
			struct $7ASTNODE* vr$40 = ASTNEWCONSTI( LGT$1, 8, (struct $8FBSYMBOL*)0u );
			EXPR$1 = vr$40;
		}
		label$79:;
	}
	...
	label$78:;
	{
		struct $7ASTNODE* vr$41 = ASTNEWCONSTI( LGT$1, 8, (struct $8FBSYMBOL*)0u );
		EXPR$1 = vr$41;
	}
	label$77:;
	fb$result$1 = EXPR$1;
