...
void CNAMESPACESTMTBEGIN( void )
{
	...
	int32 LEVELS$1;
	if( (*(int32*)((uint8*)&ENV$ + 1040) & 4) != 0 ) goto label$17;
	{
		ERRREPORTNOTALLOWED( 4, 146, (uint8*)0u );
		HSKIPCOMPOUND( 286, -1, 0 );
		goto label$15;
	}
	label$17:;
	label$16:;
	int32 vr$1 = CCOMPSTMTISALLOWED( 4 );
	...
	PALIAS$1 = (uint8*)0u;
	{
		...
		label$22:;
		{
			struct $13FB_CMPSTMTSTK* vr$3 = CCOMPSTMTPUSH( 286, -50 );
			STK$1 = vr$3;
			NAMESPACEBEGIN( STK$1, (struct $8FBSYMBOL*)0u );
			goto label$15;
		}
		goto label$20;
		label$21:;
		...
		if( (TMP$92$2 - 256u) > 4u ) goto label$20;
		goto *tmp$94[TMP$92$2 - 256u];
		label$20:;
	}
	LEVELS$1 = 0;
	label$23:;
	{
		if( (*(int32*)((uint8*)&PARSER$ + 88) + LEVELS$1) < 64 ) goto label$27;
		{
		...
		LEVELS$1 = LEVELS$1 + 1;
		{
			...
			goto label$28;
			label$29:;
			if( TMP$93$3 != 2 ) goto label$31;
			label$32:;
			{
				if( *(struct $8FBSYMBOL**)((uint8*)&SYMB$ + 98536) != (struct $8FBSYMBOL*)((uint8*)&SYMB$ + 98352) ) goto label$34;
				{
				...
				label$34:;
				{
					...
					fb_StrAssign( (void*)ID$1, 129, (void*)vr$11, 0, 0 );
					CHAIN_$1 = *(struct $10FBSYMCHAIN**)((uint8*)*(struct $7FBTOKEN**)((uint8*)*(struct $9LEX_TKCTX**)((uint8*)&LEX$ + 840072) + 16548) + 4116);
				}
				label$33:;
			}
		...
		if( CHAIN_$1 == (struct $10FBSYMCHAIN*)0u ) goto label$37;
		{
			SYM$1 = *(struct $8FBSYMBOL**)CHAIN_$1;
			if( *(int32*)SYM$1 == 8 ) goto label$39;
			{
				ERRREPORTEX( 4, (uint8*)ID$1, 0, 1, (uint8*)0u );
				uint8* vr$16 = SYMBUNIQUELABEL(  );
				fb_StrAssign( (void*)ID$1, 129, (void*)vr$16, 0, 0 );
				SYM$1 = (struct $8FBSYMBOL*)0u;
			}
			goto label$38;
			label$39:;
			{
				if( *(struct $8FBHASHTB**)((uint8*)SYM$1 + 144) == *(struct $8FBHASHTB**)((uint8*)&SYMB$ + 98540) ) goto label$41;
				{
					SYM$1 = (struct $8FBSYMBOL*)0u;
				}
				label$41:;
		...
		label$36:;
		if( (int32)*(uint8*)ID$1 == 0 ) goto label$43;
		{
			LEXSKIPTOKEN( 2112 );
		}
		label$43:;
		...
		{
			if( LEVELS$1 != 1 ) goto label$47;
			{
				uint8* vr$19 = CALIASATTRIBUTE(  );
				PALIAS$1 = vr$19;
			}
			label$47:;
			label$46:;
			struct $8FBSYMBOL* vr$20 = SYMBADDNAMESPACE( (uint8*)ID$1, PALIAS$1 );
			SYM$1 = vr$20;
			if( SYM$1 != (struct $8FBSYMBOL*)0u ) goto label$49;
			{
				ERRREPORTEX( 4, (uint8*)ID$1, 0, 1, (uint8*)0u );
			}
			label$49:;
		...
		label$45:;
		label$44:;
		struct $13FB_CMPSTMTSTK* vr$21 = CCOMPSTMTPUSH( 286, -34 );
		STK$1 = vr$21;
		NAMESPACEBEGIN( STK$1, SYM$1 );
		if( PALIAS$1 == (uint8*)0u ) goto label$51;
		{
			goto label$24;
		}
		label$51:;
	...
	goto label$23;
	label$24:;
	*(int32*)((uint8*)STK$1 + 20) = LEVELS$1;
	*(int32*)((uint8*)&PARSER$ + 88) = *(int32*)((uint8*)&PARSER$ + 88) + LEVELS$1;
	label$15:;
}
...
void CNAMESPACESTMTEND( void )
{
	...
	struct $13FB_CMPSTMTSTK* STK$1;
	int32 LEVELS$1;
	struct $13FB_CMPSTMTSTK* vr$0 = CCOMPSTMTGETTOS( 286, -1 );
	STK$1 = vr$0;
	if( STK$1 != (struct $13FB_CMPSTMTSTK*)0u ) goto label$57;
	{
		HSKIPUNTIL( -1, 0, 0, 0 );
		goto label$55;
	}
	...
	LEXSKIPTOKEN( 2048 );
	LEXSKIPTOKEN( 2048 );
	LEVELS$1 = *(int32*)((uint8*)STK$1 + 20);
	*(int32*)((uint8*)&PARSER$ + 88) = *(int32*)((uint8*)&PARSER$ + 88) - LEVELS$1;
	label$58:;
	if( LEVELS$1 <= 0 ) goto label$59;
	{
		SYMBNESTEND( 0 );
		struct $8FBSYMBOL* NS$2;
		NS$2 = *(struct $8FBSYMBOL**)((uint8*)STK$1 + 16);
		*(int32*)((uint8*)NS$2 + 96) = *(int32*)((uint8*)NS$2 + 96) + 1;
		if( *(int32*)((uint8*)NS$2 + 96) <= 1 ) goto label$61;
		{
			SYMBNAMESPACEREIMPORT( NS$2 );
		}
		label$61:;
		label$60:;
		*(struct $8FBSYMBOL**)((uint8*)NS$2 + 100) = *(struct $8FBSYMBOL**)((uint8*)NS$2 + 64);
		CCOMPSTMTPOP( STK$1 );
		struct $13FB_CMPSTMTSTK* vr$10 = CCOMPSTMTGETTOS( 286, 0 );
		STK$1 = vr$10;
		if( STK$1 != (struct $13FB_CMPSTMTSTK*)0u ) goto label$63;
		{
			goto label$59;
		}
		label$63:;
...
void CUSINGSTMT( void )
{
	label$64:;
	struct $8FBSYMBOL* SYM$1;
	if( (*(int32*)((uint8*)&ENV$ + 1040) & 4) != 0 ) goto label$67;
	{
		ERRREPORTNOTALLOWED( 4, 146, (uint8*)0u );
		HSKIPUNTIL( -1, 0, 0, 0 );
		goto label$65;
	...
	label$68:;
	{
		struct $8FBSYMBOL* vr$1 = CPARENTID( 1 );
		SYM$1 = vr$1;
		if( SYM$1 != (struct $8FBSYMBOL*)0u ) goto label$72;
		{
			int32 vr$2 = LEXGETTOKEN( 0 );
			if( vr$2 == 265 ) goto label$74;
			{
				ERRREPORT( 14, 0, (uint8*)0u );
			}
			goto label$73;
		...
		label$72:;
		{
			if( *(int32*)SYM$1 == 8 ) goto label$76;
			{
...
static void NAMESPACEBEGIN( struct $13FB_CMPSTMTSTK* STK$1, struct $8FBSYMBOL* SYM$1 )
{
	...
	if( SYM$1 != (struct $8FBSYMBOL*)0u ) goto label$13;
	{
		...
		struct $8FBSYMBOL* vr$1 = SYMBADDNAMESPACE( vr$0, (uint8*)0u );
		SYM$1 = vr$1;
	}
	label$13:;
	label$12:;
	*(struct $8FBSYMBOL**)((uint8*)STK$1 + 16) = SYM$1;
	*(int32*)((uint8*)STK$1 + 20) = 1;
