...
void RTLERRORTHROW( struct $7ASTNODE* ERREXPR$1, int32 LINENUM$1, uint8* MODULE$1 )
{
	...
	struct $8FBSYMBOL* NXTLABEL$1;
	struct $8FBSYMBOL* RESLABEL$1;
	struct $8FBSYMBOL* vr$0 = RTLPROCLOOKUP( (uint8*)"fb_ErrorThrowEx", 293 );
...
void RTLERRORSETHANDLER( struct $7ASTNODE* NEWHANDLER$1, int32 SAVECURRENT$1 )
{
	...
	struct $8FBSYMBOL* vr$0 = RTLPROCLOOKUP( (uint8*)"fb_ErrorSetHandler", 294 );
	struct $7ASTNODE* vr$1 = ASTNEWCALL( vr$0, (struct $7ASTNODE*)0u );
	PROC$1 = vr$1;
	...
	{
		if( *(struct $8FBSYMBOL**)((uint8*)&PARSER$ + 108) == *(struct $8FBSYMBOL**)((uint8*)&ENV$ + 1032) ) goto label$49;
		{
			{
				struct $10FB_PROCERR* TMP$113$4;
				TMP$113$4 = (struct $10FB_PROCERR*)((uint8*)*(struct $10FB_PROCEXT**)((uint8*)*(struct $8FBSYMBOL**)((uint8*)&PARSER$ + 108) + 112) + 28);
				if( *(struct $8FBSYMBOL**)TMP$113$4 != (struct $8FBSYMBOL*)0u ) goto label$51;
				{
					struct $8FBSYMBOL* vr$7 = SYMBADDTEMPVAR( 32, (struct $8FBSYMBOL*)0u );
					*(struct $8FBSYMBOL**)TMP$113$4 = vr$7;
					struct $7ASTNODE* vr$10 = ASTNEWVAR( *(struct $8FBSYMBOL**)TMP$113$4, 0ll, -2147483648u, (struct $8FBSYMBOL*)0u );
					EXPR$1 = vr$10;
...
struct $7ASTNODE* RTLERRORGETNUM( void )
{
	...
	__builtin_memset( &fb$result$1, 0, 4 );
	label$54:;
	struct $8FBSYMBOL* vr$1 = RTLPROCLOOKUP( (uint8*)"fb_ErrorGetNum", 295 );
...
void RTLERRORSETNUM( struct $7ASTNODE* ERREXPR$1 )
{
	label$56:;
	struct $7ASTNODE* PROC$1;
	struct $8FBSYMBOL* vr$0 = RTLPROCLOOKUP( (uint8*)"fb_ErrorSetNum", 296 );
	struct $7ASTNODE* vr$1 = ASTNEWCALL( vr$0, (struct $7ASTNODE*)0u );
	PROC$1 = vr$1;
...
void RTLERRORRESUME( int32 ISNEXT$1 )
{
	...
	{
		struct $8FBSYMBOL* vr$0 = RTLPROCLOOKUP( (uint8*)"fb_ErrorResume", 297 );
		F$1 = vr$0;
	}
	goto label$62;
	label$63:;
	{
		struct $8FBSYMBOL* vr$1 = RTLPROCLOOKUP( (uint8*)"fb_ErrorResumeNext", 298 );
		F$1 = vr$1;
	}
	label$62:;
...
struct $7ASTNODE* RTLERRORSETMODNAME( struct $8FBSYMBOL* SYM$1, struct $7ASTNODE* MODNAME$1 )
{
	...
	struct $7ASTNODE* PROC$1;
	struct $7ASTNODE* EXPR$1;
	struct $8FBSYMBOL* vr$1 = RTLPROCLOOKUP( (uint8*)"fb_ErrorSetModName", 299 );
	struct $7ASTNODE* vr$2 = ASTNEWCALL( vr$1, (struct $7ASTNODE*)0u );
	PROC$1 = vr$2;
	...
	{
		{
			...
			TMP$114$3 = (struct $10FB_PROCERR*)((uint8*)*(struct $10FB_PROCEXT**)((uint8*)SYM$1 + 112) + 28);
			struct $8FBSYMBOL* vr$7 = SYMBADDTEMPVAR( 36, (struct $8FBSYMBOL*)0u );
			*(struct $8FBSYMBOL**)((uint8*)TMP$114$3 + 4) = vr$7;
			struct $7ASTNODE* vr$10 = ASTNEWVAR( *(struct $8FBSYMBOL**)((uint8*)TMP$114$3 + 4), 0ll, -2147483648u, (struct $8FBSYMBOL*)0u );
			EXPR$1 = vr$10;
			struct $7ASTNODE* vr$11 = ASTNEWASSIGN( EXPR$1, PROC$1, 0 );
			fb$result$1 = vr$11;
		}
...
struct $7ASTNODE* RTLERRORSETFUNCNAME( struct $8FBSYMBOL* SYM$1, struct $7ASTNODE* FUNCNAME$1 )
{
	...
	struct $7ASTNODE* PROC$1;
	struct $7ASTNODE* EXPR$1;
	struct $8FBSYMBOL* vr$1 = RTLPROCLOOKUP( (uint8*)"fb_ErrorSetFuncName", 300 );
	struct $7ASTNODE* vr$2 = ASTNEWCALL( vr$1, (struct $7ASTNODE*)0u );
	PROC$1 = vr$2;
	...
	{
		{
			...
			struct $8FBSYMBOL* vr$7 = SYMBADDTEMPVAR( 36, (struct $8FBSYMBOL*)0u );
			*(struct $8FBSYMBOL**)((uint8*)TMP$115$3 + 8) = vr$7;
			struct $7ASTNODE* vr$10 = ASTNEWVAR( *(struct $8FBSYMBOL**)((uint8*)TMP$115$3 + 8), 0ll, -2147483648u, (struct $8FBSYMBOL*)0u );
			EXPR$1 = vr$10;
			struct $7ASTNODE* vr$11 = ASTNEWASSIGN( EXPR$1, PROC$1, 0 );
			fb$result$1 = vr$11;
		}
...
static struct $7ASTNODE* HERRORTHROW( struct $8FBSYMBOL* RESLABEL$1, struct $8FBSYMBOL* NXTLABEL$1 )
{
	...
	struct $7ASTNODE* PROC$1;
	struct $7ASTNODE* PARAM$1;
	struct $8FBSYMBOL* vr$1 = RTLPROCLOOKUP( (uint8*)"fb_ErrorThrowAt", 292 );
	struct $7ASTNODE* vr$2 = ASTNEWCALL( vr$1, (struct $7ASTNODE*)0u );
	PROC$1 = vr$2;
	struct $7ASTNODE* vr$5 = ASTNEWCONSTI( (int64)*(int32*)((uint8*)*(struct $9LEX_TKCTX**)((uint8*)&LEX$ + 840072) + 16568), 8, (struct $8FBSYMBOL*)0u );
	ASTNEWARG( PROC$1, vr$5, -2147483648u, -1 );
	struct $7ASTNODE* vr$7 = ASTNEWCONSTSTR( (uint8*)((uint8*)&ENV$ + 304) );
