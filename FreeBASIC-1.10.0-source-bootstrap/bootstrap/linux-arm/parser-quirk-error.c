...
static void fb_ctor__parserzquirkzerror( void ) __attribute__(( constructor ));
...
int32 CERRORSTMT( void )
{
	...
	label$13:;
	label$12:;
	RTLERRORTHROW( EXPR$1, *(int32*)((uint8*)*(struct $9LEX_TKCTX**)((uint8*)&LEX$ + 840072) + 16568), (uint8*)((uint8*)&ENV$ + 304) );
	fb$result$1 = -1;
	label$11:;
	return fb$result$1;
}
...
struct $7ASTNODE* CERRORFUNCT( void )
{
	...
	if( vr$1 == 0 ) goto label$23;
	{
		int32 vr$2 = LEXGETTOKEN( 0 );
		if( vr$2 == 41 ) goto label$25;
		{
	...
	label$23:;
	label$22:;
	struct $7ASTNODE* vr$3 = RTLERRORGETNUM(  );
	fb$result$1 = vr$3;
	label$21:;
	return fb$result$1;
}
