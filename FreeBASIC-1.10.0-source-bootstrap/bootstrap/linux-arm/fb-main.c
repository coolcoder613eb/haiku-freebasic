...
{
	label$24:;
	if( *(int32*)((uint8*)&ENV$ + 852) == 0 ) goto label$27;
	{
		HMAINBEGIN(  );
	}
	goto label$26;
	...
	label$26:;
	if( (*(int32*)((uint8*)&ENV$ + 852) & -(*(int32*)((uint8*)&ENV$ + 96) == 2)) == 0 ) goto label$29;
	{
...
void FBMAINEND( void )
{
	...
	int32 CALLRTEXIT$1;
	CALLRTEXIT$1 = 0;
	if( *(int32*)((uint8*)&ENV$ + 852) == 0 ) goto label$35;
	{
		if( *(struct $8FBSYMBOL**)((uint8*)&AST$ + 124) == (struct $8FBSYMBOL*)0u ) goto label$37;
		{
			RTLDATARESTORE( (struct $8FBSYMBOL*)0u, *(struct $7ASTNODE**)((uint8*)&ENV$ + 1036) );
		}
		label$37:;
		label$36:;
...
static void HCALLMAIN( void )
{
	...
	struct $7ASTNODE* vr$0 = ASTNEWCALL( *(struct $8FBSYMBOL**)((uint8*)&ENV$ + 1032), (struct $7ASTNODE*)0u );
	MAIN$1 = vr$0;
...
static void HBUILDDLLMAINWIN32( void )
{
	...
	struct $8FBSYMBOL* vr$2 = SYMBADDPROC( PROC$1, (uint8*)0u, (uint8*)"DllMain", 8, (struct $8FBSYMBOL*)0u, 32, 0, *(int32*)((uint8*)&ENV$ + 280), 4 );
	PROC$1 = vr$2;
...
static void HMAINBEGIN( void )
{
	...
	*(struct $8FBSYMBOL**)((uint8*)&ENV$ + 1032) = vr$9;
	*($12FB_SYMBSTATS*)((uint8*)*(struct $8FBSYMBOL**)((uint8*)&ENV$ + 1032) + 12) = *(int32*)((uint8*)*(struct $8FBSYMBOL**)((uint8*)&ENV$ + 1032) + 12) | 4096;
	ASTPROCBEGIN( *(struct $8FBSYMBOL**)((uint8*)&ENV$ + 1032), -1 );
...
static void HMODLEVELBEGIN( void )
{
	...
	fb_StrAssign( (void*)&TMP$91$1, -1, (void*)vr$1, -1, 0 );
	struct $8FBSYMBOL* vr$3 = SYMBPREADDPROC( (uint8*)0u );
	struct $8FBSYMBOL* vr$4 = SYMBADDPROC( vr$3, (uint8*)"{modlevel}", (uint8*)*(uint8**)&TMP$91$1, 0, (struct $8FBSYMBOL*)0u, 64, 0, 3, 4 );
	*(struct $8FBSYMBOL**)((uint8*)&ENV$ + 1032) = vr$4;
	fb_StrDelete( (FBSTRING*)&TMP$91$1 );
	SYMBADDGLOBALCTOR( *(struct $8FBSYMBOL**)((uint8*)&ENV$ + 1032) );
	*($12FB_SYMBSTATS*)((uint8*)*(struct $8FBSYMBOL**)((uint8*)&ENV$ + 1032) + 12) = *(int32*)((uint8*)*(struct $8FBSYMBOL**)((uint8*)&ENV$ + 1032) + 12) | 2;
	*($12FB_SYMBSTATS*)((uint8*)*(struct $8FBSYMBOL**)((uint8*)&ENV$ + 1032) + 12) = *(int32*)((uint8*)*(struct $8FBSYMBOL**)((uint8*)&ENV$ + 1032) + 12) | 8192;
	ASTPROCBEGIN( *(struct $8FBSYMBOL**)((uint8*)&ENV$ + 1032), -1 );
	label$23:;
}
