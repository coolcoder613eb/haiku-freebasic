...
int64 ASTGETOFFSETCHILDOFS( struct $7ASTNODE* L$1 )
{
	...
	label$10:;
	if( *(int32*)L$1 != 17 ) goto label$13;
	{
		fb$result$1 = *(int64*)((uint8*)L$1 + 24);
	}
	goto label$12;
	label$13:;
	{
		fb$result$1 = ((*(int64*)((uint8*)L$1 + 24) + *(int64*)((uint8*)*(struct $7ASTNODE**)((uint8*)L$1 + 68) + 24)) + *(int64*)((uint8*)*(struct $8FBSYMBOL**)((uint8*)L$1 + 12) + 72)) + *(int64*)((uint8*)*(struct $8FBSYMBOL**)((uint8*)L$1 + 12) + 48);
	}
	label$12:;
	label$11:;
	return fb$result$1;
...
struct $6IRVREG* ASTLOADOFFSET( struct $7ASTNODE* N$1 )
{
	...
	if( SYM$1 == (struct $8FBSYMBOL*)0u ) goto label$23;
	{
		*($12FB_SYMBSTATS*)((uint8*)SYM$1 + 12) = *(int32*)((uint8*)SYM$1 + 12) | 2;
	}
	label$23:;
	label$22:;
	if( *(int32*)((uint8*)&AST$ + 136) == 0 ) goto label$25;
	{
		struct $6IRVREG* vr$8 = (*(tmp$71*)((uint8*)&IR$ + 248))( *(int32*)((uint8*)N$1 + 4), *(struct $8FBSYMBOL**)((uint8*)N$1 + 8), SYM$1, *(int64*)((uint8*)N$1 + 24) );
		VR$1 = vr$8;
	}
	label$25:;
	label$24:;
	L$1 = *(struct $7ASTNODE**)((uint8*)N$1 + 64);
	if( *(int32*)L$1 != 18 ) goto label$27;
	{
		ASTDELNODE( *(struct $7ASTNODE**)((uint8*)L$1 + 64) );
		ASTDELNODE( *(struct $7ASTNODE**)((uint8*)L$1 + 68) );
	}
	label$27:;
	label$26:;
	ASTDELNODE( L$1 );
...
struct $7ASTNODE* ASTNEWADDROF( struct $7ASTNODE* L$1 )
{
	...
	if( L$1 != (struct $7ASTNODE*)0u ) goto label$49;
	{
	...
	{
		$13AST_NODECLASS TMP$84$2;
		TMP$84$2 = *($13AST_NODECLASS*)T$1;
		if( TMP$84$2 != 20 ) goto label$51;
		label$52:;
		{
			if( *(int32*)((uint8*)&ENV$ + 176) == 0 ) goto label$54;
			{
				HREMOVENULLPTRCHECK( T$1 );
			}
			label$54:;
			label$53:;
			if( *(struct $7ASTNODE**)((uint8*)T$1 + 64) == (struct $7ASTNODE*)0u ) goto label$56;
			{
				if( *(int64*)((uint8*)T$1 + 24) != 0ll ) goto label$58;
				{
					N$1 = *(struct $7ASTNODE**)((uint8*)T$1 + 64);
					ASTDELNODE( T$1 );
				}
				label$58:;
				label$57:;
			...
			label$56:;
			{
				struct $7ASTNODE* vr$7 = ASTNEWCONSTI( *(int64*)((uint8*)T$1 + 24), 8, (struct $8FBSYMBOL*)0u );
				N$1 = vr$7;
				ASTDELNODE( T$1 );
			}
			label$55:;
		...
		goto label$50;
		label$51:;
		if( TMP$84$2 != 19 ) goto label$59;
		label$60:;
		{
			if( *(int32*)*(struct $7ASTNODE**)((uint8*)T$1 + 64) != 20 ) goto label$62;
			{
				if( *(int32*)((uint8*)&ENV$ + 176) == 0 ) goto label$64;
				{
					HREMOVENULLPTRCHECK( *(struct $7ASTNODE**)((uint8*)T$1 + 64) );
				}
				label$64:;
				label$63:;
				if( *(struct $7ASTNODE**)((uint8*)*(struct $7ASTNODE**)((uint8*)T$1 + 64) + 64) != (struct $7ASTNODE*)0u ) goto label$66;
				{
					struct $7ASTNODE* vr$15 = ASTNEWCONSTI( *(int64*)((uint8*)*(struct $7ASTNODE**)((uint8*)T$1 + 64) + 24), 8, (struct $8FBSYMBOL*)0u );
					N$1 = vr$15;
					ASTDELNODE( *(struct $7ASTNODE**)((uint8*)T$1 + 64) );
					ASTDELNODE( T$1 );
				}
				label$66:;
				label$65:;
		...
		goto label$50;
		label$59:;
		if( TMP$84$2 != 17 ) goto label$67;
		label$68:;
		{
			struct $8FBSYMBOL* S$3;
			S$3 = *(struct $8FBSYMBOL**)((uint8*)T$1 + 12);
			if( S$3 == (struct $8FBSYMBOL*)0u ) goto label$70;
			{
				if( (-((*(int32*)((uint8*)S$3 + 4) & 128) == 0) | -((*(int32*)((uint8*)S$3 + 4) & 11) != 0)) == 0 ) goto label$72;
				{
		...
		label$74:;
		{
			if( T$1 == L$1 ) goto label$76;
			{
				...
				T$1 = vr$26;
				*(struct $7ASTNODE**)((uint8*)L$1 + 64) = T$1;
			}
			goto label$75;
			label$76:;
			{
			...
			label$75:;
			if( *(struct $7ASTNODE**)((uint8*)T$1 + 64) != (struct $7ASTNODE*)0u ) goto label$78;
			{
				struct $8FBSYMBOL* S$4;
				S$4 = *(struct $8FBSYMBOL**)((uint8*)T$1 + 12);
				if( (-((*(int32*)((uint8*)S$4 + 4) & 128) == 0) | -((*(int32*)((uint8*)S$4 + 4) & 11) != 0)) == 0 ) goto label$80;
				{
					if( (*(int32*)((uint8*)S$4 + 4) & 16388) != 0 ) goto label$82;
					{
	...
	DTYPE$1 = (((*(int32*)((uint8*)L$1 + 4) & 31) | ((*(int32*)((uint8*)L$1 + 4) & 480) + 32)) | ((*(int32*)((uint8*)L$1 + 4) & 261632) << (1 & 31))) | (*(int32*)((uint8*)L$1 + 4) & 32505856);
	SUBTYPE$1 = *(struct $8FBSYMBOL**)((uint8*)L$1 + 8);
	if( N$1 == (struct $7ASTNODE*)0u ) goto label$84;
	{
		...
		label$86:;
		label$85:;
		struct $7ASTNODE* vr$55 = ASTNEWCONV( DTYPE$1, SUBTYPE$1, N$1, 24, (int32*)0u );
		fb$result$1 = vr$55;
		goto label$47;
	}
	label$84:;
	label$83:;
	struct $7ASTNODE* vr$56 = ASTNEWNODE( 6, DTYPE$1, SUBTYPE$1 );
	N$1 = vr$56;
	*(int32*)((uint8*)N$1 + 24) = 22;
...
struct $6IRVREG* ASTLOADADDROF( struct $7ASTNODE* N$1 )
{
	...
	struct $6IRVREG* V1$1;
	struct $6IRVREG* VR$1;
	P$1 = *(struct $7ASTNODE**)((uint8*)N$1 + 64);
	if( P$1 != (struct $7ASTNODE*)0u ) goto label$90;
	{
	...
	V1$1 = vr$2;
	if( *(int32*)((uint8*)&AST$ + 136) == 0 ) goto label$92;
	{
		int32 TMP$85$2;
		int32 TMP$86$2;
		if( (*(int32*)((uint8*)V1$1 + 4) & 480) == 0 ) goto label$93;
		TMP$85$2 = 24;
		goto label$97;
		label$93:;
		TMP$85$2 = *(int32*)((uint8*)V1$1 + 4) & 31;
		label$97:;
		if( (*(int32*)((uint8*)V1$1 + 4) & 480) == 0 ) goto label$94;
		TMP$86$2 = 24;
		goto label$98;
		label$94:;
		TMP$86$2 = *(int32*)((uint8*)V1$1 + 4) & 31;
		label$98:;
		if( ((-(*(int32*)V1$1 != 4) | -(*(int32*)((int32)(struct $13SYMB_DATATYPE*)SYMB_DTYPETB$ + (TMP$85$2 * 28)) != 0)) | -(*(int32*)(((int32)(struct $13SYMB_DATATYPE*)SYMB_DTYPETB$ + (TMP$86$2 * 28)) + 4) != *(int32*)((uint8*)&ENV$ + 296))) == 0 ) goto label$96;
		{
			struct $6IRVREG* vr$21 = (*(tmp$68*)((uint8*)&IR$ + 224))( *(int32*)((uint8*)N$1 + 4), *(struct $8FBSYMBOL**)((uint8*)N$1 + 8) );
			VR$1 = vr$21;
			(*(tmp$51*)((uint8*)&IR$ + 120))( 22, V1$1, VR$1 );
		}
		goto label$95;
		label$96:;
		{
...
static struct $7ASTNODE* ASTNEWOFFSET( struct $7ASTNODE* L$1 )
{
	...
	label$17:;
	label$16:;
	struct $7ASTNODE* vr$15 = ASTNEWNODE( 23, (((*(int32*)((uint8*)L$1 + 4) & 31) | ((*(int32*)((uint8*)L$1 + 4) & 480) + 32)) | ((*(int32*)((uint8*)L$1 + 4) & 261632) << (1 & 31))) | (*(int32*)((uint8*)L$1 + 4) & 32505856), *(struct $8FBSYMBOL**)((uint8*)L$1 + 8) );
	N$1 = vr$15;
	*(struct $7ASTNODE**)((uint8*)N$1 + 64) = L$1;
	*(struct $8FBSYMBOL**)((uint8*)N$1 + 12) = *(struct $8FBSYMBOL**)((uint8*)L$1 + 12);
	int64 vr$19 = ASTGETOFFSETCHILDOFS( L$1 );
	*(int64*)((uint8*)N$1 + 24) = vr$19;
	if( *(struct $8FBSYMBOL**)((uint8*)L$1 + 12) == (struct $8FBSYMBOL*)0u ) goto label$19;
	{
		*($12FB_SYMBSTATS*)((uint8*)*(struct $8FBSYMBOL**)((uint8*)L$1 + 12) + 12) = *(int32*)((uint8*)*(struct $8FBSYMBOL**)((uint8*)L$1 + 12) + 12) | 2;
	}
	label$19:;
	label$18:;
	fb$result$1 = N$1;
...
static void HREMOVENULLPTRCHECK( struct $7ASTNODE* L$1 )
{
	...
	if( N$1 != (struct $7ASTNODE*)0u ) goto label$31;
	{
		goto label$29;
	}
	label$31:;
	label$30:;
	{
		$13AST_NODECLASS TMP$82$2;
		TMP$82$2 = *($13AST_NODECLASS*)N$1;
		if( TMP$82$2 != 32 ) goto label$33;
		label$34:;
		{
			*(struct $7ASTNODE**)((uint8*)L$1 + 64) = *(struct $7ASTNODE**)((uint8*)N$1 + 64);
			ASTDELTREE( *(struct $7ASTNODE**)((uint8*)N$1 + 68) );
			ASTDELNODE( N$1 );
		}
		goto label$32;
		label$33:;
		if( TMP$82$2 != 3 ) goto label$35;
		label$36:;
		{
			label$37:;
			{
				...
				{
					$13AST_NODECLASS TMP$83$5;
					TMP$83$5 = *($13AST_NODECLASS*)T$1;
					if( TMP$83$5 != 32 ) goto label$41;
					label$42:;
					{
						*(struct $7ASTNODE**)((uint8*)N$1 + 64) = *(struct $7ASTNODE**)((uint8*)T$1 + 64);
						ASTDELTREE( *(struct $7ASTNODE**)((uint8*)T$1 + 68) );
						ASTDELNODE( T$1 );
						goto label$38;
					}
					goto label$40;
					label$41:;
					if( TMP$83$5 != 3 ) goto label$43;
					label$44:;
					{
						N$1 = T$1;
					}
