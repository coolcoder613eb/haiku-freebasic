...
struct $7ASTNODE* ASTNEWVAR( struct $8FBSYMBOL* SYM$1, int64 OFS$1, int32 DTYPE$1, struct $8FBSYMBOL* SUBTYPE$1 )
{
	...
	{
		{
			...
			goto label$14;
			label$15:;
			if( TMP$82$3 != 3 ) goto label$17;
			label$18:;
			{
				DTYPE$1 = 22;
				if( (*(int32*)((uint8*)SYM$1 + 12) & 16384) == 0 ) goto label$20;
				{
					SUBTYPE$1 = SYM$1;
				}
				goto label$19;
			...
			label$17:;
			{
				...
				if( ((-((*(int32*)((uint8*)SYM$1 + 4) & 65536) != 0) | -((*(int32*)((uint8*)SYM$1 + 4) & 512) != 0)) | -((*(int32*)((uint8*)SYM$1 + 4) & 262144) != 0)) == 0 ) goto label$23;
				{
	...
	label$13:;
	label$12:;
	struct $7ASTNODE* vr$27 = ASTNEWNODE( 17, DTYPE$1, SUBTYPE$1 );
	N$1 = vr$27;
	if( SYM$1 == (struct $8FBSYMBOL*)0u ) goto label$25;
	{
		if( (-(*(int32*)SYM$1 == 1) & -((*(int32*)((uint8*)SYM$1 + 4) & 4096) != 0)) == 0 ) goto label$27;
		{
	...
	*(int64*)((uint8*)N$1 + 24) = OFS$1;
	if( (DTYPE$1 & 511) != 1 ) goto label$29;
	{
		struct $7ASTNODE* vr$37 = ASTNEWCONV( DTYPE$1, (struct $8FBSYMBOL*)0u, N$1, 0, (int32*)0u );
		N$1 = vr$37;
	}
	label$29:;
	label$28:;
...
struct $6IRVREG* ASTLOADVAR( struct $7ASTNODE* N$1 )
{
	...
	if( S$1 == (struct $8FBSYMBOL*)0u ) goto label$33;
	{
		*($12FB_SYMBSTATS*)((uint8*)S$1 + 12) = *(int32*)((uint8*)S$1 + 12) | 2;
		OFS$1 = OFS$1 + *(int64*)((uint8*)S$1 + 48);
	}
	label$33:;
	label$32:;
	if( *(int32*)((uint8*)&AST$ + 136) == 0 ) goto label$35;
	{
		struct $6IRVREG* vr$10 = (*(tmp$71*)((uint8*)&IR$ + 236))( *(int32*)((uint8*)N$1 + 4), *(struct $8FBSYMBOL**)((uint8*)N$1 + 8), S$1, OFS$1 );
		VR$1 = vr$10;
