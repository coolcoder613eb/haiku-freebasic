...
struct $7ASTNODE* CFUNCTIONCALL( struct $8FBSYMBOL* BASE_PARENT$1, struct $8FBSYMBOL* SYM$1, struct $7ASTNODE* PTREXPR$1, struct $7ASTNODE* THISEXPR$1, $12FB_PARSEROPT OPTIONS$1 )
{
	...
	*(struct $11FB_CALL_ARG**)((uint8*)&ARG_LIST$1 + 8) = (struct $11FB_CALL_ARG*)0u;
	...
	label$13:;
	label$12:;
	OPTIONS$1 = OPTIONS$1 | 16;
	HMETHODCALLADDINSTPTROVLARG( SYM$1, THISEXPR$1, &ARG_LIST$1, &OPTIONS$1 );
	if( (*(int32*)((uint8*)SYM$1 + 8) & 32) == 0 ) goto label$15;
	{
		OPTIONS$1 = OPTIONS$1 | 128;
		int32 vr$7 = LEXGETTOKEN( 0 );
		if( vr$7 != 40 ) goto label$17;
		{
			if( (*(int32*)((uint8*)*(struct $8FBSYMBOL**)*(struct $10FBSYMBOLTB**)((uint8*)SYM$1 + 164) + 120) & 512) != 0 ) goto label$19;
			{
			...
			label$18:;
			LEXSKIPTOKEN( 0 );
			struct $7ASTNODE* vr$13 = CPROCARGLIST( BASE_PARENT$1, SYM$1, PTREXPR$1, &ARG_LIST$1, OPTIONS$1 );
			FUNCEXPR$1 = vr$13;
			int32 vr$14 = LEXGETTOKEN( 0 );
			if( vr$14 == 41 ) goto label$21;
			{
		...
		label$17:;
		{
			if( (*(int32*)((uint8*)*(struct $8FBSYMBOL**)*(struct $10FBSYMBOLTB**)((uint8*)SYM$1 + 164) + 120) & 128) != 0 ) goto label$23;
			{
				ERRREPORT( 194, 0, (uint8*)0u );
			}
			label$23:;
			label$22:;
			struct $7ASTNODE* vr$21 = CPROCARGLIST( BASE_PARENT$1, SYM$1, PTREXPR$1, &ARG_LIST$1, OPTIONS$1 | 32 );
			FUNCEXPR$1 = vr$21;
		}
		label$16:;
	}
	...
	label$15:;
	{
		...
		if( vr$22 != 40 ) goto label$25;
		{
			LEXSKIPTOKEN( 0 );
			struct $7ASTNODE* vr$24 = CPROCARGLIST( BASE_PARENT$1, SYM$1, PTREXPR$1, &ARG_LIST$1, OPTIONS$1 );
			FUNCEXPR$1 = vr$24;
			int32 vr$25 = LEXGETTOKEN( 0 );
			if( vr$25 == 41 ) goto label$27;
			{
				ERRREPORT( 7, 0, (uint8*)0u );
				HSKIPUNTIL( 41, -1, 0, 0 );
			}
		...
		label$25:;
		{
			struct $7ASTNODE* vr$28 = CPROCARGLIST( BASE_PARENT$1, SYM$1, PTREXPR$1, &ARG_LIST$1, OPTIONS$1 | 32 );
			FUNCEXPR$1 = vr$28;
		}
		label$24:;
	}
	label$14:;
	if( (*(int32*)((uint8*)FUNCEXPR$1 + 4) & 511) != 0 ) goto label$29;
	{
		ERRREPORT( 17, 0, (uint8*)0u );
		ASTDELTREE( FUNCEXPR$1 );
		struct $7ASTNODE* vr$31 = ASTNEWCONSTI( 0ll, 8, (struct $8FBSYMBOL*)0u );
		fb$result$1 = vr$31;
		goto label$11;
	}
	label$29:;
	label$28:;
	struct $7ASTNODE* vr$32 = ASTBUILDBYREFRESULTDEREF( FUNCEXPR$1 );
	FUNCEXPR$1 = vr$32;
	struct $7ASTNODE* vr$33 = CSTRIDXORMEMBERDEREF( FUNCEXPR$1 );
	fb$result$1 = vr$33;
	label$11:;
	return fb$result$1;
}
...
struct $7ASTNODE* CFUNCTIONEX( struct $8FBSYMBOL* BASE_PARENT$1, struct $8FBSYMBOL* SYM$1, $12FB_PARSEROPT OPTIONS$1 )
{
	...
	__builtin_memset( &fb$result$1, 0, 4 );
	label$30:;
	if( (*(int32*)((uint8*)SYM$1 + 4) & 1048576) == 0 ) goto label$33;
	if( (*(int32*)((uint8*)SYM$1 + 12) & 32) == 0 ) goto label$32;
	TMP$92$1 = 8192;
	goto label$35;
	label$32:;
	TMP$92$1 = 4096;
	...
	TMP$93$1 = 2048;
	label$34:;
	LEXSKIPTOKEN( TMP$93$1 );
	struct $7ASTNODE* vr$5 = CFUNCTIONCALL( BASE_PARENT$1, SYM$1, (struct $7ASTNODE*)0u, (struct $7ASTNODE*)0u, OPTIONS$1 );
	fb$result$1 = vr$5;
	label$31:;
	return fb$result$1;
}
...
struct $7ASTNODE* CMETHODCALL( struct $8FBSYMBOL* SYM$1, struct $7ASTNODE* THISEXPR$1, $12FB_PARSEROPT OPTIONS$1 )
{
	...
	LEXSKIPTOKEN( 4096 );
	if( (*(int32*)((uint8*)&PARSER$ + 152) & 4) == 0 ) goto label$39;
	{
		struct $7ASTNODE* vr$2 = CFUNCTIONCALL( (struct $8FBSYMBOL*)0u, SYM$1, (struct $7ASTNODE*)0u, THISEXPR$1, OPTIONS$1 );
		EXPR$1 = vr$2;
	}
	goto label$38;
	label$39:;
	{
		struct $7ASTNODE* vr$3 = CPROCCALL( (struct $8FBSYMBOL*)0u, SYM$1, (struct $7ASTNODE*)0u, THISEXPR$1, 0, OPTIONS$1 );
		EXPR$1 = vr$3;
	}
	label$38:;
	fb$result$1 = EXPR$1;
...
struct $7ASTNODE* CCTORCALL( struct $8FBSYMBOL* SYM$1 )
{
	...
	*(struct $11FB_CALL_ARG**)((uint8*)&ARG_LIST$1 + 4) = (struct $11FB_CALL_ARG*)0u;
	*(struct $11FB_CALL_ARG**)((uint8*)&ARG_LIST$1 + 8) = (struct $11FB_CALL_ARG*)0u;
	struct $8FBSYMBOL* vr$3 = SYMBADDTEMPVAR( *(int32*)((uint8*)SYM$1 + 28) & 511, SYM$1 );
	TMP$1 = vr$3;
	ASTDTORLISTADD( TMP$1 );
	int32 vr$4 = LEXGETTOKEN( 0 );
	if( vr$4 != 40 ) goto label$43;
	{
		LEXSKIPTOKEN( 0 );
		ISPRNT$1 = -1;
	}
	...
	struct $11FB_CALL_ARG* vr$7 = SYMBALLOCOVLCALLARG( (struct $5TLIST*)((uint8*)&PARSER$ + 116), &ARG_LIST$1, 0 );
	ARG$1 = vr$7;
	struct $7ASTNODE* vr$8 = ASTNEWVAR( TMP$1, 0ll, -2147483648u, (struct $8FBSYMBOL*)0u );
	*(struct $7ASTNODE**)ARG$1 = vr$8;
	*($12FB_PARAMMODE*)((uint8*)ARG$1 + 4) = -1;
	if( ISPRNT$1 != 0 ) goto label$44;
	TMP$94$1 = 32;
	goto label$49;
	label$44:;
	TMP$94$1 = 0;
	...
	struct $7ASTNODE* vr$14 = CPROCARGLIST( (struct $8FBSYMBOL*)0u, vr$13, (struct $7ASTNODE*)0u, &ARG_LIST$1, TMP$94$1 | 80 );
	PROCEXPR$1 = vr$14;
	if( ISPRNT$1 == 0 ) goto label$46;
	{
		int32 vr$15 = LEXGETTOKEN( 0 );
		if( vr$15 == 41 ) goto label$48;
		{
			ERRREPORT( 7, 0, (uint8*)0u );
			HSKIPUNTIL( 41, -1, 0, 0 );
		}
