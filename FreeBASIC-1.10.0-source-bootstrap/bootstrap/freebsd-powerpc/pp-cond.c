...
__FB_STATIC_ASSERT( sizeof( struct $9LEXPP_REC ) == 8 );
...
static int32 PPEXPRESSION( void );
...
void PPCONDIF( void )
{
	...
	ISTRUE$1 = 0;
	{
		...
		TMP$93$2 = (uint32)vr$0;
		goto label$28;
		label$29:;
		{
			struct $8FBSYMBOL* TMP$94$3;
			LEXSKIPTOKEN( 2050 );
			TMP$94$3 = (struct $8FBSYMBOL*)0u;
			struct $8FBSYMBOL* vr$2 = CIDENTIFIERORUDTMEMBER( &TMP$94$3, (struct $10FBSYMCHAIN*)0u );
			ISTRUE$1 = -(vr$2 != (struct $8FBSYMBOL*)0u);
		}
		goto label$27;
		label$30:;
		{
			...
			LEXSKIPTOKEN( 2050 );
			TMP$95$3 = (struct $8FBSYMBOL*)0u;
			struct $8FBSYMBOL* vr$5 = CIDENTIFIERORUDTMEMBER( &TMP$95$3, (struct $10FBSYMCHAIN*)0u );
			ISTRUE$1 = -(vr$5 == (struct $8FBSYMBOL*)0u);
		}
		goto label$27;
		label$31:;
		{
			LEXSKIPTOKEN( 2048 );
			int32 vr$7 = PPEXPRESSION(  );
			ISTRUE$1 = vr$7;
		}
		goto label$27;
		label$28:;
		...
		if( (TMP$93$2 - 266u) > 2u ) goto label$27;
		goto *tmp$96[TMP$93$2 - 266u];
		label$27:;
	}
	*(int32*)((uint8*)&PP$ + 216) = *(int32*)((uint8*)&PP$ + 216) + 1;
	if( *(int32*)((uint8*)&PP$ + 216) <= 64 ) goto label$33;
	{
	...
	label$33:;
	label$32:;
	*(int32*)(((int32)(struct $9LEXPP_REC*)PPTB$ + (*(int32*)((uint8*)&PP$ + 216) << (3 & 31))) + -8) = ISTRUE$1;
	*(int32*)(((int32)(struct $9LEXPP_REC*)PPTB$ + (*(int32*)((uint8*)&PP$ + 216) << (3 & 31))) + -4) = 0;
	if( ISTRUE$1 != 0 ) goto label$35;
	{
		PPSKIP(  );
	}
	label$35:;
...
void PPCONDELSE( void )
{
	...
	int32 ISTRUE$1;
	ISTRUE$1 = 0;
	if( *(int32*)((uint8*)&PP$ + 216) != 0 ) goto label$39;
	{
		ERRREPORT( 44, 0, (uint8*)0u );
		HSKIPUNTIL( -1, 0, 0, 0 );
		goto label$37;
	}
	label$39:;
	label$38:;
	if( *(int32*)(((int32)(struct $9LEXPP_REC*)PPTB$ + (*(int32*)((uint8*)&PP$ + 216) << (3 & 31))) + -4) <= 0 ) goto label$41;
	{
	...
	label$41:;
	label$40:;
	int32 vr$1 = LEXGETTOKEN( 256 );
	if( vr$1 != 270 ) goto label$43;
	{
		LEXSKIPTOKEN( 2048 );
		int32 vr$2 = PPEXPRESSION(  );
		ISTRUE$1 = vr$2;
		if( *(int32*)(((int32)(struct $9LEXPP_REC*)PPTB$ + (*(int32*)((uint8*)&PP$ + 216) << (3 & 31))) + -8) == 0 ) goto label$45;
		{
			PPSKIP(  );
			goto label$37;
		}
	...
	{
		LEXSKIPTOKEN( 2048 );
		*(int32*)(((int32)(struct $9LEXPP_REC*)PPTB$ + (*(int32*)((uint8*)&PP$ + 216) << (3 & 31))) + -4) = *(int32*)(((int32)(struct $9LEXPP_REC*)PPTB$ + (*(int32*)((uint8*)&PP$ + 216) << (3 & 31))) + -4) + 1;
		*(int32*)(((int32)(struct $9LEXPP_REC*)PPTB$ + (*(int32*)((uint8*)&PP$ + 216) << (3 & 31))) + -8) = ~(*(int32*)(((int32)(struct $9LEXPP_REC*)PPTB$ + (*(int32*)((uint8*)&PP$ + 216) << (3 & 31))) + -8));
	}
	label$42:;
	if( *(int32*)(((int32)(struct $9LEXPP_REC*)PPTB$ + (*(int32*)((uint8*)&PP$ + 216) << (3 & 31))) + -8) != 0 ) goto label$47;
	{
		PPSKIP(  );
	}
	label$47:;
...
void PPCONDENDIF( void )
{
	label$48:;
	LEXSKIPTOKEN( 2048 );
	if( *(int32*)((uint8*)&PP$ + 216) <= 0 ) goto label$51;
	{
		*(int32*)((uint8*)&PP$ + 216) = *(int32*)((uint8*)&PP$ + 216) + -1;
	}
	goto label$50;
...
void PPASSERT( void )
{
	label$52:;
	int32 ISTRUE$1;
	int32 vr$0 = PPEXPRESSION(  );
	ISTRUE$1 = vr$0;
	if( ISTRUE$1 != 0 ) goto label$55;
	{
		ERRREPORT( 308, 0, (uint8*)0u );
	}
	label$55:;
	label$54:;
	label$53:;
...
static int32 PPEXPRESSION( void )
{
	...
	{
		*($12FB_PARSEROPT*)((uint8*)&PARSER$ + 152) = *(int32*)((uint8*)&PARSER$ + 152) | 1024;
	}
	goto label$16;
	label$17:;
	{
		*($12FB_PARSEROPT*)((uint8*)&PARSER$ + 152) = *(int32*)((uint8*)&PARSER$ + 152) & -1025;
	}
	label$16:;
	...
	if( vr$7 == (struct $8FBSYMBOL*)0u ) goto label$23;
	{
	...
	goto label$22;
	label$23:;
	if( *(int32*)EXPR$1 == 16 ) goto label$24;
	{
	...
	label$24:;
	label$22:;
	int32 vr$11 = ASTCONSTEQZERO( EXPR$1 );
	fb$result$1 = ~vr$11;
	label$15:;
	return fb$result$1;
}
...
static void PPSKIP( void )
{
	label$56:;
	int32 IFLEVEL$1;
	*(int32*)((uint8*)&PP$ + 220) = -1;
	CCOMMENT( 0 );
	if( *(int32*)((uint8*)&ENV$ + 148) == 0 ) goto label$59;
	{
		if( *(int32*)((uint8*)&ENV$ + 900) != 0 ) goto label$61;
		{
			struct $7ASTNODE* vr$1 = ASTNEWLIT( *(uint8**)((uint8*)*(struct $9LEX_TKCTX**)((uint8*)&LEX$ + 840072) + 49400) );
			ASTADD( vr$1 );
	...
	{
		{
			...
			TMP$97$3 = vr$5;
			if( TMP$97$3 != 35 ) goto label$68;
			label$69:;
			{
				LEXSKIPTOKEN( 256 );
				{
					uint32 TMP$98$5;
					int32 vr$6 = LEXGETTOKEN( 256 );
					TMP$98$5 = (uint32)vr$6;
					goto label$71;
					label$72:;
					{
						IFLEVEL$1 = IFLEVEL$1 + 1;
					}
					goto label$70;
					label$73:;
					{
						{
							if( IFLEVEL$1 != *(int32*)((uint8*)&PP$ + 216) ) goto label$75;
							label$76:;
							{
					...
					{
						{
							if( IFLEVEL$1 != *(int32*)((uint8*)&PP$ + 216) ) goto label$81;
							label$82:;
							{
								*(int32*)((uint8*)&PP$ + 220) = 0;
								PPCONDENDIF(  );
					...
					if( (TMP$98$5 - 266u) > 5u ) goto label$70;
					goto *tmp$99[TMP$98$5 - 266u];
					label$70:;
				}
			}
			goto label$67;
			label$68:;
			if( TMP$97$3 != 256 ) goto label$86;
			label$87:;
			{
