...
struct $6IRVREG* IRHLNEWVREG( int32, struct $8FBSYMBOL*, int32 );
...
void IRINIT( void )
{
	label$10:;
	{
		...
		TMP$104$2 = *($10FB_BACKEND*)((uint8*)&ENV$ + 104);
		if( TMP$104$2 != 1 ) goto label$13;
		label$14:;
		{
			__builtin_memcpy( (struct $7IR_VTBL*)&IR$, &IRHLC_VTBL$, 272 );
		}
		goto label$12;
		label$13:;
		if( TMP$104$2 != 2 ) goto label$15;
		label$16:;
		{
			__builtin_memcpy( (struct $7IR_VTBL*)&IR$, &IRLLVM_VTBL$, 272 );
		}
		goto label$12;
		label$15:;
		if( TMP$104$2 != 3 ) goto label$17;
		label$18:;
		{
			__builtin_memcpy( (struct $7IR_VTBL*)&IR$, &IRGAS64_VTBL$, 272 );
		}
		goto label$12;
		label$17:;
		{
			__builtin_memcpy( (struct $7IR_VTBL*)&IR$, &IRTAC_VTBL$, 272 );
		}
		label$19:;
		label$12:;
	}
	*($6IR_OPT*)((uint8*)&IR$ + 272) = 0;
	(*(tmp$37*)&IR$)(  );
	label$11:;
}
...
{
	label$22:;
	FLISTINIT( (struct $6TFLIST*)((uint8*)&IRHL$ + 4), 6144, 72 );
	LISTINIT( (struct $5TLIST*)((uint8*)&IRHL$ + 60), 32, 12, 6 );
	label$23:;
}
...
{
	label$24:;
	LISTEND( (struct $5TLIST*)((uint8*)&IRHL$ + 60) );
	FLISTEND( (struct $6TFLIST*)((uint8*)&IRHL$ + 4) );
	label$25:;
}
...
{
	label$28:;
	FLISTRESET( (struct $6TFLIST*)((uint8*)&IRHL$ + 4) );
	label$29:;
}

void IRHLEMITPUSHARG( struct $8FBSYMBOL* PARAM$1, struct $6IRVREG* VR$1, int64 UDTLEN$1, int32 LEVEL$1, struct $6IRVREG* LREG$1 )
{
	label$30:;
	struct $9IRCALLARG* ARG$1;
	void* vr$1 = LISTNEWNODE( (struct $5TLIST*)((uint8*)&IRHL$ + 60) );
	ARG$1 = (struct $9IRCALLARG*)vr$1;
	*(struct $8FBSYMBOL**)ARG$1 = PARAM$1;
	*(struct $6IRVREG**)((uint8*)ARG$1 + 4) = VR$1;
	*(int32*)((uint8*)ARG$1 + 8) = LEVEL$1;
	label$31:;
}

struct $6IRVREG* IRHLNEWVREG( int32 DTYPE$1, struct $8FBSYMBOL* SUBTYPE$1, int32 VTYPE$1 )
{
	struct $6IRVREG* fb$result$1;
	__builtin_memset( &fb$result$1, 0, 4 );
	label$32:;
	struct $6IRVREG* V$1;
	void* vr$2 = FLISTNEWITEM( (struct $6TFLIST*)((uint8*)&IRHL$ + 4) );
	V$1 = (struct $6IRVREG*)vr$2;
	*($15IRVREGTYPE_ENUM*)V$1 = VTYPE$1;
	*($11FB_DATATYPE*)((uint8*)V$1 + 4) = DTYPE$1;
	*(struct $8FBSYMBOL**)((uint8*)V$1 + 8) = SUBTYPE$1;
	if( VTYPE$1 != 4 ) goto label$35;
	{
		*(int32*)((uint8*)V$1 + 12) = *(int32*)&IRHL$;
		*(int32*)&IRHL$ = *(int32*)&IRHL$ + 1;
	}
	goto label$34;
	label$35:;
	{
...
struct $6IRVREG* IRHLALLOCVREG( int32 DTYPE$1, struct $8FBSYMBOL* SUBTYPE$1 )
{
	struct $6IRVREG* fb$result$1;
	__builtin_memset( &fb$result$1, 0, 4 );
	label$36:;
	struct $6IRVREG* vr$1 = IRHLNEWVREG( DTYPE$1, SUBTYPE$1, 4 );
	fb$result$1 = vr$1;
	label$37:;
	return fb$result$1;
}

struct $6IRVREG* IRHLALLOCVRIMM( int32 DTYPE$1, struct $8FBSYMBOL* SUBTYPE$1, int64 VALUE$1 )
{
	struct $6IRVREG* fb$result$1;
	__builtin_memset( &fb$result$1, 0, 4 );
	label$38:;
	struct $6IRVREG* VR$1;
	struct $6IRVREG* vr$1 = IRHLNEWVREG( DTYPE$1, SUBTYPE$1, 0 );
	VR$1 = vr$1;
...
struct $6IRVREG* IRHLALLOCVRIMMF( int32 DTYPE$1, struct $8FBSYMBOL* SUBTYPE$1, double VALUE$1 )
{
	struct $6IRVREG* fb$result$1;
	__builtin_memset( &fb$result$1, 0, 4 );
	label$40:;
...
struct $6IRVREG* IRHLALLOCVRVAR( int32 DTYPE$1, struct $8FBSYMBOL* SUBTYPE$1, struct $8FBSYMBOL* SYMBOL$1, int64 OFS$1 )
{
	struct $6IRVREG* fb$result$1;
	__builtin_memset( &fb$result$1, 0, 4 );
	label$42:;
	struct $6IRVREG* VR$1;
	struct $6IRVREG* vr$1 = IRHLNEWVREG( DTYPE$1, SUBTYPE$1, 1 );
	VR$1 = vr$1;
...
struct $6IRVREG* IRHLALLOCVRIDX( int32 DTYPE$1, struct $8FBSYMBOL* SUBTYPE$1, struct $8FBSYMBOL* SYMBOL$1, int64 OFS$1, int32 MULT$1, struct $6IRVREG* VIDX$1 )
{
	struct $6IRVREG* fb$result$1;
	__builtin_memset( &fb$result$1, 0, 4 );
	label$44:;
	struct $6IRVREG* VR$1;
	struct $6IRVREG* vr$1 = IRHLNEWVREG( DTYPE$1, SUBTYPE$1, 2 );
	VR$1 = vr$1;
	*(struct $8FBSYMBOL**)((uint8*)VR$1 + 32) = SYMBOL$1;
	*(int64*)((uint8*)VR$1 + 40) = OFS$1;
...
struct $6IRVREG* IRHLALLOCVRPTR( int32 DTYPE$1, struct $8FBSYMBOL* SUBTYPE$1, int64 OFS$1, struct $6IRVREG* VIDX$1 )
{
	struct $6IRVREG* fb$result$1;
	__builtin_memset( &fb$result$1, 0, 4 );
	label$46:;
	struct $6IRVREG* VR$1;
	struct $6IRVREG* vr$1 = IRHLNEWVREG( DTYPE$1, SUBTYPE$1, 3 );
	VR$1 = vr$1;
	*(int64*)((uint8*)VR$1 + 40) = OFS$1;
	*(struct $6IRVREG**)((uint8*)VR$1 + 52) = VIDX$1;
	fb$result$1 = VR$1;
...
struct $6IRVREG* IRHLALLOCVROFS( int32 DTYPE$1, struct $8FBSYMBOL* SUBTYPE$1, struct $8FBSYMBOL* SYMBOL$1, int64 OFS$1 )
{
	struct $6IRVREG* fb$result$1;
	__builtin_memset( &fb$result$1, 0, 4 );
	label$48:;
	struct $6IRVREG* VR$1;
	struct $6IRVREG* vr$1 = IRHLNEWVREG( DTYPE$1, SUBTYPE$1, 5 );
	VR$1 = vr$1;
	*(struct $8FBSYMBOL**)((uint8*)VR$1 + 32) = SYMBOL$1;
	*(int64*)((uint8*)VR$1 + 40) = OFS$1;
	fb$result$1 = VR$1;
...
void IRFOREACHDATASTMT( tmp$41 CALLBACK$1 )
{
	...
	SYM$1 = *(struct $8FBSYMBOL**)((uint8*)&AST$ + 120);
	label$52:;
	if( SYM$1 == (struct $8FBSYMBOL*)0u ) goto label$53;
	{
		(CALLBACK$1)( SYM$1 );
		SYM$1 = *(struct $8FBSYMBOL**)((uint8*)SYM$1 + 108);
	}
	goto label$52;
	label$53:;
	label$51:;
...
{
	label$54:;
	ASTLOADSTATICINITIALIZER( *(struct $7ASTNODE**)((uint8*)SYM$1 + 56), SYM$1 );
