...
struct $7ASTNODE* ASTNEWBOUNDCHK( struct $7ASTNODE*, struct $7ASTNODE*, struct $7ASTNODE*, int32, uint8* );
struct $7ASTNODE* ASTNEWPTRCHK( struct $7ASTNODE*, int32, uint8* );
...
struct $7ASTNODE* RTLARRAYBOUNDSCHECK( struct $7ASTNODE*, struct $7ASTNODE*, struct $7ASTNODE*, int32, uint8* );
struct $7ASTNODE* RTLNULLPTRCHECK( struct $7ASTNODE*, int32, uint8* );
...
struct $7ASTNODE* ASTNEWBOUNDCHK( struct $7ASTNODE* L$1, struct $7ASTNODE* LB$1, struct $7ASTNODE* UB$1, int32 LINENUM$1, uint8* FILENAME$1 )
{
	struct $7ASTNODE* fb$result$1;
	__builtin_memset( &fb$result$1, 0, 4 );
	label$10:;
	struct $7ASTNODE* N$1;
	if( *(int32*)LB$1 != 16 ) goto label$13;
	{
		if( *(int32*)L$1 != 16 ) goto label$15;
		{
			if( *(int64*)((uint8*)L$1 + 24) >= *(int64*)((uint8*)LB$1 + 24) ) goto label$17;
			{
			...
			label$17:;
			label$16:;
			if( *(int64*)((uint8*)L$1 + 24) <= *(int64*)((uint8*)UB$1 + 24) ) goto label$19;
			{
				fb$result$1 = (struct $7ASTNODE*)0u;
				goto label$11;
			}
		...
		label$15:;
		label$14:;
		if( *(int64*)((uint8*)LB$1 + 24) != 0ll ) goto label$21;
		{
			ASTDELNODE( LB$1 );
			LB$1 = (struct $7ASTNODE*)0u;
		}
		label$21:;
		label$20:;
	}
	label$13:;
	label$12:;
	struct $7ASTNODE* vr$10 = ASTNEWNODE( 31, *(int32*)((uint8*)L$1 + 4), *(struct $8FBSYMBOL**)((uint8*)L$1 + 8) );
	N$1 = vr$10;
	fb$result$1 = N$1;
	*(struct $7ASTNODE**)((uint8*)N$1 + 64) = L$1;
	struct $8FBSYMBOL* vr$14 = SYMBADDTEMPVAR( *(int32*)((uint8*)L$1 + 4), *(struct $8FBSYMBOL**)((uint8*)L$1 + 8) );
	*(struct $8FBSYMBOL**)((uint8*)N$1 + 12) = vr$14;
	struct $7ASTNODE* vr$17 = ASTNEWVAR( *(struct $8FBSYMBOL**)((uint8*)N$1 + 12), 0ll, -2147483648u, (struct $8FBSYMBOL*)0u );
...
struct $6IRVREG* ASTLOADBOUNDCHK( struct $7ASTNODE* N$1 )
{
	...
	if( (-(L$1 == (struct $7ASTNODE*)0u) | -(R$1 == (struct $7ASTNODE*)0u)) == 0 ) goto label$25;
	{
	...
	label$25:;
	label$24:;
	struct $7ASTNODE* vr$7 = ASTNEWVAR( *(struct $8FBSYMBOL**)((uint8*)N$1 + 12), 0ll, -2147483648u, (struct $8FBSYMBOL*)0u );
	struct $7ASTNODE* vr$8 = ASTNEWASSIGN( vr$7, L$1, 64 );
	T$1 = vr$8;
	ASTLOAD( T$1 );
	ASTDELNODE( T$1 );
	...
	if( *(int32*)((uint8*)&AST$ + 136) == 0 ) goto label$27;
	{
		...
		LABEL$1 = vr$10;
		struct $6IRVREG* vr$11 = (*(tmp$69*)((uint8*)&IR$ + 228))( 8, (struct $8FBSYMBOL*)0u, 0ll );
		(*(tmp$50*)((uint8*)&IR$ + 92))( 45, VR$1, vr$11, (struct $6IRVREG*)0u, LABEL$1 );
		(*(tmp$52*)((uint8*)&IR$ + 136))( VR$1 );
		(*(tmp$41*)((uint8*)&IR$ + 64))( LABEL$1 );
	}
	label$27:;
	label$26:;
	struct $7ASTNODE* vr$13 = ASTNEWVAR( *(struct $8FBSYMBOL**)((uint8*)N$1 + 12), 0ll, -2147483648u, (struct $8FBSYMBOL*)0u );
	T$1 = vr$13;
...
struct $7ASTNODE* ASTBUILDBOUNDCHK( struct $7ASTNODE* EXPR$1, struct $7ASTNODE* LB$1, struct $7ASTNODE* UB$1 )
{
	...
	__builtin_memset( &fb$result$1, 0, 4 );
	label$28:;
	struct $7ASTNODE* vr$3 = ASTNEWBOUNDCHK( EXPR$1, LB$1, UB$1, *(int32*)((uint8*)*(struct $9LEX_TKCTX**)((uint8*)&LEX$ + 840072) + 16568), (uint8*)((uint8*)&ENV$ + 304) );
	fb$result$1 = vr$3;
	label$29:;
	return fb$result$1;
}

struct $7ASTNODE* ASTNEWPTRCHK( struct $7ASTNODE* L$1, int32 LINENUM$1, uint8* FILENAME$1 )
{
	struct $7ASTNODE* fb$result$1;
	__builtin_memset( &fb$result$1, 0, 4 );
	label$30:;
	...
	struct $7ASTNODE* vr$4 = ASTNEWNODE( 32, DTYPE$1, SUBTYPE$1 );
	N$1 = vr$4;
	fb$result$1 = N$1;
	*(struct $7ASTNODE**)((uint8*)N$1 + 64) = L$1;
	struct $8FBSYMBOL* vr$6 = SYMBADDTEMPVAR( DTYPE$1, SUBTYPE$1 );
	*(struct $8FBSYMBOL**)((uint8*)N$1 + 12) = vr$6;
	struct $7ASTNODE* vr$9 = ASTNEWVAR( *(struct $8FBSYMBOL**)((uint8*)N$1 + 12), 0ll, -2147483648u, (struct $8FBSYMBOL*)0u );
	struct $7ASTNODE* vr$10 = RTLNULLPTRCHECK( vr$9, LINENUM$1, FILENAME$1 );
	*(struct $7ASTNODE**)((uint8*)N$1 + 68) = vr$10;
	label$31:;
	return fb$result$1;
}
...
struct $6IRVREG* ASTLOADPTRCHK( struct $7ASTNODE* N$1 )
{
	...
	L$1 = *(struct $7ASTNODE**)((uint8*)N$1 + 64);
	R$1 = *(struct $7ASTNODE**)((uint8*)N$1 + 68);
	if( (-(L$1 == (struct $7ASTNODE*)0u) | -(R$1 == (struct $7ASTNODE*)0u)) == 0 ) goto label$37;
	{
		fb$result$1 = (struct $6IRVREG*)0u;
		goto label$35;
	}
	...
	label$36:;
	struct $7ASTNODE* vr$7 = ASTNEWVAR( *(struct $8FBSYMBOL**)((uint8*)N$1 + 12), 0ll, -2147483648u, (struct $8FBSYMBOL*)0u );
	struct $7ASTNODE* vr$8 = ASTNEWASSIGN( vr$7, L$1, 80 );
	T$1 = vr$8;
	ASTLOAD( T$1 );
	ASTDELNODE( T$1 );
	struct $6IRVREG* vr$9 = ASTLOAD( R$1 );
...
struct $7ASTNODE* ASTBUILDPTRCHK( struct $7ASTNODE* EXPR$1 )
{
	...
	__builtin_memset( &fb$result$1, 0, 4 );
	label$40:;
	struct $7ASTNODE* vr$3 = ASTNEWPTRCHK( EXPR$1, *(int32*)((uint8*)*(struct $9LEX_TKCTX**)((uint8*)&LEX$ + 840072) + 16568), (uint8*)((uint8*)&ENV$ + 304) );
	fb$result$1 = vr$3;
	label$41:;
	return fb$result$1;
}
