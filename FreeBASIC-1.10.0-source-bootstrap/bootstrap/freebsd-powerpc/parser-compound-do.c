...
void CDOSTMTBEGIN( void )
{
	...
	LEXSKIPTOKEN( 2048 );
	struct $8FBSYMBOL* vr$0 = SYMBADDLABEL( (uint8*)0u, 4 );
	IL$1 = vr$0;
	struct $8FBSYMBOL* vr$1 = SYMBADDLABEL( (uint8*)0u, 0 );
	EL$1 = vr$1;
	struct $7ASTNODE* vr$2 = ASTNEWLABEL( IL$1, -1 );
	ASTADD( vr$2 );
	ISWHILE$1 = 0;
	ISUNTIL$1 = 0;
	{
	...
	if( (ISWHILE$1 | ISUNTIL$1) == 0 ) goto label$18;
	{
		LEXSKIPTOKEN( 2048 );
		struct $7ASTNODE* vr$5 = CEXPRESSION(  );
		EXPR$1 = vr$5;
		if( EXPR$1 != (struct $7ASTNODE*)0u ) goto label$20;
		{
		...
		label$20:;
		label$19:;
		struct $7ASTNODE* vr$8 = ASTBUILDBRANCH( EXPR$1, EL$1, ~ISWHILE$1, 0 );
		EXPR$1 = vr$8;
		if( EXPR$1 != (struct $7ASTNODE*)0u ) goto label$22;
		{
	...
	label$17:;
	struct $13FB_CMPSTMTSTK* vr$11 = CCOMPSTMTPUSH( 278, 1 );
	STK$1 = vr$11;
	struct $7ASTNODE* vr$12 = ASTSCOPEBEGIN(  );
	*(struct $7ASTNODE**)((uint8*)STK$1 + 8) = vr$12;
	*(int32*)((uint8*)STK$1 + 16) = -(EXPR$1 != (struct $7ASTNODE*)0u);
	*(struct $8FBSYMBOL**)((uint8*)STK$1 + 20) = IL$1;
	*(struct $8FBSYMBOL**)((uint8*)STK$1 + 24) = CL$1;
	*(struct $8FBSYMBOL**)((uint8*)STK$1 + 28) = EL$1;
	label$11:;
}
...
void CDOSTMTEND( void )
{
	...
	int32 ISUNTIL$1;
	struct $13FB_CMPSTMTSTK* STK$1;
	struct $13FB_CMPSTMTSTK* vr$0 = CCOMPSTMTGETTOS( 278, -1 );
	STK$1 = vr$0;
	if( STK$1 != (struct $13FB_CMPSTMTSTK*)0u ) goto label$26;
	{
		HSKIPUNTIL( -1, 0, 0, 0 );
		goto label$24;
	}
	...
	if( ((ISWHILE$1 | ISUNTIL$1) & *(int32*)((uint8*)STK$1 + 16)) == 0 ) goto label$33;
	{
		ERRREPORT( 17, 0, (uint8*)0u );
	}
	label$33:;
	label$32:;
	if( *(struct $7ASTNODE**)((uint8*)STK$1 + 8) == (struct $7ASTNODE*)0u ) goto label$35;
	{
		ASTSCOPEEND( *(struct $7ASTNODE**)((uint8*)STK$1 + 8) );
	}
	label$35:;
	label$34:;
	if( *(struct $8FBSYMBOL**)((uint8*)STK$1 + 24) == *(struct $8FBSYMBOL**)((uint8*)STK$1 + 20) ) goto label$37;
	{
		struct $7ASTNODE* vr$10 = ASTNEWLABEL( *(struct $8FBSYMBOL**)((uint8*)STK$1 + 24), -1 );
		ASTADD( vr$10 );
	}
	label$37:;
	label$36:;
	if( (ISWHILE$1 | ISUNTIL$1) == 0 ) goto label$39;
	{
		LEXSKIPTOKEN( 2048 );
		struct $7ASTNODE* vr$12 = CEXPRESSION(  );
		EXPR$1 = vr$12;
		if( EXPR$1 != (struct $7ASTNODE*)0u ) goto label$41;
		{
			ERRREPORT( 9, 0, (uint8*)0u );
		...
		label$41:;
		label$40:;
		struct $7ASTNODE* vr$15 = ASTBUILDBRANCH( EXPR$1, *(struct $8FBSYMBOL**)((uint8*)STK$1 + 20), ISWHILE$1, 0 );
		EXPR$1 = vr$15;
		if( EXPR$1 != (struct $7ASTNODE*)0u ) goto label$43;
		{
			ERRREPORT( 24, 0, (uint8*)0u );
	...
	label$39:;
	{
		struct $7ASTNODE* vr$18 = ASTNEWBRANCH( 98, *(struct $8FBSYMBOL**)((uint8*)STK$1 + 20), (struct $7ASTNODE*)0u );
		ASTADD( vr$18 );
	}
	label$38:;
	struct $7ASTNODE* vr$20 = ASTNEWLABEL( *(struct $8FBSYMBOL**)((uint8*)STK$1 + 28), -1 );
	ASTADD( vr$20 );
	CCOMPSTMTPOP( STK$1 );
	label$24:;
}
