...
void CEXTERNSTMTBEGIN( void )
{
	...
	int32 MANGLING$1;
	uint8* LITSTR$1;
	if( (*(int32*)((uint8*)&ENV$ + 1040) & 8) != 0 ) goto label$13;
	{
		ERRREPORTNOTALLOWED( 8, 146, (uint8*)0u );
		HSKIPCOMPOUND( 306, -1, 0 );
		goto label$11;
	}
	label$13:;
	label$12:;
	int32 vr$1 = CCOMPSTMTISALLOWED( 16 );
	...
	label$16:;
	{
		...
		fb_StrInit( (void*)&TMP$93$2, -1, (void*)vr$5, -1, 0 );
		int32 vr$8 = fb_StrCompare( (void*)&TMP$93$2, -1, (void*)"c", 2 );
		if( vr$8 != 0 ) goto label$19;
		label$20:;
		{
			MANGLING$1 = 1;
			LEXSKIPTOKEN( 0 );
		...
		goto label$18;
		label$19:;
		int32 vr$10 = fb_StrCompare( (void*)&TMP$93$2, -1, (void*)"windows", 8 );
		if( vr$10 != 0 ) goto label$21;
		label$22:;
		{
			MANGLING$1 = 2;
			LEXSKIPTOKEN( 0 );
		...
		goto label$18;
		label$21:;
		int32 vr$12 = fb_StrCompare( (void*)&TMP$93$2, -1, (void*)"windows-ms", 11 );
		if( vr$12 != 0 ) goto label$23;
		label$24:;
		{
			MANGLING$1 = 3;
			LEXSKIPTOKEN( 0 );
		...
		goto label$18;
		label$23:;
		int32 vr$14 = fb_StrCompare( (void*)&TMP$93$2, -1, (void*)"c++", 4 );
		if( vr$14 != 0 ) goto label$25;
		label$26:;
		{
			MANGLING$1 = 4;
			LEXSKIPTOKEN( 0 );
		...
		goto label$18;
		label$25:;
		int32 vr$16 = fb_StrCompare( (void*)&TMP$93$2, -1, (void*)"rtlib", 6 );
		if( vr$16 != 0 ) goto label$27;
		label$28:;
		{
			MANGLING$1 = 6;
			LEXSKIPTOKEN( 0 );
	...
	CLIBATTRIBUTE(  );
	struct $13FB_CMPSTMTSTK* vr$18 = CCOMPSTMTPUSH( 306, -34 );
	STK$1 = vr$18;
	*($11FB_MANGLING*)((uint8*)STK$1 + 16) = *($11FB_MANGLING*)((uint8*)&PARSER$ + 104);
	*($11FB_MANGLING*)((uint8*)&PARSER$ + 104) = MANGLING$1;
	label$11:;
}
...
void CEXTERNSTMTEND( void )
{
	label$30:;
	struct $13FB_CMPSTMTSTK* STK$1;
	struct $13FB_CMPSTMTSTK* vr$0 = CCOMPSTMTGETTOS( 306, -1 );
	STK$1 = vr$0;
	if( STK$1 != (struct $13FB_CMPSTMTSTK*)0u ) goto label$33;
	{
		HSKIPUNTIL( -1, 0, 0, 0 );
		goto label$31;
	}
	...
	LEXSKIPTOKEN( 2048 );
	LEXSKIPTOKEN( 2048 );
	*($11FB_MANGLING*)((uint8*)&PARSER$ + 104) = *($11FB_MANGLING*)((uint8*)STK$1 + 16);
	CCOMPSTMTPOP( STK$1 );
	label$31:;
}
