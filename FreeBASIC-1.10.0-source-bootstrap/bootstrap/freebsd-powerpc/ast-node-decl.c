...
static void fb_ctor__astznodezdecl( void ) __attribute__(( constructor ));
...
static struct $7ASTNODE* HCTORLIST( struct $8FBSYMBOL* );
static struct $7ASTNODE* HDEFAULTINIT( struct $8FBSYMBOL* );
...
struct $7ASTNODE* ASTNEWDECL( struct $8FBSYMBOL* SYM$1, int32 DO_DEFAULTINIT$1 )
{
	struct $7ASTNODE* fb$result$1;
	__builtin_memset( &fb$result$1, 0, 4 );
	label$24:;
	struct $7ASTNODE* N$1;
	struct $7ASTNODE* vr$1 = ASTNEWNODE( 24, -2147483648u, (struct $8FBSYMBOL*)0u );
	N$1 = vr$1;
	*(struct $8FBSYMBOL**)((uint8*)N$1 + 12) = SYM$1;
	if( DO_DEFAULTINIT$1 == 0 ) goto label$27;
	{
		struct $7ASTNODE* vr$3 = HDEFAULTINIT( SYM$1 );
...
struct $6IRVREG* ASTLOADDECL( struct $7ASTNODE* N$1 )
{
	struct $6IRVREG* fb$result$1;
	__builtin_memset( &fb$result$1, 0, 4 );
	label$28:;
	if( *(int32*)((uint8*)&AST$ + 136) == 0 ) goto label$31;
	{
		if( (*(int32*)((uint8*)*(struct $8FBSYMBOL**)((uint8*)N$1 + 12) + 4) & 128) == 0 ) goto label$33;
		{
			(*(tmp$41*)((uint8*)&IR$ + 164))( *(struct $8FBSYMBOL**)((uint8*)N$1 + 12) );
		}
		label$33:;
		label$32:;
	}
	label$31:;
	label$30:;
	if( *(struct $7ASTNODE**)((uint8*)N$1 + 64) == (struct $7ASTNODE*)0u ) goto label$35;
	{
...
static struct $7ASTNODE* HCTORLIST( struct $8FBSYMBOL* SYM$1 )
{
	struct $7ASTNODE* fb$result$1;
	__builtin_memset( &fb$result$1, 0, 4 );
	label$10:;
	...
	struct $8FBSYMBOL* vr$2 = SYMBADDTEMPVAR( 8, (struct $8FBSYMBOL*)0u );
	CNT$1 = vr$2;
	struct $8FBSYMBOL* vr$3 = SYMBADDLABEL( (uint8*)0u, 4 );
	LABEL$1 = vr$3;
	struct $8FBSYMBOL* vr$21 = SYMBADDTEMPVAR( ((((*(int32*)((uint8*)SYM$1 + 28) & 511) & 31) | (((*(int32*)((uint8*)SYM$1 + 28) & 511) & 480) + 32)) | (((*(int32*)((uint8*)SYM$1 + 28) & 511) & 261632) << (1 & 31))) | ((*(int32*)((uint8*)SYM$1 + 28) & 511) & 32505856), SUBTYPE$1 );
	THIS_$1 = vr$21;
	struct $7ASTNODE* vr$22 = ASTNEWVAR( SYM$1, 0ll, -2147483648u, (struct $8FBSYMBOL*)0u );
	struct $7ASTNODE* vr$23 = ASTNEWADDROF( vr$22 );
	struct $7ASTNODE* vr$24 = _Z17ASTBUILDVARASSIGNP8FBSYMBOLP7ASTNODEl( THIS_$1, vr$23, 64 );
	struct $7ASTNODE* vr$25 = ASTNEWLINK( TREE$1, vr$24, 0 );
	TREE$1 = vr$25;
	struct $7ASTNODE* vr$26 = ASTBUILDFORBEGIN( TREE$1, CNT$1, LABEL$1, 0, -1 );
	TREE$1 = vr$26;
	struct $7ASTNODE* vr$27 = ASTBUILDVARDEREF( THIS_$1 );
	struct $7ASTNODE* vr$29 = ASTBUILDCTORCALL( *(struct $8FBSYMBOL**)((uint8*)SYM$1 + 32), vr$27 );
	struct $7ASTNODE* vr$30 = ASTNEWLINK( TREE$1, vr$29, 0 );
	TREE$1 = vr$30;
	struct $7ASTNODE* vr$31 = ASTBUILDVARINC( THIS_$1, 1 );
	struct $7ASTNODE* vr$32 = ASTNEWLINK( TREE$1, vr$31, 0 );
	TREE$1 = vr$32;
	struct $7ASTNODE* vr$34 = ASTNEWCONSTI( *(int64*)((uint8*)SYM$1 + 80), 8, (struct $8FBSYMBOL*)0u );
	struct $7ASTNODE* vr$35 = ASTBUILDFOREND( TREE$1, CNT$1, LABEL$1, vr$34 );
	TREE$1 = vr$35;
	fb$result$1 = TREE$1;
	label$11:;
	return fb$result$1;
...
static struct $7ASTNODE* HDEFAULTINIT( struct $8FBSYMBOL* SYM$1 )
{
	struct $7ASTNODE* fb$result$1;
	__builtin_memset( &fb$result$1, 0, 4 );
	label$12:;
	if( (*(int32*)((uint8*)SYM$1 + 4) & 15) == 0 ) goto label$15;
	{
		goto label$13;
	}
	label$15:;
	label$14:;
	if( (*(int32*)((uint8*)SYM$1 + 12) & 2048) == 0 ) goto label$17;
	{
		goto label$13;
	}
	label$17:;
	label$16:;
	int32 vr$5 = SYMBHASDEFCTOR( SYM$1 );
	if( vr$5 == 0 ) goto label$19;
	{
		if( (*(int32*)((uint8*)SYM$1 + 4) & 131072) == 0 ) goto label$21;
		{
			goto label$13;
		}
		label$21:;
		label$20:;
		if( *(int32*)((uint8*)SYM$1 + 64) != 0 ) goto label$23;
		{
			struct $7ASTNODE* vr$9 = ASTNEWVAR( SYM$1, 0ll, -2147483648u, (struct $8FBSYMBOL*)0u );
			struct $7ASTNODE* vr$11 = ASTBUILDCTORCALL( *(struct $8FBSYMBOL**)((uint8*)SYM$1 + 32), vr$9 );
			fb$result$1 = vr$11;
		}
		goto label$22;
		label$23:;
		{
			struct $7ASTNODE* vr$12 = HCTORLIST( SYM$1 );
			fb$result$1 = vr$12;
		}
		label$22:;
		goto label$13;
	...
	label$19:;
	label$18:;
	struct $7ASTNODE* vr$16 = ASTNEWCONSTI( *(int64*)((uint8*)SYM$1 + 40) * *(int64*)((uint8*)SYM$1 + 80), 8, (struct $8FBSYMBOL*)0u );
	struct $7ASTNODE* vr$17 = ASTNEWVAR( SYM$1, 0ll, -2147483648u, (struct $8FBSYMBOL*)0u );
