...
struct $8FBSYMBOL* SYMBADDENUM( uint8* ID$1, uint8* ID_ALIAS$1, $13FB_SYMBATTRIB ATTRIB$1, int32 USE_HASHTB$1 )
{
	...
	label$13:;
	label$12:;
	struct $8FBSYMBOL* vr$1 = SYMBNEWSYMBOL( 32, (struct $8FBSYMBOL*)0u, (struct $10FBSYMBOLTB*)0u, (struct $8FBHASHTB*)0u, 9, (uint8*)ID$1, (uint8*)ID_ALIAS$1, 10, (struct $8FBSYMBOL*)0u, ATTRIB$1, 0 );
	E$1 = vr$1;
	if( E$1 != (struct $8FBSYMBOL*)0u ) goto label$17;
	{
	...
	label$17:;
	label$16:;
	*(struct $8FBSYMBOL**)((uint8*)E$1 + 56) = E$1;
	*(struct $8FBSYMBOL**)((uint8*)E$1 + 60) = (struct $8FBSYMBOL*)0u;
	*(struct $8FBSYMBOL**)((uint8*)E$1 + 64) = (struct $8FBSYMBOL*)0u;
	if( USE_HASHTB$1 == 0 ) goto label$19;
	{
		*(struct $8FBSYMBOL**)((uint8*)E$1 + 68) = E$1;
		*(struct $8FBHASHTB**)((uint8*)E$1 + 84) = (struct $8FBHASHTB*)0u;
		*(struct $8FBHASHTB**)((uint8*)E$1 + 88) = (struct $8FBHASHTB*)0u;
		{
			HASHINIT( (struct $5THASH*)((uint8*)E$1 + 72), 16, 0 );
		}
		goto label$20;
		label$21:;
		{
			memset( (void*)((uint8*)E$1 + 72), 0, 12u );
		}
		label$20:;
	}
	goto label$18;
	label$19:;
	{
		...
		*(struct $8FBHASHTB**)((uint8*)E$1 + 88) = (struct $8FBHASHTB*)0u;
		goto label$23;
		{
			HASHINIT( (struct $5THASH*)((uint8*)E$1 + 72), 0, 0 );
		}
		goto label$22;
		label$23:;
		{
	...
	label$18:;
	*(struct $13FBNAMESPC_EXT**)((uint8*)E$1 + 92) = (struct $13FBNAMESPC_EXT*)0u;
	*(int32*)((uint8*)E$1 + 96) = 0;
	*(int32*)((uint8*)E$1 + 100) = -1;
	if( *(int32*)((uint8*)&SYMB$ + 98692) <= 0 ) goto label$25;
	{
		SYMBCHECKFWDREF( E$1 );
	}
	label$25:;
...
struct $8FBSYMBOL* SYMBADDENUMELEMENT( struct $8FBSYMBOL* PARENT$1, uint8* ID$1, int64 INTVAL$1, $13FB_SYMBATTRIB ATTRIB$1 )
{
	...
	*(int64*)&V$1 = INTVAL$1;
	struct $8FBSYMBOL* vr$3 = SYMBADDCONST( ID$1, 10, PARENT$1, &V$1, ATTRIB$1 );
	S$1 = vr$3;
	*(int32*)((uint8*)PARENT$1 + 96) = *(int32*)((uint8*)PARENT$1 + 96) + 1;
	fb$result$1 = S$1;
	label$27:;
	return fb$result$1;
}
...
{
	label$28:;
	SYMBDELNAMESPACEMEMBERS( S$1, -(*(int32*)((uint8*)S$1 + 76) != 0) );
	SYMBFREESYMBOL( S$1 );
	label$29:;
}
...
struct $8FBSYMBOL* SYMBGETENUMFIRSTELM( struct $8FBSYMBOL* PARENT$1 )
{
	...
	label$32:;
	if( SYM$1 == (struct $8FBSYMBOL*)0u ) goto label$33;
	{
		if( *(int32*)SYM$1 != 2 ) goto label$35;
		{
			fb$result$1 = SYM$1;
			goto label$31;
		}
...
struct $8FBSYMBOL* SYMBGETENUMNEXTELM( struct $8FBSYMBOL* SYM$1 )
{
	...
	SYM$1 = *(struct $8FBSYMBOL**)((uint8*)SYM$1 + 176);
	label$38:;
	if( SYM$1 == (struct $8FBSYMBOL*)0u ) goto label$39;
	{
		if( *(int32*)SYM$1 != 2 ) goto label$41;
		{
			fb$result$1 = SYM$1;
			goto label$37;
		}
