...
struct $8FBSYMBOL* SYMBADDSCOPE( struct $7ASTNODE* BACKNODE$1 )
{
	...
	struct $8FBSYMBOL* vr$2 = SYMBNEWSYMBOL( 0, (struct $8FBSYMBOL*)0u, *(struct $10FBSYMBOLTB**)((uint8*)&SYMB$ + 98544), (struct $8FBHASHTB*)0u, 15, (uint8*)0u, (uint8*)0u, -2147483648u, (struct $8FBSYMBOL*)0u, 0, 0 );
	S$1 = vr$2;
	*(struct $8FBSYMBOL**)((uint8*)S$1 + 60) = S$1;
	*(struct $8FBSYMBOL**)((uint8*)S$1 + 64) = (struct $8FBSYMBOL*)0u;
	*(struct $8FBSYMBOL**)((uint8*)S$1 + 68) = (struct $8FBSYMBOL*)0u;
	*(struct $7ASTNODE**)((uint8*)S$1 + 56) = BACKNODE$1;
	fb$result$1 = S$1;
	label$11:;
	return fb$result$1;
}
...
{
	label$12:;
	if( SCP$1 != (struct $8FBSYMBOL*)0u ) goto label$15;
	{
		goto label$13;
	}
	label$15:;
	...
	label$16:;
	{
		...
		S$2 = *(struct $8FBSYMBOL**)((uint8*)SCP$1 + 68);
		if( S$2 != (struct $8FBSYMBOL*)0u ) goto label$20;
		{
			goto label$17;
		}
		label$20:;
...
void SYMBDELSCOPETB( struct $8FBSYMBOL* SCP$1 )
{
	label$21:;
	struct $8FBSYMBOL* S$1;
	S$1 = *(struct $8FBSYMBOL**)((uint8*)SCP$1 + 68);
	label$23:;
	if( S$1 == (struct $8FBSYMBOL*)0u ) goto label$24;
	{
		if( *(int32*)S$1 == 17 ) goto label$26;
		{
			SYMBDELFROMHASH( S$1 );
		}
		goto label$25;
