...
static void fb_ctor__rtlzoop( void ) __attribute__(( constructor ));
...
static struct $14FB_RTL_PROCDEF FUNCDATA$[4] = { { (uint8*)"fb_IsTypeOf", (uint8*)0u, 11, -1, (tmp$33)0u, 0, 2, { { 0, 2, 0 }, { 0, 2, 0 } } }, { (uint8*)0u } };
...
struct $7ASTNODE* RTLOOPISTYPEOF( struct $7ASTNODE* INST$1, struct $7ASTNODE* RTTI$1 )
{
	struct $7ASTNODE* fb$result$1;
	__builtin_memset( &fb$result$1, 0, 4 );
	label$14:;
	struct $7ASTNODE* PROC$1;
	struct $8FBSYMBOL* vr$1 = RTLPROCLOOKUP( (uint8*)"fb_IsTypeOf", 138 );
	struct $7ASTNODE* vr$2 = ASTNEWCALL( vr$1, (struct $7ASTNODE*)0u );
	PROC$1 = vr$2;
	struct $7ASTNODE* vr$3 = ASTNEWARG( PROC$1, INST$1, -2147483648u, -1 );
	...
	label$17:;
	label$16:;
	struct $7ASTNODE* vr$4 = ASTNEWARG( PROC$1, RTTI$1, -2147483648u, -1 );
...
__attribute__(( constructor )) static void fb_ctor__rtlzoop( void )
{
	label$0:;
	label$1:;
}
