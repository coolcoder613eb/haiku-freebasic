...
struct $7ASTNODE* CTYPECONVEXPR( $8FB_TOKEN TK$1, int32 ISASM$1 )
{
	...
	OP$1 = -1;
	{
		...
		if( (TMP$92$2 - 401u) > 14u ) goto label$12;
		goto *tmp$93[TMP$92$2 - 401u];
		label$12:;
	}
	if( DTYPE$1 != -2147483648u ) goto label$30;
	{
		if( OP$1 != -1 ) goto label$32;
		{
	...
	label$29:;
	LEXSKIPTOKEN( 2048 );
	if( (-(TK$1 == 406) | -(TK$1 == 407)) == 0 ) goto label$34;
	{
		int32 vr$4 = HMATCH( 301, 0 );
		if( vr$4 == 0 ) goto label$36;
		{
			int64 LGT$3;
			struct $7ASTNODE* vr$5 = CGTINPARENSONLYEXPR(  );
			int64 vr$6 = CCONSTINTEXPR( vr$5, 8 );
			LGT$3 = vr$6;
			$11FB_DATATYPE vr$8 = HINTEGERTYPEFROMBITSIZE( LGT$3, -(TK$1 == 407) );
			DTYPE$1 = vr$8;
			int32 vr$9 = HMATCH( 300, 0 );
			if( vr$9 != 0 ) goto label$38;
			{
	...
	label$34:;
	label$33:;
	int32 vr$10 = HMATCH( 40, 0 );
	if( vr$10 != 0 ) goto label$40;
	{
	...
	EXPR$1 = vr$11;
	if( EXPR$1 != (struct $7ASTNODE*)0u ) goto label$42;
	{
	...
	label$41:;
	{
		if( OP$1 != 119 ) goto label$44;
		label$45:;
		{
			int32 vr$14 = TYPETOSIGNED( *(int32*)((uint8*)EXPR$1 + 4) );
			DTYPE$1 = vr$14;
		}
		goto label$43;
		label$44:;
		if( OP$1 != 120 ) goto label$46;
		label$47:;
		{
			int32 vr$16 = TYPETOUNSIGNED( *(int32*)((uint8*)EXPR$1 + 4) );
			DTYPE$1 = vr$16;
		}
		label$46:;
		label$43:;
	}
	struct $7ASTNODE* vr$18 = ASTNEWCONV( DTYPE$1, (struct $8FBSYMBOL*)0u, EXPR$1, 66, &ERRMSG$1 );
	EXPR$1 = vr$18;
	if( EXPR$1 != (struct $7ASTNODE*)0u ) goto label$49;
	{
		if( ERRMSG$1 != 0 ) goto label$51;
		{
			ERRMSG$1 = 20;
		}
		label$51:;
...
struct $7ASTNODE* CANONTYPE( void )
{
	...
	IS_EXPLICIT$1 = vr$1;
	if( IS_EXPLICIT$1 == 0 ) goto label$59;
	{
		int64 TMP$94$2;
		int32 TMP$95$2;
		TMP$95$2 = 0;
		TMP$94$2 = 0ll;
		int32 vr$6 = CSYMBOLTYPE( &DTYPE$1, &SUBTYPE$1, &TMP$94$2, &TMP$95$2, 1 );
		if( vr$6 != 0 ) goto label$61;
		{
	...
	label$59:;
	{
		SUBTYPE$1 = *(struct $8FBSYMBOL**)((uint8*)&PARSER$ + 160);
		DTYPE$1 = *(int32*)((uint8*)&PARSER$ + 156);
		...
		{
			int32 TMP$96$3;
			TMP$96$3 = DTYPE$1 & 511;
			if( TMP$96$3 == 0 ) goto label$66;
			label$67:;
			if( TMP$96$3 != 23 ) goto label$65;
			label$66:;
			{
				ERRREPORT( 71, 0, (uint8*)0u );
				DTYPE$1 = 8;
	...
	if( IS_EXPLICIT$1 == 0 ) goto label$69;
	{
		int32 vr$8 = HMATCH( 300, 0 );
		if( vr$8 != 0 ) goto label$71;
		{
			ERRREPORT( 17, 0, (uint8*)0u );
			HSKIPUNTIL( 300, -1, 0, 0 );
		}
		label$71:;
		label$70:;
	}
	label$69:;
	label$68:;
	if( (DTYPE$1 & 511) != 20 ) goto label$73;
	{
		int32 vr$10 = LEXGETTOKEN( 0 );
		if( vr$10 != 40 ) goto label$75;
		{
			goto label$77;
			{
		...
		if( vr$13 == (struct $8FBSYMBOL*)0u ) goto label$79;
		{
	...
	SYM$1 = vr$15;
	struct $7ASTNODE* vr$16 = CINITIALIZER( SYM$1, 0, -2147483648u, (struct $8FBSYMBOL*)0u );
	INITREE$1 = vr$16;
	ASTREPLACESYMBOLONTREE( INITREE$1, SYM$1, (struct $8FBSYMBOL*)0u );
