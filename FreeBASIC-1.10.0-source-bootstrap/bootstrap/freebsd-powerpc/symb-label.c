...
static void fb_ctor__symbzlabel( void ) __attribute__(( constructor ));
...
struct $8FBSYMBOL* SYMBADDLABEL( uint8* SYMBOL$1, $10FB_SYMBOPT OPTIONS$1 )
{
	$10FB_SYMBOPT TMP$92$1;
	...
	if( SYMBOL$1 == (uint8*)0u ) goto label$13;
	{
		struct $8FBSYMBOL* vr$1 = SYMBLOOKUPBYNAMEANDCLASS( *(struct $8FBSYMBOL**)((uint8*)&SYMB$ + 98536), (uint8*)SYMBOL$1, 7, 0, -1 );
		L$1 = vr$1;
		if( L$1 == (struct $8FBSYMBOL*)0u ) goto label$15;
		{
			if( (OPTIONS$1 & 4) == 0 ) goto label$17;
			{
				if( *(int32*)((uint8*)L$1 + 60) == 0 ) goto label$19;
				{
					goto label$11;
				}
				label$19:;
				label$18:;
				*(int32*)((uint8*)L$1 + 60) = -1;
				*(struct $8FBSYMBOL**)((uint8*)L$1 + 56) = *(struct $8FBSYMBOL**)((uint8*)&PARSER$ + 112);
				*(int32*)((uint8*)L$1 + 64) = *(int32*)((uint8*)&PARSER$ + 28);
				*(uint16*)((uint8*)L$1 + 36) = (uint16)*(uint32*)((uint8*)&PARSER$ + 100);
				fb$result$1 = L$1;
				goto label$11;
			}
			goto label$16;
		...
		label$15:;
		label$14:;
		if( (OPTIONS$1 & 64) != 0 ) goto label$21;
		{
			ID_ALIAS$1 = SYMBOL$1;
		}
		goto label$20;
	...
	label$12:;
	if( (OPTIONS$1 & 8) == 0 ) goto label$23;
	{
		ISGLOBAL$1 = -1;
	...
	label$23:;
	{
		if( *(struct $8FBSYMBOL**)((uint8*)&PARSER$ + 108) != *(struct $8FBSYMBOL**)((uint8*)&ENV$ + 1032) ) goto label$25;
		{
			ISGLOBAL$1 = -1;
			if( *(struct $8FBSYMBOL**)((uint8*)&SYMB$ + 98536) == (struct $8FBSYMBOL*)((uint8*)&SYMB$ + 98352) ) goto label$27;
			{
	...
	label$22:;
	if( ISGLOBAL$1 == 0 ) goto label$29;
	TMP$93$1 = 0;
	goto label$34;
	label$29:;
	TMP$93$1 = 128;
	label$34:;
	if( SYMBOL$1 != (uint8*)0u ) goto label$28;
	TMP$92$1 = 0;
	goto label$35;
	label$28:;
	TMP$92$1 = 32;
	label$35:;
	struct $8FBSYMBOL* vr$20 = SYMBNEWSYMBOL( TMP$92$1, (struct $8FBSYMBOL*)0u, SYMTB$1, HASHTB$1, 7, (uint8*)ID$1, (uint8*)ID_ALIAS$1, -2147483648u, (struct $8FBSYMBOL*)0u, TMP$93$1, 0 );
	L$1 = vr$20;
	if( L$1 != (struct $8FBSYMBOL*)0u ) goto label$31;
	{
		goto label$11;
	}
	label$31:;
	label$30:;
	if( (OPTIONS$1 & 4) == 0 ) goto label$33;
	{
		*(struct $8FBSYMBOL**)((uint8*)L$1 + 56) = *(struct $8FBSYMBOL**)((uint8*)&PARSER$ + 112);
		*(int32*)((uint8*)L$1 + 64) = *(int32*)((uint8*)&PARSER$ + 28);
		*(int32*)((uint8*)L$1 + 60) = -1;
	...
	label$33:;
	{
		*(int32*)((uint8*)L$1 + 60) = 0;
	}
	label$32:;
	*(boolean*)((uint8*)L$1 + 68) = (boolean)0;
	fb$result$1 = L$1;
	label$11:;
	return fb$result$1;
}

struct $8FBSYMBOL* SYMBCLONELABEL( struct $8FBSYMBOL* SYM$1 )
{
	struct $8FBSYMBOL* fb$result$1;
	__builtin_memset( &fb$result$1, 0, 4 );
	label$36:;
...
void SYMBDELLABEL( struct $8FBSYMBOL* S$1 )
{
	label$38:;
	if( S$1 != (struct $8FBSYMBOL*)0u ) goto label$41;
	{
		goto label$39;
	}
	label$41:;
...
int32 SYMBCHECKLABELS( struct $8FBSYMBOL* SYMTBHEAD$1 )
{
	int32 fb$result$1;
	__builtin_memset( &fb$result$1, 0, 4 );
	label$42:;
	...
	S$1 = SYMTBHEAD$1;
	label$44:;
	if( S$1 == (struct $8FBSYMBOL*)0u ) goto label$45;
	{
		if( *(int32*)S$1 != 7 ) goto label$47;
		{
			if( *(int32*)((uint8*)S$1 + 60) != 0 ) goto label$49;
			{
				if( *(uint8**)((uint8*)S$1 + 16) == (uint8*)0u ) goto label$51;
				{
					ERRREPORTEX( 48, (uint8*)*(uint8**)((uint8*)S$1 + 16), -1, 1, (uint8*)0u );
					COUNT$1 = COUNT$1 + 1;
				}
				label$51:;
				label$50:;
