...
static void fb_ctor__parserzstatement( void ) __attribute__(( constructor ));
...
void CSTATEMENT( void )
{
	...
	label$14:;
	{
		int32 vr$2 = CDECLARATION(  );
		if( vr$2 != 0 ) goto label$18;
		{
			int32 vr$3 = CCOMPOUNDSTMT(  );
			if( vr$3 != 0 ) goto label$20;
			{
				int32 vr$4 = CPROCCALLORASSIGN(  );
				if( vr$4 != 0 ) goto label$22;
				{
					int32 vr$5 = CQUIRKSTMT( -1 );
					if( vr$5 != 0 ) goto label$24;
					{
						int32 vr$6 = CASMBLOCK(  );
...
int32 CSTMTSEPARATOR( $8LEXCHECK LEXFLAGS$1 )
{
	int32 fb$result$1;
	...
	{
		{
			...
			TMP$92$3 = vr$1;
			if( TMP$92$3 == 258 ) goto label$36;
			label$37:;
			if( TMP$92$3 != 257 ) goto label$35;
			label$36:;
			{
				*(int32*)((uint8*)&PARSER$ + 28) = *(int32*)((uint8*)&PARSER$ + 28) + 1;
				LEXSKIPTOKEN( LEXFLAGS$1 );
				fb$result$1 = -1;
			}
			goto label$34;
			label$35:;
			if( TMP$92$3 != 256 ) goto label$38;
			label$39:;
			{
				fb$result$1 = -1;
				goto label$32;
