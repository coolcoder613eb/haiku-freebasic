...
void CSCOPESTMTBEGIN( void )
{
	...
	if( (*(int32*)((uint8*)&ENV$ + 1040) & 2) != 0 ) goto label$13;
	{
		ERRREPORTNOTALLOWED( 2, 146, (uint8*)0u );
		HSKIPCOMPOUND( 285, -1, 0 );
		goto label$11;
	}
	label$13:;
	label$12:;
	...
	N$1 = vr$1;
	if( N$1 != (struct $7ASTNODE*)0u ) goto label$15;
	{
		ERRREPORT( 27, 0, (uint8*)0u );
	}
	label$15:;
	label$14:;
	struct $13FB_CMPSTMTSTK* vr$2 = CCOMPSTMTPUSH( 285, 1 );
	STK$1 = vr$2;
	*(struct $7ASTNODE**)((uint8*)STK$1 + 8) = N$1;
	*(int32*)((uint8*)STK$1 + 16) = -((*(int32*)((uint8*)&PARSER$ + 152) & 8) != 0);
	{
		*($12FB_PARSEROPT*)((uint8*)&PARSER$ + 152) = *(int32*)((uint8*)&PARSER$ + 152) | 8;
	}
	goto label$16;
	label$17:;
	{
		*($12FB_PARSEROPT*)((uint8*)&PARSER$ + 152) = *(int32*)((uint8*)&PARSER$ + 152) & -9;
	}
	label$16:;
	label$11:;
}
...
void CSCOPESTMTEND( void )
{
	label$18:;
	struct $13FB_CMPSTMTSTK* STK$1;
	struct $13FB_CMPSTMTSTK* vr$0 = CCOMPSTMTGETTOS( 285, -1 );
	STK$1 = vr$0;
	if( STK$1 != (struct $13FB_CMPSTMTSTK*)0u ) goto label$21;
	{
		HSKIPUNTIL( -1, 0, 0, 0 );
		goto label$19;
	}
	...
	LEXSKIPTOKEN( 2048 );
	LEXSKIPTOKEN( 2048 );
	if( *(int32*)((uint8*)STK$1 + 16) == 0 ) goto label$23;
	{
		*($12FB_PARSEROPT*)((uint8*)&PARSER$ + 152) = *(int32*)((uint8*)&PARSER$ + 152) | 8;
	}
	goto label$22;
	...
	label$22:;
	if( *(struct $7ASTNODE**)((uint8*)STK$1 + 8) == (struct $7ASTNODE*)0u ) goto label$25;
	{
