...
int32 CDECLARATION( void )
{
	...
	{
		if( *(int32*)((uint8*)*(struct $7FBTOKEN**)((uint8*)*(struct $9LEX_TKCTX**)((uint8*)&LEX$ + 840072) + 16548) + 8) == -2147483648u ) goto label$15;
		{
			fb$result$1 = 0;
			goto label$11;
		}
	...
	label$12:;
	{
		...
		if( (TMP$92$2 - 321u) > 58u ) goto label$16;
		goto *tmp$98[TMP$92$2 - 321u];
		label$16:;
	}
	...
	TK$1 = vr$6;
	{
		...
		{
			{
				...
				if( (TMP$94$4 - 345u) > 10u ) goto label$33;
				goto *tmp$99[TMP$94$4 - 345u];
				label$30:;
			}
		}
		goto label$27;
			...
			{
				{
					...
					TMP$95$5 = vr$9;
					if( TMP$95$5 == 299 ) goto label$45;
					label$46:;
					if( TMP$95$5 != 305 ) goto label$44;
					label$45:;
					{
					}
					goto label$43;
		...
		label$53:;
		{
			...
			label$55:;
			{
				if( *(struct $8FBSYMBOL**)((uint8*)&PARSER$ + 108) != *(struct $8FBSYMBOL**)((uint8*)&ENV$ + 1032) ) goto label$57;
				{
					CPROCSTMTBEGIN( 0, 0 );
					fb$result$1 = -1;
				}
				...
				{
					{
						...
						TMP$96$6 = vr$10;
						if( TMP$96$6 == 299 ) goto label$60;
						label$61:;
						if( TMP$96$6 != 305 ) goto label$59;
						label$60:;
						{
						}
						goto label$58;
			...
			{
				{
					...
					TMP$97$5 = vr$11;
					if( TMP$97$5 == 301 ) goto label$68;
					label$69:;
					if( TMP$97$5 != 40 ) goto label$67;
					label$68:;
					{
						fb$result$1 = 0;
						goto label$11;
		...
		if( (TMP$93$2 - 306u) > 49u ) goto label$73;
		goto *tmp$100[TMP$93$2 - 306u];
		label$27:;
	}
	label$11:;
	return fb$result$1;
