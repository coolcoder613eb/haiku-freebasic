...
jmp .L_007C
.L_007D:
mov ebx, dword ptr [ebp-2136]
not ebx
and dword ptr [ebp-2132], ebx
.L_007C:
push dword ptr [ebp+8]
...
jl .L_00A0
cmp dword ptr [_PP+224], 1
jle .L_00A2
mov dword ptr [ebp-2140], 41
.L_00A2:
.L_00A1:
.L_00A0:
.L_009F:
...
mov eax, dword ptr [_LEX+422280]
mov ebx, dword ptr [_LEX+422280]
mov ecx, dword ptr [eax+8408]
mov dword ptr [ebx+8404], ecx
mov ecx, dword ptr [_LEX+422280]
mov ebx, dword ptr [ebp-8]
add dword ptr [ecx+8400], ebx
mov ebx, dword ptr [_LEX+422280]
mov dword ptr [ebx+8364], 4294967295
mov dword ptr [ebp-4], -1
.L_0100:
...
shr ebx, 1
sbb ebx, ebx
mov dword ptr [ebp-2128], ebx
mov dword ptr [ebp-2144], -1
mov dword ptr [ebp-2120], 0
cmp dword ptr [ebp-2108], 0
je .L_0134
mov ebx, dword ptr [ebp-2108]
...
jmp .L_0287
.L_0169:
mov dword ptr [ebp-2152], 10
.L_0287:
mov eax, dword ptr [ebp-2152]
mov dword ptr [ebp-2144], eax
.L_0167:
mov dword ptr [ebp-2112], 0
jmp .L_013D
...
shr eax, 1
sbb eax, eax
mov ebx, dword ptr [ebp-2148]
mov ecx, dword ptr [ebp-2148]
push dword ptr [ecx]
mov esi, eax
call _fb_WstrLen@4
sal eax, 1
