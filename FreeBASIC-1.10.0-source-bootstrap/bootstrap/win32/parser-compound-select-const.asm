...
.globl _PARSERSELCONSTSTMTINIT@0
_PARSERSELCONSTSTMTINIT@0:
.L_0068:
...
.globl _PARSERSELCONSTSTMTEND@0
_PARSERSELCONSTSTMTEND@0:
.L_006A:
.L_006B:
ret
.balign 16

.globl _CSELCONSTSTMTBEGIN@0
_CSELCONSTSTMTBEGIN@0:
push ebp
mov ebp, esp
sub esp, 40
push ebx
...
.globl _CSELCONSTSTMTNEXT@4
_CSELCONSTSTMTNEXT@4:
push ebp
mov ebp, esp
sub esp, 24
push ebx
...
mov ebx, dword ptr [ebp-20]
mov eax, dword ptr [ebp-16]
sub dword ptr [ecx+8], ebx
sbb dword ptr [ecx+12], eax
mov ebx, dword ptr [ebp-24]
sal ebx, 3
mov eax, offset _CTX
add eax, ebx
...
add dword ptr [eax+48], ebx
adc dword ptr [eax+52], ecx
.L_00CC:
.L_00CB:
...
mov ebx, offset _CTX
add ebx, esi
mov esi, dword ptr [ecx+65540]
mov dword ptr [ebx+65544], esi
.L_009D:
