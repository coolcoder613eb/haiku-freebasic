...
.globl _RTLMATHLONGINTDIV@20
_RTLMATHLONGINTDIV@20:
push ebp
mov ebp, esp
sub esp, 16
mov dword ptr [ebp-4], 0
...
.globl _RTLMATHLONGINTMOD@20
_RTLMATHLONGINTMOD@20:
push ebp
mov ebp, esp
sub esp, 16
mov dword ptr [ebp-4], 0
...
.globl _RTLMATHFP2ULONGINT@8
_RTLMATHFP2ULONGINT@8:
push ebp
mov ebp, esp
sub esp, 8
mov dword ptr [ebp-4], 0
