...
.globl _ASTDATASTMTINIT@0
_ASTDATASTMTINIT@0:
.L_005D:
mov dword ptr [_AST+120], 0
mov dword ptr [_AST+124], 0
mov dword ptr [_AST+128], 0
call _HCREATEDATADESC@0
.L_005E:
ret
.balign 16

.globl _ASTDATASTMTBEGIN@0
_ASTDATASTMTBEGIN@0:
push ebp
mov ebp, esp
sub esp, 8
