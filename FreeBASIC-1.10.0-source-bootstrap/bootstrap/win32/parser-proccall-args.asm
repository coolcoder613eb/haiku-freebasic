...
.globl _PARSERPROCCALLINIT@0
_PARSERPROCCALLINIT@0:
.L_0067:
push 6
push 12
push 128
...
.globl _PARSERPROCCALLEND@0
_PARSERPROCCALLEND@0:
.L_0069:
lea eax, [_PARSER+116]
push eax
call _LISTEND@4
...
push dword ptr [ecx]
push dword ptr [ebp+12]
call _HGETVTABLELOOKUPIFNEEDED@12
...
push dword ptr [ebp-20]
push dword ptr [ebp-8]
call _HMAYBEWARNABOUTEQOUTSIDEPARENS@12
.L_0119:
mov eax, dword ptr [ebp-12]
cmp dword ptr [ebp-8], eax
jge .L_011A
...
ret 16
.balign 16
_HMAYBEWARNABOUTEQOUTSIDEPARENS@12:
push ebp
mov ebp, esp
sub esp, 4
push ebx
