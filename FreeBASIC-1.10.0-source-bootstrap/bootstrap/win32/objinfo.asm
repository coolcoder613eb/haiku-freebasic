...
.globl _OBJINFOREADLIBFILE@4
_OBJINFOREADLIBFILE@4:
push ebp
mov ebp, esp
.L_0161:
push dword ptr [ebp+8]
...
.globl _OBJINFOGETFILENAME@0
_OBJINFOGETFILENAME@0:
push ebp
mov ebp, esp
sub esp, 4
mov dword ptr [ebp-4], 0
...
.L_01AD:
.L_01AB:
call _HRESETBUFFERS@0
.L_01AA:
ret
.balign 16

.globl _OBJINFOENCODE@4
_OBJINFOENCODE@4:
push ebp
mov ebp, esp
sub esp, 4
...
push dword ptr [ebp-4]
call _HGETSECTIONNAMEELF32_SH@12
...
push dword ptr [ebp-20]
push dword ptr [ebp-4]
call _HGETSECTIONNAMEELF64_SH@12
mov dword ptr [ebp-16], eax
cmp dword ptr [ebp-16], 0
je .L_0093
push 9
...
jne .L_00F1
push dword ptr [ebp-8]
call _HPROCESSMACHOSEGMENT32@4
test eax, eax
je .L_00F3
jmp .L_00CE
.L_00F3:
...
jne .L_00F4
push dword ptr [ebp-8]
call _HPROCESSMACHOSEGMENT64@4
test eax, eax
je .L_00F6
jmp .L_00CE
.L_00F6:
...
ret 8
.balign 16
_HLOADFBCTINFFROMOBJ@0:
push ebp
mov ebp, esp
sub esp, 4
push ebx
.L_0134:
call _FBTARGETSUPPORTSCOFF@0
test eax, eax
je .L_0137
call _FBGETCPUFAMILY@0
mov dword ptr [ebp-4], eax
...
.L_0142:
push 62
call _HLOADFBCTINFFROMELF64_H@4
jmp .L_013F
.L_0141:
cmp dword ptr [ebp-4], 0
jne .L_0143
.L_0144:
push 3
call _HLOADFBCTINFFROMELF32_H@4
jmp .L_013F
.L_0143:
...
jmp .L_0136
.L_013E:
call _FBTARGETSUPPORTSMACHO@0
test eax, eax
je .L_014E
call _HLOADFBCTINFFROMMACHO@0
.L_014E:
.L_0136:
cmp dword ptr [_FBCTINF+4], 0
jne .L_0150
