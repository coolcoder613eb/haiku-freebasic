...
.L_013B:
push dword ptr [ebp-20]
call _HCHECKINTEGERINDEX@4
push eax
push dword ptr [ebp+16]
push dword ptr [ebp+8]
call _HSTRINDEXING@12
mov dword ptr [ebp+16], eax
mov dword ptr [ebp-20], 0
mov eax, dword ptr [ebp+16]
mov ebx, dword ptr [eax+4]
...
.globl _CFUNCPTRORMEMBERDEREF@20
_CFUNCPTRORMEMBERDEREF@20:
push ebp
mov ebp, esp
sub esp, 4
push ebx
...
.globl __Z11CVARIABLEEXP8FBSYMBOLl@8
__Z11CVARIABLEEXP8FBSYMBOLl@8:
push ebp
mov ebp, esp
sub esp, 36
push ebx
...
mov ebx, dword ptr [ebp-8]
push dword ptr [ebx+4]
call _CFUNCPTRORMEMBERDEREF@20
mov dword ptr [ebp-8], eax
jmp .L_01D0
.L_01D1:
cmp dword ptr [ebp-36], 0
...
.globl __Z11CVARIABLEEXP10FBSYMCHAINl@8
__Z11CVARIABLEEXP10FBSYMCHAINl@8:
push ebp
mov ebp, esp
sub esp, 16
push ebx
...
.globl _CIMPLICITDATAMEMBER@16
_CIMPLICITDATAMEMBER@16:
push ebp
mov ebp, esp
sub esp, 12
push ebx
