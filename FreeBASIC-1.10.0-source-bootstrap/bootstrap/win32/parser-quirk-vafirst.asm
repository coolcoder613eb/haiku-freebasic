...
call _HCHECKFORVALISTCOMPATIBLETYPE@8
test eax, eax
jne .L_00B4
push 0
push 0
...
lea eax, [ebp-8]
push eax
call _HSOLVEVALISTTYPE@4
push dword ptr [ebp-16]
push dword ptr [ebp-12]
push 0
push dword ptr [ebp-8]
push 112
call _ASTNEWMACRO@20
mov dword ptr [ebp-4], eax
jmp .L_00BD
.L_00BE:
...
push dword ptr [ebp-20]
push dword ptr [ebp-12]
call _HCHECKLASTPARAMETERSYMBOL@12
mov dword ptr [ebp-12], eax
push 0
push 41
call _HMATCH@8
...
ret 12
.balign 16
_HCHECKFORVALISTCOMPATIBLETYPE@8:
push ebp
mov ebp, esp
sub esp, 8
push ebx
