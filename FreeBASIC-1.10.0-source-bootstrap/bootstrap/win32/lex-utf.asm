...
jmp .L_00A8
.L_00A9:
call _HUTF8TOUTF16LE@0
mov dword ptr [ebp-4], eax
jmp .L_00A8
.L_00AA:
call _HUTF8TOUTF32LE@0
mov dword ptr [ebp-4], eax
.L_00A8:
mov eax, dword ptr [_LEX+422280]
mov ebx, dword ptr [ebp-4]
mov dword ptr [eax+8420], ebx
mov ebx, dword ptr [_LEX+422280]
lea eax, [ebx+8428]
mov ebx, dword ptr [_LEX+422280]
mov dword ptr [ebx+8424], eax
.L_00A7:
pop ebx
mov esp, ebp
pop ebp
...
.globl _LEXREADUTF16LE@0
_LEXREADUTF16LE@0:
push ebx
.L_00D4:
jmp .L_00D7
call _HUTF16LETOCHAR@0
mov dword ptr [_Lt_00D9], eax
jmp .L_00D6
.L_00D7:
call _HUTF16LETOUTF16LE@0
mov dword ptr [_Lt_00D9], eax
jmp .L_00D6
.L_00D8:
call _HUTF16LETOUTF32LE@0
mov dword ptr [_Lt_00D9], eax
.L_00D6:
mov eax, dword ptr [_LEX+422280]
...
.globl _LEXREADUTF16BE@0
_LEXREADUTF16BE@0:
push ebx
.L_0101:
jmp .L_0104
call _HUTF16BETOCHAR@0
mov dword ptr [_Lt_0106], eax
jmp .L_0103
.L_0104:
call _HUTF16BETOUTF16LE@0
mov dword ptr [_Lt_0106], eax
jmp .L_0103
.L_0105:
call _HUTF16BETOUTF32LE@0
mov dword ptr [_Lt_0106], eax
.L_0103:
mov eax, dword ptr [_LEX+422280]
...
mov dword ptr [ebp-4], 0
jmp .L_012B
call _HUTF32LETOCHAR@0
mov dword ptr [ebp-4], eax
jmp .L_012A
.L_012B:
call _HUTF32LETOUTF16LE@0
mov dword ptr [ebp-4], eax
jmp .L_012A
.L_012C:
call _HUTF32LETOUTF32LE@0
mov dword ptr [ebp-4], eax
.L_012A:
mov eax, dword ptr [_LEX+422280]
mov ebx, dword ptr [ebp-4]
...
mov dword ptr [ebp-4], 0
jmp .L_014F
call _HUTF32BETOCHAR@0
mov dword ptr [ebp-4], eax
jmp .L_014E
.L_014F:
call _HUTF32BETOUTF16LE@0
mov dword ptr [ebp-4], eax
jmp .L_014E
.L_0150:
call _HUTF32BETOUTF32LE@0
mov dword ptr [ebp-4], eax
.L_014E:
mov eax, dword ptr [_LEX+422280]
mov ebx, dword ptr [ebp-4]
