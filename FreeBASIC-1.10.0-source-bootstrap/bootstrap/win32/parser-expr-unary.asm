...
.globl _CNEGNOTEXPRESSION@0
_CNEGNOTEXPRESSION@0:
push ebp
mov ebp, esp
sub esp, 12
...
.globl _CSTRIDXORMEMBERDEREF@4
_CSTRIDXORMEMBERDEREF@4:
push ebp
mov ebp, esp
sub esp, 24
push ebx
...
.globl _CADDROFEXPRESSION@0
_CADDROFEXPRESSION@0:
push ebp
mov ebp, esp
sub esp, 28
push ebx
...
push dword ptr [ebp+12]
call _HPROCPTRRESOLVEOVERLOAD@12
mov dword ptr [ebp-12], eax
cmp dword ptr [ebp-12], 0
je .L_0119
mov eax, dword ptr [ebp-12]
...
push dword ptr [ebp-8]
push 22
call _SYMBFINDSELFUOPOVLPROC@12
mov dword ptr [ebp-16], eax
cmp dword ptr [ebp-16], 0
je .L_014D
push 0
