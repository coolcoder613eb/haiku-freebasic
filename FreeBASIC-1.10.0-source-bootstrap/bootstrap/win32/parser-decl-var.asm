...
.globl _HCOMPLAINIFABSTRACTCLASS@8
_HCOMPLAINIFABSTRACTCLASS@8:
push ebp
mov ebp, esp
.L_0068:
...
call _SYMBCOMPGETABSTRACTCOUNT@4
test eax, eax
jle .L_006D
push 0
push 0
...
.globl _HMAYBECOMPLAINTYPEUSAGE@12
_HMAYBECOMPLAINTYPEUSAGE@12:
push ebp
mov ebp, esp
sub esp, 8
push ebx
...
.globl _HCOMPLAINABOUTCONSTDYNAMICARRAY@4
_HCOMPLAINABOUTCONSTDYNAMICARRAY@4:
push ebp
mov ebp, esp
push ebx
.L_0079:
...
.globl _HMAYBECONVERTEXPRTB2DIMTB@16
_HMAYBECONVERTEXPRTB2DIMTB@16:
push ebp
mov ebp, esp
push ebx
.L_016C:
...
.globl _HCOMPLAINABOUTELLIPSIS@12
_HCOMPLAINABOUTELLIPSIS@12:
push ebp
mov ebp, esp
sub esp, 8
push ebx
...
lea eax, [ebp-60]
push eax
call _HMAYBECOMPLAINTYPEUSAGE@12
...
je .L_0249
call _HIDXINPARENSONLYEXPR@0
push eax
call _HCHECKDYNAMICARRAYEXPR@4
...
lea eax, [ebp-60]
push eax
call _HERRORDEFTYPENOTALLOWED@12
.L_026D:
.L_026C:
.L_026A:
.L_0267:
...
push dword ptr [ebp-8]
push dword ptr [ebp-20]
call _HLOOKUPVARANDCHECKPARENT@24
mov dword ptr [ebp-12], eax
...
push dword ptr [ebp-56]
push dword ptr [ebp-12]
call _HMAYBEBUILDFIELDACCESS@8
mov dword ptr [ebp-24], eax
cmp dword ptr [ebp-24], 0
je .L_0275
push dword ptr [ebp-24]
call _ASTNEWNIDXARRAY@4
push eax
call _HCHECKDYNAMICARRAYEXPR@4
mov dword ptr [ebp-24], eax
jmp .L_0274
...
push dword ptr [ebp+16]
push dword ptr [ebp+8]
call _HCHECKEXTERNVARANDRECOVER@36
mov eax, dword ptr [ebp+8]
...
push dword ptr [ecx]
push dword ptr [ebp+8]
call _SYMBCHECKDYNAMICARRAYDIMENSIONS@8
.L_0117:
.L_0116:
jmp .L_0110
.L_0111:
...
push 1
push dword ptr [ebp+8]
call _SYMBFINDBYCLASSANDTYPE@12
mov dword ptr [ebp-8], eax
cmp dword ptr [ebp-8], 0
jne .L_0154
push dword ptr [ebp+12]
...
.L_0187:
push dword ptr [ebp+8]
call _ASTBUILDTYPEINICTORLIST@4
mov dword ptr [ebp-4], eax
.L_0186:
.L_0185:
jmp .L_0183
...
push dword ptr [ebp+12]
push dword ptr [ebp+8]
call _HCHECKVARSUSEDINGLOBALINIT@8
.L_0192:
pop ebx
mov esp, ebp
pop ebp
...
ret 8
.balign 16
_HRESOLVEREFTOREFINITIALIZER@8:
push ebp
mov ebp, esp
sub esp, 44
push ebx
...
ret 8
.balign 16
_HCHECKANDBUILDBYREFINITIALIZER@8:
push ebp
mov ebp, esp
sub esp, 20
push ebx
...
mov eax, dword ptr [ebp+8]
push dword ptr [eax+28]
call _HBUILDFAKEBYREFINITEXPR@8
mov ebx, dword ptr [ebp+12]
mov dword ptr [ebx], eax
jmp .L_01C3
.L_01C4:
...
mov eax, dword ptr [ebp+8]
push dword ptr [eax+28]
call _HRESOLVEREFTOREFINITIALIZER@8
mov ebx, dword ptr [ebp+12]
mov dword ptr [ebx], eax
.L_01C3:
mov eax, dword ptr [ebp+8]
...
push eax
push dword ptr [ebp+8]
call _HVALIDATEGLOBALVARINIT@8
mov eax, dword ptr [ebp-20]
mov dword ptr [ebp-4], eax
.L_01C2:
mov eax, dword ptr [ebp-4]
...
push eax
push dword ptr [ebp+8]
call _HCHECKANDBUILDBYREFINITIALIZER@8
mov dword ptr [ebp-4], eax
jmp .L_01C6
.L_01D0:
.L_01CF:
...
je .L_01E9
push dword ptr [ebp+8]
call _ASTPROCADDSTATICINSTANCE@4
mov dword ptr [ebp-16], eax
push 0
push dword ptr [ebp-16]
...
push dword ptr [ebp+16]
push dword ptr [ebp+8]
call _ASTPROCADDGLOBALINSTANCE@12
.L_01EF:
.L_01EE:
mov eax, dword ptr [ebp+12]
mov dword ptr [ebp-4], eax
...
ret 8
.balign 16
_HCHECKANDBUILDAUTOVARINITIALIZER@8:
push ebp
mov ebp, esp
sub esp, 8
mov dword ptr [ebp-4], 0
...
push dword ptr [ebp+12]
push dword ptr [ebp+8]
call _HBUILDAUTOVARINITIALIZER@8
mov dword ptr [ebp-8], eax
lea eax, [ebp-8]
push eax
push dword ptr [ebp+8]
...
push dword ptr [ebp-24]
push dword ptr [ebp-8]
call _HCHECKANDBUILDAUTOVARINITIALIZER@8
mov dword ptr [ebp-24], eax
.L_0364:
push 0
push dword ptr [ebp-8]
