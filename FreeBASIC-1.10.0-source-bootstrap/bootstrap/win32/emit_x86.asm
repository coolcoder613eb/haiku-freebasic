...
push eax
push dword ptr [ebp-4]
call _HSTOREREGISTERARGUMENT@8
lea eax, [ebp-20]
push eax
call _fb_StrDelete@4
jmp .L_025F
...
.L_0296:
push dword ptr [ebp+8]
call _HSTOREREGISTERARGUMENTS@4
.L_026C:
.L_026B:
.L_0268:
pop ebx
