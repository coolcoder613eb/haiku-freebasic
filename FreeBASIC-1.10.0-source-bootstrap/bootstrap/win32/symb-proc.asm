...
.globl _SYMBLOOKUPINTERNALLYMANGLEDSUBTYPE@28
_SYMBLOOKUPINTERNALLYMANGLEDSUBTYPE@28:
push ebp
mov ebp, esp
sub esp, 20
push ebx
...
.globl _SYMBFINDCTOROVLPROC@20
_SYMBFINDCTOROVLPROC@20:
push ebp
mov ebp, esp
sub esp, 16
mov dword ptr [ebp-4], 0
...
ret 40
.balign 16
_HSETUPPROCREGISTERPARAMETERS@4:
push ebp
mov ebp, esp
sub esp, 16
push ebx
...
push dword ptr [ebp-20]
push dword ptr [ebp+12]
call _SYMBSETCOMPDTOR1@8
jmp .L_0157
.L_0159:
push dword ptr [ebp-20]
push dword ptr [ebp+12]
call _SYMBSETCOMPDTOR0@8
.L_0157:
jmp .L_0155
.L_0156:
mov eax, dword ptr [ebp+44]
...
.L_018F:
push dword ptr [ebp-20]
call _HSETUPPROCREGISTERPARAMETERS@4
mov eax, dword ptr [ebp-20]
mov dword ptr [ebp-4], eax
.L_0149:
mov eax, dword ptr [ebp-4]
