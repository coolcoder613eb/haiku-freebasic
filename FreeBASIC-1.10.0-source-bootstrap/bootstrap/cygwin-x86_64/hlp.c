...
uint8* HHEXUINT( uint64 VALUE$1 )
{
	...
	static struct $8FBARRAY1IlE tmp$92$1 = { (int64*)HEXTB$1, (int64*)HEXTB$1, 128ll, 8ll, 1ll, 49ll, { { 16ll, 0ll, 15ll } } };
	MAXLEN$1 = 4ll;
...
FBSTRING* HSTRIPPATH( uint8* FILENAME$1 )
{
	...
	static int64 P$1[2];
	static struct $8FBARRAY1IlE tmp$124$1 = { (int64*)((uint8*)P$1 + -8ll), (int64*)P$1, 16ll, 8ll, 1ll, 49ll, { { 2ll, 1ll, 2ll } } };
	LP$1 = 0ll;
	label$90:;
	{
...
FBSTRING* HSTRIPFILENAME( uint8* FILENAME$1 )
{
	...
	static int64 P_FOUND$1;
	static int64 P$1[2];
	static struct $8FBARRAY1IlE tmp$126$1 = { (int64*)((uint8*)P$1 + -8ll), (int64*)P$1, 16ll, 8ll, 1ll, 49ll, { { 2ll, 1ll, 2ll } } };
	LP$1 = 0ll;
	label$101:;
	{
		FBSTRING* vr$1 = fb_StrAllocTempDescZEx( (uint8*)"\x5C", 1ll );
...
void HREPLACESLASH( uint8* S$1, int64 CHAR$1 )
{
	label$124:;
	{
		...
		I$2 = I$2 + 1ll;
		label$126:;
		if( I$2 <= TMP$127$2 ) goto label$129;
		label$128:;
	}
	label$125:;
}
...
FBSTRING* PATHSTRIPDIV( FBSTRING* PATH$1 )
{
	...
	if( LENGTH$1 <= 0ll ) goto label$135;
	{
		...
		{
			uint8 TMP$128$3;
			TMP$128$3 = *(uint8*)((uint8*)*(uint8**)PATH$1 + LENGTH$1);
			if( (uint64)(int64)TMP$128$3 != 47ull ) goto label$137;
			label$138:;
			{
...
FBSTRING* HCURDIR( void )
{
	...
	fb_StrAssign( (void*)&TMP$129$1, -1ll, (void*)vr$2, -1ll, 0 );
	FBSTRING* vr$5 = PATHSTRIPDIV( &TMP$129$1 );
	fb_StrAssign( (void*)&fb$result$1, -1ll, (void*)vr$5, -1ll, 0 );
	fb_StrDelete( (FBSTRING*)&TMP$129$1 );
	label$165:;
...
FBSTRING* PATHSTRIPCURDIR( FBSTRING* PATH$1 )
{
	...
	FBSTRING* vr$4 = fb_StrConcat( &TMP$130$1, (void*)vr$1, -1ll, (void*)"/", 2ll );
...
int64 HISVALIDSYMBOLNAME( uint8* SYM$1 )
{
	...
	TMP$133$1 = (int64)-((uint64)(int64)*SYM$1 <= 122ull);
	goto label$194;
	label$176:;
	TMP$133$1 = 0ll;
	label$194:;
	if( TMP$133$1 != 0ll ) goto label$178;
	if( (uint64)(int64)*SYM$1 > 90ull ) goto label$177;
	TMP$135$1 = (int64)-((uint64)(int64)*SYM$1 >= 65ull);
	goto label$196;
	label$177:;
	TMP$135$1 = 0ll;
	label$196:;
	TMP$136$1 = (int64)-(TMP$135$1 != 0ll);
	goto label$195;
	label$178:;
	TMP$136$1 = -1ll;
	label$195:;
	if( TMP$136$1 != 0ll ) goto label$179;
	TMP$138$1 = (int64)-((uint64)(int64)*SYM$1 == 95ull);
	goto label$197;
	label$179:;
	TMP$138$1 = -1ll;
	label$197:;
	if( TMP$138$1 != 0ll ) goto label$181;
	{
		goto label$171;
		label$181:;
	}
	{
		...
		label$185:;
		{
			...
			TMP$140$3 = (int64)-((uint64)(int64)*(uint8*)((uint8*)SYM$1 + I$2) <= 122ull);
			goto label$198;
			label$186:;
			TMP$140$3 = 0ll;
			label$198:;
			if( TMP$140$3 != 0ll ) goto label$188;
			if( (uint64)(int64)*(uint8*)((uint8*)SYM$1 + I$2) > 90ull ) goto label$187;
			TMP$141$3 = (int64)-((uint64)(int64)*(uint8*)((uint8*)SYM$1 + I$2) >= 65ull);
			goto label$200;
			label$187:;
			TMP$141$3 = 0ll;
			label$200:;
			TMP$142$3 = (int64)-(TMP$141$3 != 0ll);
			goto label$199;
			label$188:;
			TMP$142$3 = -1ll;
			label$199:;
			if( TMP$142$3 != 0ll ) goto label$189;
			TMP$143$3 = (int64)-((uint64)(int64)*(uint8*)((uint8*)SYM$1 + I$2) == 95ull);
			goto label$201;
			label$189:;
			TMP$143$3 = -1ll;
			label$201:;
			if( TMP$143$3 != 0ll ) goto label$191;
			if( (uint64)(int64)*(uint8*)((uint8*)SYM$1 + I$2) > 57ull ) goto label$190;
			TMP$144$3 = (int64)-((uint64)(int64)*(uint8*)((uint8*)SYM$1 + I$2) >= 48ull);
			goto label$203;
			label$190:;
			TMP$144$3 = 0ll;
			label$203:;
			...
			TMP$145$3 = -1ll;
			label$202:;
			if( TMP$145$3 != 0ll ) goto label$193;
			{
				goto label$171;
				label$193:;
			}
		...
		I$2 = I$2 + 1ll;
		label$182:;
		if( I$2 <= TMP$139$2 ) goto label$185;
		label$184:;
	}
	fb$result$1 = -1ll;
	label$171:;
