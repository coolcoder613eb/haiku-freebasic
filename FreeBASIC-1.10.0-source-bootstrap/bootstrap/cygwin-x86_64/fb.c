...
void FBGLOBALINIT( void )
{
	...
	*($13FB_COMPTARGET*)((uint8*)&ENV$ + 216ll) = 1ll;
...
int64 FBISCROSSCOMP( void )
{
	...
	__builtin_memset( &fb$result$1, 0, 8ll );
	label$194:;
	fb$result$1 = (int64)-(*(int64*)((uint8*)&ENV$ + 216ll) != 1ll);
	label$195:;
	return fb$result$1;
}
...
FBSTRING* FBGETHOSTID( void )
{
	...
	__builtin_memset( &fb$result$1, 0, 24ll );
	label$209:;
	FBSTRING* vr$1 = HGETTARGETID( 1ll, 13ll );
	fb_StrAssign( (void*)&fb$result$1, -1ll, (void*)vr$1, -1ll, 0 );
	label$210:;
	FBSTRING* vr$4 = fb_StrAllocTempResult( (FBSTRING*)&fb$result$1 );
	return vr$4;
...
void FBINCLUDEFILE( uint8* FILENAME$1, int64 ISONCE$1 )
{
	...
	FBSTRING* vr$5 = fb_StrConcat( &TMP$199$1, (void*)INCFILE$1, 260ll, (void*)FILENAME$1, 0ll );
	...
	if( vr$6 != 0ll ) goto label$418;
	{
		...
		if( vr$7 != 0ll ) goto label$420;
		{
			...
			if( PATH$3 == (FBSTRING*)0ull ) goto label$422;
			{
				...
				FBSTRING* vr$12 = fb_StrConcat( &TMP$200$4, (void*)PATH$3, -1ll, (void*)"/", 2ll );
				__builtin_memset( &TMP$201$4, 0, 24ll );
				FBSTRING* vr$15 = fb_StrConcat( &TMP$201$4, (void*)vr$12, -1ll, (void*)FILENAME$1, 0ll );
			...
			if( PATH$3 != (FBSTRING*)0ull ) goto label$426;
			{
				...
				if( *(int64*)((uint8*)&ENV$ + 504ll) == 0ll ) goto label$428;
				{
					FBSTRING TMP$203$5;
					FBSTRING TMP$204$5;
					__builtin_memset( &TMP$204$5, 0, 24ll );
					__builtin_memset( &TMP$203$5, 0, 24ll );
					FBSTRING* vr$21 = fb_StrConcat( &TMP$203$5, (void*)FILENAME$1, 0ll, (void*)" (not found in include dirs)", 29ll );
					fb_StrAssign( (void*)&TMP$204$5, -1ll, (void*)vr$21, -1ll, 0 );
					HSHOWINCLUDE( *(int64*)((uint8*)&ENV$ + 1272ll) + 1ll, &TMP$204$5 );
					fb_StrDelete( (FBSTRING*)&TMP$204$5 );
				}
				label$428:;
				label$427:;
				__builtin_memset( &TMP$208$4, 0, 24ll );
				__builtin_memset( &TMP$206$4, 0, 24ll );
				FBSTRING* vr$29 = fb_StrConcat( &TMP$206$4, (void*)"\x22", 2ll, (void*)FILENAME$1, 0ll );
				__builtin_memset( &TMP$207$4, 0, 24ll );
				FBSTRING* vr$32 = fb_StrConcat( &TMP$207$4, (void*)vr$29, -1ll, (void*)"\x22", 2ll );
				fb_StrAssign( (void*)&TMP$208$4, -1ll, (void*)vr$32, -1ll, 0 );
				ERRREPORTEX( 23ll, (uint8*)*(uint8**)&TMP$208$4, 0ll, 1ll, (uint8*)0ull );
				fb_StrDelete( (FBSTRING*)&TMP$208$4 );
				ERRHIDEFURTHERERRORS(  );
				goto label$414;
			}
			label$426:;
	...
	label$418:;
	label$417:;
	TMP$209$1 = (uint8*)INCFILE$1;
	int64 vr$36 = IS_ROOTPATH( &TMP$209$1 );
	if( vr$36 != 0ll ) goto label$430;
	{
		...
		FBSTRING* vr$40 = fb_StrConcat( &TMP$210$2, (void*)vr$37, -1ll, (void*)"/", 2ll );
		__builtin_memset( &TMP$211$2, 0, 24ll );
		FBSTRING* vr$43 = fb_StrConcat( &TMP$211$2, (void*)vr$40, -1ll, (void*)INCFILE$1, 260ll );
		fb_StrAssign( (void*)INCFILE$1, 260ll, (void*)vr$43, -1ll, 0 );
	}
	label$430:;
	label$429:;
	TMP$212$1 = (uint8*)INCFILE$1;
	int64 vr$45 = IS_ROOTPATH( &TMP$212$1 );
	if( vr$45 != 0ll ) goto label$432;
	{
		...
		FBSTRING* vr$49 = fb_StrConcat( &TMP$213$2, (void*)"\x22", 2ll, (void*)INCFILE$1, 260ll );
		__builtin_memset( &TMP$214$2, 0, 24ll );
		FBSTRING* vr$52 = fb_StrConcat( &TMP$214$2, (void*)vr$49, -1ll, (void*)"\x22", 2ll );
		fb_StrAssign( (void*)&TMP$215$2, -1ll, (void*)vr$52, -1ll, 0 );
		ERRREPORTEX( 23ll, (uint8*)*(uint8**)&TMP$215$2, 0ll, 1ll, (uint8*)0ull );
	...
	if( vr$55 != 0ll ) goto label$434;
	{
		...
		FBSTRING* vr$59 = fb_StrConcat( &TMP$216$2, (void*)"\x22", 2ll, (void*)INCFILE$1, 260ll );
		__builtin_memset( &TMP$217$2, 0, 24ll );
		FBSTRING* vr$62 = fb_StrConcat( &TMP$217$2, (void*)vr$59, -1ll, (void*)"\x22", 2ll );
		fb_StrAssign( (void*)&TMP$218$2, -1ll, (void*)vr$62, -1ll, 0 );
	...
	if( ISONCE$1 == 0ll ) goto label$436;
	{
		...
		if( vr$66 == (uint8*)0ull ) goto label$438;
		{
			...
			fb_StrAssign( (void*)&TMP$219$3, -1ll, (void*)INCFILE$1, 260ll, 0 );
			HONSKIPPEDFILE( &TMP$219$3 );
	...
	*(uint8**)((uint8*)&ENV$ + 872ll) = FILEIDX$1;
	if( *(int64*)((uint8*)&ENV$ + 504ll) == 0ll ) goto label$442;
	{
		...
		fb_StrAssign( (void*)&TMP$221$2, -1ll, (void*)INCFILE$1, 260ll, 0 );
		FBSTRING* vr$90 = PATHSTRIPCURDIR( &TMP$221$2 );
		fb_StrAssign( (void*)&TMP$222$2, -1ll, (void*)vr$90, -1ll, 0 );
		HSHOWINCLUDE( *(int64*)((uint8*)&ENV$ + 1272ll), &TMP$222$2 );
	...
	*(int64*)((uint8*)&ENV$ + 600ll) = (int64)vr$95;
	...
	if( (int64)vr$99 == 0ll ) goto label$444;
	{
		...
		FBSTRING* vr$104 = fb_StrConcat( &TMP$223$2, (void*)"\x22", 2ll, (void*)FILENAME$1, 0ll );
		__builtin_memset( &TMP$224$2, 0, 24ll );
		FBSTRING* vr$107 = fb_StrConcat( &TMP$224$2, (void*)vr$104, -1ll, (void*)"\x22", 2ll );
		fb_StrAssign( (void*)&TMP$225$2, -1ll, (void*)vr$107, -1ll, 0 );
		ERRREPORTEX( 23ll, (uint8*)*(uint8**)&TMP$225$2, 0ll, 1ll, (uint8*)0ull );
...
$7FB_LANG FBGETLANGID( uint8* TXT$1 )
{
	...
	label$448:;
	{
		...
		fb_StrInit( (void*)&TMP$226$2, -1ll, (void*)vr$2, -1ll, 0 );
		int32 vr$5 = fb_StrCompare( (void*)&TMP$226$2, -1ll, (void*)"fb", 3ll );
		...
		goto label$450;
		label$451:;
		int32 vr$8 = fb_StrCompare( (void*)&TMP$226$2, -1ll, (void*)"deprecated", 11ll );
		...
		goto label$450;
		label$453:;
		int32 vr$11 = fb_StrCompare( (void*)&TMP$226$2, -1ll, (void*)"fblite", 7ll );
		...
		goto label$450;
		label$455:;
		int32 vr$14 = fb_StrCompare( (void*)&TMP$226$2, -1ll, (void*)"qb", 3ll );
...
$19FB_CVA_LIST_TYPEDEF FBGETBACKENDVALISTTYPE( void )
{
	...
	TYPEDEF$1 = 0ll;
	{
		$10FB_BACKEND TMP$227$2;
		TMP$227$2 = *($10FB_BACKEND*)((uint8*)&ENV$ + 208ll);
		if( TMP$227$2 != 1ll ) goto label$463;
		label$464:;
		{
			{
				int64 TMP$228$4;
				...
				TMP$228$4 = vr$1;
				if( TMP$228$4 != 0ll ) goto label$466;
				label$467:;
				{
					TYPEDEF$1 = 2ll;
				}
				goto label$465;
				label$466:;
				if( TMP$228$4 != 1ll ) goto label$468;
				label$469:;
				{
					{
						$13FB_COMPTARGET TMP$229$6;
						TMP$229$6 = *($13FB_COMPTARGET*)((uint8*)&ENV$ + 216ll);
						if( TMP$229$6 != 0ll ) goto label$471;
						label$472:;
						{
							TYPEDEF$1 = 2ll;
						}
				...
				goto label$465;
				label$468:;
				if( TMP$228$4 != 2ll ) goto label$474;
				label$475:;
				{
					TYPEDEF$1 = 5ll;
				}
				goto label$465;
				label$474:;
				if( TMP$228$4 != 3ll ) goto label$476;
				label$477:;
				{
					TYPEDEF$1 = 4ll;
				}
				goto label$465;
				label$476:;
				if( TMP$228$4 != 4ll ) goto label$478;
				label$479:;
				{
					TYPEDEF$1 = 2ll;
				}
				goto label$465;
				label$478:;
				if( TMP$228$4 == 5ll ) goto label$481;
				label$482:;
				if( TMP$228$4 != 6ll ) goto label$480;
				label$481:;
				{
					TYPEDEF$1 = 2ll;
				}
		...
		goto label$462;
		label$463:;
		if( TMP$227$2 != 0ll ) goto label$484;
		label$485:;
		{
			TYPEDEF$1 = 1ll;
		}
		goto label$462;
		label$484:;
		if( TMP$227$2 != 2ll ) goto label$486;
		label$487:;
		{
			TYPEDEF$1 = 1ll;
		}
		goto label$462;
		label$486:;
		if( TMP$227$2 != 3ll ) goto label$488;
		label$489:;
		{
			{
				$13FB_COMPTARGET TMP$230$4;
				TMP$230$4 = *($13FB_COMPTARGET*)((uint8*)&ENV$ + 216ll);
				if( TMP$230$4 != 0ll ) goto label$491;
				label$492:;
				{
					TYPEDEF$1 = 2ll;
				}
...
static int64 SOLVE_PATH( uint8* PATH$1 )
{
	...
	static struct $8FBARRAY1IlE tmp$196$1 = { (int64*)CIDX$1, (int64*)CIDX$1, 1048ll, 8ll, 1ll, 49ll, { { 131ll, 0ll, 130ll } } };
	int64 STK$1;
	int64 S$1;
	int64 N$1;
	int64 D$1;
	...
	*(int64*)((int64)(int64*)CIDX$1 + (STK$1 << (3ll & 63ll))) = S$1;
	...
	D$1 = 0ll;
	{
		...
		R$1 = R$1 + 1ll;
		label$399:;
		if( R$1 <= TMP$197$2 ) goto label$402;
		label$401:;
	}
