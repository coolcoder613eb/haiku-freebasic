...
int32 main( int32 __FB_ARGC__$0, char** __FB_ARGV__$0 )
{
	...
	label$1399:;
	{
		...
		fb_StrAssign( (void*)&TMP$781$1, -1ll, (void*)((uint8*)&FBC$ + 3034ll), 261ll, 0 );
		FBADDINCLUDEPATH( &TMP$781$1 );
		fb_StrDelete( (FBSTRING*)&TMP$781$1 );
		...
		if( *(int64*)((uint8*)&FBC$ + 136ll) < 0ll ) goto label$1405;
		{
			{
				int64 TMP$782$3;
				TMP$782$3 = *(int64*)((uint8*)&FBC$ + 136ll);
				if( TMP$782$3 != 0ll ) goto label$1407;
				label$1408:;
				{
				...
				goto label$1406;
				label$1407:;
				if( TMP$782$3 != 1ll ) goto label$1409;
				label$1410:;
				{
				...
				goto label$1406;
				label$1409:;
				if( TMP$782$3 != 2ll ) goto label$1411;
				label$1412:;
				{
				...
				goto label$1406;
				label$1411:;
				if( TMP$782$3 != 3ll ) goto label$1415;
				label$1416:;
				{
				...
				goto label$1406;
				label$1415:;
				if( TMP$782$3 != 4ll ) goto label$1417;
				label$1418:;
				{
...
static int64 HLINKFILES( void )
{
	...
	label$235:;
	{
		...
		goto label$243;
		label$244:;
		static const void* tmp$785[12ll] = {
			&&label$245,
			&&label$245,
			&&label$254,
			&&label$243,
	...
	}
	{
				...
				{
					{
						...
						goto label$332;
						label$333:;
						static const void* tmp$787[3ll] = {
							&&label$334,
							&&label$335,
							&&label$334,
						};
						if( (TMP$207$6 - 8ull) > 2ull ) goto label$335;
						goto *tmp$787[TMP$207$6 - 8ull];
						label$332:;
					}
				}
				goto label$330;
				...
				{
					{
						...
						goto label$336;
						label$337:;
						static const void* tmp$788[3ll] = {
							&&label$338,
							&&label$339,
							&&label$338,
						};
						if( (TMP$209$6 - 8ull) > 2ull ) goto label$339;
						goto *tmp$788[TMP$209$6 - 8ull];
						label$336:;
					}
				}
				label$330:;
		...
		goto label$312;
		label$313:;
		static const void* tmp$789[11ll] = {
			&&label$319,
			&&label$314,
			&&label$327,
			&&label$324,
	...
	label$366:;
	{
		...
		goto label$370;
		label$371:;
		static const void* tmp$790[11ll] = {
			&&label$377,
			&&label$370,
			&&label$372,
			&&label$370,
...
static void HANDLEOPT( int64 OPTID$1, FBSTRING* ARG$1, int64 IS_SOURCE$1 )
{
	label$500:;
	{
		...
		label$637:;
		{
			...
			if( (((int64)-(OS$3 != 1ll) | (int64)-(CPUTYPE$3 != 13ll)) | IS_GNU_TRIPLET$3) == 0ll ) goto label$641;
			{
				FBSTRING TMP$344$4;
		...
		goto label$502;
		label$503:;
		static const void* tmp$794[70ll] = {
			&&label$504,
			&&label$505,
			&&label$508,
			&&label$515,
...
static int64 PARSEOPTION( uint8* OPT$1 )
{
	...
	label$711:;
	{
		...
		goto label$713;
		label$714:;
		static const void* tmp$795[78ll] = {
			&&label$880,
			&&label$713,
			&&label$713,
			&&label$713,
	...
	label$891:;
	{
		...
		label$912:;
		{
			...
			fb_StrAssign( (void*)&EXT$3, -1ll, (void*)vr$27, -1ll, 0 );
			{
				...
				if( (int64)vr$30 != 0ll ) goto label$920;
				label$921:;
				{
					HADDBAS( ARG$1 );
				}
				...
				if( (int64)vr$33 != 0ll ) goto label$922;
				label$923:;
				{
					FBCADDOBJ( ARG$1 );
				}
				...
				if( (int64)vr$36 != 0ll ) goto label$924;
				label$925:;
				{
				...
				if( (int64)vr$43 != 0ll ) goto label$926;
				label$927:;
				{
				...
				if( (int64)vr$48 != 0ll ) goto label$929;
				label$930:;
				{
					int64 vr$51 = fb_StrLen( (void*)((uint8*)&FBC$ + 272ll), -1ll );
					if( vr$51 <= 0ll ) goto label$932;
					{
						HFATALINVALIDOPTION( ARG$1, IS_SOURCE$1 );
					}
					label$932:;
...
static void HADDDEFAULTLIBS( void )
{
	...
	label$1325:;
	{
		...
		label$1342:;
		{
			...
			if( ((int64)-(vr$28 > 0ll) | (int64)-(vr$31 > 0ll)) == 0ll ) goto label$1344;
			{
			...
			if( ((int64)-(vr$35 > 0ll) | (int64)-(vr$38 > 0ll)) == 0ll ) goto label$1346;
			{
		...
		label$1349:;
		{
			...
			if( ((int64)-(vr$42 > 0ll) | (int64)-(vr$45 > 0ll)) == 0ll ) goto label$1351;
			{
				FBCADDDEFLIB( (uint8*)"gcc_eh" );
			}
			label$1351:;
		...
		goto label$1331;
		label$1332:;
		static const void* tmp$800[11ll] = {
			&&label$1349,
			&&label$1333,
			&&label$1342,
			&&label$1337,
		...
		if( TMP$643$2 > 10ull ) goto label$1331;
		goto *tmp$800[TMP$643$2 - 0ull];
		label$1331:;
	}
	label$1322:;
}
...
static void HPRINTVERSION( int64 VERBOSE$1 )
{
	...
	FBSTRING* vr$6 = fb_StrConcat( &TMP$775$1, (void*)"FreeBASIC Compiler - Version 1.10.0 (2023-10-18), built for ", 61ll, (void*)vr$3, -1ll );
	__builtin_memset( &TMP$776$1, 0, 24ll );
	FBSTRING* vr$9 = fb_StrConcat( &TMP$776$1, (void*)vr$6, -1ll, (void*)" (", 3ll );
	__builtin_memset( &TMP$777$1, 0, 24ll );
	FBSTRING* vr$12 = fb_StrConcat( &TMP$777$1, (void*)vr$9, -1ll, (void*)vr$2, -1ll );
	__builtin_memset( &TMP$778$1, 0, 24ll );
	FBSTRING* vr$15 = fb_StrConcat( &TMP$778$1, (void*)vr$12, -1ll, (void*)"bit)", 5ll );
	fb_PrintString( 0, (FBSTRING*)vr$15, 1 );
