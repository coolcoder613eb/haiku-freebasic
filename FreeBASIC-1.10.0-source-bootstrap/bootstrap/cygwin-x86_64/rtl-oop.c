...
static struct $14FB_RTL_PROCDEF FUNCDATA$[4] = { { (uint8*)"fb_IsTypeOf", (uint8*)0ull, 11ll, -1ll, (tmp$34)0ull, 0ll, 2ll, { { 0ll, 2ll, 0ll }, { 0ll, 2ll, 0ll } } }, { (uint8*)0ull } };
...
struct $7ASTNODE* RTLOOPISTYPEOF( struct $7ASTNODE* INST$1, struct $7ASTNODE* RTTI$1 )
{
	...
	struct $8FBSYMBOL* vr$1 = RTLPROCLOOKUP( (uint8*)"fb_IsTypeOf", 138ll );
