...
static void HUNDEFSYMBOL( void )
{
	...
	__builtin_memset( &S$1, 0, 8ll );
	{
		...
		label$52:;
		{
			S$1 = *(struct $8FBSYMBOL**)*(struct $10FBSYMCHAIN**)((uint8*)*(struct $7FBTOKEN**)((uint8*)*(struct $9LEX_TKCTX**)((uint8*)&LEX$ + 426768ll) + 8520ll) + 2088ll);
		...
		label$55:;
		{
			struct $8FBSYMBOL* vr$7 = SYMBFINDBYCLASS( *(struct $10FBSYMCHAIN**)((uint8*)*(struct $7FBTOKEN**)((uint8*)*(struct $9LEX_TKCTX**)((uint8*)&LEX$ + 426768ll) + 8520ll) + 2088ll), 3ll );
			S$1 = vr$7;
			...
			label$57:;
			{
				struct $8FBSYMBOL* vr$17 = SYMBFINDBYCLASS( *(struct $10FBSYMCHAIN**)((uint8*)*(struct $7FBTOKEN**)((uint8*)*(struct $9LEX_TKCTX**)((uint8*)&LEX$ + 426768ll) + 8520ll) + 2088ll), 5ll );
				S$1 = vr$17;
