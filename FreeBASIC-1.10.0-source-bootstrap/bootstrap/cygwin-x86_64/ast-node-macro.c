	...
	{
		{
			...
			goto label$26;
			label$14:;
			TMP$83$3 = DTYPE$1 & 31ll;
			label$26:;
			TMP$84$3 = *($12FB_DATACLASS*)((int64)(struct $13SYMB_DATATYPE*)SYMB_DTYPETB$ + (TMP$83$3 * 56ll));
			if( TMP$84$3 != 0ll ) goto label$16;
			label$17:;
			{
				int64 TMP$85$4;
				...
				label$27:;
				if( *(int64*)(((int64)(struct $13SYMB_DATATYPE*)SYMB_DTYPETB$ + (TMP$85$4 * 56ll)) + 8ll) >= *(int64*)((int64)(struct $13SYMB_DATATYPE*)SYMB_DTYPETB$ + 456ll) ) goto label$20;
				{
			...
			label$22:;
			{
				...
				label$28:;
				if( *(int64*)(((int64)(struct $13SYMB_DATATYPE*)SYMB_DTYPETB$ + (TMP$86$4 * 56ll)) + 8ll) >= *(int64*)((int64)(struct $13SYMB_DATATYPE*)SYMB_DTYPETB$ + 904ll) ) goto label$25;
				{
...
struct $6IRVREG* ASTLOADMACRO( struct $7ASTNODE* N$1 )
{
	...
	OP$1 = *($6AST_OP*)((uint8*)N$1 + 40ll);
	{
		...
		label$37:;
		{
			...
			V2$1 = vr$12;
			struct $6IRVREG* vr$15 = (*(tmp$69*)((uint8*)&IR$ + 448ll))( *(int64*)((uint8*)N$1 + 8ll), *(struct $8FBSYMBOL**)((uint8*)N$1 + 16ll) );
			VR$1 = vr$15;
		}
		goto label$31;
		label$36:;
	...
	{
		(*(tmp$59*)((uint8*)&IR$ + 304ll))( OP$1, V1$1, V2$1, VR$1 );
	}
	label$41:;
	label$40:;
