...
uint16* fb_WstrConcatAW( void*, int64, uint16* );
...
int64 PARSERISGLOBALASMKEYWORD( uint8* ID$1 )
{
	...
	fb_StrAssign( (void*)&TMP$828$1, -1ll, (void*)vr$3, -1ll, 0 );
	void* vr$6 = HASHLOOKUP( (struct $5THASH*)((uint8*)&GLOBALASMKEYWORDS$ + 8ll), (uint8*)*(uint8**)&TMP$828$1 );
...
void CASMCODE( void )
{
	...
	label$60:;
	{
		...
		THISTOK$1 = vr$0;
		{
			...
			goto label$63;
			label$64:;
			static const void* tmp$838[85ll] = {
				&&label$65,
				&&label$65,
				&&label$63,
				&&label$65,
			...
			if( (TMP$829$3 - 256ull) > 84ull ) goto label$63;
			goto *tmp$838[TMP$829$3 - 256ull];
			label$63:;
		}
		...
		DOSKIP$1 = 0ll;
		{
			...
			label$68:;
			{
				...
				goto label$69;
				label$70:;
				__builtin_memset( &TMP$831$4, 0, 24ll );
				FBSTRING* vr$7 = fb_StrAllocTempDescZ( (uint8*)TEXT$1 );
				FBSTRING* vr$8 = fb_StrLcase2( (FBSTRING*)vr$7, 0 );
				fb_StrAssign( (void*)&TMP$831$4, -1ll, (void*)vr$8, -1ll, 0 );
				int64 vr$10 = HISINLINEASMKEYWORD( (uint8*)*(uint8**)&TMP$831$4 );
				TMP$832$4 = (int64)-(vr$10 == 0ll);
				fb_StrDelete( (FBSTRING*)&TMP$831$4 );
				if( TMP$832$4 == 0ll ) goto label$75;
				{
					...
					if( CHAIN_$1 == (struct $10FBSYMCHAIN*)0ull ) goto label$77;
					{
						...
						{
							{
								$12FB_SYMBCLASS TMP$833$8;
								TMP$833$8 = *($12FB_SYMBCLASS*)S$6;
								if( TMP$833$8 == 3ll ) goto label$83;
								label$84:;
								if( TMP$833$8 != 7ll ) goto label$82;
								label$83:;
								{
									SYM$1 = S$6;
									goto label$77;
								...
								goto label$81;
								label$82:;
								if( TMP$833$8 != 2ll ) goto label$85;
								label$86:;
								{
								...
								goto label$81;
								label$85:;
								if( TMP$833$8 != 1ll ) goto label$87;
								label$88:;
								{
			...
			label$94:;
			{
				...
				if( EXPR$1 == (struct $7ASTNODE*)0ull ) goto label$96;
				{
					...
					if( LITSYM$5 == (struct $8FBSYMBOL*)0ull ) goto label$98;
					{
						...
						{
							FBSTRING TMP$835$7;
							__builtin_memset( &TMP$835$7, 0, 24ll );
							FBSTRING* vr$33 = fb_StrConcat( &TMP$835$7, (void*)TEXT$1, 1025ll, *(void**)((uint8*)LITSYM$5 + 96ll), 0ll );
						...
						{
							uint16* TMP$836$7;
							uint16* vr$35 = fb_WstrConcatAW( (void*)TEXT$1, 1025ll, (uint16*)*(uint16**)((uint8*)LITSYM$5 + 96ll) );
							TMP$836$7 = vr$35;
							fb_WstrAssignToA( (void*)TEXT$1, 1025ll, (uint16*)TMP$836$7, 0 );
							fb_WstrDelete( (uint16*)TMP$836$7 );
						}
						label$99:;
						__builtin_memset( &TMP$837$6, 0, 24ll );
						FBSTRING* vr$38 = fb_StrConcat( &TMP$837$6, (void*)TEXT$1, 1025ll, (void*)"\x22", 2ll );
			...
			if( TMP$830$3 > 4ull ) goto label$66;
			goto *tmp$839[TMP$830$3 - 0ull];
			label$66:;
		}
...
int64 CASMBLOCK( void )
{
	...
	if( vr$3 == 0ll ) goto label$128;
	{
		if( *(int64*)((uint8*)&ENV$ + 296ll) == 0ll ) goto label$130;
		{
			...
			{
				struct $7ASTNODE* vr$5 = ASTNEWLIT( *(uint8**)((uint8*)*(struct $9LEX_TKCTX**)((uint8*)&LEX$ + 426768ll) + 25072ll) );
				ASTADD( vr$5 );
	...
	label$137:;
	{
		...
		{
			struct $7ASTNODE* vr$11 = ASTNEWDBG( 113ll, *(int64*)((uint8*)*(struct $9LEX_TKCTX**)((uint8*)&LEX$ + 426768ll) + 8560ll), *(uint8**)((uint8*)&ENV$ + 872ll) );
			ASTADD( vr$11 );
		}
		label$141:;
		label$140:;
		...
		if( *(int64*)((uint8*)&ENV$ + 296ll) == 0ll ) goto label$143;
		{
			...
			{
				struct $7ASTNODE* vr$13 = ASTNEWLIT( *(uint8**)((uint8*)*(struct $9LEX_TKCTX**)((uint8*)&LEX$ + 426768ll) + 25072ll) );
				ASTADD( vr$13 );
				DZSTRRESET( (struct $8DZSTRING*)((uint8*)*(struct $9LEX_TKCTX**)((uint8*)&LEX$ + 426768ll) + 25072ll) );
			}
			label$145:;
		...
		label$142:;
		{
			...
			TMP$840$3 = vr$16;
			if( TMP$840$3 != 257ll ) goto label$147;
			label$148:;
			{
			...
			goto label$146;
			label$147:;
			if( TMP$840$3 != 256ll ) goto label$151;
			label$152:;
			{
				goto label$138;
			}
			goto label$146;
			label$151:;
			if( TMP$840$3 != 340ll ) goto label$153;
			label$154:;
			{
				goto label$138;
			}
...
static void HINITGLOBALASMKEYWORDS( void )
{
	...
	if( *(int64*)&GLOBALASMKEYWORDS$ != 0ll ) goto label$25;
	{
		...
		HASHINIT( (struct $5THASH*)((uint8*)&GLOBALASMKEYWORDS$ + 8ll), 200ll, 0ll );
		{
			...
			TMP$827$3 = vr$2;
			if( TMP$827$3 == 0ll ) goto label$28;
			label$29:;
			if( TMP$827$3 != 1ll ) goto label$27;
			label$28:;
			{
				{
					int64 I$5;
