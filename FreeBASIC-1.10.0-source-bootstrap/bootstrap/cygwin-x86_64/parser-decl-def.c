...
void SYMBSETDEFTYPE( int64, int64, int64 );
...
void CDEFDECL( void )
{
	...
	int64 ICHAR$1;
	int64 ECHAR$1;
	if( (*(int64*)((uint8*)&ENV$ + 1424ll) & 4194304ll) != 0ll ) goto label$13;
	{
	...
	TMP$93$1 = 8ll;
	label$43:;
	int64 vr$1 = CCOMPSTMTISALLOWED( TMP$93$1 );
	...
	DTYPE$1 = 2147483648ll;
	{
		...
		if( (TMP$94$2 - 321ull) > 12ull ) goto label$17;
		goto *tmp$95[TMP$94$2 - 321ull];
		label$17:;
	}
	LEXSKIPTOKEN( 2048ll );
	label$32:;
	{
		...
		uint32 vr$8 = fb_ASC( (FBSTRING*)vr$7, 1ll );
		ICHAR$1 = (int64)vr$8;
		LEXSKIPTOKEN( 2048ll );
		...
		if( vr$10 != 45ll ) goto label$38;
		{
			...
			label$40:;
			label$39:;
			FBSTRING* vr$15 = fb_StrAllocTempDescZ( (uint8*)CHAR$1 );
			uint32 vr$16 = fb_ASC( (FBSTRING*)vr$15, 1ll );
			ECHAR$1 = (int64)vr$16;
			LEXSKIPTOKEN( 2048ll );
		}
		goto label$37;
