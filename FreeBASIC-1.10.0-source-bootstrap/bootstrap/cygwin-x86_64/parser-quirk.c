...
int64 CQUIRKSTMT( $8FB_TOKEN TK$1 )
{
	...
	if( TK$1 != -1ll ) goto label$13;
	{
		...
		TK$1 = vr$1;
		{
			...
			TMP$93$3 = vr$2;
			if( TMP$93$3 == 1ll ) goto label$16;
			label$17:;
			if( TMP$93$3 != 2ll ) goto label$15;
			label$16:;
			{
	...
	RES$1 = 0ll;
	{
		...
		goto label$27;
		label$28:;
		static const void* tmp$95[259ll] = {
			&&label$83,
			&&label$27,
			&&label$27,
			&&label$27,
		...
		if( (TMP$94$2 - 260ull) > 258ull ) goto label$27;
		goto *tmp$95[TMP$94$2 - 260ull];
		label$27:;
	}
...
struct $7ASTNODE* CQUIRKFUNCTION( struct $8FBSYMBOL* SYM$1 )
{
	...
	if( (*(int64*)((uint8*)&PARSER$ + 304ll) & 1024ll) == 0ll ) goto label$94;
	{
		...
		if( ((int64)-(vr$3 != 40ll) & ((int64)-(TK$1 != 336ll) | (int64)-(vr$6 != 301ll))) == 0ll ) goto label$96;
		{
			...
			fb_StrAssign( (void*)&TMP$96$3, -1ll, (void*)vr$13, -1ll, 0 );
			struct $7ASTNODE* vr$15 = ASTNEWCONSTSTR( (uint8*)*(uint8**)&TMP$96$3 );
			FUNCEXPR$1 = vr$15;
			fb_StrDelete( (FBSTRING*)&TMP$96$3 );
			LEXSKIPTOKEN( 0ll );
	...
	label$93:;
	{
		...
		goto label$97;
		label$98:;
		static const void* tmp$98[184ll] = {
			&&label$111,
			&&label$97,
			&&label$97,
			&&label$97,
		...
		if( (TMP$97$2 - 336ull) > 183ull ) goto label$97;
		goto *tmp$98[TMP$97$2 - 336ull];
		label$97:;
	}
