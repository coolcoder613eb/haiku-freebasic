...
static void HANDLEOPT( int64 OPTID$1, FBSTRING* ARG$1, int64 IS_SOURCE$1 )
{
	label$500:;
	{
		...
		label$637:;
		{
			...
			if( (((int64)-(OS$3 != 2ll) | (int64)-(CPUTYPE$3 != 16ll)) | IS_GNU_TRIPLET$3) == 0ll ) goto label$641;
			{
				FBSTRING TMP$344$4;
