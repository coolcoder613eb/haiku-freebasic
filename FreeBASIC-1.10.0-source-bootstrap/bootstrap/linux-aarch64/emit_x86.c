...
int64 HFINDREGNOTINVREG( struct $6IRVREG* VREG$1, int64 NOSIDI$1 )
{
	...
	label$34:;
	label$33:;
	int64 vr$13 = (*(tmp$87*)((uint8*)*(struct $8REGCLASS**)((uint8*)&EMIT$ + 16ll) + 48ll))( *(struct $8REGCLASS**)((uint8*)&EMIT$ + 16ll) );
	REGS$1 = vr$13;
...
int64 HFINDFREEREG( int64 DCLASS$1 )
{
	...
	{
		int64 R$2;
		int64 vr$3 = (*(tmp$87*)((uint8*)*(struct $8REGCLASS**)((uint8*)((uint8*)&EMIT$ + (DCLASS$1 << (3ll & 63ll))) + 16ll) + 48ll))( *(struct $8REGCLASS**)((uint8*)((uint8*)&EMIT$ + (DCLASS$1 << (3ll & 63ll))) + 16ll) );
		R$2 = vr$3 + -1ll;
		goto label$85;
		label$88:;
		{
...
uint8* HGETREGNAME( int64 DTYPE$1, int64 REG$1 )
{
	...
	label$116:;
	{
		...
		label$118:;
		TB$2 = *(int64*)((int64)(struct $12EMITDATATYPE*)DTYPETB$ + (TMP$144$2 * 24ll));
	...
	label$142:;
	{
		...
		label$146:;
		{
			...
			if( IDX_OP$3 == (uint8*)0ull ) goto label$152;
			{
				...
				FBSTRING* vr$10 = fb_StrConcat( &TMP$156$4, (void*)OPERAND$1, -1ll, (void*)IDX_OP$3, 0ll );
		...
		label$162:;
		{
			...
			FBSTRING* vr$20 = fb_StrConcat( &TMP$159$3, (void*)OPERAND$1, -1ll, (void*)vr$17, 0ll );
			...
			if( *(int64*)((uint8*)VREG$1 + 64ll) == 0ll ) goto label$164;
			{
				...
				FBSTRING* vr$26 = fb_StrConcat( &TMP$161$4, (void*)OPERAND$1, -1ll, (void*)vr$23, -1ll );
...
void OUTP( uint8* S$1 )
{
	...
	if( *(int64*)((uint8*)&ENV$ + 296ll) == 0ll ) goto label$187;
	{
		...
		__builtin_memset( &TMP$164$2, 0, 24ll );
		FBSTRING* vr$2 = fb_StrConcat( &TMP$164$2, (void*)&OSTR$1, -1ll, (void*)S$1, 0ll );
...
void HBRANCH( uint8* MNEMONIC$1, uint8* LABEL$1 )
{
	...
	FBSTRING* vr$2 = fb_StrConcat( &TMP$167$1, (void*)&OSTR$1, -1ll, (void*)LABEL$1, 0ll );
	fb_StrAssign( (void*)&OSTR$1, -1ll, (void*)vr$2, -1ll, 0 );
...
void HPUSH( uint8* RNAME$1 )
{
	...
	FBSTRING* vr$2 = fb_StrConcat( &TMP$169$1, (void*)&OSTR$1, -1ll, (void*)RNAME$1, 0ll );
	fb_StrAssign( (void*)&OSTR$1, -1ll, (void*)vr$2, -1ll, 0 );
	OUTP( (uint8*)*(uint8**)&OSTR$1 );
	label$191:;
}
...
void HPOP( uint8* RNAME$1 )
{
	...
	FBSTRING* vr$2 = fb_StrConcat( &TMP$171$1, (void*)&OSTR$1, -1ll, (void*)RNAME$1, 0ll );
	fb_StrAssign( (void*)&OSTR$1, -1ll, (void*)vr$2, -1ll, 0 );
	OUTP( (uint8*)*(uint8**)&OSTR$1 );
	label$193:;
}
...
void HMOV( uint8* DNAME$1, uint8* SNAME$1 )
{
	...
	FBSTRING* vr$2 = fb_StrConcat( &TMP$173$1, (void*)&OSTR$1, -1ll, (void*)DNAME$1, 0ll );
	fb_StrAssign( (void*)&OSTR$1, -1ll, (void*)vr$2, -1ll, 0 );
	fb_StrConcatAssign( (void*)&OSTR$1, -1ll, (void*)", ", 3ll, 0 );
	__builtin_memset( &TMP$174$1, 0, 24ll );
	FBSTRING* vr$5 = fb_StrConcat( &TMP$174$1, (void*)&OSTR$1, -1ll, (void*)SNAME$1, 0ll );
...
void EMITVARINIF( int64 DTYPE$1, double VALUE$1 )
{
	...
	FBSTRING* vr$11 = fb_StrConcat( &TMP$944$1, (void*)vr$8, -1ll, (void*)"\x0A", 2ll );
...
void EMITVARINIPAD( int64 BYTES$1 )
{
	...
	FBSTRING* vr$10 = fb_StrConcat( &TMP$956$1, (void*)vr$7, -1ll, (void*)"\x0A", 2ll );
...
void EMITFBCTINFSTRING( uint8* S$1 )
{
	...
	uint8* vr$0 = (*(tmp$102*)((uint8*)&EMIT$ + 456ll))( 4ll );
...
static void HPUBLIC( uint8* LABEL$1, int64 ISEXPORT$1 )
{
	...
	FBSTRING* vr$2 = fb_StrConcat( &TMP$183$1, (void*)&OSTR$1, -1ll, (void*)LABEL$1, 0ll );
	fb_StrAssign( (void*)&OSTR$1, -1ll, (void*)vr$2, -1ll, 0 );
	fb_StrConcatAssign( (void*)&OSTR$1, -1ll, (void*)"\x0A", 2ll, 0 );
	OUTEX( (uint8*)*(uint8**)&OSTR$1, 0ll );
	label$201:;
...
static void HINITREGTB( void )
{
	...
	static struct $8FBARRAY1I12REG_SIZEMASKE tmp$187$1 = { ($12REG_SIZEMASK*)INT_BITSMASK$1, ($12REG_SIZEMASK*)INT_BITSMASK$1, 48ll, 8ll, 1ll, 49ll, { { 6ll, 0ll, 5ll } } };
	struct $8REGCLASS* vr$3 = REGNEWCLASS( 0ll, 6ll, (struct $7FBARRAYI12REG_SIZEMASKE*)&tmp$187$1, 0ll );
	*(struct $8REGCLASS**)((uint8*)&EMIT$ + 16ll) = vr$3;
	static $12REG_SIZEMASK FLT_BITSMASK$1[7] = { 12ll, 12ll, 12ll, 12ll, 12ll, 12ll, 12ll };
	static struct $8FBARRAY1I12REG_SIZEMASKE tmp$188$1 = { ($12REG_SIZEMASK*)FLT_BITSMASK$1, ($12REG_SIZEMASK*)FLT_BITSMASK$1, 56ll, 8ll, 1ll, 49ll, { { 7ll, 0ll, 6ll } } };
	if( *(int64*)((uint8*)&ENV$ + 232ll) != 1ll ) goto label$209;
	{
		struct $8REGCLASS* vr$4 = REGNEWCLASS( 1ll, 7ll, (struct $7FBARRAYI12REG_SIZEMASKE*)&tmp$188$1, 0ll );
		*(struct $8REGCLASS**)((uint8*)&EMIT$ + 24ll) = vr$4;
		{
			...
			label$213:;
			{
				...
				FBSTRING* vr$8 = fb_StrConcat( &TMP$190$4, (void*)"xmm", 4ll, (void*)vr$5, -1ll );
	...
	label$209:;
	{
		struct $8REGCLASS* vr$12 = REGNEWCLASS( 1ll, 7ll, (struct $7FBARRAYI12REG_SIZEMASKE*)&tmp$188$1, -1ll );
...
static void HEMITVARBSS( struct $8FBSYMBOL* S$1 )
{
	...
	FBSTRING* vr$9 = fb_StrConcat( &TMP$193$1, (void*)&OSTR$1, -1ll, (void*)vr$6, 0ll );
...
static void HEMITVARCONST( struct $8FBSYMBOL* S$1 )
{
	...
	DTYPE$1 = *(int64*)((uint8*)S$1 + 56ll) & 511ll;
	{
		...
		label$240:;
		{
			...
			FBSTRING* vr$6 = fb_StrConcat( &TMP$198$3, (void*)&STEXT$1, -1ll, (void*)vr$3, 0ll );
		...
		label$241:;
		{
			FBSTRING TMP$202$3;
			fb_StrAssign( (void*)&STEXT$1, -1ll, (void*)"\x22", 2ll, 0 );
			uint8* vr$8 = HESCAPEW( (uint32*)*(uint32**)((uint8*)S$1 + 96ll) );
		...
		if( (TMP$196$2 - 4ull) > 3ull ) goto label$246;
		goto *tmp$1020[TMP$196$2 - 4ull];
		label$238:;
	}
...
static void HEMITEXPORT( struct $8FBSYMBOL* S$1 )
{
	...
	if( (*(int64*)((uint8*)S$1 + 8ll) & 256ll) == 0ll ) goto label$264;
	{
		...
		FBSTRING* vr$10 = fb_StrConcat( &TMP$212$2, (void*)vr$7, -1ll, (void*)"\x22\x0A", 3ll );
	...
	if( (*(int64*)((uint8*)PROC$1 + 16ll) & 128ll) != 0ll ) goto label$345;
	{
		...
		if( *(int64*)((uint8*)&ENV$ + 216ll) != 3ll ) goto label$357;
		{
			if( *(int64*)((uint8*)&ENV$ + 368ll) == 0ll ) goto label$359;
			{
				...
				FBSTRING* vr$36 = fb_StrConcat( &TMP$273$4, (void*)vr$33, -1ll, (void*)"\x0A", 2ll );
...
static void HDESTROYFRAME( struct $8FBSYMBOL* PROC$1, int64 BYTESTOPOP$1 )
{
	...
	if( ISLINUX$1 == 0ll ) goto label$384;
	{
		...
		FBSTRING* vr$41 = fb_StrConcat( &TMP$295$2, (void*)vr$38, -1ll, (void*)"\x0A", 2ll );
...
static void _EMITLIT( uint8* S$1 )
{
	...
	FBSTRING* vr$3 = fb_StrConcat( &TMP$297$1, (void*)S$1, 0ll, (void*)"\x0A", 2ll );
...
static void _EMITJMPTB( struct $8FBSYMBOL* TBSYM$1, uint64* VALUES1$1, struct $8FBSYMBOL** LABELS1$1, int64 LABELCOUNT$1, struct $8FBSYMBOL* DEFLABEL$1, uint64 BIAS$1, uint64 SPAN$1 )
{
	...
	FBSTRING* vr$13 = fb_StrConcat( &TMP$299$1, (void*)vr$10, -1ll, (void*)"\x0A", 2ll );
...
static int64 _GETFREEPRESERVEDREG( int64 DCLASS$1, int64 DTYPE$1 )
{
	...
	label$1695:;
	label$1694:;
	int64 vr$3 = (*(tmp$85*)((uint8*)*(struct $8REGCLASS**)((uint8*)((uint8*)&EMIT$ + (DCLASS$1 << (3ll & 63ll))) + 16ll) + 32ll))( *(struct $8REGCLASS**)((uint8*)((uint8*)&EMIT$ + (DCLASS$1 << (3ll & 63ll))) + 16ll), 4ll );
	...
	goto label$1696;
	label$1697:;
	int64 vr$9 = (*(tmp$85*)((uint8*)*(struct $8REGCLASS**)((uint8*)((uint8*)&EMIT$ + (DCLASS$1 << (3ll & 63ll))) + 16ll) + 32ll))( *(struct $8REGCLASS**)((uint8*)((uint8*)&EMIT$ + (DCLASS$1 << (3ll & 63ll))) + 16ll), 2ll );
	...
	goto label$1696;
	label$1698:;
	int64 vr$18 = (*(tmp$85*)((uint8*)*(struct $8REGCLASS**)((uint8*)((uint8*)&EMIT$ + (DCLASS$1 << (3ll & 63ll))) + 16ll) + 32ll))( *(struct $8REGCLASS**)((uint8*)((uint8*)&EMIT$ + (DCLASS$1 << (3ll & 63ll))) + 16ll), 1ll );
...
static void _PROCFOOTER( struct $8FBSYMBOL* PROC$1, int64 BYTESTOPOP$1, struct $8FBSYMBOL* INITLABEL$1, struct $8FBSYMBOL* EXITLABEL$1 )
{
	...
	if( ISLINUX$1 == 0ll ) goto label$1749;
	{
		...
		FBSTRING* vr$20 = fb_StrConcat( &TMP$979$2, (void*)vr$17, -1ll, (void*)"\x0A", 2ll );
		...
		{
			OUTEX( (uint8*)".cfi_startproc\x0A", 0ll );
		}
		label$1751:;
		label$1750:;
	}
	...
	{
		OUTEX( (uint8*)".cfi_endproc\x0A", 0ll );
	}
	label$1754:;
	label$1753:;
