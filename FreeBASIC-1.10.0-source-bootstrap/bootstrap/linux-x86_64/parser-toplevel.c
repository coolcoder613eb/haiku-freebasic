...
void CPROGRAM( void )
{
	...
	label$26:;
	{
		...
		*(uint64*)((uint8*)&PARSER$ + 192ll) = 1ull;
		struct $7ASTNODE* vr$10 = ASTNEWDBG( 113ll, *(int64*)((uint8*)*(struct $9LEX_TKCTX**)((uint8*)&LEX$ + 844560ll) + 16752ll), *(uint8**)((uint8*)&ENV$ + 872ll) );
		ASTADD( vr$10 );
		CLABEL(  );
		CSTATEMENT(  );
		CCOMMENT( 0ll );
		...
		label$42:;
		{
			...
			TMP$92$3 = vr$12;
			if( TMP$92$3 != 257ll ) goto label$47;
			label$48:;
			{
				LEXSKIPTOKEN( 0ll );
			}
			goto label$46;
			label$47:;
			if( TMP$92$3 != 256ll ) goto label$49;
			label$50:;
			{
			}
			goto label$46;
	...
	{
		{
			...
			goto label$63;
			label$64:;
			static const void* tmp$94[221ll] = {
				&&label$70,
				&&label$74,
				&&label$89,
				&&label$89,
			...
			if( (TMP$93$3 - 40ull) > 220ull ) goto label$89;
			goto *tmp$94[TMP$93$3 - 40ull];
			label$63:;
		}
	...
	{
		{
			...
			TMP$95$3 = vr$2;
			if( TMP$95$3 != 256ll ) goto label$104;
			label$105:;
			{
				goto label$97;
			}
			goto label$103;
			label$104:;
			if( TMP$95$3 != 257ll ) goto label$106;
			label$107:;
			{
				ISCOMMENT$1 = 0ll;
			}
			goto label$103;
			label$106:;
			if( TMP$95$3 == 259ll ) goto label$109;
			label$110:;
			if( TMP$95$3 != 260ll ) goto label$108;
			label$109:;
			{
				ISCOMMENT$1 = -1ll;
			}
			goto label$103;
			label$108:;
			if( TMP$95$3 != 340ll ) goto label$111;
			label$112:;
			{
...
static void HEMITCURRENTLINETEXT( void )
{
	...
	if( N$1 == (struct $7ASTNODE*)0ull ) goto label$19;
	{
		if( *(int64*)N$1 != 30ll ) goto label$21;
		{
			...
			{
				struct $7ASTNODE* vr$4 = ASTNEWLIT( *(uint8**)((uint8*)*(struct $9LEX_TKCTX**)((uint8*)&LEX$ + 844560ll) + 49648ll) );
