...
push dword ptr [ebp+8]
call _HCHECKCONSTANDPOINTEROPS
add esp, 16
test eax, eax
jne .L_00DF
jmp .L_00AF
...
.globl _ASTCHECKASSIGNTOTYPE
_ASTCHECKASSIGNTOTYPE:
push ebp
mov ebp, esp
sub esp, 8
mov dword ptr [ebp-4], 0
...
.globl _ASTCHECKBYREFASSIGN
_ASTCHECKBYREFASSIGN:
push ebp
mov ebp, esp
sub esp, 4
mov dword ptr [ebp-4], 0
