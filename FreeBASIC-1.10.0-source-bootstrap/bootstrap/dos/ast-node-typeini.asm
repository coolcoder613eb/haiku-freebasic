...
call _HASTTYPEINIMAYBECONVERTUPCAST
add esp, 8
mov eax, dword ptr [ebp-4]
...
push dword ptr [ebp-8]
push dword ptr [ebp+8]
call _HASTTYPEINITREEMERGEUPCAST
add esp, 16
jmp .L_00E6
.L_00E7:
mov eax, dword ptr [ebp+8]
...
push dword ptr [ebp-28]
push dword ptr [ebp-8]
call _HASTCHECKTYPEINIASSIGNMENT
add esp, 16
test eax, eax
je .L_0128
mov eax, dword ptr [ebp-8]
...
ret
.balign 16
_HASTTYPEINIMAYBECONVERTUPCAST:
push ebp
mov ebp, esp
sub esp, 24
push ebx
