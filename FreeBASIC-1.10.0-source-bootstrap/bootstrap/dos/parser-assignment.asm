...
.globl _CASSIGNMENTORPTRCALLEX
_CASSIGNMENTORPTRCALLEX:
push ebp
mov ebp, esp
sub esp, 4
mov dword ptr [ebp-4], 0
...
.globl _CASSIGNMENTORPTRCALL
_CASSIGNMENTORPTRCALL:
push ebp
mov ebp, esp
sub esp, 32
push ebx
