...
.globl _PARSERINLINEASMADDKEYWORD
_PARSERINLINEASMADDKEYWORD:
push ebp
mov ebp, esp
sub esp, 4
...
call _fb_StrAssign
add esp, 20
call _HINITINLINEASMKEYWORDS
push offset _Lt_036C
call _HISINLINEASMKEYWORD
add esp, 4
test eax, eax
je .L_036B
mov dword ptr [ebp-4], 0
...
.globl _PARSERGLOBALASMADDKEYWORD
_PARSERGLOBALASMADDKEYWORD:
push ebp
mov ebp, esp
sub esp, 4
mov dword ptr [ebp-4], 0
...
.globl _PARSERISGLOBALASMKEYWORD
_PARSERISGLOBALASMKEYWORD:
push ebp
mov ebp, esp
sub esp, 16
push ebx
...
.globl _PARSERASMINIT
_PARSERASMINIT:
.L_0376:
call _HINITGLOBALASMKEYWORDS
.L_0377:
ret
.balign 16
