...
mov dword ptr [ebp-4], 0
push 0
call _HFBIMAGEEXPRINFRONTOFCOORD
add esp, 4
...
add esp, 20
mov dword ptr [ebp-12], eax
mov eax, dword ptr [_SYMB+99624]
add eax, dword ptr [_SYMB+99616]
mov ecx, eax
mov ebx, ecx
sar ebx, 31
push ebx
...
push dword ptr [ebp+16]
push dword ptr [ebp+8]
call _HNIDXARRAY2ARRAYACCESS
add esp, 4
push eax
call _HMAYBEARRAYACCESS2PTR
add esp, 8
mov dword ptr [ebp+8], eax
jmp .L_0087
.L_0088:
