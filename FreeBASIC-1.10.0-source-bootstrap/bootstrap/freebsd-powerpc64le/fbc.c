...
static void HANDLEOPT( int64 OPTID$1, FBSTRING* ARG$1, int64 IS_SOURCE$1 )
{
	label$502:;
	{
		...
		label$639:;
		{
			...
			if( (((int64)-(OS$3 != 5ll) | (int64)-(CPUTYPE$3 != 19ll)) | IS_GNU_TRIPLET$3) == 0ll ) goto label$643;
			{
				FBSTRING TMP$347$4;
