	...
	if( *(uint8**)((int64)(struct $7SYMBKWD*)KWDTB$ + (I$1 << (5ll & 63ll))) == (uint8*)0ull ) goto label$13;
	{
		...
		if( (*(int64*)(((int64)(struct $7SYMBKWD*)KWDTB$ + (I$1 << (5ll & 63ll))) + 24ll) & 1ll) == 0ll ) goto label$15;
		{
			if( *(int64*)((uint8*)&ENV$ + 272ll) != 3ll ) goto label$17;
			{
				...
				__builtin_memset( &TMP$332$4, 0, 24ll );
				FBSTRING* vr$6 = fb_StrConcat( &TMP$332$4, (void*)"__", 3ll, (void*)KNAME$2, 0ll );
...
void SYMBKEYWORDTYPEINIT( void )
{
	...
	static struct $8FBARRAY1I10FBARRAYDIME tmp$333$1 = { (struct $10FBARRAYDIM*)DTB$1, (struct $10FBARRAYDIM*)DTB$1, 16ll, 16ll, 1ll, 49ll, { { 1ll, 0ll, 0ll } } };
	...
	label$48:;
	{
		...
		TMP$336$2 = vr$0;
		if( TMP$336$2 != 2ll ) goto label$51;
		label$52:;
		{
			DTYPE$1 = 19922976ll;
		...
		goto label$50;
		label$51:;
		if( TMP$336$2 != 3ll ) goto label$53;
		label$54:;
		{
			...
			S$1 = vr$1;
			SYMBADDFIELD( S$1, (uint8*)"gp_offset", 0ll, (struct $7FBARRAYI10FBARRAYDIME*)&tmp$333$1, 12ll, (struct $8FBSYMBOL*)0ull, 0ll, 0ll, 0ll );
			SYMBADDFIELD( S$1, (uint8*)"fp_offset", 0ll, (struct $7FBARRAYI10FBARRAYDIME*)&tmp$333$1, 12ll, (struct $8FBSYMBOL*)0ull, 0ll, 0ll, 0ll );
			SYMBADDFIELD( S$1, (uint8*)"overflow_arg_area", 0ll, (struct $7FBARRAYI10FBARRAYDIME*)&tmp$333$1, 32ll, (struct $8FBSYMBOL*)0ull, 0ll, 0ll, 0ll );
			SYMBADDFIELD( S$1, (uint8*)"reg_save_area", 0ll, (struct $7FBARRAYI10FBARRAYDIME*)&tmp$333$1, 32ll, (struct $8FBSYMBOL*)0ull, 0ll, 0ll, 0ll );
		...
		goto label$50;
		label$53:;
		if( TMP$336$2 != 4ll ) goto label$55;
		label$56:;
		{
			...
			S$1 = vr$12;
			SYMBADDFIELD( S$1, (uint8*)"__stack", 0ll, (struct $7FBARRAYI10FBARRAYDIME*)&tmp$333$1, 32ll, (struct $8FBSYMBOL*)0ull, 0ll, 0ll, 0ll );
			SYMBADDFIELD( S$1, (uint8*)"__gr_top", 0ll, (struct $7FBARRAYI10FBARRAYDIME*)&tmp$333$1, 32ll, (struct $8FBSYMBOL*)0ull, 0ll, 0ll, 0ll );
			SYMBADDFIELD( S$1, (uint8*)"__vr_top", 0ll, (struct $7FBARRAYI10FBARRAYDIME*)&tmp$333$1, 32ll, (struct $8FBSYMBOL*)0ull, 0ll, 0ll, 0ll );
			SYMBADDFIELD( S$1, (uint8*)"__gr_offs", 0ll, (struct $7FBARRAYI10FBARRAYDIME*)&tmp$333$1, 11ll, (struct $8FBSYMBOL*)0ull, 0ll, 0ll, 0ll );
			SYMBADDFIELD( S$1, (uint8*)"__vr_offs", 0ll, (struct $7FBARRAYI10FBARRAYDIME*)&tmp$333$1, 11ll, (struct $8FBSYMBOL*)0ull, 0ll, 0ll, 0ll );
			SYMBSTRUCTEND( S$1, 0ll );
		...
		goto label$50;
		label$55:;
		if( TMP$336$2 != 5ll ) goto label$57;
		label$58:;
		{
			...
			S$1 = vr$23;
			SYMBADDFIELD( S$1, (uint8*)"__ap", 0ll, (struct $7FBARRAYI10FBARRAYDIME*)&tmp$333$1, 32ll, (struct $8FBSYMBOL*)0ull, 0ll, 0ll, 0ll );
			SYMBSTRUCTEND( S$1, 0ll );
