...
static void HPTRDECL( int64* );
static uint8* HREADTYPE( int64*, struct $8FBSYMBOL**, int64*, int64* );
static void HADDFORWARDREF( uint8*, uint8*, int64*, struct $8FBSYMBOL**, int64*, int64*, $13FB_SYMBATTRIB );
static void HADDTYPEDEF( uint8*, uint8*, int64, struct $8FBSYMBOL*, int64, int64, $13FB_SYMBATTRIB );
...
static void HPTRDECL( int64* DTYPE$1 )
{
	label$10:;
	int64 PTR_CNT$1;
	PTR_CNT$1 = 0ll;
	...
	{
		{
			...
			label$17:;
			{
				LEXSKIPTOKEN( 2048ll );
				{
					...
					TMP$93$5 = vr$1;
					if( TMP$93$5 == 373ll ) goto label$20;
					label$21:;
					if( TMP$93$5 != 374ll ) goto label$19;
					label$20:;
					{
			...
			if( (TMP$92$3 - 335ull) > 39ull ) goto label$28;
			goto *tmp$96[TMP$92$3 - 335ull];
			label$15:;
		}
	}
	label$14:;
...
static uint8* HREADTYPE( int64* DTYPE$1, struct $8FBSYMBOL** SUBTYPE$1, int64* LGT$1, int64* IS_FIXLENSTR$1 )
{
	uint8* fb$result$1;
	...
	label$31:;
	{
		...
		TMP$94$2 = vr$2;
		if( TMP$94$2 == 0ll ) goto label$35;
		label$36:;
		if( TMP$94$2 != 2ll ) goto label$34;
		label$35:;
		{
			uint8* vr$3 = LEXGETTEXT(  );
			fb_StrAssign( (void*)TNAME$1, 129ll, (void*)vr$3, 0ll, 0 );
			LEXSKIPTOKEN( 2048ll );
		}
		goto label$33;
		label$34:;
		{
			...
			uint8* vr$4 = SYMBUNIQUEID( (boolean)0ll );
			fb_StrAssign( (void*)TNAME$1, 129ll, (void*)vr$4, 0ll, 0 );
			HSKIPUNTIL( -1ll, 0ll, 0ll, 0ll );
		}
		label$37:;
		label$33:;
...
static void HADDFORWARDREF( uint8* PID$1, uint8* PFWDNAME$1, int64* DTYPE$1, struct $8FBSYMBOL** SUBTYPE$1, int64* LGT$1, int64* IS_FIXLENSTR$1, $13FB_SYMBATTRIB ATTRIB$1 )
{
	label$38:;
	int64 PTRCOUNT$1;
	PTRCOUNT$1 = (*DTYPE$1 & 480ll) >> (5ll & 63ll);
	int64 CONSTMASK$1;
	CONSTMASK$1 = *DTYPE$1 & 261632ll;
	...
	label$41:;
	{
		...
		*LGT$1 = -1ll;
		...
		{
			struct $8FBSYMBOL* vr$29 = SYMBLOOKUPBYNAMEANDCLASS( *(struct $8FBSYMBOL**)((uint8*)&SYMB$ + 197024ll), (uint8*)PFWDNAME$1, 14ll, -1ll, 0ll );
			*SUBTYPE$1 = vr$29;
			if( *SUBTYPE$1 != (struct $8FBSYMBOL*)0ull ) goto label$47;
			{
				ERRREPORT( 4ll, 0ll, (uint8*)0ull );
				uint8* vr$32 = SYMBUNIQUELABEL(  );
				struct $8FBSYMBOL* vr$33 = SYMBADDFWDREF( vr$32 );
				*SUBTYPE$1 = vr$33;
			}
			label$47:;
			label$46:;
	...
	label$40:;
	*DTYPE$1 = ((((*DTYPE$1 & 31ll) | ((*DTYPE$1 & 480ll) + (PTRCOUNT$1 << (5ll & 63ll)))) | ((*DTYPE$1 & 261632ll) << (PTRCOUNT$1 & 63ll))) | (*DTYPE$1 & 32505856ll)) | CONSTMASK$1;
	label$39:;
}

static void HADDTYPEDEF( uint8* PID$1, uint8* PFWDNAME$1, int64 DTYPE$1, struct $8FBSYMBOL* SUBTYPE$1, int64 LGT$1, int64 IS_FIXLENSTR$1, $13FB_SYMBATTRIB ATTRIB$1 )
{
	label$48:;
	if( PFWDNAME$1 == (uint8*)0ull ) goto label$51;
	{
	...
	if( TYPEDEF$1 == (struct $8FBSYMBOL*)0ull ) goto label$53;
	{
		...
		label$55:;
		label$54:;
		*($13FB_SYMBATTRIB*)((uint8*)TYPEDEF$1 + 8ll) = *(int64*)((uint8*)TYPEDEF$1 + 8ll) | (ATTRIB$1 & 2097152ll);
		*($13FB_SYMBATTRIB*)((uint8*)TYPEDEF$1 + 8ll) = *(int64*)((uint8*)TYPEDEF$1 + 8ll) | (ATTRIB$1 & 4194304ll);
	}
	goto label$52;
	label$53:;
	{
		...
		struct $8FBSYMBOL* vr$16 = SYMBLOOKUPBYNAMEANDCLASS( *(struct $8FBSYMBOL**)((uint8*)&SYMB$ + 197024ll), (uint8*)PID$1, 13ll, 0ll, 0ll );
		SYM$2 = vr$16;
...
static uint8* HREADID( void )
{
	...
	CCURRENTPARENTID(  );
	{
		...
		label$68:;
		{
			if( (*(int64*)((uint8*)&ENV$ + 1424ll) & 524288ll) == 0ll ) goto label$70;
			{
				if( *(struct $8FBSYMBOL**)((uint8*)&SYMB$ + 197024ll) == (struct $8FBSYMBOL*)((uint8*)&SYMB$ + 196704ll) ) goto label$72;
				{
					if( *(int64*)((uint8*)*(struct $7FBTOKEN**)((uint8*)*(struct $9LEX_TKCTX**)((uint8*)&LEX$ + 844560ll) + 16712ll) + 4144ll) <= 0ll ) goto label$74;
					{
		...
		if( TMP$95$2 > 2ull ) goto label$75;
		goto *tmp$97[TMP$95$2 - 0ull];
		label$66:;
	}
